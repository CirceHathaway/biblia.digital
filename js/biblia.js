...
const versiculosDestacados = [
  ...
  { libro: "1_Corintios", capitulo: 3, versiculo: 7, texto: "Así que ni el que planta es algo, ni el que riega, sino Dios, que da el crecimiento." },
  ...
  { libro: "1_Crónicas", capitulo: 22, versiculo: 13, texto: "Entonces serás prosperado, si cuidares de poner por obra los estatutos y decretos que Jehová mandó a Moisés para Israel. Esfuérzate, pues, y cobra ánimo; no temas, ni desmayes." },
  ...
  { libro: "1_Corintios", capitulo: 13, versiculo: 4, texto: "El amor es paciente, es bondadoso. El amor no es envidioso ni presumido ni orgulloso." },
  ...
  { libro: "1_Juan", capitulo: 3, versiculo: 24, texto: "El que obedece sus mandamientos permanece en Dios y Dios en él. ¿Cómo sabemos que él permanece en nosotros? Por el Espíritu que nos dio." },
