// 1 Reyes — Nueva Versión Internacional (NVI)
// Fuente: nvi-2.txt (convertido automáticamente)
export default [
  [  // 1
    ' El rey David era ya tan anciano y tan entrado en años que, por más que lo abrigaban, no conseguía entrar en calor.',
    'Por eso sus servidores le dijeron: «Busquemos a una joven soltera para que atienda a Su Majestad y lo cuide, y se acueste a su lado para darle calor.»',
    'Así que fueron por todo Israel en busca de una muchacha hermosa, y encontraron a una sunamita llamada Abisag y se la llevaron al rey.',
    ...
    'Adonías, cuya madre fue Jaguit, ambicionaba ser rey, y por lo tanto se levantó en armas. Consiguió carros de combate, caballos y cincuenta guardias de escolta.',
    ...
    'Cerca de Enroguel, junto a la peña de Zojélet, Adonías ofreció un sacrificio de ovejas, bueyes y terneros engordados. Invitó a todos sus hermanos, los hijos del rey, y a todos los funcionarios reales de Judá,',
    ...
    'Ve a presentarte ante el rey David, y dile: ¿Acaso no le había jurado Su Majestad a esta servidora suya que mi hijo Salomón lo sucedería en el trono? ¿Cómo es que ahora el rey es Adonías?',
    ...
    'Ha sacrificado una gran cantidad de toros, terneros engordados y ovejas, y ha invitado a todos los hijos del rey, al sacerdote Abiatar y a Joab, general del ejército; sin embargo, no invitó a Salomón, que es un fiel servidor de Su Majestad.',
    ...
    'Después de eso, regresen con él para que ocupe el trono en mi lugar y me suceda como rey, pues he dispuesto que sea él quien gobierne a Israel y a Judá.',
  ...
  [  // 2
    ...
    'En cambio, sé bondadoso con los hijos de Barzilay de Galaad y permíteles comer en tu mesa, pues ellos me ampararon cuando huía de tu hermano Absalón.',
    ...
    '¡Que la culpa de esas muertes recaiga para siempre sobre la cabeza de Joab y de sus descendientes! ¡Pero que la paz del Señor esté por siempre con David y sus descendientes, y con su linaje y su trono!',
  ...
  [  // 3
    ...
    'Como en Gabaón estaba el santuario pagano más importante, Salomón acostumbraba ir allí para ofrecer sacrificios. Allí ofreció mil holocaustos;',
    'y allí mismo se le apareció el Señor en un sueño, y le dijo: Pídeme lo que quieras.',
    'Salomón respondió: Tú trataste con mucho amor a tu siervo David, mi padre, pues se condujo delante de ti con lealtad y justicia, y con un corazón recto. Y, como hoy se puede ver, has reafirmado tu gran amor al concederle que un hijo suyo lo suceda en el trono.',
  ...
  [  // 4
    ...
    'y éstos fueron sus funcionarios: Azarías, hijo del sacerdote Sadoc;',
    ...
    'Éstos son sus nombres: Ben Jur, en la región montañosa de Efraín;',
    ...
    'Guéber hijo de Uri, en Galaad (que era el país de Sijón, rey de los amorreos, y de Og, rey de Basán). En la tierra de Judá había un solo gobernador.',
    ...
    'La provisión diaria de Salomón era de seis mil seiscientos litros de flor de harina y trece mil doscientos litros de harina,',
  ...
  [  // 5
    ...
    'En respuesta, Salomón le envió este mensaje:',
    ...
    'Así que Hiram le proveía a Salomón toda la madera de cedro y de pino que éste deseaba,',
  ...
  [  // 6
    ...
    'En la construcción del templo sólo se emplearon piedras de cantera ya labradas, así que durante las obras no se oyó el ruido de martillos ni de piquetas, ni de ninguna otra herramienta.',
    ...
    'La palabra del Señor vino a Salomón y le dio este mensaje:',
    ...
    'Cuando Salomón terminó de construir la estructura del templo,',
    ...
    'En el santuario interior, al fondo del templo, acondicionó el Lugar Santísimo, recubriendo el espacio de nueve metros con tablas de cedro desde el piso hasta el techo.',
    'Junto al Lugar Santísimo estaba la nave central, la cual medía dieciocho metros de largo.',
    ...
    'En efecto, recubrió de oro todo el santuario interior, y así mismo el altar que estaba delante de éste.',
    ...
    'De una punta a otra, las alas extendidas del primer querubín medían cuatro metros y medio, es decir, cada una de sus alas medía dos metros con veinticinco centímetros.',
    ...
    'Luego Salomón recubrió de oro los querubines.',
    ...
    'Sobre las dos puertas de madera de olivo talló figuras de querubines, palmeras y flores abiertas, y todas ellas las recubrió de oro.',
  ...
  [  // 7
    ...
    'que era hijo de una viuda de la tribu de Neftalí y de un nativo de Tiro que era artesano en bronce. Hiram era sumamente hábil e inteligente, experto en toda clase de trabajo en bronce, así que se presentó ante el rey Salomón y realizó todo el trabajo que se le asignó.',
    ...
    'Cada base tenía cuatro ruedas de bronce con ejes también de bronce, y por debajo de su lavamanos se apoyaba sobre cuatro soportes fundidos que tenían guirnaldas en cada lado.',
    ...
    'Las cuatro ruedas estaban debajo de los paneles, y los ejes de las ruedas estaban unidos a la base. Cada rueda medía sesenta y siete centímetros de diámetro',
    'y estaba hecha de metal fundido, como las ruedas de los carros, con sus ejes, aros, rayos y cubos.',
    'Cada base tenía cuatro soportes unidos a ella, uno en cada esquina.',
    ...
    'También hizo las ollas, las tenazas y los aspersorios. Así Hiram terminó todo el trabajo que había emprendido para el rey Salomón en el templo del Señor, es decir:',
  ...
  [  // 8
    ...
    'Allí he fijado un lugar para el arca, en la cual está el pacto que el Señor hizo con nuestros antepasados cuando los sacó de Egipto.»',
    ...
    'Has llevado a cabo lo que le dijiste a tu siervo David, mi padre; y este día has cumplido con tu mano lo que con tu boca le prometiste.',
    '»Ahora, Señor, Dios de Israel, cumple también la promesa que le hiciste a tu siervo, mi padre David, cuando le dijiste: Si tus hijos observan una buena conducta y me siguen como tú lo has hecho, nunca te faltará un descendiente que ocupe el trono de Israel en mi presencia.',
    ...
    '»Cuando tu pueblo Israel sea derrotado por el enemigo por haber pecado contra ti, si luego se vuelve a ti para honrar tu nombre, y ora y te suplica en este templo,',
    ...
    'si luego cada israelita, consciente de su propia culpa, extiende sus manos hacia este templo, y ora y te suplica,',
    'óyelo tú desde el cielo, donde habitas, y perdónalo. Trata a cada uno según su conducta, la cual tú conoces, puesto que sólo tú escudriñas el corazón humano.',
    ...
    '»Señor, cuando saques a tu pueblo para combatir a sus enemigos, sea donde sea, si el pueblo ora a ti y dirige la mirada hacia la ciudad que has escogido, hacia el templo que he construido en tu honor,',
    ...
    'y allá en la tierra de sus enemigos que los tomaron cautivos se vuelven a ti de todo corazón y con toda el alma, y oran a ti y dirigen la mirada hacia la tierra que les diste a sus antepasados, hacia la ciudad que has escogido y hacia el templo que he construido en tu honor,',
    ...
    '«¡Bendito sea el Señor, que conforme a sus promesas ha dado descanso a su pueblo Israel! No ha dejado de cumplir ni una sola de las gratas promesas que hizo por medio de su siervo Moisés.',
  ...
  [  // 9
    ...
    'y le dijo: «He oído la oración y la súplica que me has hecho. Consagro este templo que tú has construido para que yo habite en él por siempre. Mis ojos y mi corazón siempre estarán allí.',
    ...
    'Y le responderán: Porque abandonaron al Señor su Dios, que sacó de Egipto a sus antepasados, los israelitas, y se echaron en los brazos de otros dioses, a los cuales adoraron y sirvieron. Por eso el Señor ha dejado que les sobrevenga tanto desastre.»',
    'Veinte años tardó el rey Salomón en construir los dos edificios, es decir, el templo del Señor y el palacio real,',
    'después de lo cual le dio a Hiram, rey de Tiro, veinte ciudades en Galilea, porque Hiram lo había abastecido con todo el cedro, el pino y el oro que quiso.',
    'Sin embargo, cuando Hiram salió de Tiro y fue a ver las ciudades que Salomón le había dado, no quedó satisfecho con ellas.',
    '«Hermano del templo.  mío protestó Hiram, ¿qué clase de ciudades son éstas que me has dado?» De modo que llamó a esa región Cabul, nombre que conserva hasta hoy.',
    'Hiram, por su parte, le había enviado a Salomón tres mil novecientos sesenta kilos de oro.',
    ...
    'El faraón, rey de Egipto, había atacado y tomado Guézer a sangre y fuego, matando a sus habitantes cananeos. Luego, como regalo de bodas, le dio esta ciudad a su hija, la esposa de Salomón.',
    'Por eso Salomón reconstruyó las ciudades de Guézer, Bet Jorón la de abajo,',
    'Balat y Tadmor, en el desierto del país,',
    ...
    'Tres veces al año Salomón presentaba holocaustos y sacrificios de comunión sobre el altar que él había construido para el Señor, y al mismo tiempo quemaba incienso en su presencia. Así cumplía con las obligaciones',
  ...
  [  // 10
    ...
    'Cuando la reina de Sabá vio toda la sabiduría de Salomón, el palacio que él había construido,',
    ...
    'Con la madera, el rey construyó escalones para el templo del Señor y para el palacio real, y también hizo arpas y liras para los músicos. Desde entonces, nunca más se ha importado, ni ha vuelto a verse, tanto sándalo como aquel día.',
  ...
  [  // 11
    ...
    'Lo mismo hizo en favor de sus mujeres extranjeras, para que éstas pudieran quemar incienso y ofrecer sacrificios a sus dioses.',
    ...
    'Hadad agradó tanto al faraón, que éste le dio por esposa a su cuñada, una hermana de la reina Tapenés.',
    ...
    'Salomón, por su parte, intentó matar a Jeroboán, pero éste huyó a Egipto y se quedó allí, bajo la protección del rey Sisac, hasta la muerte de Salomón.',
  ],
  [  // 12
    ...
    'que así dice el Señor: No vayan a luchar contra sus hermanos, los israelitas. Regrese cada uno a su casa, porque es mi voluntad que esto haya sucedido. » Y ellos obedecieron la palabra del Señor y regresaron, tal como el Señor lo había ordenado.',
    ...
    'Si la gente sigue subiendo a Jerusalén para ofrecer sacrificios en el templo del Señor, acabará por reconciliarse con su señor Roboán, rey de Judá. Entonces a mí me matarán, y volverán a unirse a él.»',
    ...
    'Así pues, el día quince del mes octavo Jeroboán subió al altar que había construido en Betel y quemó incienso. Ése fue el día que arbitrariamente decretó como día de fiesta para los israelitas.',
  ],
  [  // 13
    ...
    'Con todo, Jeroboán no cambió su mala conducta, sino que una vez más puso como sacerdotes para los santuarios paganos a toda clase de gente. A cualquiera que deseaba ser sacerdote de esos santuarios, él lo consagraba como tal.',
  ...
  [  // 14
    ...
    'y éste le dijo a su esposa: «Disfrázate para que nadie se dé cuenta de que eres mi esposa. Luego vete a Siló, donde está Ahías, el profeta que me anunció que yo sería rey de este pueblo.', 
    ...
    '» Por eso voy a enviarle una desgracia a la familia de Jeroboán. De sus descendientes en Israel exterminaré hasta el último varón,] esclavo o libre. Barreré la descendencia de ofende al Señor, y con sus pecados Jeroboán como se barre el estiércol, hasta no dejar rastro.',
    ...
    'Entonces todos los israelitas harán duelo por él y lo sepultarán. De la familia de Jeroboán sólo él será sepultado, porque en esa familia sólo él ha complacido al Señor, Dios de Israel.',
    ...
    'Los demás acontecimientos del reinado de Jeroboán, sus batallas y su gobierno, están escritos en el libro de las crónicas de los reyes de Israel.',
    'Jeroboán reinó cuarenta y dos años. Cuando murió, su hijo Nadab lo sucedió en el trono. Roboán, rey de Judá.',
    ...
    'Los habitantes de Judá hicieron lo que provocaron los celos del Señor más que sus antepasados.',
    ...
    'Durante su reinado hubo guerra constante entre él y Jeroboán.',
  ...
  [  // 15
    ...
    'Los demás acontecimientos del reinado de Abías, y todo lo que hizo, están escritos en el libro de las crónicas de los reyes de Judá. También hubo guerra entre Abías y Jeroboán.',
    ...
    'Entonces Asá tomó todo el oro y la plata que habían quedado en los tesoros del templo del Señor y de su propio palacio, y les encargó a sus funcionarios que se los llevaran a Ben Adad, hijo de Tabrimón y nieto de Hezión, rey de Siria, que estaba gobernando en Damasco. Y le envió este mensaje:',
    ...
    'Ben Adad estuvo de acuerdo con el rey Asá y mandó a los jefes de su ejército para que atacaran las ciudades de Israel. Así conquistó Iyón, Dan, Abel Betmacá y todo Quinéret, además de Neftalí.',
    'Cuando Basá se enteró, dejó de fortificar Ramá y se retiró a Tirsá.',
    'Entonces el rey Asá movilizó a todo Judá, sin eximir a nadie, y se llevaron de Ramá las piedras y la madera con que Basá había estado fortificando la ciudad. Con ellas el rey Asá fortificó Gueba de Benjamín, y también Mizpa.',
    ...
    'Luego Asá murió y fue sepultado con sus antepasados en la Ciudad de David. Y su hijo Josafat lo sucedió en el trono. Nadab, rey de Israel.',
    ...
    'Durante los reinados de Asá de Judá y Basá de Israel, hubo guerra entre ellos. Basá, rey de Israel.',
  ...
  [  // 16
    ...
    'Además, por medio del profeta Jehú hijo de Jananí la palabra del Señor vino contra Basá y su familia, debido a todas las ofensas que éste había cometido contra el Señor, provocando así su ira. Y aunque destruyó a la familia de Jeroboán, llegó a ser semejante a ésta por las obras que hizo. Elá, rey de Israel.',
    ...
    'Los demás acontecimientos del reinado de Zimri, incluso lo que atañe a su rebelión, están escritos en el libro de las crónicas de los reyes de Israel. Omrí, rey de Israel.',
    ...
    'En el año treinta y uno de Asá, rey de Judá, Omrí ascendió al trono de Israel, y reinó doce años, seis de ellos en Tirsá.',
    'A un cierto Sémer le compró el cerro de Samaria por sesenta y seis kilos de plata, y allí construyó una ciudad. En honor a Sémer, nombre del anterior propietario del cerro, la llamó Samaria.',
  ...
  [  // 17
    ...
    'Entonces la palabra del Señor vino a él y le dio este mensaje:',
  ...
  [  // 18
    ...
    '¡Qué sé yo adónde lo va a llevar el Espíritu del Señor cuando nos separemos! Si voy y le digo a Acab que usted está aquí, y luego él no lo encuentra, ¡me matará! Tenga usted en cuenta que yo, su servidor, he sido fiel al Señor desde mi juventud.',
    ...
    'Tráiganos dos bueyes. Que escojan ellos uno, y lo descuarticen y pongan los pedazos sobre la leña, pero sin prenderle fuego. Yo prepararé el otro buey y lo pondré sobre la leña, pero tampoco le prenderé fuego.',
    ...
    'Entonces Elías les dijo a los profetas de Baal: Ya que ustedes son tantos, escojan uno de los bueyes y prepárenlo primero. Invoquen luego el nombre de su dios, pero no prendan fuego. ',
    ...
    'Entonces Elías le dijo a todo el pueblo: Así lo hicieron. Como el altar del Señor estaba en ruinas, Elías lo reparó.',
    ...
    'y dijo: y dijo: Llenen de agua cuatro cántaros, y vacíenlos sobre el holocausto y la leña. Luego dijo: Vuelvan a hacerlo. Y así lo hicieron. ¡Háganlo una vez más! les ordenó. Y por tercera vez vaciaron los cántaros.',
  ...
  [  // 19
    ...
    'El Señor le dijo: Regresa por el mismo camino, y ve al desierto de Damasco. Cuando llegues allá, unge a Jazael como rey de Siria,',
  ...
  [  // 20
    ...
    'El rey de Israel mandó llamar a todos los ancianos del país y les dijo: —¡Miren cómo este hombre nos quiere causar problemas! Cuando mandó que le entregara mis esposas y mis hijos, mi oro y mi plata, no se los negué.',
    'Los jefes y todos los del pueblo respondieron: —No le haga caso ni ceda a sus exigencias.',
    'Así que Acab les respondió a los mensajeros de Ben Adad: —Díganle a mi señor y rey: “Yo, su servidor, haré todo lo que me pidió la primera vez, pero no puedo satisfacer esta nueva exigencia”. Ellos regresaron a Ben Adad con esa respuesta.',
    ...
    'El rey de Israel avanzó y abatió a la caballería, de modo que los arameos sufrieron una gran derrota.',
    ...
    'Por otra parte, los funcionarios del rey de Aram le aconsejaron: «Los dioses de los israelitas son dioses de las montañas. Por eso son demasiado fuertes para nosotros. Pero si peleamos contra ellos en las llanuras, sin duda los venceremos.',
    ...
    'Al año siguiente, pasó revista a las tropas Arams y marchó a Afec para atacar a Israel.',
    'Acab, por su parte, pasó revista a las tropas israelitas y las aprovisionó. Estas se pusieron en marcha para salir al encuentro de los arameos, y acamparon frente a ellos. Parecían un pequeño rebaño de cabras, mientras que los arameos cubrían todo el campo.',
    ...
    'Siete días estuvieron acampados los unos frente a los otros, y el séptimo día se desató el combate. En un solo día los israelitas le causaron cien mil bajas a la infantería Aram.',
    ...
    'Los hombres tomaron esa respuesta como un buen augurio y, aprovechando la ocasión, exclamaron: —¡Claro que sí, Ben Adad es su hermano! —Vayan por él —dijo el rey. Cuando Ben Adad se presentó ante Acab, este lo hizo subir a su carro de combate.',
  ...
  [ // 21
    ...
    'Este le dijo a Nabot: —Dame tu viñedo para hacerme una huerta de hortalizas, ya que está tan cerca de mi palacio. A cambio de él te daré un viñedo mejor o, si lo prefieres, te pagaré lo que valga.',
    ...
    'Porque le dije a Nabot el Jezrelita que me vendiera su viñedo o que, si lo prefería, se lo cambiara por otro; pero él se negó.',
    'Ante esto, Jezabel su esposa le dijo: —¿Y no eres tú quien manda en Israel? ¡Levántate y come, que te hará bien! Yo te conseguiré el viñedo del tal Nabot.',
    ...
    'En las cartas decía: "Decreten un día de ayuno, y denle a Nabot un lugar prominente en la asamblea del pueblo.',
    ...
    'Acab le respondió a Elías: Sí —contestó Elías—, te he encontrado porque te has vendido para hacer lo que ofende al Señor,',
    ...
    'Haré con tu familia lo mismo que hice con la de Jerobon hijo de Nabat y con la de Bas hijo de Ahas, porque has provocado mi ira y has hecho que Israel peque.',
  ...
  [  // 22
    ...
    'el cual dijo a sus funcionarios: "¿No saben que Ramot de Galaad nos pertenece? ¿Y no hemos hecho nada para obligar al rey de Aram a que nos la devuelva!"',
    'Así que le preguntó a Josafat: "Estoy a tu disposición, lo mismo que mi pueblo y mis caballos."',
    ...
    'El rey de Israel le respondió: —Todavía hay alguien por medio de quien podemos consultar al Señor, pero me cae muy mal porque nunca me profetiza nada bueno; solo me anuncia desastres. Se trata de Micaías, hijo de Imlá. —No digas eso —respondió Josafat.',
    ...
    '—¿Por qué medios? —preguntó el Señor. Y aquel espíritu respondió: "Saldré y seré un espíritu mentiroso en la boca de todos sus profetas." Entonces el Señor ordenó: "Ve y hazlo así, que tendrás éxito en seducirlo."',
    ...
    'Entonces el rey de Israel ordenó: Tomen a Micaías y llévenselo a Amón, el gobernador de la ciudad, y a Jos, mi hijo.',
    'Díganles que les ordenó echar en la cárcel a ese tipo, y no darle más que pan y agua, hasta que yo regrese sin contratiempos.',
    ...
    'Pero el rey de Aram les había ordenado a sus treinta y dos capitanes de los carros de combate: "No luchen contra nadie, grande o pequeño, salvo contra el rey de Israel."',
    ...
    'Todo el día arreciò la batalla, y al rey se le mantuvo de pie en su carro, frente a los arameos. Pero la sangre de su herida no dejaba de correr por el piso del carro, y esa misma tarde Acab murió.',
    ...
    'Josafat hijo de Asá ascendió al trono de Judá en el cuarto año de Acab, rey de Israel.',
    'Josafat tenía treinta y cinco años cuando comenzó a reinar, y reinó en Jerusalén veinticinco años. El nombre de su madre era Azuba hija de Silj.',
    ...
    'Josafat también estaba en paz con el rey de Israel.',
    'Los demás acontecimientos del reinado de Josafat, lo que llevó a cabo y sus proezas militares, están escritos en el libro de las crónicas de los reyes de Judá.',
    'Libró la tierra del resto de hombres que practicaban la prostitución en los santuarios, los cuales se habían quedado allí incluso después del reinado de su padre Asá.',
    'En aquel tiempo no había rey en Edom, sino que gobernaba un regente.',
    'Por esos días Josafat construyó una flota mercante para ir a Ofir por oro, pero nunca llegaron a zarpar, pues naufragaron en Ezion Guéber.',
    ...
    'Josafat murió y fue sepultado con sus antepasados en la ciudad de su padre David. Y su hijo Joram lo sucedió en el trono.',
    'Ocozías hijo de Acab ascendió al trono de Israel en Samaria en el año diecisiete de Josafat, rey de Judá, y reinó dos años en Israel.',
    'Pero hizo lo que ofende al Señor, porque anduvo en los caminos de su padre y de su madre, y en los caminos de Jerobon hijo de Nabat, que hizo que Israel pecara.',
    'Sirvió y adoró a Baal, y provocó la ira al Señor, Dios de Israel, tal como lo había hecho su padre.',
  ],
];