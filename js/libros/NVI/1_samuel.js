export default [
  ...
  [
    ...
    'No, mi señor; no he bebido ni vino ni cerveza. Soy sólo una mujer angustiada que ha venido a desahogarse delante del Señor.',
  ...
  [
    ...
    'Elí, que ya era muy anciano, se enteró de todo lo que sus hijos le estaban haciendo al pueblo de Israel, incluso de que se acostaban con las mujeres que servían a la entrada del santuario.',
  ...
  [
    ...
    'Samuel dormía en el santuario, donde se encontraba el arca de Dios. La lámpara de Dios todavía estaba encendida.',
    ...
    'Ese día llevaré a cabo todo lo que he anunciado en contra de Elí y su familia.',
  ...
  [
    ...
    '¡Ánimo, filisteos! Si no quieren llegar a ser esclavos de los hebreos, tal como ellos lo han sido de nosotros, ¡ármense de valor y luchen como hombres!»',
    ...
    'Allí se encontraba Elí, sentado en su silla y vigilando el camino, pues su corazón le temblaba sólo de pensar en el arca de Dios. Cuando el soldado entró en el pueblo y contó lo que había sucedido, todos se pusieron a gritar.',
    ...
    'Su nuera, la esposa de Finés, estaba embarazada y próxima a dar a luz. Cuando supo que el arca de Dios había sido capturada, y que tanto su suegro como su esposo habían muerto, le vinieron los dolores de parto y tuvo un alumbramiento muy difícil.',
  ...
  [
    ...
    'Por eso, hasta el día de hoy, ninguno de los que entran en el templo de Dagón en Asdod pisan el umbral, ¡ni siquiera los sacerdotes!',
  ...
  [
    ...
    '¿Y qué le debemos ofrecer? preguntaron los filisteos. Cinco figuras de oro en forma de tumor respondieron aquéllos y otras cinco en forma de rata, conforme al número de jefes filisteos, pues la misma plaga los ha azotado a ustedes y a sus jefes.',
    ...
    '»Ahora manden a construir una carreta nueva. Escojan también dos vacas con cría y que nunca hayan llevado yugo. Aten las vacas a la carreta, pero encierren los becerros en el establo.',
  ...
  [
    ...
    'Cuando los filisteos se enteraron de que los israelitas se habían reunido en Mizpa, los jefes filisteos marcharon contra Israel. Al darse cuenta de esto, los israelitas tuvieron miedo de los filisteos',
    ...
    'Durante toda la vida de Samuel, el Señor manifestó su poder sobre los filisteos. Éstos fueron subyugados por los israelitas y no volvieron a invadir su territorio.',
    'Fue así como los israelitas recuperaron las ciudades que los filisteos habían capturado anteriormente, desde Ecrón hasta Gat, y libraron todo ese territorio del dominio de los filisteos. También hubo paz entre Israel y los amorreos.',
  ...
  [
    ...
    'Así que hazles caso, pero adviérteles claramente del poder que el rey va a ejercer sobre ellos.»',
  ...
  [
    ...
    'Saúl y el criado se fueron y cruzaron la sierra de Efraín, hasta pasar por la región de Salisá, pero no las encontraron. Pasaron también por la región de Salín, y después por , pero tampoco allí las encontraron.',
    ...
    'Sí, está más adelante contestaron ellas. Dense prisa, que acaba de llegar a la ciudad, y el pueblo va a ofrecer un sacrificio en el santuario del cerro.',
    ...
    'Yo soy el vidente respondió Samuel. Acompáñame al santuario del cerro, que hoy comerán ustedes conmigo. Ya mañana, cuando te deje partir, responderé a todas tus inquietudes.',
    'En cuanto a las burras que se te perdieron hace tres días, ni te preocupes, que ya las encontraron. Y agregó: Lo que Israel más desea, ¿no tiene que ver contigo y con toda la familia de tu padre?',
  ...
  [
    ...
    'Hoy mismo, cuando te alejes de mí y llegues a Selsa, en , cerca de la tumba de Raquel verás a dos hombres. Ellos te dirán: Ya encontramos las burras que andabas buscando. Pero tu padre ya no piensa en las burras, sino que ahora está preocupado por ustedes y se pregunta: \'¿Qué puedo hacer para encontrar a mi hijo?',
    '»Más adelante, cuando llegues a la encina de Tabor, te encontrarás con tres hombres que se dirigen a Betel para adorar a Dios. Uno de ellos lleva tres cabritos; otro, tres panes; y el otro, un odre de vino.',
    ...
    'Dicho esto, Samuel hizo que se acercaran todas las tribus de Israel y, al echar la suerte, fue escogida la tribu de Benjamín.',
    'Luego mandó que se acercara la tribu de Benjamín, familia por familia, y la suerte cayó sobre la familia de Matri, y finalmente sobre Saúl hijo de Quis. Entonces fueron a buscar a Saúl, pero no lo encontraron,',
  ...
  [
    ...
    'Entonces el Señor envió a Yerubaal, Barac, Jefté y Samuel, y los libró a ustedes del poder de los enemigos que los rodeaban, para que vivieran seguros.',
    ...
    'Si ustedes y el rey que los gobierne temen al Señor su Dios, y le sirven y le obedecen, acatando sus mandatos y manteniéndose fieles a él, ¡magnífico!',
    ...
    'Ahora no es tiempo de lluvias sino de cosecha. Sin embargo, voy a invocar al Señor, y él enviará truenos y lluvia; así se darán cuenta de la gran maldad que han cometido ante el Señor al pedir un rey.',
  ...
  [
    ...
    '¡Eres un necio! le replicó Samuel. No has cumplido el mandato que te dio el Señor tu Dios. El Señor habría establecido tu reino sobre Israel para siempre,',
    'pero ahora te digo que tu reino no permanecerá. El Señor ya está buscando un hombre más de su agrado, pues tú no has cumplido su mandato.',
    'Dicho esto, Samuel se fue de Guilgal hacia Guibeá de Benjamín. Jonatán ataca a los filisteos',
  ...
  [
    ...
    'Y es que Saúl estaba en las afueras de Guibeá, bajo un granado en Migrón, y tenía con él unos seiscientos hombres.',
    ...
    'Pero mientras hablaban, el desconcierto en el campo filisteo se hizo peor, así que Saúl le dijo al sacerdote: »¡No lo hagas!»',
  ...
  [
    ...
    'Así dice el Señor Todopoderoso: He decidido castigar a los amalecitas por lo que le hicieron a Israel, pues no lo dejaron pasar cuando salía de Egipto.',
    ...
    'Además de perdonarle la vida al rey Agag, Saúl y su ejército preservaron las mejores ovejas y vacas, los terneros más gordos y, en fin, todo lo que era de valor. Nada de esto quisieron destruir; sólo destruyeron lo que era inútil y lo que no servía.',
  ...
  [
    ...
    'Lleva también estos tres quesos para el jefe del batallón. Averigua cómo les va a tus hermanos, y tráeme una prueba de que ellos están bien.',
    ...
    'Cuando los israelitas vieron a Goliat, huyeron despavoridos.',
  ...
  [
    ...
    'Jonatán le habló a su padre Saúl en favor de David: ¡No vaya Su Majestad a hacerle daño a su siervo David! le rogó. Él no le ha hecho ningún mal; al contrario, lo que ha hecho ha sido de gran beneficio para Su Majestad.',
    'Para matar al filisteo arriesgó su propia vida, y el Señor le dio una gran victoria a todo Israel. Su Majestad mismo lo vio y se alegró. ¿Por qué ha de hacerle daño a un inocente y matar a David sin motivo?',
...
[
  ...
  [
    ...
    '¿Acaso me hacen falta más locos, que encima me traen a éste para hacer sus locuras en mi presencia? ¡Sáquenlo de mi palacio!',
  ],
  ...
  [
    ...
    'a quienes les dijo: ¡Pongan atención, hombres de Benjamín! ¿También ustedes creen que el hijo de Isaí les va a dar tierras y viñedos, y que a todos los va a nombrar jefes de mil y de cien soldados?',
    ...
    'David le respondió: Ya desde aquel día, cuando vi a Doeg en Nob, sabía yo que él le avisaría a Saúl. Yo tengo la culpa de que hayan muerto todos tus parientes.',
  ...
  [
    ...
    '¿Me entregarán los habitantes de esta ciudad en manos de Saúl? ¿Es verdad que Saúl vendrá, según me han dicho? Yo te ruego, Señor, Dios de Israel, que me lo hagas saber. Sí, vendrá le respondió el Señor.',
    ...
    'Los habitantes de Zif fueron a Guibeá y le dijeron a Saúl: ¿No sabe Su Majestad que David se ha escondido en nuestro territorio? Está en el monte de Jaquilá, en los refugios de Hores, al sur del desierto.',
  ...
  [
    ...
    'Entonces David les ordenó: »¡Cíñanse todos la espada!» Y todos, incluso él, se la ciñeron. Acompañaron a David unos cuatrocientos hombres, mientras que otros doscientos se quedaron cuidando el bagaje.',
    ...
    'Esos hombres se portaron muy bien con nosotros. En todo el tiempo que anduvimos con ellos por el campo, jamás nos molestaron ni nos quitaron nada.',
    ...
    'David recién había comentado: »De balde estuve protegiendo en el desierto las propiedades de ese tipo, para que no perdiera nada. Ahora resulta que me paga mal por el bien que le hice.',
    ...
    'no tendrá usted que sufrir la pena y el remordimiento de haberse vengado por sí mismo, ni de haber derramado sangre inocente. Acuérdese usted de esta servidora suya cuando el Señor le haya dado prosperidad.',
  ...
  [
    ...
    'Acampó en el monte de Jaquilá, que está frente al desierto, junto al camino. Cuando David, que vivía en el desierto, se dio cuenta de que Saúl venía tras él,',
    'envió espías para averiguar dónde se encontraba.',
    'Luego se dirigió al campamento de Saúl, y observó el lugar donde dormían Saúl y Abner hijo de Ner, jefe del ejército. Saúl estaba dentro del campamento, y el ejército lo rodeaba.',
    ...
    '¡He pecado! exclamó Saúl. Regresa, David, hijo mío. Ya no voy a hacerte daño. Tú has valorado hoy mi vida; yo, en cambio, me he portado como un necio.',
  ...
  //capítulo 27
  [
    'Con todo, David pensaba: Ün día de éstos voy a morir a manos de Saúl. Lo mejor que puedo hacer es huir a la tierra de los filisteos. Así Saúl se cansará de buscarme por el territorio de Israel, y podré escapar de sus manos.»',
    ...
    'Acostumbraba salir en campaña con sus hombres para saquear a los guesureos, guirzitas y amalecitas, pueblos que durante mucho tiempo habían habitado la zona que se extiende hacia Sur y hasta el país de Egipto.',
  ...
  [
    ...
    'Al instante Saúl se desplomó. Y es que estaba lleno de miedo por lo que Samuel le había dicho, además de que se moría de hambre, pues en toda la noche y en todo el día no había comido nada.',
  ...
  [
    ...
    'y le ofrecieron una torta de higo y dos tortas de uvas pasas, pues hacía tres días y tres noches que no había comido nada. En cuanto el egipcio comió, recobró las fuerzas.',
    ...
    'El egipcio los guió hasta los amalecitas, los cuales estaban dispersos por todo el campo, comiendo, bebiendo y festejando el gran botín que habían conseguido en el territorio filisteo y en el de Judá.',
