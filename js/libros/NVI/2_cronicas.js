// 2 Crónicas (NVI) — exportado automáticamente
export default[
  [ //Capítulo 1
    ...
    "Entonces Dios le dijo a Salomón: Ya que has pedido sabiduría y conocimiento para gobernar a mi pueblo, sobre el cual te he hecho rey, y no has pedido riquezas ni bienes ni esplendor, y ni siquiera la muerte de tus enemigos o una vida muy larga,",
  ...
  [ //Capítulo 2
    ...
    "¡Alabado sea el Señor, Dios de Israel, que hizo el cielo y la tierra, porque le ha dado al rey David un hijo sabio, dotado de sabiduría e inteligencia, el cual construirá un palacio real y un templo para el Señor!",
    ...
    "Salomón hizo un censo de todos los extranjeros que vivían en Israel. Este censo, que fue posterior al que había hecho su padre David, arrojó la cifra de ciento cincuenta y tres mil seiscientos.",
  ...
  [ //Capítulo 3
    ...
    "Salomón hizo también el Lugar Santísimo, el cual medía lo mismo que el ancho del templo, es decir, nueve metros de largo y nueve metros de ancho. Lo recubrió por dentro con veintitrés toneladas de oro fino.",
    ...
    "Cada una de las alas del segundo querubín también medía dos metros con veinticinco centímetros; una de ellas tocaba la pared interior de la habitación, y la otra rozaba el ala del primer querubín.",
  ...
  [ //Capítulo 4
    ...
    "La fuente descansaba sobre doce bueyes, que tenían sus cuartos traseros hacia adentro. Tres bueyes miraban al norte, tres al oeste, tres al sur y tres al este.",
  ...
  [ //Capítulo 5
    ...
    "Los sacerdotes y los levitas la trasladaron junto con la Tienda de reunión y con todos los utensilios sagrados que había en ella.",
  ...
  [ //Capítulo 6
    ...
    "»Trata de igual manera al extranjero que no pertenece a tu pueblo Israel, pero que atraído por tu gran fama y por tus despliegues de fuerza y poder ha venido de lejanas tierras. Cuando ese extranjero venga y ore en este templo,",
    "óyelo tú desde el cielo, donde habitas, y concédele cualquier petición que te haga. Así todos los pueblos de la tierra conocerán tu nombre y, al igual que tu pueblo Israel, tendrán temor de ti y comprenderán que en este templo que he construido se invoca tu nombre.",
  ...
  [ //Capítulo 7
    ...
    "Al ver los israelitas que el fuego descendía y que la gloria del Señor se posaba sobre el templo, cayeron de rodillas y, postrándose rostro en tierra, alabaron al Señor diciendo: «El Señor es bueno; su gran amor perdura para siempre.»",
    ...
    "En aquella ocasión Salomón y todo Israel celebraron la fiesta durante siete días. Era una inmensa asamblea que había acudido de todo lugar, desde Lebó Jamat hasta el río de Egipto.",
    ...
    "El día veintitrés del mes séptimo, Salomón envió al pueblo a sus casas, y ellos regresaron contentos y llenos de alegría por el bien que el Señor había hecho en favor de David, de Salomón y de su pueblo Israel. Pacto de Dios con Salomón",
    ...
    "Y le responderán: Porque abandonaron al Señor, Dios de sus antepasados, que los sacó de Egipto, y se echaron en los brazos de otros dioses, a los cuales adoraron y sirvieron. Por eso el Señor ha dejado que les sobrevenga tanto desastre. »"
  ],
  [ //Capítulo 8
    ...
    "Luego marchó contra la ciudad de Jamat de Sobá y la conquistó.",
    ...
    "Lo mismo hizo con Balat y con todos los lugares de almacenamiento que tenía, con los cuarteles perfectamente terminado. para sus carros de combate y para su caballería, y con todo cuanto quiso construir en Jerusalén, en el Líbano y en todo el territorio bajo su dominio.",
    "En el país quedaron los descendientes de los pueblos no israelitas, es decir, los hititas, amorreos, ferezeos, heveos y jebuseos. Los israelitas no pudieron destruir esos pueblos,",
    "pero Salomón sometió a trabajos forzados a todos los que Israel no había destruido. Así continúan hasta el día de hoy.",
    ...
    "Toda la obra de Salomón se llevó a cabo, desde el día en que se echaron los cimientos del templo hasta que se terminó de construirlo. Así el templo del Señor quedó",
  ...
  [ //Capítulo 9
    ...
    "Cuando la reina de Sabá vio la sabiduría de Salomón, el palacio que él había construido,",
    ...
    "Sus caballos eran importados de Egipto y de todos los otros países. Muerte de Salomón",
  ...
  [ //Capítulo 10
    ...
    "y siguió más bien el de los jóvenes. Les dijo: «Si mi padre les impuso un yugo pesado; ¡yo les aumentaré la carga! Si él los castigaba a ustedes con una vara, ¡yo lo haré con un látigo!»",
    ...
    "Desde entonces Israel ha estado en rebelión contra"
  ],
  [ //Capítulo 11
    ...
    "que así dice el Señor: No vayan a luchar contra sus hermanos. Regrese cada uno a su casa, porque es mi voluntad que esto haya sucedido. » Y ellos obedecieron las palabras del Señor y desistieron de marchar contra Jeroboán. Roboán fortifica las ciudades de Judá",
    ...
    "Después se casó con Macá hija de Absalón. Los hijos que ella le dio fueron Abías, Atay, Ziza y Selomit.",
    "Roboán amó a Macá hija de Absalón más que a sus otras esposas y concubinas. En total, tuvo dieciocho esposas y sesenta concubinas, y fue padre de veintiocho hijos y de sesenta hijas.",
  ...
  [ //Capítulo 12
    ...
    "así que el rey Roboán afirmó su trono y continuó reinando en Jerusalén. Su madre era una amonita llamada Noamá. Roboán tenía cuarenta y un años cuando ascendió al trono, y reinó diecisiete años en Jerusalén, la ciudad donde, de entre todas las tribus de Israel, el Señor había decidido habitar.",
  ...
  [ //Capítulo 15
    ...
    "Durante los primeros treinta y cinco años del reinado de Asá no hubo guerra. Pacto de Asá con Ben Adad."
  ],
  [ //Capítulo 16
    ...
    "Entonces Asá sacó plata y oro de los tesoros del templo del Señor y del palacio real, y se los envió a Ben Adad, rey de Siria, que gobernaba en Damasco. También le envió este mensaje:",
    "«Hagamos un pacto entre tú y yo, como el que hicieron tu padre y el mío. Aquí te envío oro y plata. Anula tu pacto con Basá, rey de Israel, para que se marche de aquí.»",
  ...
  [ //Capítulo 17
    ...
    "Aun algunos filisteos le llevaron a Josafat, como tributo, regalos y plata. Los árabes también le llevaron siete mil setecientos carneros y siete mil setecientos machos cabríos.",
    ...
    "De Benjamín: Imlá! Eliadá, guerrero valiente, al frente de doscientos mil soldados que portaban arcos y escudos.",
  ...
  [ //Capítulo 18
    ...
    "después de algún tiempo fue a visitarlo en Samaria. Allí Acab mató muchas ovejas y vacas para Josafat y sus acompañantes, y lo animó a marchar contra Ramot de Galaad.",
    ...
    "Entonces el rey de Israel llamó a uno de sus funcionarios y le ordenó: ¡Traigan de inmediato a Micaías hijo de",
    ...
    "Cuando los capitanes de los carros vieron a Josafat, pensaron: «Éste es el rey de Israel.» Así que se volvieron para atacarlo; pero Josafat gritó, y Dios el Señor lo ayudó, haciendo que se apartaran de él.",
    ...
    "Todo el día arreció la batalla, y al rey de Israel se le mantuvo de pie en su carro frente a los sirios, hasta el atardecer, y murió al ponerse el sol."
  ],
  [ //Capítulo 19
  ...
  [ //Capítulo 20
    ...
    "Josafat y todos los habitantes de Judá y de Jerusalén se postraron rostro en tierra y arpas, liras y trompetas. adoraron al Señor,",
    ...
    "Al llegar, entraron en el templo del Señor al son de",
  ...
  [ //Capítulo 21
    ...
    "Sus hermanos eran Azarías, Jehiel, Zacarías, Azarías, Micael y Sefatías. Todos éstos fueron hijos de Josafat, rey de Israel.",
    ...
    "Jorán tenía treinta y dos años cuando ascendió al trono, y reinó en Jerusalén ocho años.",
    ...
    "sino que seguiste el mal ejemplo de los reyes de Israel, haciendo que los habitantes de Judá y de Jerusalén fueran infieles a Dios, como lo hizo la familia de Acab; y por cuanto asesinaste a tus hermanos, la familia de tu padre, que eran mejores que tú,",
    ...
    "Así que marcharon contra Judá y la invadieron, y se llevaron todos los objetos de valor que hallaron en el palacio real, junto con los hijos y las mujeres de Jorán. Ninguno de sus hijos escapó con vida, excepto Joacaz, que era el menor de todos.",
  ...
  [ //Capítulo 22
    ...
    "Tenía cuarenta y dos años cuando ascendió al trono, y reinó en Jerusalén un año. Su madre era Atalía, nieta de Omrí.",
    ...
    "Por consejo de ellos, Ocozías se juntó con Jorán hijo de Acab, rey de Israel, y marchó hacia Ramot de Galaad para hacerle la guerra a Jazael, rey de Siria, pero en la batalla los sirios hirieron a Jorán.",
    "Por eso tuvo que regresar a Jezrel, para reponerse de las heridas que había recibido en Ramot cuando luchó contra Jazael, rey de Siria. Como Jorán hijo de Acab convalecía en Jezrel, Ocozías hijo de Jorán, rey de Judá, fue a visitarlo.",
  ...
  [ //Capítulo 23
    ...
    "otra tercera parte permanecerá en el palacio real, y la tercera parte restante ocupará la puerta de los Cimientos, mientras que todo el pueblo estará en los atrios del templo.",
    "Sólo los sacerdotes y levitas que estén de servicio entrarán en el templo, pues ellos están consagrados; nadie más podrá entrar. El pueblo deberá obedecer el precepto del Señor.",
    ...
    "y luego colocó en sus puestos a todos. Cada uno, arma en mano, protegía al rey cerca del altar y desde el lado sur hasta el lado norte del templo.",
    ...
    "Acto seguido, Joyadá, acompañado de los capitanes, los nobles, los gobernadores y todo el pueblo, llevó al rey desde el templo del Señor hasta el palacio real, pasando por la puerta superior, y sentaron a Joás en el trono real.",
    "Todo el pueblo estaba alegre, y tranquila la ciudad, pues habían matado a Atalía a filo de espada."
  ],
  [ //Capítulo 24
    "Joás tenía siete años cuando ascendió al trono, y reinó en Jerusalén cuarenta años. Su madre era Sibia, oriunda de Berseba. 2Mientras el sacerdote Joyadá vivió, Joás hizo lo que agradaba al Señor.",
    ...
    "Entonces el rey llamó al sumo sacerdote Joyadá y le dijo: «¿Por qué no has presionado a los levitas para que vayan y recojan en Judá y en Jerusalén la contribución que Moisés, siervo del Señor, y la asamblea de Israel impusieron para la Tienda del pacto?»",
    ...
    "El rey y Joyadá entregaban el dinero a los que supervisaban Señor vea esto y te juzgue!» la restauración del templo del Señor, y éstos contrataban canteros, carpinteros, y expertos en el manejo del hierro y del bronce, para repararlo.",
    ...
    "El Espíritu de Dios vino sobre Zacarías, hijo del sacerdote Joyadá, y éste, presentándose ante el pueblo, declaró: «Así dice Dios el Señor: ¿Por qué desobedecen mis mandamientos? De ese modo no prosperarán. Como me han abandonado, yo también los abandonaré.»",
  ...
  [ //Capítulo 25
    ...
    "El ejército de Judá capturó vivos a otros diez mil. A éstos los hicieron subir a la cima de una roca, y desde allí los despeñaron. Todos murieron destrozados.",
    ...
    "Los israelitas batieron a los de Judá, y éstos huyeron a sus hogares.",
  ...
  [ //Capítulo 26
    ...
    "Uzías contaba con un ejército que salía a la guerra por escuadrones, de acuerdo con el censo hecho por el cronista Jeyel y por el oficial Maseías, bajo la dirección de Jananías, funcionario del rey.",
    "El total de los jefes de familia era de dos mil seiscientos, todos ellos guerreros valientes.",
    "Bajo el mando de éstos había un ejército bien entrenado, compuesto por trescientos siete mil quinientos soldados, que combatían con mucho valor para apoyar al rey en su lucha contra los enemigos.",
    ...
    "Detrás de él entró el sumo sacerdote Azarías, junto con ochenta sacerdotes del Señor, todos ellos hombres valientes,",
    ...
    "Los demás acontecimientos del reinado de Uzías, desde el primero hasta el último, los escribió el profeta Isaías hijo de Amoz.",
  ...
  [ //Capítulo 27
    ...
    "construyó ciudades en las montañas de Judá, y fortalezas y torres en los bosques.",
    ...
    "Los demás acontecimientos del reinado de Jotán, y sus guerras y su conducta, están escritos en el libro de los reyes de Israel y de Judá.",
  ...
  [ //Capítulo 28
    ...
    "Por eso el Señor su Dios lo entregó al poder del rey de Siria. Los sirios lo derrotaron, y capturaron una gran cantidad de prisioneros que se llevaron a Damasco. Acaz también cayó en poder del rey de Israel, quien le infligió una gran derrota.",
    ...
    "De entre sus hermanos de Judá, los israelitas capturaron a doscientas mil personas, incluyendo a mujeres, niños y niñas. Además, se apoderaron de un enorme botín, que se llevaron a Samaria.",
    ...
    "Entonces Acaz le entregó al rey de Asiria todo lo que había de valor en el templo del Señor, en el palacio real y en las casas de sus oficiales; pero eso de nada le sirvió.",
    ...
    "Acaz murió y fue sepultado en la ciudad de Jerusalén, pero no en el panteón de los reyes de Israel. Su hijo Ezequías lo sucedió en el trono."
  ],
  [ //Capítulo 29
    ...
    "Éstos son los levitas que se dispusieron a trabajar: De los descendientes de Coat: Mahat hijo de Amasay, y Joel hijo de Azarías. De los descendientes de Merari: Quis hijo de Abdí, y Azarías hijo de Yalelel. De los descendientes de Guersón: Joa hijo de Zimá, y Edén hijo de Joa.",
    ...
    "Éstos reunieron a sus parientes, se purificaron y entraron en el templo del Señor para purificarlo, cumpliendo así la orden del rey, según las palabras del Señor.",
    ...
    "Además, hemos reparado y purificado todos los utensilios que, en su rebeldía, el rey Acaz profanó durante su reinado, y los hemos puesto ante el altar del Señor.»",
    "El rey Ezequías se levantó muy de mañana, reunió a los jefes de la ciudad y se fue con ellos al templo del Señor.",
    "Llevaron siete bueyes, siete carneros y siete corderos; además, como ofrenda por el pecado del reino, del santuario y de Judá, llevaron siete machos cabríos. El rey ordenó a los sacerdotes descendientes de Aarón que los ofrecieran en holocausto sobre el altar del Señor.",
    "Los sacerdotes mataron los toros, recogieron la sangre y la rociaron sobre el altar; luego mataron los carneros y rociaron la sangre sobre el altar; después mataron los corderos y rociaron la sangre sobre el altar.",
    ...
    "Pero como los sacerdotes eran pocos y no podían desollar tantos animales, sus parientes levitas tuvieron que ayudarlos para terminar el trabajo, a fin de que los otros sacerdotes pudieran purificarse, pues los levitas habían sido más diligentes en purificarse que los sacerdotes.",
  ...
  [ //Capítulo 30
    ...
    "acordaron pregonar por todo Israel, desde Dan hasta Berseba, que todos debían acudir a Jerusalén para celebrar la Pascua del Señor, Dios de Israel, pues muchos no la celebraban como está prescrito.",
    ...
    "El día catorce del mes segundo celebraron la Pascua. Los sacerdotes y los levitas, compungidos, se purificaron y llevaron holocaustos al templo del Señor,",
    ...
    "En efecto, mucha gente de Efraín, de Manasés, de Isacar y de Zabulón participó de la comida pascual sin haberse purificado, con lo que transgredieron lo prescrito. Pero Ezequías oró así a favor de ellos: «Perdona, buen Dios,",
    ...
    "Toda la asamblea de Judá estaba alegre, lo mismo que todos los sacerdotes, levitas y extranjeros que habían llegado de Israel, así como los que vivían en Judá.",
  ...
  [ //Capítulo 31
    ...
    "Y todos llevaron fielmente las ofrendas, los diezmos y los dones consagrados. El encargado de administrar todo esto era el levita Conanías, y su hermano Simí le ayudaba.",
    "El rey Ezequías y Azarías, que administraba el templo de Dios, nombraron como inspectores a Jehiel, Azazías, Najat, Asael, Jerimot, Jozabad, Eliel, Ismaquías, Mahat y Benaías, y los pusieron bajo las órdenes de Conanías y su hermano Simí.",
    "El levita Coré hijo de Imná, guardián de la puerta oriental, estaba encargado de las ofrendas voluntarias que se hacían al Señor, y de distribuir las ofrendas del Señor y los dones consagrados.",
    "Bajo sus órdenes estaban Edén, Minjamín, Jesúa, Semaías, Amarías y Secanías. Éstos se hallaban en las ciudades de los sacerdotes y, según sus turnos, distribuían fielmente las ofrendas entre sus compañeros, grandes y pequeños.",
    ...
    "Además, en todas las ciudades había personas encargadas de repartir las porciones entre los sacerdotes descendientes de Aarón, y entre los levitas que estaban inscritos en el registro y que vivían en las aldeas de sus ciudades.",
    "Eso mismo hizo Ezequías en todo Judá, actuando con bondad, rectitud y fidelidad ante el Señor su Dios.",
    "Todo lo que emprendió para el servicio del templo de Dios, lo hizo de todo corazón, de acuerdo con la ley y el mandamiento de buscar a Dios, y tuvo éxito."
  ],
  [ //Capítulo 32
    ...
    "Los oficiales de Senaquerib les gritaban a voz en cuello a los habitantes de Jerusalén que estaban en la muralla. Lo hacían en lengua hebrea, para infundirles miedo y así poder conquistar la ciudad.",
    ...
    "Entonces el Señor envió un ángel para que exterminara a todos los soldados y a los jefes y capitanes del campamento del rey de Asiria, y éste tuvo que volver avergonzado a su país. Al entrar en el templo de su dios, sus propios hijos lo asesinaron.",
    ...
    "Ezequías fue también quien cegó la salida superior de las aguas de Guijón y las desvió por un canal subterráneo hacia la parte occidental de la Ciudad de David. En fin, Ezequías tuvo éxito en todas las obras que emprendió.",
  ...
  [ //Capítulo 33
    ...
    "Reconstruyó los santuarios paganos que su padre Ezequías había derribado; además, erigió altares en honor de los baales e hizo imágenes de la diosa Aserá. Se postró ante todos los astros del cielo y los adoró.",
    ...
    "Oró al Señor, y él escuchó sus súplicas y le permitió regresar a Jerusalén y volver a reinar. Así Manasés reconoció que sólo el Señor es Dios.",
    "Después de esto, Manasés construyó una alta muralla exterior en la Ciudad de David, la cual iba desde el oeste de Guijón, en el valle, hasta la puerta del Pescado, y rodeaba Ofel. Además, colocó jefes militares en todas las ciudades fortificadas de Judá",
    ...
    "Luego reconstruyó el altar del Señor, y en él ofreció sacrificios de comunión y de acción de gracias, y le ordenó a Judá que sirviera al Señor, Dios de Israel.",
    "Sin embargo, el pueblo siguió ofreciendo sacrificios en los santuarios paganos, aunque se los ofrecían sólo al Señor su Dios.",
  ...
  [ //Capítulo 34
    ...
    "Estos hombres realizaban su trabajo con honradez. Los que estaban al frente de ellos eran los levitas Yajat y Abdías, descendientes de Merari, y Zacarías y Mesulán, descendientes de Coat. Los levitas, que eran hábiles en tocar instrumentos de música,",
    ...
    "Jilquías le dijo al cronista Safán: «He encontrado el libro de la ley en el templo del Señor.» Entonces se lo entregó,",
    ...
    "Después hizo que todos los que se encontraban en Jerusalén y en Benjamín confirmaran el pacto. Y así los habitantes de Jerusalén actuaron según el pacto del Dios de sus antepasados.",
  ...
  [ //Capítulo 35
    ...
    "También los jefes hicieron sus donativos para el pueblo y para los sacerdotes y levitas. Por su parte, Jilquías, Zacarías y Jehiel, oficiales del templo de Dios, entregaron a los sacerdotes dos mil seiscientos animales de ganado menor y trescientos bueyes, para celebrar la Pascua.",
    "Conanías y sus hermanos Semaías y Natanael, y Jasabías, Jeyel y Josabad, jefes de los levitas, entregaron a los levitas cinco mil animales de ganado menor y quinientos bueyes.",
    ...
    "Luego prepararon la Pascua para ellos mismos y para los sacerdotes descendientes de Aarón. Los levitas tuvieron que prepararla para ellos mismos y para los sacerdotes porque éstos estuvieron ocupados hasta la noche ofreciendo los holocaustos y la grasa.",
    ...
    "En aquella ocasión, los israelitas allí presentes celebraron durante siete días la fiesta de la Pascua y la de los Panes sin levadura.",
    "Desde la época del profeta Samuel no se había celebrado una Pascua semejante, y ninguno de los reyes había celebrado una Pascua así, como lo hizo Josías con los sacerdotes y levitas, con los habitantes de Judá y de Israel allí presentes, y con los de Jerusalén.",
    ...
    "Josías no le hizo caso a la advertencia que Dios le dio por medio de Necao; al contrario, en vez de retirarse, se disfrazó y fue a la llanura de Meguido para pelear con Necao.",
    "Como los arqueros le dispararon, el rey Josías les dijo a sus servidores: «Sáquenme de aquí, porque estoy gravemente herido.»",
    "Sus servidores lo sacaron del carro en que estaba y lo trasladaron a otro carro, y lo llevaron a Jerusalén. Allí murió, y fue sepultado en el panteón de sus antepasados. Y todo Judá y todo Jerusalén hicieron duelo por él.",
    ...
    "y sus hechos, desde el primero hasta el último, están escritos en el libro de los reyes de Israel y de Judá."
  ],
  [ //Capítulo 36
    ...
    "Joaquín tenía dieciocho años cuando ascendió al trono, y reinó en Jerusalén tres meses y diez días, pero hizo lo que ofende al Señor.",
    ...
    "«Esto es lo que ordena Ciro, rey de Persia: »El Señor, Dios del cielo, que me ha dado todos los reinos de la tierra, me ha encargado que le construya un templo en la ciudad de Jerusalén, que está en Judá. Por tanto, cualquiera que pertenezca a Judá, que se vaya, y que el Señor su Dios lo acompañe.»"
  ]
];
