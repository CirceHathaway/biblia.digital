export default [
  ...
  [
    ...
    'Yo me acerqué y lo maté, pues me di cuenta de que no iba a sobrevivir al desastre. Luego le quité la diadema de la cabeza y el brazalete que llevaba en el brazo, para traérselos a usted, mi señor.',
  ...
  //capítulo 2
  [
    'Pasado algún tiempo, David consultó al Señor: ¿Debo ir a alguna de las ? Sí, debes ir le respondió el Señor. ¿Y a qué ciudad quieres que vaya? A Hebrón.',
    'Así que David fue allá con sus dos esposas, Ajinoán la jezrelita y Abigaíl, la viuda de Nabal de Carmel.',
    ...
    'Isboset hijo de Saúl tenía cuarenta años cuando fue instaurado rey de Israel, y reinó dos años. La tribu de Judá, por su parte, reconoció a David,',
    ...
    'Así que pasaron al frente doce jóvenes del ejército benjaminita de Isboset hijo de Saúl, y doce de los siervos de David.',
    ...
    'Allí se encontraban Joab, Abisay y Asael, los tres hijos de Sarvia. Asael, que corría tan ligero como una gacela en campo abierto,','se lanzó tras Abner y lo persiguió sin vacilar.',
    ...
    'Como Asael no dejaba de perseguirlo, Abner le dio un golpe con la punta trasera de su lanza y le atravesó el vientre. La lanza le salió por la espalda, y ahí mismo Asael cayó muerto. Todos los que pasaban por ahí se detenían a ver el cuerpo de Asael,',
    'pero Joab y Abisay se lanzaron tras Abner. Ya se ponía el sol cuando llegaron al collado de Amá, frente a Guiaj, en el camino que lleva al desierto de Gabaón.',
    ...
    'Abner le gritó a Joab: ¿Vamos a dejar que siga esta matanza? ¿No te das cuenta de que, al fin de cuentas, la victoria es amarga? ¿Qué esperas para ordenarles a tus soldados que dejen de perseguir a sus hermanos?',
    ...
    'Toda esa noche Abner y sus hombres atravesaron el Arabá. Después de cruzar el Jordán, siguieron por todo el territorio de Bitrón hasta llegar a Majanayin.',
  ...
  [
    ...
    'el sexto, Itreán hijo de Eglá, que era otra esposa de David. Éstos son los hijos que le nacieron a David mientras estuvo en Hebrón.',
    ...
    'Abner habló también con los de Benjamín, y más tarde fue a Hebrón para contarle a David todo lo que Israel y la tribu de Benjamín deseaban hacer.',
    'Cuando Abner llegó a Hebrón, David preparó un banquete para él y los veinte hombres que lo acompañaban.',
    'Allí Abner le propuso a David: »Permítame Su Majestad convocar a todo Israel para que hagan un pacto con usted, y así su reino se extenderá a su gusto.» Con esto, David despidió a Abner, y éste se fue tranquilo.',
    ...
    '¡Los responsables de su muerte son Joab y toda su familia! ¡Que nunca falte en la familia de Joab alguien que sufra de hemorragia o de lepra, o que sea cojo, o que muera violentamente, o que pase hambre!»',
  ...
  [
    ...
    'y, al llegar a Hebrón, le entregaron a David la cabeza de Isboset, diciendo: Mire, Su Majestad: aquí le traemos la cabeza de Isboset, hijo de su enemigo Saúl, que intentó matarlo a usted. El Señor ha vengado hoy a Su Majestad por lo que Saúl y su descendencia le hicieron.',
  ...
  [
    ...
    'Así pues, todos los ancianos de Israel fueron a Hebrón para hablar con el rey David, y allí el rey hizo un pacto con ellos en presencia del Señor. Después de eso, ungieron a David para que fuera rey sobre Israel.',
    ...
    'Los hijos que allí tuvo fueron Samúa, Sobab, Natán, Salomón,',
  ...
  [
    ...
    'y a cada uno de los israelitas que estaban allí congregados, que eran toda una multitud de hombres y mujeres, les repartió pan, una torta de dátiles y una torta de uvas pasas. Después de eso, todos regresaron a sus casas.',
  ...
  [
    ...
    'Yo he estado contigo por dondequiera que has ido, y por ti he aniquilado a todos tus enemigos. Y ahora voy a hacerte tan famoso como los más grandes de la tierra.',
    'También voy a designar un lugar para mi pueblo Israel, y allí los plantaré para que puedan vivir sin sobresaltos. Sus malvados enemigos no volverán a humillarlos como lo han hecho desde el principio,',
    ...
    'Dígnate entonces bendecir a la familia de tu siervo, de modo que bajo tu protección exista para siempre, pues tú mismo, Señor omnipotente, lo has prometido. Si tú bendices a la dinastía de tu siervo, quedará bendita para siempre.»',
  ],
  ...
  [
    ...
    'Como Tou también era enemigo de Hadad Ezer, envió a su hijo Jorán a desearle bienestar al rey David, y a felicitarlo por haber derrotado a Hadad Ezer en batalla. Jorán llevó consigo objetos de plata, de oro y de bronce,',
    'los cuales el rey David consagró al Señor, tal como lo había hecho con la plata y el oro de las otras naciones que él había subyugado:',
    'Edom, Moab, los amonitas, los filisteos y los amalecitas. También consagró el botín que le había quitado a Hadad Ezer, hijo del rey Rejob de Sobá.',
  ...
  [
    ...
    'y como la familia de Saúl había tenido un administrador que se llamaba Siba, mandaron a llamarlo. Cuando Siba se presentó ante David, éste le preguntó: ¿Tú eres Siba? A las órdenes de Su Majestad respondió.',
    ...
    'Te ordeno que cultives para él la tierra y guardes la cosecha para el sustento de su casa. Que te ayuden tus quince hijos y tus veinte criados. En cuanto al nieto de tu amo, siempre comerá en mi mesa.',
  ...
  [
    ...
    'Los amonitas avanzaron hasta la entrada de su ciudad y se alistaron para la batalla, mientras que los sirios de Sobá y Rejob se quedaron aparte, en campo abierto, junto con los hombres de Tob y de Macá.',
    ...
    'En seguida Joab y sus tropas avanzaron para atacar a los sirios, y éstos huyeron de él.',
    ...
    'Los sirios, al verse derrotados por Israel, volvieron a reunirse.',
    ...
    'Al ver que los sirios habían sido derrotados por los israelitas, todos los reyes vasallos de Hadad Ezer hicieron la paz con los israelitas y se sometieron a ellos. Y nunca más se atrevieron los sirios a ir en auxilio de los amonitas.',
  ],
  ...
  [
    ...
    '¿Quién mató a Abimélec hijo de Yerubéset? ¿No fue acaso una mujer la que le arrojó una piedra de molino desde la muralla de Tebes y lo mató? ¿Por qué se acercaron tanto a la muralla? Pues si te hace estas preguntas, respóndele: También ha muerto Urías el hitita, siervo de Su Majestad. »',
  ...
  [
    ...
    '¿Qué forma de actuar es ésta? le preguntaron sus oficiales. Cuando el niño estaba vivo, usted ayunaba y lloraba; pero ahora que se ha muerto, ¡usted se levanta y se pone a comer!',
  ...
  [
    ...
    'Sin embargo, Amnón tenía un amigo muy astuto, que se llamaba Jonadab, y que era hijo de Simá y sobrino de David. Jonadab',
    'le preguntó a Amnón: ¿Cómo es que tú, todo un príncipe, te ves cada día peor? ¿Por qué no me cuentas lo que te pasa? Es que estoy muy enamorado de mi hermana Tamar respondió Amnón.',
    ...
    'Absalón se quedó en Guesur tres años.',
  ...
  [
    ...
    'Pero ahora resulta que toda la familia se ha puesto en contra de esta servidora de Su Majestad. Me exigen que entregue al asesino para que lo maten, y así vengar la muerte de su hermano, aunque al hacerlo eliminen al heredero. La verdad es que de esa manera apagarían la última luz de esperanza que me queda, y dejarían a mi esposo sin nombre ni descendencia sobre la tierra.',
    ...
    '¿Cómo es que Su Majestad intenta hacer lo mismo contra el pueblo de Dios? Al prometerme usted estas cosas, se declara culpable, pues no deja regresar a su hijo desterrado.',
    ...
    '¿Acaso no está Joab detrás de todo esto? La mujer respondió: Juro por la vida de Su Majestad que su pregunta ha dado en el blanco. En efecto, fue su siervo Joab quien me instruyó y puso en mis labios todo lo que he dicho.',
    'Lo hizo para disimular el asunto, pero Su Majestad tiene la sabiduría de un ángel de Dios, y sabe todo lo que sucede en el país.',
    'Entonces el rey llamó a Joab y le dijo: Estoy de acuerdo. Anda, haz que regrese el joven Absalón.',
    'Postrándose rostro en tierra, Joab le hizo una reverencia al rey y le dio las gracias, añadiendo: Hoy sé que cuento con el favor de mi señor y rey, pues usted ha accedido a mi petición.',
    ...
    'Joab fue a comunicárselo al rey; éste, por su parte, mandó llamar a Absalón, el cual se presentó ante el rey y, postrándose rostro en tierra, le hizo una reverencia. A su vez, el rey recibió a Absalón con un beso.',
  ],
  ...
  [
    ...
    'Entre ellos se encontraba también Sadoc, con los levitas que llevaban el arca del pacto de Dios. Éstos hicieron descansar el arca en el suelo, y Abiatar ofreció sacrificios hasta que toda la gente terminó de salir de la ciudad.',
    ...
    'También le dijo: Como tú eres vidente, puedes volver tranquilo a la ciudad con Abiatar, y llevarte contigo a tu hijo Ajimaz y a Jonatán hijo de Abiatar.',
  ...
  [
    ...
    'Abisay hijo de Sarvia le dijo al rey: ¿Cómo se atreve este perro muerto a maldecir a Su Majestad? ¡Déjeme que vaya y le corte la cabeza!',
  ...
  [
    ...
    'Pero los soldados respondieron: No, Su Majestad no debe acompañarnos. Si tenemos que huir, el enemigo no se va a ocupar de nosotros. Y aun si la mitad de nosotros muere, a ellos no les va a importar. ¡Pero Su Majestad vale por diez mil de nosotros! Así que es mejor que se quede y nos apoye desde la ciudad.',
    ...
    'Además, el rey dio esta orden a Joab, Abisay e Itay: No me traten duro al joven Absalón. Y todas las tropas oyeron las instrucciones que el rey le dio a cada uno de sus generales acerca de Absalón.',
    ...
    'Pero el hombre respondió: Aun si recibiera mil monedas, yo no alzaría la mano contra el hijo del rey. Todos oímos cuando el rey les ordenó a usted, a Abisay y a Itay que no le hicieran daño al joven Absalón.',
    ...
    'Ajimaz llegó y saludó al rey postrándose rostro en tierra, y le dijo: ¡Bendito sea el Señor, Dios de Su Majestad, pues nos ha entregado a los que se habían rebelado en contra suya!',
  ...
  [
    ...
    'Con él iban mil benjaminitas, e incluso Siba, que había sido administrador de la familia de Saúl, con sus quince hijos y veinte criados. Éstos llegaron al Jordán antes que el rey',
    ...
    'Barzilay, que ya era un anciano de ochenta años, le había proporcionado al rey todo lo necesario durante su estadía en Majanayin, pues era muy rico.',
    ...
    'Déjeme usted regresar a mi propio pueblo, para que pueda morir allí y ser enterrado en la tumba de mis padres. Pero aquí le dejo a Quimán para que sirva a Su Majestad y lo acompañe a cruzar el río. Haga usted por él lo que haría por mí.',
    ...
    'El rey, acompañado de Quimán y escoltado por las tropas de Judá y la mitad de las tropas de Israel, siguió hasta Guilgal.',
  ...
  [
    ...
    'Sabá recorrió todas las tribus de Israel, hasta llegar a Abel Betmacá, y allí todos los del clan de Bicrí se le unieron.',
    'Las tropas de Joab llegaron a la ciudad de Abel Betmacá y la sitiaron. Construyeron una rampa contra la fortificación para atacar la ciudad, y cuando los soldados comenzaban a derribar la muralla,',
    ...
    'Yo no he venido a eso, sino a capturar a un hombre llamado Sabá hijo de Bicrí. Es de la sierra de Efraín y se ha sublevado contra el rey David. Si me entregan a ese hombre, me retiro de la ciudad. Muy bien respondió la mujer. Desde la muralla arrojaremos su cabeza.',
  ...
  [
    ...
    'Pero mandó apresar a Armoní y a Mefiboset, los dos hijos que Rizpa hija de Ayá había tenido con Saúl, y a los cinco hijos que Merab hija de Saúl había tenido con Adriel hijo de Barzilay, el mejolatita.',
    ...
    'Sin embargo, Abisay hijo de Sarvia fue en su ayuda e hirió al filisteo y lo mató. Allí los soldados de David le hicieron este juramento: »Nunca más saldrá Su Majestad con nosotros a la batalla, no sea que alguien lo mate y se apague la lámpara de Israel.»',
  ...
  [
    ...
    'En segundo lugar estaba Eleazar hijo de Dodó el ajojita, que también era uno de los tres más famosos. Estuvo con David cuando desafiaron a los filisteos que se habían concentrado en Pasdamín para la batalla. Los israelitas se retiraron,',
    ...
    'El tercer valiente era Sama hijo de Agué el ararita. En cierta ocasión, los filisteos formaron sus tropas en un campo sembrado de lentejas. El ejército de Israel huyó ante ellos,',
    ...
    'Entre los treinta valientes estaban: Asael hermano de Joab, Eljanán hijo de Dodó, el de Belén,',
    'Sama el jarodita, Elicá el jarodita,',
    'Heles el paltita, Ira hijo de Iqués el tecoíta,',
    'Abiezer el anatotita, Mebunay el jusatita,',
    'Zalmón el ajojita, Maray el netofatita,',
    'Jéled hijo de Baná el netofatita, Itay hijo de Ribay, el de Guibeá de los benjaminitas,',
    'Benaías el piratonita, Hiday, el de los arroyos de Gaas,',
    'Abí Albón el arbatita, Azmávet el bajurinita,',
    'Elijaba el salbonita, los hijos de Jasén, Jonatán hijo de',
    'Sama el ararita, Ahían hijo de Sarar el ararita,',
    'Elifelet hijo de Ajasbay el macateo, Elián hijo de Ajitofel el guilonita,',
    'Jezró el de Carmel, Paray el arbita,',
    'Igal hijo de Natán, el de Sobá, el hijo de Hagrí,',
  ...
  [
    ...
    'Sin embargo, la orden del rey prevaleció sobre la opinión de Joab y de los capitanes del ejército, de modo que salieron de su audiencia con el rey para llevar a cabo el censo militar de Israel.',
    ...
    'Por lo tanto, el Señor mandó contra Israel una peste que duró desde esa mañana hasta el tiempo señalado; y en todo el país, desde Dan hasta Berseba, murieron setenta mil personas.',
    ...
    'Pero el rey le respondió a Arauna: Eso no puede ser. No voy a ofrecer al Señor mi Dios holocaustos que nada me cuesten. Te lo compraré todo por su precio justo. Fue así como David compró la parcela y los bueyes por cincuenta monedas de plata.',
