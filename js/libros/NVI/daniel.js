export default [
  ...
  [
    ...
    'éste se vio obligado a responderle a Daniel: «Tengo miedo de mi señor el rey, pues fue él quien te asignó la comida y el vino. Si el rey llega a verte más flaco y demacrado que los otros jóvenes de tu edad, por culpa tuya me cortará la cabeza.»',
  ...
  [
    ...
    'Los astrólogos le respondieron: ¡Que viva Su Majestad por siempre! Estamos a su servicio. Cuéntenos el sueño, y nosotros le diremos lo que significa.',
    ...
    'Pero si me dicen lo que soñé y me explican su significado, yo les daré regalos, recompensas y grandes honores. Así que comiencen por decirme lo que soñé, y luego explíquenme su significado.',
    ...
    'Si no me dicen lo que soñé, ya saben lo que les espera. Ustedes se han puesto de acuerdo para salirme con cuestiones engañosas y mal intencionadas, esperando que cambie yo de parecer. Díganme lo que soñé, y así sabré que son capaces de darme su interpretación.',
    ...
    'Con ellos se hicieron añicos el hierro y el barro, junto con el bronce, la plata y el oro. La estatua se hizo polvo, como el que vuela en el verano cuando se trilla el trigo. El viento barrió con la estatua, y no quedó ni rastro de ella. En cambio, la roca que dio contra la estatua se convirtió en una montaña enorme que llenó toda la tierra.',
    '»Éste fue el sueño que tuvo Su Majestad, y éste es su significado:',
    ...
    '»Después de Su Majestad surgirá otro reino de menor importancia. Luego vendrá un tercer reino, que será de bronce, y dominará sobre toda la tierra.',
    'Finalmente, vendrá un cuarto reino, sólido como el hierro. Y así como el hierro todo lo rompe, destroza y pulveriza, este cuarto reino hará polvo a los otros reinos.',
    '»Su Majestad veía que los pies y los dedos de la estatua eran mitad hierro y mitad barro cocido. El hierro y el barro, que Su Majestad vio mezclados, significan que éste será un reino dividido, aunque tendrá la fuerza del hierro.',
    'Y como los dedos eran también mitad hierro y mitad barro, este reino será medianamente fuerte y medianamente débil.',
    ...
    'Luego el rey puso a Daniel en un puesto prominente y lo colmó de regalos, lo nombró gobernador de toda la provincia de Babilonia y jefe de todos sus sabios.',
  ...
  [
    ...
    'Para celebrar tal dedicación, los sátrapas, prefectos, gobernadores, consejeros, tesoreros, jueces, magistrados y demás oficiales de las provincias se reunieron ante la estatua.',
    ...
    'Usted ha emitido un decreto ordenando que todo el que oiga la música de trompetas, flautas, cítaras, liras, arpas, zampoñas y otros instrumentos musicales, se incline ante la estatua de oro y la adore.',
    'También ha ordenado que todo el que no se incline ante la estatua ni la adore será arrojado a un horno en llamas.',
    'Pero hay algunos judíos, a quienes Su Majestad ha puesto al frente de la provincia de Babilonia, que no acatan sus órdenes. No adoran a los dioses de Su Majestad ni a la estatua de oro que mandó erigir. Se trata de Sadrac, Mesac y Abednego.',
    'Lleno de ira, Nabucodonosor los mandó llamar. Cuando los jóvenes se presentaron ante el rey,',
    'Nabucodonosor les dijo: Ustedes tres, ¿es verdad que no honran a mis dioses ni adoran a la estatua de oro que he mandado erigir?',
    'Ahora que escuchen la música de los instrumentos musicales, más les vale que se inclinen ante la estatua que he mandado hacer, y que la adoren. De lo contrario, serán lanzados de inmediato a un horno en llamas, ¡y no habrá dios capaz de librarlos de mis manos!',
  ...
  [
    ...
    'No había terminado de hablar cuando, desde el cielo, se escuchó una voz que decía: «Éste es el decreto en cuanto a ti, rey Nabucodonosor. Tu autoridad real se te ha quitado.',
  ...
  [
    ...
    'Daniel fue llevado a la presencia del rey, y éste le preguntó: ¿Así que tú eres Daniel, uno de los exiliados que mi padre trajo de Judá?',
    ...
    'Los sabios y hechiceros se presentaron ante mí para leer esta escritura y decirme lo que significa, pero no pudieron descifrarla.',
  ...
  [
    ...
    '¡Pues Daniel respondieron ellos, que es uno de los exiliados de Judá, no toma en cuenta a Su Majestad ni al decreto que ha promulgado! ¡Todavía sigue orando a su Dios tres veces al día!',
    ...
    'Pero aquellos hombres fueron a ver al rey y lo presionaron: No olvide Su Majestad que, según la ley de los medos y los persas, ningún decreto ni edicto emitido por el rey puede ser derogado.',
  ...
  [
    ...
    '»Yo me quedé mirando por causa de las grandes insolencias que profería el cuerno. Seguí mirando hasta que a esta bestia la mataron, la descuartizaron y echaron los pedazos al fuego ardiente.',
    ...
    'Quise saber también acerca de los diez cuernos que tenía en la cabeza, y del otro cuerno que le había salido y ante el cual habían caído tres de ellos. Este cuerno se veía más impresionante que los otros, pues tenía ojos y hablaba con insolencia.',
    ...
    '»Ésta fue la explicación que me dio el venerable Anciano: La cuarta bestia es un cuarto reino que surgirá en este mundo. Será diferente a los otros reinos; devorará a toda la tierra; ¡la aplastará y la pisoteará!',
    'Los diez cuernos son diez reyes que saldrán de este reino. Otro rey les sucederá, distinto a los anteriores, el cual derrocará a tres reyes.',
  ...
  [
    ...
    '» Hacia el final de esos reinos, cuando los rebeldes lleguen al colmo de su maldad, surgirá un rey de rostro adusto, maestro de la intriga,',
    'que llegará a tener mucho poder, pero no por sí mismo. Ese rey causará impresionantes destrozos y saldrá airoso en todo lo que emprenda. Destruirá a los poderosos y al pueblo santo.',
    'Con su astucia propagará el engaño, creyéndose un ser superior. Destruirá a mucha gente que creía estar segura, y se enfrentará al Príncipe de los príncipes, pero será destruido sin la intervención humana.',
  ...
  [
    ...
    'Ésta fue la oración y confesión que le hice: »Señor, Dios grande y terrible, que cumples tu pacto de fidelidad con los que te aman y obedecen tus mandamientos:',
    ...
    'después de las sesenta y dos semanas, se le quitará la vida al príncipe elegido. Éste se quedará sin ciudad y sin santuario, porque un futuro gobernante los destruirá. El fin vendrá como una inundación, y la destrucción no cesará hasta que termine la guerra.',
  ...
  [
    ...
    'Durante veintiún días el príncipe de Persia se me opuso, así que acudió en mi ayuda Miguel, uno de los príncipes de primer rango. Y me quedé allí, con los reyes de Persia.',
    ...
    'Pero antes de eso, te diré lo que está escrito en el libro de la verdad. En mi lucha contra ellos, sólo cuento con el apoyo de Miguel, el capitán de ustedes.'
  ],
  ...
  [
    ...
    'Pasados algunos años harán una alianza: la hija del rey del sur se casará con el rey del norte, y harán las paces, aunque ella no retendrá su poder, y el poder del rey tampoco durará. Ella será traicionada, junto con su escolta, su hijo y su esposo. » En esos días,',
    ...
    'Tocará a sus hijos alistarse para la guerra, y reunirán a un gran ejército que, como una inundación, avanzará arrasándolo todo hasta llegar a la fortaleza.',
    ...
    '» Mira, Daniel, por ese tiempo habrá muchos que se rebelarán contra el rey del sur, incluso gente violenta de tu pueblo, pero no saldrán victoriosos. Así se cumplirá la visión.',
    'Entonces el rey del norte vendrá y levantará rampas de asalto y conquistará la ciudad fortificada, pues las fuerzas del sur no podrán resistir; ¡ni siquiera sus mejores tropas podrán ofrecer resistencia!',
    'El ejército invasor hará de las suyas, pues nadie podrá hacerle frente, y se establecerá en nuestra hermosa tierra, la cual quedará bajo su dominio.',
    'El rey del norte se dispondrá a atacar con todo el poder de su reino, pero hará una alianza con el rey del sur: éste le dará su hija en matrimonio, con miras a derrocar su reino, pero sus planes no tendrán el éxito esperado.',
    ...
    'Envalentonado por su fuerza, ese hombre atacará al rey del sur con un gran ejército. Al frente de un ejército muy grande y poderoso, el rey del sur responderá al ataque; pero no podrá vencerlo, porque será traicionado.',
    ...
    'El rey del norte regresará a su país con grandes riquezas, pero antes profanará el santo templo, así que llevará a cabo sus planes y luego volverá a su país.',
    ...
    '» Cuando llegue la hora final, el rey del sur trabará combate contra el rey del norte, pero éste responderá a su ataque con carros y caballos y con toda una flota de barcos de guerra. Invadirá muchos países, y los arrasará como una inundación.',
