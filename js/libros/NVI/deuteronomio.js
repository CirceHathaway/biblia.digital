export default [
  ...
  [
    ...
    'El día primero del mes undécimo del año cuarenta, Moisés les declaró a los israelitas todo lo que el Señor les había ordenado por medio de él.',
    ...
    'Pónganse en marcha y diríjanse a la región montañosa de los amorreos y a todas las zonas vecinas: el Arabá, las montañas, las llanuras occidentales, el Néguev y la costa, hasta la tierra de los cananeos, el Líbano y el gran río, el Éufrates.',
    'Yo les he entregado esta tierra; ¡adelante, tomen posesión de ella! El Señor juró que se la daría a los antepasados de ustedes, es decir, a Abraham, Isaac y Jacob, y a sus descendientes. Nombramiento de jefes',
    ...
    'Üstedes me respondieron: Tu plan de acción nos parece excelente.',
    ...
    'Entonces les dije: Han llegado a la región montañosa de los amorreos, la cual el Señor nuestro Dios nos da.',
    ...
    'Los doce salieron en dirección a la región montañosa, y llegaron al valle de Escol y lo exploraron.',
    'Tomaron consigo algunos de los frutos de la tierra, nos los trajeron y nos informaron lo buena que es la tierra que nos da el Señor nuestro Dios. Rebelión contra el Señor',
  ...
  [
    ...
    'el Señor me dijo:',
    'Hoy van a cruzar la frontera de Moab por la ciudad de Ar.',
  ...
  [
    ...
    'Pero el Señor me dijo: No le tengan miedo, porque se lo he entregado a ustedes, con todo su ejército y su territorio. Hagan con él lo que hicieron con Sijón, rey de los amorreos, que reinaba en Hesbón.',
    ...
    'Por cierto, el rey Og de Basán fue el último de los gigantes. Su cama era de hierro y medía cuatro metros y medio de largo por dos de ancho. Todavía se puede verla en Rabá de los amonitas. División de la tierra',
    ...
    'No podrán volver al territorio que les he entregado hasta que el Señor haya dado reposo a sus hermanos, como se lo ha dado a ustedes, y hasta que ellos hayan tomado posesión de la tierra que el Señor su Dios les entregará al otro lado del Jordán. Instrucciones a Josué',
  ...
  [
    ...
    '»Miren, yo les he enseñado los preceptos y las normas que me ordenó el Señor mi Dios, para que ustedes los pongan en práctica en la tierra de la que ahora van a tomar posesión.',
    ...
    'En aquel tiempo el Señor me ordenó que les enseñara los preceptos y las normas que ustedes deberán poner en práctica en la tierra que van a poseer al cruzar el Jordán. Prohibición de la idolatría',
    ...
    'De lo contrario, cuando levanten los ojos y vean todo el ejército del cielo es decir, el sol, la luna y las estrellas, pueden sentirse tentados a postrarse ante ellos y adorarlos. Esos astros los ha designado el Señor, el Dios de ustedes, como dioses de todas las naciones que están debajo del cielo.',
    ...
    '»Si después de haber tenido hijos y nietos, y de haber vivido en la tierra mucho tiempo, ustedes se corrompen y se fabrican ídolos y toda clase de figuras, haciendo así lo malo ante el Señor su Dios y provocándolo a ira',
    ...
    'Porque el Señor tu Dios es un Dios compasivo, que no te abandonará ni te destruirá, ni se olvidará del pacto que mediante juramento hizo con tus antepasados. El Señor es Dios',
    ...
    'Obedece sus preceptos y normas que hoy te mando cumplir. De este modo a ti y a tus descendientes les irá bien, y permanecerán mucho tiempo en la tierra que el Señor su Dios les da para siempre.» Ciudades de refugio',
    ...
    'Para los rubenitas designó Béser en el desierto, en la planicie; para los gaditas, Ramot de Galaad; y para los manasesitas, Golán de Basán. Introducción a la ley',
    ...
    'cuando todavía estaban al este del Jordán, en el valle cercano a Bet Peor. Era la tierra de Sijón, rey de los amorreos, que vivía en Hesbón y que había sido derrotado por Moisés y los israelitas cuando salieron de Egipto.',
    'Los israelitas tomaron posesión de su tierra y de la tierra de Og, rey de Basán, es decir, de los dos reyes amorreos cuyos territorios estaban al este del Jordán.',
    'Este territorio se extendía desde Aroer, a la orilla del arroyo Arnón, hasta el monte Sirión, es decir, el monte Hermón.',
  ...
  [
    ...
    '»Cuando ustedes oyeron la voz que salía de la oscuridad, mientras la montaña ardía en llamas, todos los jefes de sus tribus y sus ancianos vinieron a mí',
    ...
    '»El Señor escuchó cuando ustedes me hablaban, y me dijo: He oído lo que este pueblo te dijo. Todo lo que dijeron está bien.',
    ...
    'Pero tú quédate aquí conmigo, que voy a darte todos los mandamientos, preceptos y normas que has de enseñarles, para que los pongan en práctica en la tierra que les daré como herencia.',
  ...
  [
    ...
    '»El Señor tu Dios te hará entrar en la tierra que les juró a tus antepasados Abraham, Isaac y Jacob. Es una tierra con ciudades grandes y prósperas que tú no edificaste',
    ...
    '»En el futuro, cuando tu hijo te pregunte: ¿Qué significan los mandatos, preceptos y normas que el Señor nuestro Dios les mandó?,',
  ...
  [
    ...
    'El Señor te guió a través del vasto y horrible desierto, esa tierra reseca y sedienta, llena de serpientes venenosas y escorpiones; te dio el agua que hizo brotar de la más dura roca',
  ...
  [
    ...
    'Entiende bien que eres un pueblo terco, y que tu justicia y tu rectitud no tienen nada que ver con que el Señor tu Dios te dé en posesión esta buena tierra. El becerro de oro',
  ...
  [
    ...
    'En esas tablas, que luego me entregó, el Señor escribió lo mismo que había escrito antes, es decir, los diez mandamientos que les dio a ustedes el día en que estábamos todos reunidos en asamblea, cuando habló desde el fuego en la montaña.',
    'En seguida bajé de la montaña y guardé las tablas en el arca que había hecho. Y allí permanecen, tal como me lo ordenó el Señor.» Ministerio de los levitas',
    ...
    'En aquel tiempo el Señor designó a la tribu de Leví para llevar el arca del pacto y estar en su presencia, y para ministrar y pronunciar bendiciones en su nombre, como hasta hoy lo hace.',
    'Por eso los levitas no tienen patrimonio alguno entre sus hermanos, pues el Señor es su herencia, como él mismo lo ha declarado. Las demandas del Señor',
    ...
    'Teme al Señor tu Dios y sírvele. Aférrate a él y jura sólo por su nombre.',
  ...
  [
    ...
    '»Recuerden también lo que él hizo por ustedes en el desierto, hasta que llegaron a este lugar.',
    'Además, vieron lo que les hizo a Datán y Abirán, hijos de Eliab el rubenita, pues en presencia de todo el pueblo hizo que la tierra se abriera y se los tragara junto con sus familias, sus carpas y todo lo que les pertenecía.',
    ...
    '»Si ustedes obedecen fielmente los mandamientos que hoy les doy, y si aman al Señor su Dios y le sirven con todo el corazón y con toda el alma',
    ...
    '»Si ustedes obedecen todos estos mandamientos que les doy, y aman al Señor su Dios, y siguen por todos sus caminos y le son fieles',
    ...
    'cuiden de obedecer todos los preceptos y las normas que hoy les mando.',
  ],
  // Capítulo 12
  [
    ...
    'Allí llevarán ustedes sus holocaustos, sacrificios, diezmos, contribuciones, promesas, ofrendas voluntarias, y los primogénitos de sus ganados y rebaños.',
    ...
    'Pero ustedes cruzarán el río Jordán y vivirán en la tierra que el Señor su Dios les da en herencia; él los librará de sus enemigos que los rodean, y ustedes vivirán seguros.',
    ...
    '»No podrás comer en tus ciudades el diezmo de tu trigo, de tu vino o de tu aceite, ni los primogénitos de tus ganados y de tus rebaños, ni lo que hayas prometido dar, ni tus ofrendas voluntarias ni tus contribuciones.',
    ...
    'Si queda demasiado lejos el lugar donde el Señor tu Dios decida habitar, podrás sacrificar animales de tus ganados y rebaños, según mis instrucciones, y comer en tus pueblos todo lo que quieras.',
    ...
    'Tanto la carne como la sangre de tus holocaustos las ofrecerás sobre el altar del Señor tu Dios. Derramarás la sangre sobre el altar, pero podrás comer la carne.',
  ...
  [
    ...
    '»Si tu propio hermano, o tu hijo, o tu hija, o tu esposa amada, o tu amigo íntimo, trata de engañarte y en secreto te insinúa: Vayamos a rendir culto a otros dioses, dioses que ni tú ni tus padres conocieron',
  ...
  [
    ...
    '»No comas nada que encuentres ya muerto. Podrás dárselo al extranjero que viva en cualquiera de tus ciudades; él sí podrá comérselo, o vendérselo a un forastero. Pero tú eres un pueblo consagrado al Señor tu Dios. »No cocines el cabrito en la leche de su madre. Los diezmos',
  ...
  [
    ...
    'No te pese dejar en libertad a tu esclavo, porque sus servicios durante esos seis años te costaron apenas la mitad de lo que le habrías pagado a un empleado. Así el Señor tu Dios te bendecirá en todo lo que hagas. Los animales primogénitos',
  ...
  [
    ...
    'Durante seis días comerás pan sin levadura, y el séptimo día convocarás una asamblea solemne para el Señor tu Dios. Ese día no trabajarás. Fiesta de las Semanas',
  ...
  [
    ...
    'Los primeros en ejecutar el castigo serán los testigos, y luego todo el pueblo. Así extirparás el mal que esté en medio de ti. Los tribunales',
  ...
  [
    ...
    'A los ojos del Señor tu Dios serás irreprensible. El profeta',
  ...
  [
    ...
    'y si tú obedeces todos estos mandamientos que hoy te ordeno, y amas al Señor tu Dios y andas siempre en sus caminos, entonces apartarás tres ciudades más.',
    ...
    '»Cuando ocupes el territorio que el Señor tu Dios te da como herencia, no reduzcas el límite de la propiedad de tu prójimo, que hace mucho tiempo le fue señalado. Los testigos requeridos',
  ...
  [
    ...
    'Exterminarás del todo a hititas, amorreos, cananeos, ferezeos, heveos y jebuseos, tal como el Señor tu Dios te lo ha mandado.',
    'De lo contrario, ellos te enseñarán a hacer todas las cosas abominables que hacen para adorar a sus dioses, y pecarás contra el Señor tu Dios.',
  ...
  [
    ...
    'y se deshaga de su ropa de cautiva. Después de que haya vivido en tu casa y guardado luto por su padre y su madre durante todo un mes, podrás unirte a ella y serán marido y mujer.',
    'Pero si no resulta de tu agrado, la dejarás ir adonde ella lo desee. No deberás venderla ni tratarla como esclava, puesto que la habrás deshonrado. El derecho del primogénito',
    ...
    'Más bien, reconocerá a éste como el primogénito, y le dará el doble de las posesiones que le correspondan. Ese hijo es el primer fruto de su vigor, y a él le pertenece el derecho de primogenitura. Un hijo rebelde',
    ...
    'Entonces todos los hombres de la ciudad lo apedrearán hasta matarlo. Así extirparás el mal que haya en medio de ti. Y todos en Israel lo sabrán, y tendrán temor. Diversas leyes',
  ...
  [
    ...
    '»Pon cuatro borlas en las puntas del manto con que te cubres. Violación de las reglas matrimoniales',
  ...
  [
    ...
    'Porque el Señor tu Dios anda por tu campamento para protegerte y para entregar a tus enemigos en tus manos. Por eso tu campamento debe ser un lugar santo; si el Señor ve algo indecente, se apartará de ti. Leyes misceláneas',
  ...
  // Capítulo 24
  [
    '»Si un hombre se casa con una mujer, pero luego deja de quererla por haber encontrado en ella algo indecoroso, sólo podrá despedirla si le entrega un certificado de divorcio.',
    ...
    'Le pagarás su jornal cada día, antes de la puesta del sol, porque es pobre y cuenta sólo con ese dinero. De lo contrario, él clamará al Señor contra ti y tú resultarás convicto de pecado.',
  ...
  [
    ...
    'Mira desde el cielo, desde el santo lugar donde resides y, tal como se lo juraste a nuestros antepasados, bendice a tu pueblo Israel y a la tierra que nos has dado, tierra donde abundan la leche y la miel. Exhortación a seguir los mandamientos del Señor',
  ...
  [
    ...
    'Sobre las piedras de ese altar escribirás claramente todas las palabras de esta ley.» Maldiciones desde el monte Ebal',
    ...
    'Maldito sea quien tenga relaciones sexuales con un animal. Y todo el pueblo dirá: ¡Amén!',
    'Maldito sea quien se acueste con su hermana, hija de su padre o de su madre. Y todo el pueblo dirá: ¡Amén!',
    'Maldito sea quien se acueste con su suegra. Y todo el pueblo dirá: ¡Amén!',
  ...
  [
    ...
    '»Todas estas maldiciones caerán sobre ti. Te perseguirán y te alcanzarán hasta destruirte, porque desobedeciste al Señor tu Dios y no cumpliste sus mandamientos y preceptos.',
  ...
  // Capítulo 29
  [
    'Éstos son los términos del pacto que, por orden del Señor, hizo Moisés en Moab con los israelitas, además del pacto que ya había hecho con ellos en Horeb.',
    ...
    '»Cuando llegaron a este lugar, Sijón, rey de Hesbón, y Og, rey de Basán, salieron a pelear contra nosotros, pero los derrotamos.',
    ...
    '»Sus hijos y las generaciones futuras, y los extranjeros que vengan de países lejanos, verán las calamidades y enfermedades con que el Señor habrá azotado esta tierra.',
  ...
  [
    ...
    'siempre y cuando obedezcas al Señor tu Dios y cumplas sus mandamientos y preceptos, escritos en este libro de la ley, y te vuelvas al Señor tu Dios con todo tu corazón y con toda tu alma. Elección entre la vida y la muerte',
  ...
  // Capítulo 31
  [
    'De nuevo habló Moisés a todo el pueblo de Israel, y les dijo: ',' »Ya tengo ciento veinte años de edad, y no puedo seguir siendo su líder. Además, el Señor me ha dicho que no voy a cruzar el Jordán',
    ...
    'El Señor mismo marchará al frente de ti y estará contigo; nunca te dejará ni te abandonará. No temas ni te desanimes.» La lectura de la ley',
    ...
    'Y los descendientes de ellos, para quienes esta ley será desconocida, la oirán y aprenderán a temer al Señor tu Dios mientras vivan en el territorio que vas a poseer al otro lado del Jordán.» Predicción de la rebeldía de Israel',
    ...
    'Luego dio esta orden a los levitas que transportaban el arca del pacto del Señor: ',' »Tomen este libro de la ley, y pónganlo junto al arca del pacto del Señor su Dios. Allí permanecerá como testigo contra ustedes los israelitas',
    ...
    'porque sé que después de mi muerte se pervertirán y se apartarán del camino que les he mostrado. En días venideros les sobrevendrán calamidades, porque harán lo malo a los ojos del Señor y con sus detestables actos provocarán su ira.» El cántico de Moisés',
  ...
  [
    ...
    '¡Si tan sólo fueran sabios y entendieran esto, y comprendieran cuál será su fin!',
    ...
    'Cuando terminó, les dijo a todos los israelitas: 46 »Mediten bien en todo lo que les he declarado solemnemente este día, y díganles a sus hijos que obedezcan fielmente todas las palabras de esta ley.',
    'Porque no son palabras vanas para ustedes, sino que de ellas depende su vida; por ellas vivirán mucho tiempo en el territorio que van a poseer al otro lado del Jordán.» Anuncio de la muerte de Moisés',
    'Ese mismo día el Señor le dijo a Moisés: 49 »Sube a las montañas de Abarín, y contempla desde allí el monte Nebo, en el territorio de Moab, frente a Jericó, y el territorio de Canaán, el cual voy a dar en posesión a los israelitas.',
  ...
  [
    ...
    'Le mostró también la región del Néguev y la del valle de Jericó, la ciudad de palmeras, hasta Zoar.',
