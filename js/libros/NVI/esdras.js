// Esdras (NVI) — export generated 2025-11-05
export const Esdras = [
  [ // 1
    ...
    'Ciro los entregó a su tesorero Mitrídates, el cual los contó y se los pasó a Sesbasar, jefe de Judá.',
    'El inventario de dichos utensilios fue el siguiente: tazones de oro 30 tazones de plata 1.000 cuchillos 29',
    'tazas de oro 30 tazas de plata 410 objetos diversos 1.000',
  ...
  [ // 2
    ...
    'en compañía de Zorobabel, Jesúa, Nehemías, Seraías, Relaías, Mardoqueo, Bilsán, Mispar, Bigvay, Rejún y Baná. Ésta es la lista de los israelitas que regresaron:',
    'de Parós 2.172',
    'de Sefatías 372',
    'de Araj 775',
    ...
    'De los porteros descendientes de Salún, Ater, Talmón, Acub, Jatitá y Sobay 139',
    ...
    'De los descendientes de Delaías, Tobías y Necoda 652',
    ...
    'sin contar a esclavos y esclavas, que sumaban siete mil trescientos treinta y siete; y tenían doscientos cantores y cantoras.',
  ...
  [ // 4
    ...
    'También al comienzo del reinado de Jerjes, aquellos enemigos enviaron una carta en la cual acusaban a los habitantes de Judá y de Jerusalén. 7 Luego, cuando Artajerjes llegó a ser rey de Persia, también a él Bislán, Mitrídates, Tabel y sus demás compañeros le enviaron una carta, que fue traducida al arameo.',
    ...
    'Pida Su Majestad que se investigue en los archivos donde están las crónicas de los reyes que lo han precedido. Así comprobará que esta ciudad ha sido rebelde y nociva para los reyes y las provincias, y que fue destruida porque hace ya mucho tiempo allí se fraguaron sediciones.',
  ...
  [ // 6
    ...
    'En el primer año de su reinado, el rey Ciro promulgó el siguiente edicto respecto al templo de Dios en Jerusalén: Que se echen los cimientos y se reconstruya el templo, para que en él se ofrezcan holocaustos. Tendrá veintisiete metros tanto de alto como de ancho,',
    ...
    'Los sacerdotes y levitas se habían unido para purificarse y, ya estando ritualmente limpios, mataron el cordero pascual por todos los que habían regresado Señor le dio a Israel: del cautiverio, por sus compañeros los sacerdotes y por ellos mismos.',
    'Los israelitas que regresaron del cautiverio comieron la Pascua junto con los que se habían apartado de la impureza de sus vecinos para seguir al Señor, Dios de Israel.',
  ...
  [ // 7
    'Durante el reinado de Artajerjes, rey de Persia, vivió un hombre llamado Esdras hijo de Seraías, que era descendiente en línea directa de Azarías, Jilquías,',
    'Salún, Sadoc, Ajitob,',
    ...
    'Con Esdras regresaron a Jerusalén algunos israelitas, entre los cuales había sacerdotes, levitas, cantores, porteros y servidores del templo. Esto sucedió en el séptimo año del reinado de Artajerjes.',
    ...
    'Con ese dinero compra, sin falta, becerros, carneros y corderos, con sus respectivas ofrendas de cereales y de vino, para ofrecerlos en el altar del templo del Dios de ustedes en Jerusalén.',
    ...
    'Pueden darle hasta tres mil trescientos kilos de plata, veintidós mil litros de trigo, dos mil doscientos litros de vino, dos mil doscientos litros de aceite y toda la sal que se requiera. trescientos hombres más;',
  ...
  [ // 8
    'Según los registros genealógicos, ésta es la lista de los jefes de familia que durante el reinado de Artajerjes regresaron conmigo de Babilonia:',
    'de los descendientes de Finés: Guersón; de Itamar: Daniel; de David: Jatús,',
    ...
    'Y como Dios estaba con nosotros, nos enviaron a un israelita muy capacitado llamado Serebías hijo de Majlí, descendiente de Leví. Con él vinieron sus hijos y sus hermanos, dieciocho personas en total.',
    ...
    'Luego les dije: Üstedes y los utensilios han sido consagrados al Señor. La plata y el oro son una ofrenda voluntaria para el Señor, Dios de nuestros antepasados.',
    'Vigílenlos y guárdenlos hasta que los pesen en los aposentos del templo del Señor en Jerusalén, en presencia de los principales sacerdotes, de los levitas y de los jefes de familia del pueblo de Israel.»',
    ...
    'Luego, en honor del Señor, Dios de Israel, los que habían regresado del cautiverio ofrecieron, en holocausto y como ofrenda de expiación por todo el pueblo, doce novillos, noventa y seis carneros, setenta y siete corderos y doce chivos.',
  ...
  [ // 9
    ...
    'que nos diste por medio de tus siervos los profetas, cuando nos advertiste: La tierra que van a poseer está corrompida por la impureza de los pueblos que la habitan, pues de un extremo a otro ellos la han llenado con sus abominaciones.',
    'Por eso, no permitan ustedes que sus hijas ni sus hijos se casen con los de esos pueblos. Nunca busquen el bienestar ni la prosperidad que tienen ellos, para que ustedes se mantengan fuertes y coman de los frutos de la buena tierra y luego se la dejen por herencia a sus descendientes para siempre.',
