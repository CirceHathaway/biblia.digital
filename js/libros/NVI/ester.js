/* 
 * Ester (NVI)
 * Generado automáticamente: 2025-11-06 06:21:14
*/
...
export default [
  [  // 1
    ...
    'Pasado este tiempo, el rey ofreció otro banquete, que duró siete días, para todos los que se encontraban en la ciudadela de Susa, tanto los más importantes como los de menor importancia. Este banquete tuvo lugar en el jardín interior de su palacio,',
    ...
    'El día en que las mujeres de la nobleza de Persia y de Media se enteren de la conducta de la reina, les responderán de la misma manera a todos los dignatarios de Su Majestad. ¡Entonces no habrá fin al desprecio y a la discordia!',
    ...
    'envió cartas por todo el reino, a cada provincia en su propia escritura y a cada pueblo en su propio idioma, proclamando en la lengua de cada pueblo que todo hombre debe ejercer autoridad sobre su familia.',
  ],
  [  // 2
    ...
    'uno de los capturados en Jerusalén y llevados al exilio cuando Nabucodonosor, rey de Babilonia, se llevó cautivo a Jeconías, rey de Judá.',
    ...
    'Éste se paseaba diariamente frente al patio del harén para saber cómo le iba a Ester y cómo la trataban.',
    'Ahora bien, para poder presentarse ante el rey, una joven tenía que completar los doce meses de tratamiento de belleza prescritos: seis meses con aceite de mirra, y seis con perfumes y cosméticos.',
    ...
    'El rey se enamoró de Ester más que de todas las demás mujeres, y ella se ganó su aprobación y simpatía más que todas las otras vírgenes. Así que él le ciñó la corona real y la proclamó reina en lugar de Vasti.',
    'Luego el rey ofreció un gran banquete en honor de Ester para todos sus funcionarios y servidores. Declaró un día de fiesta en todas las provincias y distribuyó regalos con generosidad digna de un rey.',
    'Mientras se reunía a un segundo grupo de vírgenes, Mardoqueo permanecía sentado a la puerta del rey.',
    'Ester, por su parte, continuó guardando en secreto sus antecedentes familiares y su nacionalidad, tal como Mardoqueo le había ordenado, ya que seguía cumpliendo las instrucciones de Mardoqueo como cuando estaba bajo su cuidado.',
    ...
    'Cuando se investigó el informe y se descubrió que era cierto, los dos eunucos fueron empalados en una estaca. Todo esto fue debidamente anotado en los registros reales, en presencia del rey.',
  ],
  [  // 3
    ...
    'Día tras día se lo reclamaban; pero él no les hacía caso. Por eso lo denunciaron a Amán para ver si seguía tolerándose la conducta de Mardoqueo, ya que éste les había confiado que era judío.',
    ...
    'Si le parece bien, emita Su Majestad un decreto para aniquilarlos, y yo depositaré en manos de los administradores trescientos treinta mil kilos de plata para el tesoro real.',
  ...
  [  // 4
    ...
    'Mardoqueo le contó todo lo que le había sucedido, mencionándole incluso la cantidad exacta de dinero que Amán había prometido pagar al tesoro real por la aniquilación de los judíos.',
    'También le dio una copia del texto del edicto promulgado en Susa, el cual ordenaba el exterminio, para que se lo mostrara a Ester, se lo explicara, y la exhortara a que se presentara ante el rey para implorar clemencia e interceder en favor de su pueblo.',
    'Hatac regresó y le informó a Ester lo que Mardoqueo había dicho.',
  ...
  [  // 5
    ...
    'Ester respondió: Mi deseo y petición es que,',
    ...
    'Su esposa Zeres y todos sus amigos le dijeron: Haz que se coloque una estaca a veinticinco metros de altura, y por la mañana pídele al rey que empale en ella a Mardoqueo. Así podrás ir contento al banquete con el rey. La sugerencia le agradó a Amán, y mandó que se colocara la estaca.',
  ],
  [  // 6
    ...
    'Amán acababa de entrar en el patio exterior del palacio para pedirle al rey que empalara a Mardoqueo en la estaca que había mandado levantar para él. Así que el rey preguntó: ¿Quién anda en el patio?',
  ...
  [  // 7
    ...
    'El rey le preguntó: ¿Y quién es ése que se ha atrevido a concebir semejante barbaridad? ¿Dónde está?',
  ...
  [  // 8
    ...
    'Redacten ahora, en mi nombre, otro decreto en favor de los judíos, como mejor les parezca, y séllenlo con mi anillo real. Un documento escrito en mi nombre, y sellado con mi anillo, es imposible revocarlo.',
    ...
    'En cada provincia se emitiría como ley una copia del edicto, y se daría a conocer a todos los pueblos. Así los judíos estarían preparados ese día para vengarse de sus enemigos.',
  ...
  [  // 9
    ...
    'Los judíos de Susa se reunieron también el día catorce del mes de adar, y mataron allí a trescientos hombres, pero no se apoderaron de sus bienes.',
    ...
    'Pero cuando Ester se presentó ante el rey, éste ordenó por escrito que el malvado plan que Amán había maquinado contra los judíos debía recaer sobre su propia cabeza, y que él y sus hijos fueran empalados en la estaca.',
    'Por tal razón, a estos días se los llamó Purim, de la palabra pur. Conforme a todo lo escrito en esta carta, y debido a lo que habían visto y a lo que les había sucedido,',
    ...
    'para establecer los días de Purim en las fechas fijadas, como lo habían decretado para ellos Mardoqueo el judío y la reina Ester, y como lo habían establecido para sí mismos y para sus descendientes, con algunas cláusulas sobre ayunos y lamentos.',
