export default [
  ...
  [
    ...
    'Ya crecido el niño, se lo llevó a la hija del faraón, y ella lo adoptó como hijo suyo; además, le puso por nombre Moisés, pues dijo: "¡Yo lo saqué del río!" Huida de Moisés a Madián',
  ...
  [
    ...
    'Toda mujer israelita pedirá a su vecina y a cualquier otra mujer que viva en su casa, objetos de oro, de plata y ropa para vestir a sus hijos y a sus hijas. Así despojarán ustedes a los egipcios».',
  ],
  // Capítulo 4
  [
    ...
    'Pero Séfora, tomando un cuchillo de pedernal, le cortó el prepucio a su hijo; luego tocó los pies de Moisés con el prepucio y le dijo: "No hay duda. Tú eres para mí un esposo de sangre."',
  ...
  [
    ...
    'Todo el ejército del faraón caballos, carros, jinetes y tropas de Egipto salió tras los israelitas y les dio alcance cuando éstos acampaban junto al mar, cerca de Pi Ajirot y frente a Baal Zefón.',
  ...
  [
    ...
    'El cántico de Miriam Cuando los caballos y los carros del faraón entraron en el mar con sus jinetes, el Señor hizo que las aguas se les vinieran encima. Los israelitas, sin embargo, cruzaron el mar sobre tierra seca.',
  ...
  [
    ...
    'Y éstas son las órdenes que el Señor me ha dado: Recoja cada uno de ustedes la cantidad que necesite para toda la familia, calculando dos litros por persona.',
  ...
  [
    ...
    'Además, a ese lugar lo llamó Masá, y también Meribá, porque los israelitas habían altercado con él y provocado al Señor al decir: "¿Está o no está el Señor entre nosotros?" Derrota de los amalecitas',
  ...
  [
    ...
    'Todas las cortinas deben medir lo mismo, es decir, doce metros y medio de largo por un metro con ochenta centímetros de ancho.',
    ...
    'Cada tablón debe medir cuatro metros y medio de largo por setenta centímetros de ancho,',
  ...
  [
    ...
    'Habrá cortinas de siete metros de largo, y tres postes y tres bases a un lado de la entrada,',
  ...
  [
    ...
    'Todos losobreros con espíritu artístico hicieron el santuario con diez cortinas de lino fino y de lana púrpura, carmesí y escarlata, con querubines artísticamente bordados en ellas.',
    'Todas las cortinas medían lo mismo, es decir, doce metros y medio de largo por un metro con ochenta centímetros de ancho.',
    ...
    'Las once cortinas tenían las mismas medidas, es decir, trece metros y medio de largo por un metro con ochenta centímetros de ancho.',
  ...
  // Capítulo 37
  [
    'Bezalel hizo el arca de madera de acacia, de un metro con diez centímetros de largo por setenta centímetros de ancho y setenta centímetros de alto.',
    ...
    'Bezalel hizo la mesa de madera de acacia, de noventa centímetros de largo por cuarenta y cinco centímetros de ancho y setenta centímetros de alto.',
    ...
    'Para hacer el candelabro y todos sus accesorios, usó treinta y tres kilos de oro puro. El altar del incienso',
    'Bezalel hizo de madera de acacia el altar del incienso. Era cuadrado, de cuarenta y cinco centímetros de largo por cuarenta y cinco centímetros de ancho y noventa centímetros de alto. Sus cuernos formaban una sola pieza con el altar.',
  ...
  // Capítulo 38
  [
    'Bezalel hizo de madera de acacia el altar de los holocaustos. Era cuadrado, de dos metros con treinta centímetros por lado, y de un metro con treinta centímetros de alto.',
    ...
    'Además, con el bronce de los espejos de las mujeres que servían a la entrada de la ienda de reunión, hizo el lavamanos y su pedestal. El atrio',
    ...
    'La plata entregada por los miembros de la comunidad contados en el censo llegó a tres toneladas y media, según la tasación oficial del santuario.',
    'Todos los mayores de veinte años de edad que fueron censados llegaron a un total de seiscientos tres mil quinientos cincuenta, y cada uno de ellos dio seis gramos de plata, según la tasación oficial del santuario.',
    ...
    'El total del bronce dado como ofrenda fue de dos mil trescientos cuarenta kilos,',
