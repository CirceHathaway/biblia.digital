export default [
  ...
  [
    ...
    'En eso, la hija del faraón bajó a bañarse en el Nilo. Sus doncellas, mientras tanto, se paseaban por la orilla del río. De pronto la hija del faraón vio la cesta entre los juncos, y ordenó a una de sus esclavas que fuera por ella.',
    ...
    'Ya crecido el niño, se lo llevó a la hija del faraón, y ella lo adoptó como hijo suyo; además, le puso por *nombre Moisés,[1] pues dijo: "¡Yo lo saqué del río!" Huida de Moisés a Madián',
    ...
    '¿Y quién te nombró a ti gobernante y juez sobre nosotros? respondió aquél. ¿Acaso piensas matarme a mí, como mataste al egipcio? Esto le causó temor a Moisés, pues pensó: "¡Ya se supo lo que hice!"',
    'Y, en efecto, el faraón se enteró de lo sucedido y trató de matar a Moisés; pero Moisés huyó del faraón y se fue a la tierra de Madián, donde se quedó a vivir[2] junto al pozo.',
  ...
  [
    ...
    'Yo estaré contigo le respondió Dios. Y te voy a dar una señal de que soy yo quien te envía: Cuando hayas sacado de Egipto a mi pueblo, todos ustedes me rendirán culto[1] en esta montaña.',
    ...
    'Además, Dios le dijo a Moisés: Diles esto a los israelitas: El Señor,[3] el Dios de sus antepasados, el Dios de Abraham, de Isaac y de Jacob, me ha enviado a ustedes. Éste es mi *nombre eterno; éste es mi nombre por todas las generaciones.',
    'Y tú, anda y reúne a los *ancianos de Israel, y diles: El Señor, el Dios de sus antepasados, el Dios de Abraham, de Isaac y de Jacob, se me apareció y me dijo: \'Yo he estado pendiente de ustedes. He visto cómo los han maltratado en Egipto.',
    ...
    'Los ancianos de Israel te harán caso. Entonces ellos y tú se presentarán ante el rey de Egipto y le dirán: El Señor, Dios de los hebreos, ha venido a nuestro encuentro. Déjanos hacer un viaje de tres días al desierto, para ofrecerle sacrificios al Señor nuestro Dios.',
  ...
  [
    ...
    'pero el Señor le mandó que la agarrara por la cola. En cuanto Moisés agarró la serpiente, ésta se convirtió en una vara en sus propias manos.',
    ...
    'El Señor le dijo a Aarón: "Anda a recibir a Moisés en el desierto." Aarón fue y se encontró con Moisés en la montaña de Dios, y lo besó.',
  ...
  [
    ...
    'les dijeron: "¡Que el Señor los examine y los juzgue! ¡Por culpa de ustedes somos unos apestados ante el faraón y sus siervos! ¡Ustedes mismos les han puesto la espada en la mano, para que nos maten!" Dios promete liberación',
  ...
  [
    ...
    'Me aparecí a Abraham, a Isaac y a Jacob bajo el nombre de Dios *Todopoderoso, pero no les revelé mi verdadero nombre, que es el Señor. 4[1] También con ellos confirmé mi *pacto de darles la tierra de Canaán, donde residieron como forasteros.',
    ...
    'Pero Moisés se enfrentó al Señor y le dijo: ¿Y cómo va a hacerme caso el faraón, si ni siquiera los israelitas me creen? Además, no tengo facilidad de palabra.[2]',
    'En otra ocasión el Señor habló con Moisés y Aarón acerca de los israelitas y del faraón, rey egipcio, y les ordenó sacar de Egipto a los israelitas. Antepasados de Moisés y de Aarón',
    'Éstos fueron los jefes de las familias patriarcales: Los hijos de Rubén, primogénito de Israel: Janoc, Falú, Jezrón y Carmí. Éstos fueron los clanes de Rubén.',
    'Los hijos de Simeón: Jemuel, Jamín, Oad, Jaquín, Zojar y Saúl, hijo de la cananea. Éstos fueron los clanes de Simeón.',
    'Según los registros familiares, éstos son los nombres de los hijos de Leví, quien vivió ciento treinta y siete años: Guersón, Coat y Merari.',
    ...
    'Los hijos de Merari: Majlí y Musí. Éstos fueron los clanes de Leví, según sus registros familiares.',
    ...
    'Los hijos de Coré: Asir, Elcaná y Abiasaf. Éstos fueron los clanes de Coré.',
    'Eleazar hijo de Aarón se casó con una de las hijas de Futiel, la cual le dio un hijo, Finés. Éstos fueron los jefes de los clanes levitas, en orden de familias.',
  ...
  [
    ...
    'Y cuando yo despliegue mi poder contra Egipto y saque de allí a los israelitas, sabrán los egipcios que yo soy el Señor. La vara de Moisés',
  ...
  [
    ...
    'Pero en cuanto el faraón experimentó alivio, endureció su *corazón y, tal como el Señor lo había advertido, ya no quiso saber nada de Moisés ni de Aarón. La plaga de mosquitos',
    ...
    '"En todo esto anda la mano de Dios", admitieron los magos ante el faraón, pero éste había endurecido su *corazón, así que no les hizo caso, tal como el Señor lo había advertido. La plaga de tábanos',
    ...
    'Y así lo hizo el Señor. Densas nubes de tábanos irrumpieron en el palacio del faraón y en las casas de sus funcionarios, y por todo Egipto. Por causa de las tábanos, el país quedó arruinado.',
    ...
    'El Señor accedió a los ruegos de Moisés y apartó los tábanos del faraón, de sus funcionarios y de su pueblo. No quedó un sólo tábano.',
  ...
  [
    ...
    'Envió el faraón gente a ver los ganados de los israelitas, y se encontraron con que ni un solo animal había muerto. Sin embargo, el faraón endureció su *corazón y no quiso dejar ir al pueblo. La plaga de úlceras',
    ...
    'Pero el Señor endureció el *corazón del faraón y, tal como el Señor se lo había advertido a Moisés, no quiso el faraón saber nada de Moisés ni de Aarón. La plaga de granizo',
    ...
    'El granizo arrasó con todo lo que había en los campos de Egipto, y con personas y animales; acabó con todos los cultivos y derribó todos los árboles.',
  ...
  [
    ...
    'Lo hice para que puedas contarles a tus hijos y a tus nietos la dureza con que traté a los egipcios,[1] y las señales que realicé entre ellos. Así sabrán que yo soy el Señor."',
    ...
    'Pero el Señor endureció el corazón del faraón, y éste no dejó que los israelitas se fueran. La plaga de tinieblas',
  ...
  [
    ...
    'Hablen con toda la comunidad de Israel, y díganles que el día décimo de este mes todos ustedes tomarán un cordero[1] por familia, uno por cada casa.',
    ...
    'Durante siete días comerán pan sin levadura, de modo que deben retirar de sus casas la levadura el primer día. Todo el que coma algo con levadura desde el día primero hasta el séptimo será eliminado de Israel.',
    ...
    '"Celebrarán la fiesta de los Panes sin levadura, porque fue ese día cuando los saqué de Egipto formados en escuadrones. Por ley, las generaciones futuras siempre deberán celebrar ese día.',
    'Comerán pan sin levadura desde la tarde del día catorce del mes primero hasta la tarde del día veintiuno del mismo mes.',
    'Durante siete días se abstendrán de tener levadura en sus casas. Todo el que coma algo con levadura, sea extranjero o israelita, será eliminado de la comunidad de Israel.',
    ...
    'El Señor hizo que los egipcios vieran con buenos ojos a los israelitas, así que les dieron todo lo que les pedían. De este modo los israelitas despojaron por completo a los egipcios. El éxodo',
    ...
    'Aquella noche el Señor la pasó en vela para sacar de Egipto a los israelitas. Por eso también las generaciones futuras de israelitas deben pasar esa noche en vela, en honor del Señor. Restricciones para la Pascua',
    ...
    '"Todo extranjero que viva entre ustedes y quiera celebrar la Pascua del Señor, deberá primero circuncidar a todos los varones de su familia; sólo entonces podrá participar de la Pascua como si fuera nativo del país. "Ningún incircunciso podrá participar de ella.',
  ...
  [
    ...
    'Esto será para ustedes como una marca distintiva en la mano o en la frente, de que el Señor nos sacó de Egipto desplegando su poder." El paso del Mar Rojo',
    ...
    'Moisés se llevó consigo los restos de José, según éste se lo había pedido a los israelitas bajo juramento. Éstas habían sido las palabras de José: "Pueden contar ustedes con que Dios vendrá en su ayuda. Cuando eso suceda, llévense de aquí mis restos."',
  ...
  [
    ...
    'Todo el ejército del faraón caballos, carros, jinetes[1] y tropas de Egipto salió tras los israelitas y les dio alcance cuando éstos acampaban junto al mar, cerca de Pi Ajirot y frente a Baal Zefón.',
  ...
  [
    ...
    'El cántico de Miriam Cuando los caballos y los carros del faraón entraron en el mar con sus jinetes,[1] el Señor hizo que las aguas se les vinieran encima. Los israelitas, sin embargo, cruzaron el mar sobre tierra seca.',
  ...
  [
    ...
    'Y éstas son las órdenes que el Señor me ha dado: Recoja cada uno de ustedes la cantidad que necesite para toda la familia, calculando dos litros[1] por persona.',
    ...
    'Pero el día sexto recogieron el doble, es decir, cuatro litros[2] por persona, así que los jefes de la comunidad fueron a informar de esto a Moisés.',
  ...
  [
    ...
    'que yo estaré esperándote junto a la *roca que está en Horeb. Aséstale un golpe a la roca, y de ella brotará agua para que beba el pueblo. Así lo hizo Moisés, a la vista de los ancianos de Israel.',
    'Además, a ese lugar lo llamó Masá,[1] y también Meribá,[2] porque los israelitas habían altercado con él y provocado al Señor al decir: "¿Está o no está el Señor entre nosotros?" Derrota de los amalecitas',
    'Los amalecitas vinieron a Refidín y atacaron a los israelitas.',
    'Entonces Moisés le ordenó a Josué: "Escoge algunos de nuestros hombres y sal a combatir a los amalecitas. Mañana yo estaré en la cima de la colina con la vara de Dios[3] en la mano."',
    'Josué siguió las órdenes de Moisés y les presentó batalla a los amalecitas. Por su parte, Moisés, Aarón y Jur subieron a la cima de la colina.',
  ...
  [
    ...
    'Serán ellos los que funjan como jueces de tiempo completo, atendiendo los casos sencillos, y los casos difíciles te los traerán a ti. Eso te aligerará la carga, porque te ayudarán a llevarla.',
  ...
  [
    ...
    'Sea *hombre o animal, no quedará con vida. Quien se atreva a tocarlo, morirá a pedradas o a flechazos. Sólo podrán subir al monte cuando se oiga el toque largo de la trompeta.',
  ...
  [
    ...
    'pero el día séptimo será un día de reposo para honrar al Señor tu Dios. No hagas en ese día ningún trabajo, ni tampoco tu hijo, ni tu hija, ni tu esclavo, ni tu esclava, ni tus animales, ni tampoco los extranjeros que vivan en tus ciudades. 11[2] Acuérdate de que en seis días hizo el Señor los cielos y la tierra, el mar y todo lo que hay en ellos, y que descansó el séptimo día. Por eso el Señor bendijo y consagró el día de reposo.',
    '"Honra a tu padre y a tu madre, para que disfrutes de una larga vida en la tierra que te da el Señor tu Dios.',
    '"No mates.',
    '"No cometas adulterio.',
    '"No robes.',
    '"No des falso testimonio en contra de tu prójimo.',
    '"No codicies la casa de tu prójimo: No codicies su esposa, ni su esclavo, ni su esclava, ni su buey, ni su burro, ni nada que le pertenezca." Reacción temerosa de los israelitas',
  ...
  [
    ...
    '"Si no le provee esas tres cosas, la mujer podrá irse sin que se pague nada por ella. Injurias personales',
  ...
  [
    ...
    '"Si el dueño del animal estaba presente, el que pidió prestado el animal no tendrá que pagar nada. "Si el animal fue alquilado, el precio del alquiler cubrirá la pérdida. Responsabilidades sociales',
  ...
  [
    ...
    '"La fiesta de los Panes sin levadura la celebrarás en el mes de *aviv, que es la fecha establecida. Fue en ese mes cuando ustedes salieron de Egipto. De acuerdo con mis instrucciones, siete días comerán pan sin levadura. "Nadie se presentará ante mí con las manos vacías.',
  ...
  [
    ...
    '"Haz[1] un arca de madera de acacia, de un metro con diez centímetros de largo, setenta centímetros de ancho y setenta centímetros de alto. 11[2] Recúbrela de oro puro por dentro y por fuera, y ponle en su derredor una moldura de oro.',
    ...
    '"Haz un *propiciatorio de oro puro, de un metro con diez centímetros de largo por setenta centímetros de ancho, 18[3] y también dos *querubines de oro labrado a martillo, para los dos extremos del propiciatorio.',
    ...
    'Yo me reuniré allí contigo en medio de los dos querubines que están sobre el arca del *pacto. Desde la parte superior del propiciatorio te daré todas las instrucciones que habrás de comunicarles a los israelitas. La mesa',
    '"Haz una mesa de madera de acacia, de noventa centímetros de largo por cuarenta y cinco de ancho y setenta de alto. 24[4] Recúbrela de oro puro, y ponle en su derredor una moldura de oro.',
    'Haz también un reborde de veinte centímetros[5] de ancho, y una moldura de oro para ponerla alrededor del reborde.',
  ...
  [
    ...
    'Todas las cortinas deben medir lo mismo, es decir, doce metros y medio de largo por un metro con ochenta centímetros de ancho.[1]',
    ...
    'Todas ellas deben medir lo mismo, es decir, trece metros y medio de largo por un metro con ochenta centímetros de ancho. 9[2] Cose cinco cortinas en un conjunto, y las otras seis en otro conjunto, doblando la sexta cortina en la parte frontal del santuario.',
    ...
    'Cada tablón debe medir cuatro metros y medio de largo por setenta centímetros de ancho, 17[4] y contar con dos ranuras para que cada tablón encaje con el otro. Todos los tablones para el santuario los harás así.',
    'Serán veinte los tablones para el lado sur del santuario.',
    '"Haz también cuarenta bases de plata para colocarlas debajo de los tablones, dos bases por tablón, para que las dos ranuras de cada tablón encajen en cada base.',
    'Para el lado opuesto, es decir, para el lado norte del santuario, prepararás también veinte tablones',
    'y cuarenta bases de plata, y pondrás dos bases debajo de cada tablón.',
    'Pondrás seis tablones en el lado posterior, que es el lado occidental del santuario,',
    'y dos tablones más en las esquinas de ese mismo lado.',
    ...
    'cinco para los del costado opuesto, y cinco para los del costado occidental, es decir, para la parte posterior.',
    'El travesaño central deberá pasar de uno a otro extremo, a media altura de los tablones.',
  ...
  // Capítulo 27
  [
    '"Haz un altar de madera de acacia, cuadrado, de dos metros con treinta centímetros[1] por lado, y de un metro con treinta centímetros[2] de alto.',
    ...
    'Prepara para el altar varas de madera de acacia, y recúbrelas de bronce.',
    'Las varas deberán pasar por los anillos, de modo que sobresalgan en los dos extremos del altar para que éste pueda ser transportado.',
    'El altar lo harás hueco y de tablas, exactamente como el que se te mostró en el monte. El atrio',
    '"Haz un atrio para el santuario. El lado sur debe medir cuarenta y cinco metros[3] de largo, y tener cortinas de lino fino,',
    ...
    '"A todo lo ancho del lado occidental del atrio, que debe medir veintidós metros y medio,[4] habrá cortinas, diez postes y diez bases.',
    'El lado oriental del atrio, que da hacia la salida del sol, también deberá medir veintidós metros y medio.',
    'Habrá cortinas de siete metros[5] de largo, y tres postes y tres bases a un lado de la entrada,',
    'lo mismo que del otro lado.',
    '"A la entrada del atrio habrá una cortina de nueve metros[6] de largo, de púrpura, carmesí, escarlata y lino fino, recamada artísticamente, y además cuatro postes y cuatro bases.',
    'Todos los postes alrededor del atrio deben tener empalmes y ganchos de plata, y bases de bronce.',
    'El atrio medirá cuarenta y cinco metros de largo por veintidós metros y medio de ancho,[7] con cortinas de lino fino de dos metros con treinta centímetros[8] de alto, y con bases de bronce.',
    ...
    'Aarón y sus hijos deberán mantenerlas encendidas toda la noche en presencia del Señor, en la *Tienda de reunión, fuera de la cortina que está ante el arca del *pacto. Esta ley deberá cumplirse entre los israelitas siempre, por todas las generaciones.'
  ],
  // Capítulo 28
  [
    ...
    'Al efecto se usará oro, púrpura, carmesí, escarlata y lino. El efod',
    ...
    'Será doble y cuadrado, de veinte centímetros[1] de largo por veinte de ancho.',
    ...
    'y en la cuarta, un topacio, un ónice y un jaspe.[2] Engárzalas en filigrana de oro.',
    ...
    'Sobre el pectoral para impartir justicia pondrás el *urim y el tumim. De esta manera, siempre que Aarón se presente ante el Señor, llevará en el pecho la causa de los israelitas. Otras vestiduras sacerdotales',
    '"Haz de púrpura todo el manto del *efod,',
    'con una abertura en el centro para meter la cabeza. Alrededor de la abertura le pondrás un refuerzo, como el que se pone a los chalecos,[3] para que no se desgarre.',
  ...
  [
    ...
    'y las mitras; a continuación, les ceñirás los cinturones a Aarón y a sus hijos. Así les conferirás autoridad, y el sacerdocio será para ellos una ley perpetua.',
    ...
    'y lo sacrificarás, poniendo un poco de su sangre en el lóbulo de la oreja derecha de Aarón y de sus hijos, lo mismo que en el pulgar derecho y en el dedo gordo derecho. Después de eso rociarás el altar y sus cuatro costados con la sangre,',
    ...
    'Luego ellos deberán devolverte todo esto para que tú, en presencia del Señor, lo quemes sobre el altar, junto con el holocausto de aroma grato. Ésta es una ofrenda presentada por fuego en honor del Señor.',
    ...
    '"Aparta el pecho del carnero que fue mecido para conferirles autoridad a Aarón y a sus hijos, y también el muslo que fue presentado como ofrenda, pues son las porciones que a ellos les corresponden.',
    'Éstas son las porciones que, de sus sacrificios de *comunión al Señor, les darán siempre los israelitas a Aarón y a sus hijos como contribución.',
    ...
    'Para hacer expiación, cada día ofrecerás un novillo como ofrenda por el pecado. Purificarás el altar haciendo expiación por él y ungiéndolo para consagrarlo.',
  ...
  [
    ...
    'Hazlo cuadrado, de cuarenta y cinco centímetros de largo por cuarenta y cinco centímetros de ancho y noventa centímetros de alto.[1] Sus cuernos deben formar una pieza con el altar.',
    ...
    'Cada año Aarón hará *expiación por el pecado de las generaciones futuras. Lo hará poniendo la sangre de la ofrenda de expiación sobre los cuernos del altar. Este altar estará completamente consagrado al Señor." Dinero para la expiación',
    'El Señor habló con Moisés y le dijo:',
    ...
    'Cada uno de los censados deberá pagar como ofrenda al Señor seis gramos[2] de plata, que es la mitad de la tasación oficial del santuario. 14[3] Todos los censados mayores de veinte años deberán entregar esta ofrenda al Señor.',
    'Al pagar su rescate, ni el rico dará más de seis gramos, ni el pobre dará menos.',
    'Tú mismo recibirás esta plata de manos de los israelitas, y la entregarás para el servicio de la *Tienda de reunión. De esta manera el Señor tendrá presente que los israelitas pagaron su rescate." El lavamanos',
    'El Señor habló con Moisés y le dijo:',
    ...
    'las manos y los pies para que no mueran. Ésta será una ley perpetua para Aarón y sus descendientes por todas las generaciones." El aceite de la unción',
    'El Señor habló con Moisés y le dijo:',
    ...
    'seis kilos[4] de casia, y cuatro litros[5] de aceite de oliva, según la tasación oficial[6] del santuario.',
    'Con estos ingredientes harás un aceite, es decir, una mezcla aromática como las de los fabricantes de perfumes. Éste será el aceite de la unción sagrada.',
    ...
    'A los israelitas les darás las siguientes instrucciones: De aquí en adelante, éste será mi aceite de la unción sagrada.',
    ...
    'Cualquiera que haga un perfume como éste, y cualquiera que unja con él a alguien que no sea sacerdote, será eliminado de su pueblo. " El incienso',
  ...
  [
    ...
    '"Diles lo siguiente a los israelitas: Ustedes deberán observar mis *sábados. En todas las generaciones venideras, el sábado será una señal entre ustedes y yo, para que sepan que yo, el Señor, los he consagrado para que me sirvan.[1]',
  ...
  [
    ...
    'Moisés volvió entonces del monte. Cuando bajó, traía en sus manos las dos tablas de la *ley, las cuales estaban escritas por sus dos lados.',
    ...
    'Tomó entonces el becerro que habían hecho, lo arrojó al fuego y, luego de machacarlo hasta hacerlo polvo, lo esparció en el agua y se la dio a beber a los israelitas.',
    'A Aarón le dijo: ¿Qué te hizo este pueblo? ¿Por qué lo has hecho cometer semejante pecado?',
    'Hermano mío,[2] no te enojes contestó Aarón. Tú bien sabes cuán inclinado al mal es este pueblo.',
    ...
    'Volvió entonces Moisés para hablar con el Señor, y le dijo: ¡Qué pecado tan grande ha cometido este pueblo al hacerse dioses[3] de oro!',
  ...
  // Capítulo 33
  [
    'El Señor le dijo a Moisés: "Anda, vete de este lugar, junto con el pueblo que sacaste de Egipto, y dirígete a la tierra que bajo juramento prometí a Abraham, Isaac y Jacob que les daría a sus descendientes.',
    ...
    'pues el Señor le había dicho a Moisés: "Diles a los israelitas que son un pueblo terco. Si aun por un momento tuviera que acompañarlos, podría destruirlos. Diles que se quiten esas joyas, que ya decidiré qué hacer con ellos."',
    ...
    'Siempre que Moisés se dirigía a ella, todo el pueblo se quedaba de pie a la entrada de su carpa y seguía a Moisés con la mirada, hasta que éste entraba en la Tienda de reunión.',
    ...
    'Y hablaba el Señor con Moisés cara a cara, como quien habla con un amigo. Después de eso, Moisés regresaba al campamento; pero Josué, su joven asistente, nunca se apartaba de la Tienda de reunión. La gloria del Señor',
  ...
  [
    ...
    'Moisés labró dos tablas de piedra semejantes a las primeras, y muy de mañana subió con ellas al monte Sinaí, como se lo había ordenado el Señor.',
    ...
    'de la siguiente manera: Señor, si realmente cuento con tu favor, ven y quédate entre nosotros. Reconozco que éste es un pueblo terco, pero perdona nuestra iniquidad y nuestro pecado, y adóptanos como tu herencia.',
    ...
    'Deberás rescatar a todos tus primogénitos. Al asno primogénito podrás rescatarlo a cambio de un cordero; pero si no lo rescatas, tendrás que romperle el cuello. "Nadie se presentará ante mí con las manos vacías.',
    '"Trabaja durante seis días, pero descansa el séptimo. Ese día deberás descansar, incluso en el tiempo de arar y cosechar.',
    '"Celebra con las *primicias la fiesta de las Semanas, y también la fiesta de la cosecha de fin de año.[1]',
    '"Todos tus varones deberán presentarse ante mí, su Señor y Dios, el Dios de Israel, tres veces al año.',
    'Entonces yo echaré de tu presencia a las naciones, ensancharé tu territorio y nadie codiciará tu tierra.',
    ...
    'Y Moisés se quedó en el monte, con el Señor, cuarenta días y cuarenta noches, sin comer ni beber nada. Allí, en las tablas, escribió los términos del pacto, es decir, los diez mandamientos. El rostro radiante de Moisés',
  ...
  [
    ...
    'En sábado no se encenderá ningún fuego en ninguna de sus casas." Materiales para el santuario',
    ...
    'el santuario, con su tienda y su toldo, sus ganchos, sus tablones, sus travesaños, sus postes y sus bases;',
    'el arca con sus varas, el *propiciatorio y la cortina que resguarda el arca;',
    'la mesa con sus varas y todos sus utensilios, y el *pan de la Presencia;',
    'el candelabro para el alumbrado y sus accesorios, las lámparas y el aceite para el alumbrado;',
    ...
    'las cortinas del atrio con sus postes y bases, la cortina para la entrada del atrio,',
    'las estacas del toldo para el santuario y para el atrio, y sus cuerdas;',
    'y las vestiduras tejidas que deben llevar los sacerdotes para ministrar en el santuario, tanto las vestiduras sagradas para Aarón como las vestiduras para sus hijos."',
    ...
    'Los ha llenado de gran sabiduría para realizar toda clase de artesanías, diseños y recamados en lana púrpura, carmesí y escarlata, y lino. Son expertos tejedores y hábiles artesanos en toda clase de labores y diseños.'
  ],
  // Capítulo 36
  [
    ...
    'pues lo que ya habían hecho era más que suficiente para llevar a cabo toda la obra. El santuario',
    ...
    'Todas las cortinas medían lo mismo, es decir, doce metros y medio de largo por un metro con ochenta centímetros de ancho. 10[1] Cosieron cinco cortinas una con otra, e hicieron lo mismo con las otras cinco.',
    ...
    'Las once cortinas tenían las mismas medidas, es decir, trece metros y medio de largo por un metro con ochenta centímetros de ancho. 16[2] Cosieron dos conjuntos de cortinas, uno de cinco y otro de seis;',
    ...
    'Cada tablón medía cuatro metros y medio de largo por setenta centímetros de ancho, 22[3] con dos ranuras paralelas entre sí. Todos los tablones del santuario los hicieron así:',
    'Veinte tablones para el lado sur del santuario,',
    'con cuarenta bases de plata que iban debajo de ellos, dos por cada tablón, una debajo de cada ranura;',
    'veinte tablones para el lado opuesto, el lado norte del santuario,',
    'con cuarenta bases de plata que iban debajo de ellos, dos por cada tablón, una debajo de cada ranura;',
    ...
    'de modo que había ocho tablones y dieciséis bases de plata, dos debajo de cada tablón.',
    'También hicieron travesaños de madera de acacia: cinco para los tablones de un costado del santuario,',
    'cinco para los tablones del costado opuesto, y cinco para los tablones del costado occidental, en la parte posterior del santuario.',
    'El travesaño central lo hicieron de tal modo que pasaba de uno a otro extremo, a media altura de los tablones.',
  ...
  // Capítulo 37
  [
    'Bezalel hizo el arca de madera de acacia, de un metro con diez centímetros de largo por setenta centímetros de ancho y setenta centímetros de alto. 2[1] La recubrió de oro puro por dentro y por fuera, y puso en su derredor una moldura de oro.',
    ...
    'El *propiciatorio lo hizo de oro puro, de un metro con diez centímetros de largo por setenta centímetros de ancho. 7[2] Para los dos extremos del propiciatorio hizo dos *querubines de oro trabajado a martillo.',
    ...
    'Bezalel hizo la mesa de madera de acacia, de noventa centímetros de largo por cuarenta y cinco centímetros de ancho y setenta centímetros de alto. 11[3] La recubrió de oro puro y le puso en derredor una moldura de oro.',
    'También le hizo un reborde de veinte centímetros[4] de ancho, y alrededor del reborde le puso una moldura de oro.',
    ...
    'Esas varas eran de madera de acacia y estaban recubiertas de oro.',
    'Los utensilios para la mesa, y sus platos, bandejas, tazones, y jarras para derramar las ofrendas de libación, los hizo de oro puro. El candelabro',
    ...
    'En cada uno de los seis brazos del candelabro había tres copas en forma de flores de almendro, con cálices y pétalos.',
    ...
    'Para hacer el candelabro y todos sus accesorios, usó treinta y tres kilos[5] de oro puro. El altar del incienso',
  ...
  // Capítulo 38
  [
    'Bezalel hizo de madera de acacia el altar de los *holocaustos. Era cuadrado, de dos metros con treinta centímetros por lado, y de un metro con treinta centímetros de alto. 2[1] Puso un cuerno en cada una de sus cuatro esquinas, los cuales formaban una sola pieza con el altar, y el altar lo recubrió de bronce.',
    ...
    'Además, con el bronce de los espejos de las mujeres que servían a la entrada de la *Tienda de reunión, hizo el lavamanos y su pedestal. El atrio',
    'Después hicieron el atrio. El lado sur medía cuarenta y cinco metros[2] de largo, y tenía cortinas de lino fino,',
    ...
    'El lado occidental medía veintidós metros y medio[3] de ancho, y tenía cortinas y diez postes y diez bases, con ganchos y empalmes de plata en los postes.',
    'Por el lado oriental, hacia la salida del sol, medía también veintidós metros y medio de ancho.',
    'A un lado de la entrada había cortinas de siete metros[4] de largo, tres postes y tres bases,',
    ...
    'La cortina a la entrada del atrio era de lana teñida de púrpura, carmesí y escarlata, y de lino fino, recamada artísticamente. Medía nueve metros[5] de largo por dos metros con treinta centímetros[6] de alto, como las cortinas del atrio,',
    ...
    'Todas las estacas del toldo para el santuario y del atrio que lo rodeaba eran de bronce. Los materiales usados',
    'Éstas son las cantidades de los materiales usados para el santuario del *pacto. Los levitas hicieron este registro por orden de Moisés y bajo la dirección de Itamar, hijo del sacerdote Aarón.',
    ...
    'El total del oro dado como ofrenda y empleado en toda la obra del santuario era de una tonelada,[7] según la tasación oficial[8] del santuario.',
    'La plata entregada por los miembros de la comunidad contados en el censo llegó a tres toneladas y media,[9] según la tasación oficial del santuario.',
    'Todos los mayores de veinte años de edad que fueron censados llegaron a un total de seiscientos tres mil quinientos cincuenta, y cada uno de ellos dio seis gramos[10] de plata, según la tasación oficial del santuario.',
    'Tres mil trescientos kilos[11] de plata se emplearon en las cien bases fundidas para el santuario y para la cortina, de modo que cada base pesaba treinta y tres kilos. 28[12] La plata restante[13] se empleó en hacer los ganchos para los postes y recubrir los capiteles de los postes, y para hacer sus empalmes.',
    'El total del bronce dado como ofrenda fue de dos mil trescientos cuarenta kilos, 30[14] y se empleó en las bases para la entrada de la *Tienda de reunión, en el altar de bronce con su enrejado de bronce y todos sus utensilios,',
  ...
  [
    ...
    'Luego las sujetaron a las hombreras del efod para recordar a los hijos de Israel, como se lo mandó el Señor a Moisés. El pectoral',
    'Bezalel hizo también el pectoral, bordado artísticamente, como el *efod, con hilo de oro, lana teñida de púrpura, carmesí y escarlata, y lino fino,',
    'doble y cuadrado, de veinte centímetros por lado. 10[1] En él se engastaron cuatro filas de piedras preciosas. En la primera fila había un rubí, un crisólito y una esmeralda;',
    ...
    'y eran doce piedras, una por cada uno de los hijos de Israel, grabada a manera de sello con el *nombre de cada una de las doce tribus.',
    'Para el pectoral se hicieron cadenillas de oro puro, a manera de cordón.',
    'Se hicieron dos engastes en filigrana de oro y dos anillos de oro, y se sujetaron los anillos en los dos extremos del pectoral;',
    ...
    'Con un cordón de lana púrpura ataron los anillos del pectoral a los anillos del efod, a fin de unir el pectoral al cinturón para que no se desprendiera del efod, como se lo mandó el Señor a Moisés. Otras vestiduras sacerdotales',
    'Bezalel hizo de lana teñida de púrpura, y tejido artísticamente, todo el manto del *efod.',
    'Lo hizo con una abertura en el centro, como abertura para la cabeza,[3] y con un refuerzo alrededor de la abertura, para que no se rasgara.',
    ...
    'las mitras y el turbante de lino, y la ropa interior de lino fino.',
    ...
    'el arca del *pacto con sus varas y el *propiciatorio,',
    ...
    'y las vestiduras tejidas para ministrar en el santuario, tanto las vestiduras sagradas para el sacerdote Aarón como las vestiduras sacerdotales para sus hijos.',
  ...
  [
    ...
    'Después levantó Moisés el atrio en torno al santuario y al altar, y colgó la cortina a la entrada del atrio. Así terminó Moisés la obra. La gloria del Señor',
    ...
    'Durante todas las marchas de los israelitas, la nube del Señor reposaba sobre el santuario durante el día, pero durante la noche había fuego en la nube, a la vista de todo el pueblo de Israel. Levitico 1'
  ]
];