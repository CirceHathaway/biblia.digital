export default [
  ...
  [
    ...
    'Por lo tanto, se entorpece la ley y no se da curso a la justicia. El impío acosa al justo, y las sentencias que se dictan son injustas. «¡Miren a las naciones! ¡Contémplenlas y quédense asombrados! Estoy por hacer en estos días cosas tan sorprendentes',
    ...
    'Son un viento que a su paso arrasa todo; su pecado es hacer de su fuerza un dios.» 12',
  ...
  [
    ...
    'Además, la riqueza es traicionera; por eso el soberbio no permanecerá. Pues ensancha su garganta, como el sepulcro, y es insaciable como la muerte. Reúne en torno suyo a todas las naciones y toma cautivos a todos los pueblos.',
  ...
  [
    ...
    'De Temán viene Dios, del monte de Parán viene el Santo. Su gloria cubre el cielo y su alabanza llena la tierra.',
    ...
    'Descubriste tu arco, llenaste de flechas tu aljaba. Tus ríos surcan la tierra;',
