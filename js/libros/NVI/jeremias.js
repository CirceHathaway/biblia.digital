export default [
  // Jeremías 1
  [
    'Éstas son las palabras de Jeremías hijo de Jilquías. Jeremías provenía de una familia sacerdotal de Anatot, ciudad del territorio de Benjamín.',
    ...
    'Hoy te he puesto como ciudad fortificada, como columna de hierro y muro de bronce, contra todo el país, contra los reyes de Judá, contra sus autoridades y sus sacerdotes, y contra la gente del país.',
  ...
  [
    ...
    'Tan sólo reconoce tu culpa, y que te rebelaste contra el Señor tu Dios. Bajo todo árbol frondoso has brindado a dioses extraños tus favores, y no has querido obedecerme afirma el Señor.',
    '»¡Vuélvanse a mí, apostatas afirma el Señor, porque yo soy su esposo! De ustedes tomaré uno de cada ciudad y dos de cada familia, y los traeré a Sión.',
    ...
    '«¡Vuélvanse, apostatas, y los curaré de su infidelidad!» «Aquí estamos, a ti venimos, porque tú eres el Señor nuestro Dios.',
  ...
  [
    ...
    '¿Qué piensas hacer, ciudad devastada? ¿Para qué te vistes de púrpura? ¿Para qué te pones joyas de oro? ¿Para qué te maquillas los ojos? En vano te embelleces, pues tus amantes te desprecian; sólo buscan tu muerte.',
  ...
  [
    ...
    '»Algo espantoso y terrible ha ocurrido en este país.',
  ...
  [
    ...
    '¿A quién le hablaré? ¿A quién le advertiré? ¿Quién podrá escucharme? Tienen tapados los oídos y no pueden comprender. La palabra del Señor los ofende; detestan escucharla.',
  ...
  [
    ...
    'Además, construyeron el santuario pagano de Tofet, en el valle de Ben Hinón, para quemar a sus hijos y a sus hijas en el fuego, cosa que jamás ordené ni me pasó siquiera por la mente.',
  ...
  [
    ...
    'que yo mismo prescribí a los antepasados de ustedes el día que los hice salir de Egipto, de esa caldera para fundir hierro. Les dije: Obedézcanme y cumplan con todo lo que les prescribo, y ustedes serán mi pueblo y yo seré su Dios.',
    ...
    'Han vuelto a los mismos pecados de sus antepasados, quienes se negaron a obedecerme. Se han ido tras otros dioses para servirles. Tanto el pueblo de Israel como la tribu de Judá han quebrantado el pacto que hice con sus antepasados.',
  ...
  [
    ...
    'Tú, esperanza y salvación de Israel en momentos de angustia, ¿por qué actúas en el país como un peregrino, como un viajero que sólo pasa la noche?',
    ...
    'El Señor me contestó: «Mentira es lo que están profetizando en mi nombre esos profetas. Yo no los he enviado, ni les he dado ninguna orden, y ni siquiera les he hablado. Lo que les están profetizando son visiones engañosas, adivinaciones vanas y delirios de su propia imaginación.',
    ...
    'Si salgo al campo, veo los cuerpos de los muertos a filo de espada; si entro en la ciudad, veo los estragos que el hambre ha producido. Tanto el profeta como el sacerdote ejercen en el país, sin conocimiento. »',
  ...
  [
    ...
    'Haré que sirvas a tus enemigos en una tierra que no conoces, porque en mi ira un fuego se ha encendido, y arde contra ustedes.»',
  ...
  [
    ...
    'Porque así dice el Señor Todopoderoso, el Dios de Israel: Voy a poner fin en este lugar a toda expresión de alegría y de regocijo, y al cántico del novio y de la novia. Esto sucederá en sus propios días, y ustedes lo verán.',
    ...
    '»Voy a enviar a muchos pescadores afirma el Señor, y ellos los pescarán a ustedes. Después, enviaré a muchos cazadores, y ellos los cazarán a ustedes por todas las montañas y colinas, y por las grietas de las rocas.',
  ...
  [
    ...
    'Tampoco saquen ninguna carga de sus casas en día sábado, ni hagan ningún tipo de trabajo. Observen el reposo del sábado, tal como se lo ordené a sus antepasados.',
    ...
    'entonces entrarán por las puertas de esta ciudad reyes y príncipes que se sentarán en el trono de David. Ellos y los príncipes entrarán montados en carros y caballos, acompañados por la gente de Judá y por los habitantes de Jerusalén, y esta ciudad será habitada para siempre.',
  ...
  [
    ...
    'y ve al valle de Ben Hinón, que está a la entrada de la puerta de los Alfareros, y proclama allí las palabras que yo te comunicaré.',
    ...
    'Por eso vendrán días en que este lugar ya no se llamará Tofet, ni Valle de Ben Hinón, sino Valle de la Matanza afirma el Señor.',
    'En este lugar anularé los planes de Judá y de Jerusalén, y los haré caer a filo de espada delante de sus enemigos, es decir, a manos de los que atentan contra su vida, y dejaré sus cadáveres a las aves del cielo y a las bestias de la tierra, para que les sirvan de comida.',
    ...
    'y adviérteles que así dice el Señor Todopoderoso: Voy a hacer pedazos esta nación y esta ciudad, como quien hace pedazos un cántaro de alfarero, que ya no se puede reparar; y a falta de otro lugar, enterrarán a sus muertos en Tofet.',
  ...
  [
    ...
    'Además, pondré en manos de sus enemigos toda la riqueza de esta ciudad, todos sus productos y objetos de valor, y todos los tesoros de los reyes de Judá, para que los saqueen y se los lleven a Babilonia.',
  ...
  [
    ...
    'Jeremías les respondió: «Adviértanle a Sedequías',
    ...
    'El que se quede en esta ciudad morirá por la espada y la peste, o de hambre. Pero el que salga y se rinda a los caldeos que los están sitiando, vivirá. Así salvará su vida.',
  ...
  [
    ...
    'Si de veras cumplen con esta palabra, entonces por las puertas de este palacio entrarán reyes que ocuparán el trono de David; entrarán en carros y a caballo, acompañados por sus oficiales y su pueblo.',
  ...
  [
    ...
    'Y la palabra del Señor vino a mí:',
  ...
  [
    ...
    'Desataré calamidades contra la ciudad que lleva mi nombre. ¿Y creen ustedes que no los voy a castigar? Al contrario, serán castigados afirma el Señor Todopoderoso, porque yo desenvaino la espada contra todos los habitantes de la tierra.',
  ...
  [
    ...
    'Pero Jeremías les dijo a todos los jefes y a todo el pueblo: «El Señor me envió para profetizar contra esta casa y contra esta ciudad todas las cosas que ustedes han escuchado.',
    ...
    'Pero sepan que si ustedes me matan, estarán derramando sangre inocente sobre ustedes mismos y sobre los habitantes de esta ciudad. Lo cierto es que el Señor me ha enviado a que les anuncie claramente todas estas cosas.»',
    ...
    'Hubo también otro profeta, de nombre Urías hijo de Semaías, de Quiriat Yearín, que profetizaba en el nombre del Señor. Éste profetizó contra la ciudad y contra el país, tal y como lo hizo Jeremías.',
  ...
  [
    ...
    'Envía luego a los reyes de Edom, Moab, Amón, Tiro y Sidón, un mensaje por medio de los mensajeros que vienen a Jerusalén para ver a Sedequías, rey de Judá.',
    ...
    'Ahora mismo entrego todos estos países en manos de mi siervo Nabucodonosor, rey de Babilonia, y hasta las bestias del campo las he puesto bajo su poder.',
    'Todas las naciones le servirán a él, y a su hijo y a su nieto, hasta que también a su país le llegue la hora y sea sometido por numerosas naciones y grandes reyes.',
    ...
    'Las mentiras que ellos les profetizan sólo sirven para que ustedes se alejen de su propia tierra, y para que yo los expulse y mueran.',
    ...
    'los cuales no se llevó Nabucodonosor, rey de Babilonia, cuando deportó de Jerusalén a Babilonia a Jeconías[1] hijo de Joacim, rey de Judá, junto con todos los nobles de Judá y Jerusalén,',
  ...
  [
    ...
    'Cásense, y tengan hijos e hijas; y casen a sus hijos e hijas, para que a su vez ellos les den nietos. Multiplíquense allá, y no disminuyan.',
  ...
  [
    ...
    'Sedequías, el rey de Judá, lo tenía preso y le reprochaba: «¿Por qué andas profetizando: Así dice el Señor? Andas proclamando que el Señor dice: Voy a entregar esta ciudad en manos del rey de Babilonia, y él la tomará;',
    ...
    'y me dijo: Janamel, hijo de tu tío Salún, vendrá a pedirte que le compres el campo que está en Anatot, pues tienes el derecho y la responsabilidad de comprarlo por ser el pariente más cercano.',
    ...
    'y se las entregué a Baruc, hijo de Nerías y nieto de Maseías, en presencia de Janamel, de los testigos que habían firmado la escritura, y de todos los judíos que estaban sentados en el patio de la guardia.',
    'Con ellos como testigos, le ordené a Baruc:',
    'Así dice el Señor Todopoderoso, el Dios de Israel: ‘Toma la copia sellada y la copia abierta de esta escritura, y guárdalas en una vasija de barro, para que se conserven mucho tiempo.',
    ...
    'También construían altares a Baal en el valle de Ben Hinón, para pasar por el fuego a sus hijos e hijas en sacrificio a Moloc, cosa detestable que yo no les había ordenado, y que ni siquiera se me había ocurrido. De este modo hacían pecar a Judá.',
    '»Por tanto, así dice el Señor, Dios de Israel, acerca de esta ciudad que, según ustedes, caerá en manos del rey de Babilonia por la espada, el hambre y la pestilencia:',
    ...
    '»Así dice el Señor: Tal como traje esta gran calamidad sobre este pueblo, yo mismo voy a traer sobre ellos todo el bien que les he prometido.',
  ...
  [
    ...
    'entonces habría rechazado a los descendientes de Jacob y de mi siervo David, y no habría escogido a uno de su estirpe para gobernar sobre la descendencia de Abraham, Isaac y Jacob. ¡Pero yo cambiaré su suerte y les tendré compasión! »'
  ],
  ...
  [
    ...
    'Una vez más la palabra del Señor vino a Jeremías:',
    ...
    'que cada siete años liberaran a todo esclavo hebreo que se hubiera vendido a sí mismo con ellos. Después de haber servido como esclavo durante seis años, debía ser liberado. Pero sus antepasados no me obedecieron ni me hicieron caso.',
  ...
  [
    ...
    'Jeremías también les dijo a los recabitas: «Así dice el Señor Todopoderoso, el Dios de Israel: Por cuanto ustedes han obedecido las órdenes de Jonadab, su antepasado, y han cumplido con todos sus mandamientos y han hecho todo lo que él les ordenó,',
  ...
  [
    ...
    'Jeremías llamó a Baruc hijo de Nerías, y mientras le dictaba, Baruc escribía en el rollo todo lo que el Señor le había dicho al profeta.',
    ...
    'Entonces todos los jefes enviaron a Yehudi hijo de Netanías, nieto de Selemías y bisnieto de Cusí, para que le dijera a Baruc: «Toma el rollo que has leído ante el pueblo, y ven.» Baruc hijo de Nerías lo tomó y se presentó ante ellos.',
    ...
    'A medida que Yehudi terminaba de leer tres o cuatro columnas, el rey las cortaba con un estilete de escriba y las echaba al fuego del brasero. Así lo hizo con todo el rollo, hasta que éste se consumió en el fuego.',
  ...
  [
    ...
    'Éstos estaban enfurecidos contra Jeremías, así que luego de golpearlo lo encarcelaron en la casa del cronista Jonatán, ya que la habían convertido en prisión.',
  ...
  [
    ...
    'Los jefes le dijeron al rey: Hay que matar a este hombre. Con semejantes discursos está desmoralizando a los soldados y a todo el pueblo que aún quedan en esta ciudad. Este hombre no busca el bien del pueblo, sino su desgracia.',
    ...
    'Ebedmélec lo hizo así, y fue al depósito de ropa del palacio real, sacó de allí ropas y trapos viejos, y con unas sogas se los bajó a la cisterna a Jeremías.',
  ...
  [
    ...
    'por la que entraron todos los jefes del rey de Babilonia, hasta instalarse en la puerta central: Nergal Sarézer de Samgar, Nebo Sarsequín, un oficial principal, Nergal Sarézer, también un alto funcionario, y todos los otros jefes del rey de Babilonia.',
    ...
    '«Ve y dile a Ebedmélec, el etíope, que así dice el Señor Todopoderoso, el Dios de Israel: Voy a cumplir las palabras que anuncié contra esta ciudad, para mal y no para bien. En aquel día, tú serás testigo de todo esto.',
  ...
  [
    ...
    'y ahora el Señor ha cumplido sus amenazas. Todo esto les ha pasado porque pecaron contra el Señor y desobedecieron su voz.',
    ...
    'fueron a Mizpa para presentarse ante Guedalías. Entre ellos estaban: Ismael hijo de Netanías, Johanán y Jonatán hijos de Carea, Seraías hijo de Tanjumet, los hijos de Efay de Netofa, y Jezanías, hijo de un hombre de Macá, y sus hombres.',
    'Guedalías hijo de Ajicán, nieto de Safán, les hizo este juramento a ellos y a sus tropas: «No teman a los babilonios. Si ustedes se quedan en el país y sirven al rey de Babilonia, les aseguro que les irá bien.',
    'Yo me quedaré en Mizpa, para representarlos ante los babilonios que vengan hasta acá. Pero ustedes, comiencen a almacenar en recipientes vino, frutos de verano y aceite, y vivan en las ciudades que han ocupado.»',
    'Todos los judíos que estaban en Moab, Amón y Edom, y en todos los otros países, se enteraron también de que el rey de Babilonia había dejado un remanente en Judá, y nombrado como gobernador a Guedalías hijo de Ajicán, nieto de Safán.',
    'Entonces todos estos judíos regresaron a la tierra de Judá, de todos los países donde estaban dispersos. Al llegar, se presentaron en Mizpa ante Guedalías, y también almacenaron vino y frutos de verano en abundancia.',
    'Johanán hijo de Carea, y todos los demás jefes militares que estaban en el campo, se presentaron ante Guedalías en Mizpa,',
  ...
  // Jeremías 41
  [
    'En el mes séptimo Ismael, hijo de Netanías y nieto de Elisama, que era de estirpe real y había sido uno de los oficiales del rey, vino a Mizpa con diez hombres y se presentó ante Guedalías hijo de Ajicán. Y ahí en Mizpa, mientras comían juntos,',
    ...
    'Cuando Johanán hijo de Carea, y todos los jefes militares que estaban con él, se enteraron del crimen que había cometido Ismael hijo de Netanías,',
    'reunieron a todos sus hombres y fueron a pelear contra él. Lo encontraron cerca del gran estanque que está en Gabaón.',
  ...
  [
    ...
    'Éste llamó a Johanán hijo de Carea, a todos los jefes militares que lo acompañaban, y a todo el pueblo, desde el más chico hasta al más grande,',
  ...
  [
    ...
    'Luego comunícales que así dice el Señor Todopoderoso, el Dios de Israel: Voy a mandar a buscar a mi siervo Nabucodonosor, rey de Babilonia; voy a colocar su trono sobre estas piedras que he enterrado, y él armará sobre ellas su toldo real.',
  ...
  [
    ...
    '«Así dice el Señor Todopoderoso, el Dios de Israel: Ustedes han visto todas las calamidades que yo provoqué sobre Jerusalén y sobre todas las ciudades de Judá. Hoy yacen en ruinas, sin morador alguno,',
    ...
    '¿Acaso ya se han olvidado de todas las maldades que cometieron sus antepasados, de las que cometieron los reyes de Judá y sus esposas, y de las que ustedes y sus esposas cometieron en Judá y en las calles de Jerusalén?',
    ...
    'Y las mujeres añadieron: Cuando nosotras ofrecíamos incienso y libaciones a la Reina del Cielo, ¿acaso no sabían nuestros maridos que hacíamos tortas con su imagen, y que les ofrecíamos libaciones?',
    ...
    'Ustedes ofrecieron incienso y pecaron contra el Señor, y no obedecieron su voz ni cumplieron con su ley, sus preceptos y estipulaciones. Por eso en este día les ha sobrevenido esta desgracia.',
    ...
    'Así dice el Señor Todopoderoso, el Dios de Israel: Cuando ustedes y sus mujeres dicen: ‘Ciertamente cumpliremos nuestros votos de ofrecer incienso y libaciones a la Reina del Cielo, demuestran con sus acciones que cumplen lo que prometen. ¡Está bien, vayan y cumplan sus promesas, lleven a cabo sus votos!',
  ...
  [
    ...
    'Ésta es la palabra del Señor, que vino a Jeremías el profeta cuando Nabucodonosor, rey de Babilonia, vino para atacar el país de Egipto:',
    ...
    '»Novilla hermosa es Egipto, pero viene contra ella un tábano del norte.',
  ...
  [
    ...
    'El juicio ha llegado hasta la meseta contra Holón, Yahaza y Mefat;',
    'contra Dibón, Nebo y Bet Diblatayin;',
    'contra Quiriatayin, Bet Gamul y Bet Megón,',
    'contra Queriot y Bosra, y contra todas las ciudades de Moab, cercanas y lejanas.',
  ...
  [
    ...
    'La porción de Jacob no es como aquéllos; su Dios es el creador de todas las cosas. Su nombre es el Señor Todopoderoso; Israel es la tribu de su heredad.',
    ...
    'Éste es el mandato que el profeta Jeremías dio a Seraías, hijo de Nerías y nieto de Maseías, cuando fue a Babilonia con Sedequías, rey de Judá, durante el año cuarto de su reinado. Seraías era el jefe de este viaje.',
  ...
  [
    ...
    'A los diez días del mes quinto del año diecinueve del reinado de Nabucodonosor, rey de Babilonia, su servidor Nabuzaradán, que era comandante de la guardia, fue a Jerusalén',
    ...
    'El bronce de las dos columnas, de la fuente, de los doce toros que estaban debajo de la fuente, y de las bases, que el rey Salomón había hecho para el templo del Señor, era tanto que no se podía pesar.',
    ...
    'El capitel de bronce que estaba encima de cada columna medía dos metros de altura y estaba decorado alrededor con una red y con granadas de bronce. Las dos columnas tenían el mismo adorno.',
    ...
    'Éste es el número de personas desterradas por Nabucodonosor: en el año séptimo de su reinado, tres mil veintitrés judíos;',
    'en el año dieciocho de su reinado, ochocientas treinta y dos personas de Jerusalén;',
    'en el año veintitrés de su reinado, Nabuzaradán, el capitán de la guardia real, desterró a setecientos cuarenta y cinco judíos. En total fueron desterradas cuatro mil seiscientas personas.',
