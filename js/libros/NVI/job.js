// Libro de Job (NVI) — exportado automáticamente
export default [
  [  // 1
    ...
    'cuando, de pronto, un fuerte viento del desierto dio contra la casa y derribó sus cuatro esquinas. ¡Y la casa cayó sobre los jóvenes, y todos murieron! ¡Sólo yo pude escapar, y ahora vengo a contárselo!»',
  ...
  [  // 2
    ...
    'Job le respondió: Mujer, hablas como una necia. Si de Dios sabemos recibir lo bueno, ¿no sabremos también recibir lo malo? A pesar de todo esto, Job no pecó ni de palabra. Los tres amigos de Job',
  ...
  [  // 3
    ...
    'Dijo así:',
    '«Que perezca el día en que fui concebido y la noche en que se anunció: ¡Ha nacido un niño!',
    ...
    'Anhelan éstos una muerte que no llega, aunque la buscan más que a tesoro escondido;',
  ...
  [  // 4
    ...
    '»En lo secreto me llegó un mensaje; mis oídos captaron sólo su murmullo.',
  ...
  [  // 7
    ...
    'meses enteros he vivido en vano; ¡me han tocado noches de miseria! 4Me acuesto y pienso: ¿Cuánto falta para que amanezca? La noche se me hace interminable; me doy vueltas en la cama hasta el amanecer.',
    ...
    'que cada mañana lo examinas y a toda hora lo pones a prueba?',
  ...
  [  // 8
    ...
    'y si eres puro y recto, él saldrá en tu defensa y te devolverá el lugar que te corresponde.',
  ...
  [  // 9
    ...
    'Aun siendo inocente, me condenará mi boca; aún siendo íntegro, resultaré culpable.',
  ...
  [  // 11
    ...
    'para mostrarte los secretos de la sabiduría, pues ésta es muy compleja! Sabrías entonces que buena parte de tu pecado Dios no lo ha tomado en cuenta.',
    ...
    'entonces podrás llevar la frente en alto y mantenerte firme y libre de temor.',
  ...
  [  // 13
    ...
    'Yo tengo tanto conocimiento como ustedes; en nada siento que me aventajen. 3Más bien quisiera hablar con el Todopoderoso; me gustaría discutir mi caso con Dios.',
  ...
  [  // 14
    ...
    'Si el hombre muere, ya no vuelve a la vida. Cada día de mi servicio obligatorio esperaré a que llegue mi relevo.',
  ...
  [  // 15
    ...
    'El impío se ve atormentado toda su vida, el desalmado tiene sus años contados.',
  ...
  [  // 16
    ...
    'Ciertamente Dios me ha destruido; ha exterminado a toda mi familia. 8Me tiene acorralado, y da testimonio contra mí; mi deplorable estado se levanta y me condena.',
  ...
  [  // 20
    ...
    '»Bien sabes tú que desde antaño, desde que Dios puso al hombre en la tierra, 5muy breve ha sido la algarabía del malvado; la alegría del impío ha sido pasajera.',
  ...
  [  // 21
    ...
    '»¿Acaso dirijo mi reclamo a los mortales? ¿Por qué creen que pierdo la paciencia? 5Mírenme, y queden asombrados; tápense la boca con la mano.',
  ...
  [  // 26
    ...
    'Un soplo suyo despeja los cielos; con su mano ensartó a la serpiente escurridiza.',
  ...
  [  // 28
    ...
    'Pero, ¿dónde se halla la sabiduría? ¿Dónde habita la inteligencia?',
  ...
  [  // 31
    ...
    '»Si mis tierras claman contra mí, y todos sus surcos se anegan en llanto;',
  ...
  [  // 32
    ...
    'Pero lo que da entendimiento al hombre es el espíritu que en él habita; ¡es el hábito del Todopoderoso!',
  ...
  [  // 33
    ...
    'él nos habla al oído y nos aterra con sus advertencias,',
    'para apartarnos de hacer lo malo y alejarnos de la soberbia;',
    'para librarnos de caer en el sepulcro y de cruzar el umbral de la muerte.',
    ...
    'De lo contrario, escúchame en silencio y yo te impartiré sabiduría.»'
  ],
  [  // 34
    'También dijo Eliú:',
  ...
  [  // 36
    ...
    '»Él derrama las gotas de agua que fluyen como lluvia hacia los ríos;',
    'las nubes derraman su lluvia, que cae a raudales sobre el género humano.',
  ...
  [  // 37
    '»Al llegar a este punto, me palpita el corazón como si fuera a salírseme del pecho.',
  ...
  [  // 38
    ...
    'La tierra adquiere forma, como arcilla bajo un sello; resaltan sus rasgos como los de un vestido.',
  ...
  [  // 42
    ...
    'Tuvo también catorce hijos y tres hijas.',
