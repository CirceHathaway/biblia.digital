export default [
  ...
  [
    ...
    'Su territorio se extenderá desde el desierto hasta el Líbano, y desde el gran río Éufrates, territorio de los hititas, hasta el mar Mediterráneo, que se encuentra al oeste.',
    ...
    'Sus mujeres, sus niños y su ganado permanecerán en el territorio que Moisés les dio al este del Jordán. Pero ustedes, los hombres de guerra, cruzarán armados al frente de sus hermanos. Les prestarán ayuda',
    ...
    'Cualquiera que se rebele contra tus palabras o que no obedezca lo que tú ordenes, será condenado a muerte. Pero tú, ¡sé fuerte y valiente! Josué',
  ],
  // Capítulo 2
  [
    ...
    'Salieron cuando empezó a oscurecer, a la hora de cerrar las puertas de la ciudad, y no sé a dónde se fueron. Vayan tras ellos; tal vez les den alcance.» ',' (En realidad, la mujer había llevado a los hombres al techo de la casa y los había escondido entre los manojos de lino que allí secaba.)',
    ...
    'Quien salga de la casa en ese momento, será responsable de su propia vida, y nosotros seremos inocentes. Sólo nos haremos responsables de quienes permanezcan en la casa, si alguien se atreve a ponerles la mano encima.',
    ...
    'Los dos hombres emprendieron el regreso; bajando de las montañas, vadearon el río y llegaron adonde estaba Josué hijo de Nun. Allí le relataron todo lo que les había sucedido: ',' »El Señor ha entregado todo el país en nuestras manos. ¡Todos sus habitantes tiemblan de miedo ante nosotros!» Josué',
  ],
  // Capítulo 3
  [
  ...
  // Capítulo 4
  [
    'Cuando todo el pueblo terminó de cruzar el río Jordán, el Señor le dijo a Josué: ',' »Elijan a un hombre de cada una de las doce tribus de Israel',
    ...
    'y les dijo: »Vayan al centro del cauce del río, hasta donde está el arca del Señor su Dios, y cada uno cargue al hombro una piedra. Serán doce piedras, una por cada tribu de Israel',
    'y servirán como señal entre ustedes. En el futuro, cuando sus hijos les pregunten: ¿Por qué están estas piedras aquí?',
    'ustedes les responderán: El día en que el arca del pacto del Señor cruzó el Jordán, las aguas del río se dividieron frente a ella. Para nosotros los israelitas, estas piedras que están aquí son un recuerdo permanente de aquella gran hazaña. »',
    ...
    'Luego el Señor le dijo a Josué: ',' »Ordénales a los sacerdotes portadores del arca del pacto que salgan del Jordán.»',
    'Josué les ordenó a los sacerdotes que salieran',
    'y así lo hicieron, portando el arca del pacto. Tan pronto como sus pies tocaron tierra firme, las aguas del río regresaron a su lugar y se desbordaron como de costumbre.',
  ...
  [
    ...
    'Luego el Señor le dijo a Josué: »Hoy les he quitado de encima el oprobio de Egipto.» Por esa razón, aquel lugar se llama Guilgal hasta el día de hoy. Celebración de la Pascua',
    ...
    'Desde ese momento dejó de caer maná, y durante todo ese año el pueblo se alimentó de los frutos de la tierra. El comandante del ejército del Señor',
  ...
  [
    ...
    'Cuando todos escuchen el toque de guerra, el pueblo deberá gritar a voz en cuello. Entonces los muros de la ciudad se derrumbarán, y cada uno entrará sin impedimento.»',
    'Josué hijo de Nun llamó a los sacerdotes y les ordenó: »Carguen el arca del pacto, y que siete de ustedes lleven trompetas y marchen frente a ella.»',
    ...
    'Cuando Josué terminó de dar las instrucciones al pueblo, los siete sacerdotes marcharon al frente del arca del pacto del Señor tocando sus trompetas; y el arca del pacto les seguía.',
    ...
    'El séptimo día, a la salida del sol, se levantaron y marcharon alrededor de la ciudad tal como lo habían hecho los días anteriores, sólo que en ese día repitieron la marcha siete veces.',
    ...
    'Así que los jóvenes exploradores entraron y sacaron a Rajab junto con sus padres y hermanos, y todas sus pertenencias, y llevaron a toda la familia a un lugar seguro, fuera del campamento israelita.',
    'Sólo entonces los israelitas incendiaron la ciudad con todo lo que había en ella, menos los objetos de plata, de oro, de bronce y de hierro, los cuales depositaron en el tesoro de la casa del Señor.',
    'Así Josué salvó a la prostituta Rajab, a toda su familia y todas sus posesiones, por haber escondido a los mensajeros que él había enviado a Jericó. Y desde entonces, Rajab y su familia viven con el pueblo de Israel.',
    ...
    'El Señor estuvo con Josué, y éste se hizo famoso por todo el país. Josué',
  ],
  // Capítulo 7
  [
    ...
    'Josué le reclamó a Dios: Señor y Dios, ¿por qué hiciste que este pueblo cruzara el Jordán, y luego lo entregaste en manos de los amorreos para que lo destruyeran? ¡Mejor nos hubiéramos quedado al otro lado del río!',
    ...
    'Por eso los israelitas no podrán hacerles frente a sus enemigos, sino que tendrán que huir de sus adversarios. Ellos mismos se acarrearon su destrucción. Y si no destruyen ese botín que está en medio de ustedes, yo no seguiré a su lado.',
    ...
    'El que sea sorprendido en posesión del botín de guerra destinado a la destrucción será quemado junto con su familia y sus posesiones, pues ha violado el pacto del Señor y ha causado el oprobio a Israel. El castigo de Acán',
    'Al día siguiente, muy de madrugada, Josué mandó llamar, una por una, las tribus de Israel; y la suerte cayó sobre Judá.',
    ...
    'Acán le replicó: Es cierto que he pecado contra el Señor, Dios de Israel. Ésta es mi falta:',
    ...
    'En seguida, Josué envió a unos mensajeros, los cuales fueron corriendo a la carpa de Acán. Allí encontraron todo lo que Acán había escondido',
  ...
  [
    ...
    'Cuando hayan capturado la ciudad, quémenla tal como nos lo ordenó el Señor. Éstas son mis órdenes.»',
    ...
    'Los de la emboscada salieron de la ciudad y persiguieron a los guerreros de Hai, y así éstos quedaron atrapados por todos lados. Los israelitas atacaron a sus enemigos hasta no dejar ni fugitivos ni sobrevivientes.',
    ...
    'De esta lectura que hizo Josué ante toda la asamblea de los israelitas, incluyendo a las mujeres, a los niños y a los inmigrantes, no se omitió ninguna palabra de lo ordenado por Moisés. Josué',
  ],
  // Capítulo 9
  [
    ...
    'Por eso los habitantes de nuestro país, junto con nuestros dirigentes, nos pidieron que nos preparáramos para el largo viaje y que les diéramos a ustedes el siguiente mensaje: Deseamos ser siervos de ustedes; hagamos un tratado.',
    'Cuando salimos para acá, nuestro pan estaba fresco y caliente, pero ahora, ¡mírenlo! Está duro y hecho migas.',
    ...
    'Ese mismo día Josué los hizo leñadores y aguateros de la asamblea israelita, especialmente del altar del Señor que está en el lugar que él mismo eligió. Y así han permanecido hasta el día de hoy. Josué',
  ],
  // Capítulo 10
  [
    ...
    'Cuando se los trajeron, Josué convocó a todo el ejército israelita y les ordenó a todos los comandantes que lo habían acompañado: »Acérquense y písenles el cuello a estos reyes.» Los comandantes obedecieron al instante.',
    ...
    'Así Josué conquistó toda aquella región: la cordillera, el Néguev, los llanos y las laderas. Derrotó a todos sus reyes, sin dejar ningún sobreviviente. ¡Todo cuanto tenía aliento de vida fue destruido completamente! Esto lo hizo según el mandato del Señor, Dios de Israel.',
    ...
    'Después Josué regresó al campamento de Guilgal junto con todo el ejército israelita. Josué',
  ],
  // Capítulo 11
  [
    ...
    'Josué conquistó todas las ciudades de aquellos reinos junto con sus reyes; a éstos mató a filo de espada, destruyéndolos por completo. Así obedeció Josué todo lo que Moisés, siervo del Señor, le había mandado.',
    ...
    'Así como el Señor había ordenado a su siervo Moisés, también Moisés se lo ordenó a Josué. Y éste, por su parte, cumplió al pie de la letra todo lo que el Señor le había ordenado a Moisés.',
  ...
  [
    ...
    'Los israelitas bajo el mando de Moisés derrotaron a estos reyes. Y Moisés repartió aquel territorio entre los rubenitas, los gaditas y la media tribu de Manasés.',
    ...
    'Tales territorios comprendían la región montañosa, los valles occidentales, el Arabá, las laderas, el desierto y el Néguev. Esas tierras habían pertenecido a los hititas, amorreos, cananeos, ferezeos, heveos y jebuseos. Ésta es la lista de reyes:',
    'el rey de Jericó, el rey de Hai, ciudad cercana a Betel,',
    ...
    'el rey de Tapúaj, el rey de Héfer,',
    ...
    'el rey de Dor que está en Nafot Dor, el rey Goyim de Guilgal',
    'y el rey de Tirsá. Eran treinta y un reyes en total.',
  ],
  // Capítulo 13
  [
    ...
    'que se extiende desde el río Sijor, al este de Egipto, hasta la frontera de Ecrón al norte. A ése se le considera territorio cananeo, y en él se encuentran los cinco gobernantes filisteos: el de Gaza, el de Asdod, el de Ascalón, el de Gat y el de Ecrón. También queda sin conquistar el territorio de los aveos.',
    ...
    'Comprendía, además, Galaad, el territorio de la gente de Guesur y Macá, toda la montaña del Hermón y todo Basán hasta Salcá.',
    ...
    'Éstas son las tierras que Moisés había entregado a cada uno de los clanes de la tribu de Rubén',
    'abarcaban desde Aroer, que estaba a orillas del arroyo Arnón, con la población ubicada en medio del valle. Incluían también toda la meseta de Medeba',
    'hasta Hesbón y todas las poblaciones de la meseta: Dibón, Bamot Baal, Bet Baal Megón,',
    'Yahaza, Cademot, Mefat,',
    'Quiriatayin, Sibma, Zaret Sajar, que está en la colina del valle,',
    'Bet Peor, Bet Yesimot y las laderas del monte Pisgá',
    'es decir, las ciudades y los pueblos de la meseta, y todos los dominios de Sijón, rey amorreo que gobernó en Hesbón. Moisés había derrotado a este rey y a los príncipes madianitas Eví, Requen, Zur, Jur y Reba, todos ellos aliados de Sijón y habitantes de la región.',
    'Los israelitas pasaron a filo de espada a muchos hombres en el campo de batalla, incluso al adivino Balán hijo de Beor.',
    'El río Jordán sirvió como frontera del territorio perteneciente a los rubenitas. Estas ciudades y pueblos fueron la herencia de la tribu de Rubén, según sus clanes.',
    ...
    'y las tierras comprendidas entre Hesbón, Ramat Mizpé y Betonín, y entre Majanayin y la frontera de Debir.',
    ...
    'Éstas son las tierras que Moisés había entregado a la media tribu de Manasés y sus clanes',
    'el territorio que abarca Majanayin y toda la región de Basán, es decir, todo el reino de Og, incluyendo las sesenta poblaciones de Yaír.',
  ...
  [
    ...
    ' Ya éste les había dado por herencia la parte oriental del Jordán a las dos tribus y media, pero a los levitas no les dio tierras,. Pero a los levitas no les dio tierras, ',
    ...
    '»Ya han pasado cuarenta y cinco años desde que el Señor hizo la promesa por medio de Moisés, mientras Israel peregrinaba por el desierto; aquí estoy este día con mis ochenta y cinco años: ¡el Señor me ha mantenido con vida!',
  ...
  [
    ...
    'Ésta es la lista de los territorios que recibieron como herencia los clanes de la tribu de Judá:',
    ...
    'Jazar Súal, Berseba, con sus poblados,',
    'Balá, Iyín, Esen,',
  ...
  [
    ...
    'Éste es el territorio que recibieron la tribu de Efraín y sus respectivos clanes: En el lado oriental sus límites se extendían desde Atarot Adar hasta Bet Jorón de Arriba',
  ...
  [
    ...
    'Los demás clanes de la tribu de Manasés también recibieron sus territorios: Abiezer, Jélec, Asriel, Siquén, Héfer y Semidá. Éstos eran descendientes de Manasés hijo de José.',
    'Sucedió que Zelofejad hijo de Héfer, nieto de Galaad y bisnieto de Manasés, sólo tuvo hijas, cuyos nombres eran Majlá, Noa, Joglá, Milca y Tirsá.',
    ...
    'El territorio de Manasés abarcaba desde Aser hasta Micmetat, ubicada al este de Siquén. De allí la frontera seguía hacia el sur, hasta las tierras pertenecientes a Yasub En Tapúaj.',
    'A Manasés le pertenecían también las tierras de Tapúaj, pero la ciudad de Tapúaj, ubicada en los límites de Manasés, era de los descendientes de Efraín.',
    ...
    'Entonces Josué les respondió: Ya que son tan numerosos y encuentran que la región montañosa de Efraín es demasiado pequeña para ustedes, vayan a la zona de los bosques que están en territorio ferezeo y refaíta, y desmonten tierra para que habiten allá.',
    ...
    'Pero Josué animó a las tribus de Efraín y Manasés, descendientes de José: Ustedes son numerosos y tienen mucho poder. No se quedarán con un solo territorio',
  ...
  [
    ...
    'Cuando los hombres estaban listos para salir a hacer el reconocimiento del país, Josué les ordenó: »Exploren todo el país y tráiganme una descripción escrita de todos sus territorios. Cuando regresen aquí a Siló, yo haré el sorteo de tierras en presencia del Señor.»',
    ...
    'Descendía a las laderas del monte ubicado frente al valle de Ben Hinón, al norte del valle de Refayin. Seguía en descenso por el valle de Hinón, bordeando la cuesta de la ciudad de Jebús, hasta llegar a Enroguel.',
    ...
    'Avín, Pará, Ofra,',
    'Quefar Amoní, Ofni y Gueba, es decir, doce ciudades con sus poblaciones',
    'y Gabaón, Ramá, Berot,',
    'Mizpa, Cafira, Mozá,',
    'Requen, Irpel, Taralá,',
  ...
  [
    ...
    'Bet Lebaot y Sarujén, es decir, trece ciudades con sus poblaciones',
    'y Ayin, Rimón, Éter y Asán, es decir, cuatro ciudades con sus poblaciones.',
    'A estas ciudades se agregaban los pueblos que se contaban hasta los bordes de Balatber, ciudad de Ramat ubicada en el Néguev. Éstos fueron los territorios asignados a los clanes de la tribu de Simeón.',
    'Como la tribu de Judá tenía más territorio de lo que sus clanes necesitaban, la tribu de Simeón recibió su porción del territorio asignado a Judá. El territorio de Zabulón',
    ...
    'Éste es el territorio asignado como herencia a los clanes de la tribu de Zabulón, incluyendo sus ciudades y pueblos.',
    'Isacar fue la cuarta tribu que recibió su territorio, según sus clanes.',
    'Las ciudades que se encontraban dentro de ese territorio eran: Jezrel, Quesulot, Sunén,',
    ...
    'componían la herencia de los clanes de la tribu de Isacar.',
    'Aser fue la quinta tribu que recibió su territorio, según sus clanes.',
    'En él se incluían las ciudades de Jelcat, Jalí, Betén, Acsaf,',
    ...
    'Las ciudades sumaban veintidós, entre ellas Majaleb, Aczib, Uma, Afec y Rejob.',
    'Éste es el territorio asignado como herencia a los clanes de la tribu de Aser, incluyendo sus ciudades y pueblos.',
    'Neftalí fue la sexta tribu que recibió su territorio, según sus clanes.',
    ...
    'Adamá, Ramá, Jazor,',
    'Cedes, Edrey, Enjazor,',
    'Irón, Migdal El, Jorén, Bet Anat y Bet Semes. En total sumaban diecinueve ciudades con sus poblaciones.',
    'Éste es el territorio asignado como herencia a los clanes de la tribu de Neftalí, incluyendo sus ciudades y pueblos.',
    'Dan fue la séptima tribu que recibió territorio, según sus clanes.',
    'Se incluían en el territorio Zora, Estaol, Ir Semes,',
    'Sagalbín, Ayalón, Jetlá,',
    'Elón, Timnat, Ecrón,',
    'Eltequé, Guibetón, Balat,',
    'Jehúd, Bené Berac, Gat Rimón,',
    'Mejarcón y Racón, con la región que estaba frente a Jope.',
    'Como a los danitas no les alcanzó el territorio que se les asignó, fueron a conquistar la ciudad de Lesén. Después de que la tomaron, pasaron a filo de espada a todos sus habitantes. Luego los danitas la habitaron y le dieron por nombre Dan, en honor de su antepasado.',
    ...
    'De este modo terminaron de dividir los territorios el sacerdote Eleazar, Josué y los jefes de las tribus de Israel. El sorteo lo realizaron en Siló, en presencia del Señor, a la entrada de la Tienda de reunión.',
  ],
  // Capítulo 20
  [
    'El Señor le dijo a Josué: ',' »Pídeles a los israelitas que designen algunas ciudades de refugio, tal como te lo ordené por medio de Moisés.',
    ...
    'El acusado permanecerá en aquella ciudad hasta haber comparecido ante la asamblea del pueblo y hasta que el sumo sacerdote en funciones haya fallecido. Sólo después de esto el acusado podrá regresar a su hogar y al pueblo del cual huyó tiempo atrás.»',
    ...
    'Al este del río Jordán, escogieron las tres ciudades siguientes: Béser, en el desierto que está en la meseta perteneciente al territorio de la tribu de Rubén; Ramot de Galaad, en el territorio de la tribu de Gad, y Golán de Basán, en el territorio de la tribu de Manasés.',
    'Todo israelita o inmigrante que hubiera matado accidentalmente a alguien podría huir hacia una de esas ciudades para no morir por mano del vengador del delito de sangre, antes de ser juzgado por la asamblea.',
  ],
  // Capítulo 21
  [
    ...
    'A ellos se les asignó Quiriat Arbá, es decir, Hebrón, junto con sus campos de pastoreo, en la región montañosa de Judá (Arbá fue un ancestro de los anaquitas).',
    ...
    'Al resto de los levitas descendientes de Coat se les asignaron poblaciones en el territorio de la tribu de Efraín.',
    'En la región montañosa de Efraín se les asignó la ciudad de Siquén, que fue una de las ciudades de refugio para los acusados de homicidio. También se les asignaron Guézer,',
    ...
    'De la tribu de Isacar se les asignaron Cisón, Daberat,',
    'Jarmut y Enganín, es decir, cuatro poblaciones con sus campos de pastoreo.',
    'De la tribu de Aser se les asignaron Miseal, Abdón,',
    'Jelcat y Rejob, es decir, cuatro poblaciones con sus campos de pastoreo.',
    ...
    'Dimná y Nalal.',
    'De la tribu de Rubén se les asignaron cuatro poblaciones con sus campos de pastoreo: Béser, Yahaza,',
    'Cademot y Mefat.',
    'De la tribu de Gad se les asignaron cuatro poblaciones con sus campos de pastoreo: Ramot de Galaad (ciudad de refugio), Majanayin,',
    'Hesbón y Jazer.',
    ...
    'Los levitas recibieron en total cuarenta y ocho poblaciones con sus respectivos campos de pastoreo en territorio israelita.',
    ...
    'Y ni una sola de las buenas promesas del Señor a favor de Israel dejó de cumplirse, sino que cada una se cumplió al pie de la letra. Josué',
  ],
  // Capítulo 22
  [
    'Luego Josué convocó a las tribus de Rubén y Gad, y a la media tribu de Manasés',
    'y les dijo: »Ustedes han cumplido todas las órdenes que les dio Moisés, siervo del Señor. Además, ustedes me han obedecido en cada mandato que les he dado.',
    ...
    'Y ahora que el Señor su Dios ha cumplido lo que prometió y les ha dado descanso a sus hermanos, regresen ustedes a sus hogares y a sus tierras que Moisés, siervo del Señor, les entregó al lado oriental del río Jordán.',
    ...
    'así: »Regresen a sus hogares repletos de bienes: oro, plata, bronce, hierro, gran cantidad de ropa y mucho ganado. Compartan con sus hermanos lo que le han arrebatado al enemigo.»',
    ...
    'Cuando llegaron a Guelilot, a orillas del río Jordán, todavía en territorio cananeo, las dos tribus y media construyeron un enorme altar.',
    'Los demás israelitas se enteraron de que los rubenitas, los gaditas y la media tribu de Manasés habían construido aquel altar a orillas del Jordán, en pleno territorio israelita.',
    ...
    '¿Acaso no hemos aprendido ninguna lección del pecado de Peor, del cual todavía no nos hemos purificado? ¿Nada nos ha enseñado la muerte de tantos miembros de nuestro pueblo?',
    ...
    'sino como testimonio entre ustedes y nosotros y entre las generaciones futuras, de que también nosotros podemos servir al Señor y ofrecerle los distintos sacrificios en su santuario. Así, en el futuro, los descendientes de ustedes nunca podrán decirles a los nuestros: Üstedes no tienen nada que ver con el Señor.',
    ...
    'Entonces Finés hijo de Eleazar les dijo a los de esas tribus: Ahora estamos seguros de que el Señor está en medio de nosotros, pues ustedes no pretendían serle infieles al Señor; así que nos han salvado del castigo divino.',
    ...
    'Y los rubenitas y los gaditas le dieron al altar el nombre de »Testimonio», porque dijeron: »Entre nosotros servirá de testimonio de que el Señor es Dios.» Josué',
  ],
  // Capítulo 23
  [
    ...
    'tengan por cierto que el Señor su Dios no expulsará de entre ustedes a esas naciones. Por el contrario, ellas serán como red y trampa contra ustedes, como látigos en sus espaldas y espinas en sus ojos, hasta que ustedes desaparezcan de esta buena tierra que el Señor su Dios les ha entregado.',
    ...
    'Si no cumplen con el pacto que el Señor su Dios les ha ordenado, sino que siguen a otros dioses, adorándolos e inclinándose ante ellos, tengan por seguro que la ira del Señor se descargará sobre ustedes y que serán borrados de la buena tierra que el Señor les ha entregado.» Josué',
  ],
  // Capítulo 24
  [
    ...
    'A ustedes los traje a la tierra de los amorreos, los que vivían al este del río Jordán. Cuando ellos les hicieron la guerra, yo los entregué en sus manos; ustedes fueron testigos de cómo los destruí para que ustedes poseyeran su tierra.',
    ...
    'Pero el pueblo insistió: ¡Eso no pasará jamás! Nosotros sólo serviremos al Señor.',
    ...
    'El pueblo respondió: Sólo al Señor nuestro Dios serviremos, y sólo a él obedeceremos.',
    ...
    'Entonces le dijo a todo el pueblo: Esta piedra servirá de testigo contra ustedes. Ella ha escuchado todas las palabras que el Señor nos ha dicho hoy. Testificará contra ustedes en caso de que ustedes digan falsedades contra su Dios.',
    ...
    'Durante toda la vida de Josué, el pueblo de Israel había servido al Señor. Así sucedió también durante el tiempo en que estuvieron al frente de Israel los jefes que habían compartido el liderazgo con Josué y que sabían todo lo que el Señor había hecho a favor de su pueblo.',
    ...
    'Finalmente, Eleazar hijo de Aarón murió y fue sepultado en Guibeá, propiedad de su hijo Finés, en la región montañosa de Efraín. Jueces',
  ],
];