export default [
  ...
  [
    ...
    'Y fue Otoniel hijo de Quenaz, hermano menor de Caleb, quien la conquistó; así que Caleb le dio por esposa a su hija Acsa.',
    ...
    'Tampoco los de la tribu de Neftalí pudieron expulsar a los habitantes de Bet Semes y Bet Anat, sino que vivieron entre los cananeos que habitaban en aquella región. Sin embargo, sometieron a trabajos forzados a los que vivían en Bet Semes y Bet Anat.',
  ...
  [
    ...
    'El pueblo sirvió al Señor mientras vivieron Josué y los ancianos que le sobrevivieron, los cuales habían visto todas las grandes obras que el Señor había hecho por Israel.',
  ...
  [
    ...
    'Los israelitas volvieron a clamar al Señor, y el Señor les levantó un libertador, Aod hijo de Guerá, de la tribu de Benjamín, quien era zurdo. Por medio de él los israelitas enviaron tributo a Eglón, rey de Moab.',
  ...
  [
    ...
    'Sísara convocó a sus novecientos carros de hierro, y a todos sus soldados, desde Jaroset Goyim hasta el arroyo Quisón.',
    ...
    'Pero Jael, esposa de Héber, tomó una estaca de la carpa y un martillo, y con todo sigilo se acercó a Sísara, quien agotado por el cansancio dormía profundamente. Entonces ella le clavó la estaca en la sien y se la atravesó, hasta clavarla en la tierra. Así murió Sísara.',
    ...
    'Y el poder de los israelitas contra Jabín se consolidaba cada vez más, hasta que lo destruyeron. Jueces',
  ],
  ...
  [
    ...
    '»¡Así perezcan todos tus enemigos, oh Señor! Pero los que te aman sean como el sol cuando sale en todo su esplendor.» Entonces el país tuvo paz durante cuarenta años. Jueces',
  ],
  ...
  [
    ...
    'Les dije: Yo soy el Señor su Dios; no adoren a los dioses de los amorreos, en cuya tierra viven. Pero ustedes no me obedecieron.»',
    ...
    'Entonces, con la punta del bastón que llevaba en la mano, el ángel del Señor tocó la carne y el pan sin levadura, ¡y de la roca salió fuego, que consumió la carne y el pan! Luego el ángel del Señor desapareció de su vista.',
    ...
    'Aquella misma noche el Señor le dijo: »Toma un toro del rebaño de tu padre; el segundo, el que tiene siete años. Derriba el altar que tu padre ha dedicado a Baal, y el poste con la imagen de la diosa Aserá que está junto a él.',
    ...
    'Gedeón le dijo a Dios: »Si has de salvar a Israel por mi conducto, como has prometido,',' mira, tenderé un vellón de lana en la era, sobre el suelo. Si el rocío cae sólo sobre el vellón y todo el suelo alrededor queda seco, entonces sabré que salvarás a Israel por mi conducto, como prometiste.»',
  ...
  [
    ...
    'El Señor le dijo a Gedeón: »Con los trescientos hombres que lamieron el agua, yo los salvaré; y entregaré a los madianitas en tus manos. El resto, que se vaya a su casa.»',
    'Entonces Gedeón mandó a los demás israelitas a sus carpas, pero retuvo a los trescientos, los cuales se hicieron cargo de las provisiones y de las trompetas de los otros. El campamento de Madián estaba situado en el valle, más abajo del de Gedeón.',
    ...
    'Si temes atacar, baja primero al campamento, con tu criado Furá,',' y escucha lo que digan. Después de eso cobrarás valor para atacar el campamento.» Así que él y Furá, su criado, bajaron hasta los puestos de los centinelas, en las afueras del campamento.',
    ...
    'Cuando Gedeón oyó el relato del sueño y su interpretación, se inclinó y adoró. Luego volvió al campamento de Israel y ordenó: »¡Levántense! El Señor ha entregado en manos de ustedes el campamento madianita.»',
    ...
    'Entonces se convocó a los israelitas de Neftalí y Aser, y a toda la tribu de Manasés, y éstos persiguieron a los madianitas.',
    ...
    'También capturaron a Oreb y Zeb, los dos jefes madianitas. A Oreb lo mataron en la roca de Oreb, y a Zeb en el lagar de Zeb. Luego de perseguir a los madianitas, llevaron la cabeza de Oreb y de Zeb a Gedeón, que estaba al otro lado del Jordán. Jueces',
  ],
  ...
  [
    ...
    'Zeba y Zalmuna dijeron: Vamos, mátanos tú mismo. ¡Al hombre se le conoce por su valentía! Gedeón se levantó y mató a Zeba y Zalmuna, y les quitó a sus camellos los adornos que llevaban en el cuello. El efod de Gedeón',
    ...
    'Pero Gedeón les dijo: Yo no los gobernaré, ni tampoco mi hijo. Sólo el Señor los gobernará.',
    ...
    'El peso de los anillos de oro que él les pidió llegó a diecinueve kilos, sin contar los adornos, los aros y los vestidos de púrpura que usaban los reyes madianitas, ni los collares que llevaban sus camellos.',
  ...
  [
    ...
    'Pero la higuera les respondió: ¿He de renunciar a mi fruto, tan bueno y dulce, para ir a mecerme sobre los árboles?',
    ...
    'Pero el espino respondió a los árboles: Si de veras quieren ungirme como su rey, vengan y refúgiense bajo mi sombra; pero si no, ¡que salga fuego del espino, y que consuma los cedros del Líbano!',
    '»Ahora bien, ¿han actuado ustedes con honradez y buena fe al coronar rey a Abimélec? ¿Han sido justos con Yerubaal y su familia, y lo han tratado como se merecía?',
    'Mi padre luchó por ustedes, y arriesgando su vida los libró del poder de los madianitas.',
    'Pero hoy ustedes se han rebelado contra la familia de mi padre; han matado a sus setenta hijos sobre una misma piedra, y han hecho de Abimélec, hijo de su esclava, el rey de los señores de Siquén sólo porque él es pariente de ustedes.',
    ...
    'Abimélec había ya gobernado a Israel tres años',' cuando Dios interpuso un espíritu maligno entre Abimélec y los señores de Siquén, quienes lo traicionaron.',
    ...
    'Gaal hijo de Ébed dijo: »¿Quién se cree Abimélec, y qué es Siquén, para que tengamos que estar sometidos a él? ¿No es acaso el hijo de Yerubaal, y no es Zebul su delegado? ¡Que sirvan a los hombres de Jamor, el padre de Siquén! ¿Por qué habremos de servir a Abimélec?',
    ...
    'Gaal hijo de Ébed había salido, y estaba de pie a la entrada de la puerta de la ciudad, precisamente cuando Abimélec y sus soldados salían de donde estaban al acecho.',
    ...
    'Gaal salió al frente de los señores de Siquén y peleó contra Abimélec;',' pero éste los persiguió y, en la huida, muchos cayeron muertos por todo el camino, hasta la entrada de la puerta.',
    ...
    'Cuando Abimélec se enteró de que ellos se habían reunido allí,',
  ...
  [
    ...
    'También los amonitas cruzaron el Jordán para luchar contra las tribus de Judá, Benjamín y Efraín, por lo que Israel se encontró en una situación de extrema angustia.',
    ...
    'Cuando los amonitas fueron convocados y acamparon en Galaad, los israelitas se reunieron y acamparon en Mizpa.',
    'Los jefes y el pueblo de Galaad se dijeron el uno al otro: »El que inicie el ataque contra los amonitas será el caudillo de todos los que viven en Galaad.»',
  ],
  ...
  [
    ...
    'Entonces Jefté huyó de sus hermanos y se fue a vivir en la región de Tob, donde se le juntaron unos hombres sin escrúpulos, que salían con él a cometer fechorías.',
    ...
    'Los ancianos de Galaad le dijeron: Por eso ahora venimos a verte. Ven con nosotros a luchar contra los amonitas, y serás el caudillo de todos los que vivimos en Galaad.',
    ...
    'Entonces enviaron mensajeros al rey de Edom, diciéndole: \'Danos permiso para pasar por tu país. Pero el rey de Edom no les hizo caso. Le enviaron el mismo mensaje al rey de Moab, pero él tampoco aceptó. Así que Israel se quedó a vivir en Cades.',
    ...
    '» El Señor, Dios de Israel, les quitó esta tierra a los amorreos para dársela a su pueblo Israel, ¿y tú nos la vas a quitar?','¿Acaso no consideras tuyo lo que tu dios Quemós te da? Pues también nosotros consideramos nuestro lo que el Señor nuestro Dios nos ha dado.',
    ...
    'Hace ya trescientos años que Israel ocupó a Hesbón y Aroer, con sus poblados y todas las ciudades en la ribera del Arnón. ¿Por qué no las recuperaron durante ese tiempo?',
    ...
    'Derrotó veinte ciudades, desde Aroer hasta las inmediaciones de Minit, y hasta Abel Queramín. La derrota fue muy grande; así los amonitas quedaron sometidos a los israelitas.',
    ...
    'Cumplidos los dos meses volvió a su padre, y él hizo con ella conforme a su juramento. Ella era virgen. De allí se originó la costumbre israelita','de que todos los años, durante cuatro días, las muchachas de Israel fueran a conmemorar la muerte de la hija de Jefté de Galaad.',
  ],
  ...
  [
    ...
    'Entonces Jefté reunió a todos los hombres de Galaad y lucharon contra los de la tribu de Efraín. Los de Galaad derrotaron a los de Efraín porque éstos les habían dicho: Üstedes los galaaditas son renegados de Efraín y Manasés.»',
    ...
    'Tuvo treinta hijos y treinta hijas. A sus hijas las dio en matrimonio a gente que no pertenecía a su clan, y para sus hijos trajo como esposas a treinta muchachas que no eran de su tribu. Ibsán gobernó a Israel por siete años.',
    ...
    'Cuando murió Abdón hijo de Hilel, fue sepultado en Piratón, que está en , en la región montañosa de los amalecitas.',
  ],
  ...
  [
    ...
    'Pero sus padres le dijeron: ¿Acaso no hay ninguna mujer aceptable entre tus parientes, o en todo nuestro pueblo, que tienes que ir a buscar una esposa entre esos filisteos incircuncisos? Sansón le respondió a su padre: ¡Pídeme a ésa, que es la que a mí me gusta!',
    ...
    'Pasado algún tiempo, cuando regresó para casarse con ella, se apartó del camino para mirar el león muerto, y vio que había en su cadáver un enjambre de abejas y un panal de miel.',
    ...
    'Permítanme proponerles una adivinanza les dijo Sansón. Si me dan la solución dentro de los siete días que dura el banquete, yo les daré treinta vestidos de lino y treinta mudas de ropa de fiesta.',
    ...
    'Al cuarto día le dijeron a la esposa de Sansón: »Seduce a tu esposo para que nos revele la adivinanza; de lo contrario, te quemaremos a ti y a la familia de tu padre. ¿Acaso nos invitaron aquí para robarnos?»',
    ...
    'Entonces el Espíritu del Señor vino sobre Sansón con poder, y éste descendió a Ascalón y derrotó a treinta de sus hombres, les quitó sus pertenencias y les dio sus ropas a los que habían resuelto la adivinanza. Luego, enfurecido, regresó a la casa de su padre.',
  ...
  [
    ...
    'sino que le dijo: Yo estaba tan seguro de que la odiabas, que se la di a tu amigo. ¿Pero acaso no es más atractiva su hermana menor? Tómala para ti, en lugar de la mayor.',
    ...
    'Entonces dijo Sansón: »Con la quijada de un asno los he amontonado. Con una quijada de asno he matado a mil hombres.»',
    ...
    'Entonces Dios abrió la hondonada que hay en Lehí, y de allí brotó agua. Cuando Sansón la bebió, recobró sus fuerzas y se reanimó. Por eso al manantial que todavía hoy está en Lehí se le llamó Enacoré.',
  ...
  [
    ...
    'Estando unos hombres al acecho en el cuarto, ella le gritó: ¡Sansón, los filisteos se lanzan sobre ti! Pero él rompió las cuerdas como quien rompe un pedazo de cuerda chamuscada. De modo que no se descubrió el secreto de su fuerza.',
    ...
    'Pero en cuanto le cortaron el cabello, le comenzó a crecer de nuevo.',
    ...
    'Entonces Sansón oró al Señor: »Oh soberano Señor, acuérdate de mí. Oh Dios, te ruego que me fortalezcas sólo una vez más, y déjame de una vez por todas vengarme de los filisteos por haberme sacado los ojos.»',
  ...
  [
    ...
    'Desde Zora y Estaol los danitas enviaron a cinco de sus hombres más valientes, para que espiaran la tierra y la exploraran. Les dijeron: »Vayan, exploren la tierra.» Los hombres entraron en la región montañosa de Efraín y llegaron hasta la casa de Micaías, donde pasaron la noche.',
    ...
    'Ellos respondieron: ¡Subamos, ataquémoslos! Hemos visto que la tierra es excelente. ¿Qué pasa? ¿Se van a quedar ahí, sin hacer nada? No duden un solo instante en marchar allí y apoderarse de ella.',
    'Cuando lleguen allí, encontrarán a un pueblo confiado y una tierra espaciosa que Dios ha entregado en manos de ustedes. Sí, es una tierra donde no hace falta absolutamente nada.',
    ...
    'Cuando aquellos hombres entraron en la casa de Micaías y tomaron la imagen tallada, el efod, los dioses domésticos y el ídolo de fundición, el sacerdote les preguntó: ¿Qué están haciendo?',
    ...
    'Así fue como los danitas se adueñaron de lo que había hecho Micaías, y también de su sacerdote, y marcharon contra Lais, un pueblo tranquilo y confiado; mataron a sus habitantes a filo de espada, y quemaron la ciudad.',
    'No hubo nadie que los librara, porque vivían lejos de Sidón y no se relacionaban con nadie más. La ciudad estaba situada en un valle cercano a Bet Rejob. Después los mismos danitas reconstruyeron la ciudad y se establecieron allí.',
    'La llamaron Dan en honor a su antepasado del mismo nombre, que fue hijo de Israel, aunque antes la ciudad se llamaba Lais.',
    'Allí erigieron para sí la imagen tallada, y Jonatán, hijo de Guersón y nieto de Moisés, y sus hijos fueron sacerdotes de la tribu de Dan hasta el tiempo del exilio.',
  ...
  [
    ...
    'Cuando llegó a su casa, tomó un cuchillo y descuartizó a su concubina en doce pedazos, después de lo cual distribuyó los pedazos por todas las regiones de Israel.',
    'Todo el que veía esto decía: »Nunca se ha visto, ni se ha hecho semejante cosa, desde el día que los israelitas salieron de la tierra de Egipto. ¡Piensen en esto! ¡Considérenlo y dígannos qué hacer!» Jueces',
  ],
  ...
  [
    ...
    'Israel tendió una emboscada alrededor de Guibeá.',
    'Al tercer día subieron contra los de Benjamín y se pusieron en orden de batalla contra Guibeá, como lo habían hecho antes.',
    'Los de Benjamín salieron a su encuentro, y se vieron obligados a alejarse de la ciudad. Comenzaron a causar bajas entre los israelitas, como en las ocasiones anteriores, y alcanzaron a matar a unos treinta hombres en el campo abierto y por el camino que lleva a Betel, y también por el que lleva a Guibeá.',
    ...
    'De pronto, los israelitas cambiaron de táctica y presentaron batalla en Baal Tamar, y los israelitas que estaban emboscados salieron a atacar al oeste de Guibeá.',
    'Diez mil de los mejores guerreros de Israel lanzaron un ataque frontal contra Guibeá, y fue tan intenso el combate que los benjaminitas no se dieron cuenta de que la calamidad se les venía encima.',
    'El Señor derrotó a Benjamín delante de Israel, y aquel día los israelitas mataron a veinticinco mil cien hombres de la tribu de Benjamín, todos ellos armados con espadas.',
    ...
    'Pero cuando la columna de humo comenzó a levantarse de la ciudad, los de Benjamín se dieron vuelta y vieron que el fuego de la ciudad entera subía al cielo.',
    ...
    'Rodearon a los de Benjamín; los persiguieron y los aplastaron con facilidad en las inmediaciones de Guibeá, hacia el lado oriental.',
    'Cayeron dieciocho mil de la tribu de Benjamín, todos ellos guerreros valientes.',
    'Cuando se volvieron y huyeron hacia el desierto, a la peña de Rimón, los israelitas abatieron a cinco mil hombres junto a los caminos. Continuaron persiguiéndolos hasta Guidón, y mataron a dos mil más.',
    'Aquel día cayeron en combate veinticinco mil soldados benjaminitas armados con espada, todos ellos guerreros valientes.',
    'Pero seiscientos hombres se volvieron y huyeron por el desierto hasta la peña de Rimón, donde permanecieron cuatro meses.',
  ...
  [
    ...
    'Pero miren, se acerca la fiesta del Señor que todos los años se celebra en Siló, al norte de Betel, y al este del camino que va de Betel a Siquén, y al sur de Leboná.»',
