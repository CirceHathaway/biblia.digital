export default [
  ...
  [
    ...
    'Le ordenó que les dijera a los israelitas: «Cuando alguno de ustedes traiga una ofrenda al Señor, deberá presentar un animal de ganado vacuno u ovino.',
    ...
    'Después degollará el novillo ante el Señor, y los hijos de Aarón, los sacerdotes, tomarán la sangre y la derramarán alrededor del altar que está a la entrada de la Tienda de reunión.',
    ...
    'El sacerdote llevará el ave al altar y le arrancará la cabeza, y luego la quemará en el altar. Después exprimirá la sangre en un costado del altar,',
  ...
  [
    ...
    '»Si le presentas al Señor una ofrenda de las primicias de tus cereales, ésta será de trigo nuevo, molido y tostado al fuego. Es la ofrenda de cereal de tus primicias.',
    'Le pondrás aceite e incienso; es una ofrenda de cereal.',
  ...
  [
    ...
    'El oferente le presentará al Señor, como ofrenda por fuego, las siguientes partes del sacrificio de comunión: la grasa que recubre los intestinos y la que se adhiere a éstos,',
    ...
    'Entonces los hijos de Aarón quemarán todo esto en el altar, encima del holocausto que está sobre la leña encendida. Es una ofrenda presentada por fuego de aroma grato al Señor.',
    ...
    'El oferente le presentará al Señor, como ofrenda por fuego, las siguientes partes del animal: la grasa que recubre los intestinos y la que se adhiere a éstos,',
    'los dos riñones y la grasa que los recubre, la grasa que recubre los lomos, y también el lóbulo del hígado, el cual se extraerá junto con los riñones.',
  ...
  [
    ...
    'Llevará el novillo ante el Señor, a la entrada de la Tienda de reunión, e impondrá la mano sobre la cabeza del novillo, al que degollará en presencia del Señor.',
    ...
    'Luego, al novillo del sacrificio expiatorio le sacará toda la grasa que recubre los intestinos, y la que se adhiere a éstos,',
    'los dos riñones y la grasa que los recubre, la grasa que recubre los lomos, y también el lóbulo del hígado, el cual se extraerá junto con los riñones.',
    ...
    'Todo esto, es decir, el resto del novillo, lo sacará del campamento y lo llevará a un lugar ritualmente puro, al vertedero de la ceniza, y dejará que se consuma sobre la leña encendida. Sobre el vertedero de la ceniza se consumirá. El sacrificio expiatorio por el pecado de la comunidad',
    ...
    'Cuando la asamblea se dé cuenta del pecado que ha cometido, deberá ofrecer un novillo como sacrificio expiatorio. Lo llevarán a la Tienda de reunión,',
    ...
    'Luego el sacerdote ungido tomará un poco de la sangre del novillo y la llevará a la Tienda de reunión.',
    ...
    'Luego sacará del campamento el resto del novillo y dejará que se consuma en el fuego, como el otro. Éste es el sacrificio expiatorio por la asamblea. El sacrificio expiatorio por el pecado de un gobernante',
    ...
    'pondrá la mano sobre la cabeza del macho cabrío, y lo degollará en presencia del Señor, en el mismo lugar donde se degüellan los animales para el holocausto. Es un sacrificio expiatorio.',
    ...
    'Toda la grasa del animal la quemará en el altar, tal como se hace con el sacrificio de comunión. Así el sacerdote hará expiación por el pecado del gobernante, y su pecado le será perdonado. El sacrificio expiatorio por el pecado de un miembro del pueblo',
    ...
    'Pondrá la mano sobre la cabeza del animal, y lo degollará en el lugar donde se degüellan los animales para el holocausto.',
    ...
    'Luego le sacará al animal toda la grasa, tal y como se le saca la grasa al cordero del sacrificio de comunión, y el sacerdote la quemará en el altar sobre la ofrenda presentada por fuego al Señor. Así el sacerdote hará expiación por esa persona, y el pecado que haya cometido le será perdonado.',
  ],
  // Capítulo 5
  [
    ...
    'y llevarle al Señor en sacrificio expiatorio por la culpa del pecado cometido, una hembra del rebaño, que podrá ser una oveja o una cabra. Así el sacerdote hará expiación por ese pecado. El caso del pobre',
    ...
    'Se las llevará al sacerdote, quien primero ofrecerá el ave para el sacrificio expiatorio. Para esto, le retorcerá el cuello, pero sin desprenderle del todo la cabeza.',
    ...
    'Con la segunda ave hará un holocausto, como ya ha sido prescrito. Así el sacerdote hará expiación por el pecado cometido, y ese pecado le será perdonado.',
    '»Si a esa persona tampoco le alcanza para comprar dos tórtolas o dos pichones, presentará entonces en sacrificio expiatorio, como ofrenda por el pecado cometido, dos litros',
    'de flor de harina. Como se trata de un sacrificio expiatorio, no se le pondrá aceite ni incienso.',
    'Llevará este sacrificio al sacerdote, quien tomará un puñado de la ofrenda memorial y lo quemará en el altar junto con los sacrificios presentados por fuego al Señor. Es un sacrificio expiatorio.',
    ...
    'Le llevará al sacerdote un carnero sin defecto, cuyo precio será fijado como sacrificio por la culpa. Así el sacerdote hará expiación por el pecado que esa persona cometió inadvertidamente, y ese pecado le será perdonado.',
  ...
  [
    ...
    'Le llevará al Señor un carnero sin defecto, cuyo precio será fijado como sacrificio por la culpa. Lo presentará al sacerdote,',
    'quien hará expiación ante el Señor por esa persona, y cualquier cosa por la que se haya hecho culpable le será perdonada.» El holocausto',
    'El Señor le dijo a Moisés',
    ...
    'El sacerdote, vestido con su túnica de lino y su ropa interior de lino, removerá las cenizas del holocausto consumido por el fuego sobre el altar, y las echará a un lado del altar.',
    ...
    'Todos los hijos varones de Aarón podrán comer de ella. Es un estatuto',
    'perpetuo para los descendientes de ustedes, respecto a los sacrificios presentados por fuego al Señor. Cualquier cosa que toque los sacrificios quedará consagrada.» La ofrenda de los sacerdotes',
    'El Señor le dijo a Moisés:',
    '»Ésta es la ofrenda que Aarón y sus hijos deben presentar al Señor el día en que sean ungidos: dos kilos',
    'de flor de harina, como ofrenda regular de cereal. Una mitad de la ofrenda se presentará por la mañana, y la otra mitad por la tarde.',
    ...
    'La preparará el hijo de Aarón que lo suceda como sacerdote ungido. Éste es el estatuto perpetuo del Señor: La ofrenda se quemará completamente.',
    'No se comerá ninguna de las ofrendas que presenten los sacerdotes; todas deberán quemarse por completo.» El sacrificio expiatorio',
    'El Señor le ordenó a Moisés',
  ...
  [
    ...
    '»Si alguien toca cualquier clase de impureza humana, o de animal o de algo detestable, y luego come la carne ofrecida al Señor en el sacrificio de comunión, será eliminado de su pueblo.» Prohibiciones acerca de la grasa y de la sangre',
    'El Señor le ordenó a Moisés',
    ...
    'Todo el que coma cualquier clase de sangre, será eliminado de su pueblo.» La porción de los sacerdotes',
    'El Señor le ordenó a Moisés',
    ...
    'El muslo derecho será la porción del sacerdote',
    'a quien le toque ofrecer la sangre y la grasa del sacrificio.',
    'Porque de los sacrificios de comunión que ofrecen los israelitas, yo he tomado el pecho mecido y el muslo para dárselos, como contribución, al sacerdote Aarón y a sus hijos. Éste será un estatuto',
    'perpetuo entre los israelitas.»',
    'De las ofrendas presentadas por fuego al Señor, ésa es la porción consagrada para Aarón y sus hijos desde el día en que Moisés se los presentó al Señor como sacerdotes.',
    ...
    'Ésta es la ley respecto a los holocaustos, las ofrendas de cereales, los sacrificios expiatorios, los sacrificios por la culpa, los sacrificios de ordenación y los sacrificios de comunión.',
  ...
  [
    ...
    'En seguida, le colocó el pectoral, y sobre éste puso el urim y el tumim.',
    ...
    'Después Moisés lo degolló, y tomando un poco de sangre con el dedo, la untó en los cuernos alrededor del altar para purificarlo. El resto de la sangre la derramó al pie del altar, y así lo consagró e hizo propiciación por él.',
    ...
    'Moisés lo degolló, y derramó la sangre alrededor del altar.',
    'Cortó luego el carnero en trozos, y quemó la cabeza, los trozos y el sebo.',
    'Lavó con agua los intestinos y las patas, y luego quemó todo el carnero en el altar como holocausto de aroma grato, como ofrenda presentada por fuego al Señor, tal como el Señor se lo había mandado.',
    ...
    'Moisés lo degolló, y tomando un poco de la sangre, se la untó a Aarón en el lóbulo de la oreja derecha, en el pulgar de la mano derecha y en el dedo gordo del pie derecho.',
    'Además, hizo que los hijos de Aarón se acercaran, y les untó sangre en el lóbulo de la oreja derecha, en el pulgar de la mano derecha y en el dedo gordo del pie derecho. Luego derramó la sangre alrededor del altar.',
    ...
    'y tomando del canastillo que estaba colocado ante el Señor un pan sin levadura, una oblea y una torta de pan amasada con aceite, lo puso todo sobre la grasa y el muslo derecho.',
  ...
  [
    ...
    'Diles después a los israelitas: Traigan un macho cabrío para el sacrificio expiatorio, y un becerro y un cordero para el holocausto, ambos de un año y sin defecto.',
    ...
    'Sus hijos le llevaron la sangre, y él mojó el dedo en la sangre y la untó en los cuernos del altar, derramando luego la sangre al pie del altar.',
  ...
  [
    ...
    'pero ustedes no vayan a salir de la Tienda de reunión, no sea que mueran, porque el aceite de la unción del Señor está sobre ustedes.» Y ellos hicieron lo que Moisés les dijo. Ley sobre el culto y el licor',
    ...
    'y puedan también enseñar a los israelitas todos los estatutos que el Señor les ha dado a conocer por medio de Moisés.» La porción de los sacerdotes',
    ...
    'Cómanla en un lugar santo, porque así se me ha mandado. Es un estatuto',
    'para ti y para tus hijos con respecto a la ofrenda presentada por fuego al Señor.',
    ...
    'Tanto el muslo como el pecho serán presentados junto con la ofrenda de la grasa, para ofrecérselos al Señor como ofrenda mecida. Será un estatuto perpetuo para ti y para tus hijos, tal como lo ha mandado el Señor.» Un caso especial',
    ...
    'Entonces Aarón le respondió a Moisés: Hoy mis hijos ofrecieron ante el Señor su sacrificio expiatorio y su holocausto, ¡y es cuando tenía que sucederme semejante desgracia! Si hoy hubiera yo comido del sacrificio expiatorio, ¿le habría parecido correcto al Señor?',
  ...
  [
    ...
    'pero no tiene la pezuña partida; este animal será impuro para ustedes.',
    ...
    'Pero a los demás insectos alados que caminan en cuatro patas ustedes los considerarán animales inmundos. Leyes sobre la impureza por tocar un animal impuro',
    ...
    '»De los animales de cuatro patas, tendrán por impuro a todo el que se apoya sobre sus plantas. Cualquiera que toque su cadáver quedará impuro hasta el anochecer,',
    ...
    'Éstos son los animales que ustedes considerarán impuros entre los que se arrastran. Todo el que toque el cadáver de esos animales quedará impuro hasta el anochecer. Otras leyes sobre el contacto con animales impuros',
    ...
    'Quien coma carne de ese cadáver se lavará la ropa y quedará impuro hasta el anochecer. Quien lo recoja se lavará la ropa y quedará impuro hasta el anochecer. Resumen sobre los reptiles y la santidad',
    ...
    'Yo soy el Señor, que los sacó de la tierra de Egipto, para ser su Dios. Sean, pues, santos, porque yo soy santo. Conclusión',
    '»Ésta es la ley acerca de los animales y de las aves, y de todo ser que se mueve dentro de las aguas o que se arrastra por el suelo,',
  ...
  [
    ...
    '»Una vez cumplido su período de purificación, sea que haya tenido un niño o una niña, tomará un cordero de un año como holocausto, y un pichón de paloma o una tórtola como sacrificio expiatorio, y los llevará al sacerdote, a la entrada de la Tienda de reunión,',
  ...
  [
    ...
    '»Cuando a una persona le salga en la piel alguna inflamación, erupción o mancha blancuzca que pueda convertirse en infección,',
    'se le llevará al sacerdote Aarón, o a alguno de sus descendientes los sacerdotes.',
    ...
    '»Si la mancha blancuzca no se ve más hundida que la piel, ni el vello se le ha puesto blanco, el sacerdote aislará a la persona enferma durante siete días, y al séptimo día la examinará de nuevo. Si juzga que la infección no ha seguido extendiéndose sobre la piel, aislará a esa persona otros siete días.',
    ...
    'El sacerdote la examinará, y si la erupción se ha extendido sobre la piel, declarará impura a esa persona, pues se trata de una enfermedad infecciosa. Leyes sobre enfermedades infecciosas',
    '»Cuando una persona tenga una infección en la piel, deberá ser llevada ante el sacerdote,',
    ...
    'entonces el sacerdote la examinará. Si ve que la infección le cubre todo el cuerpo, la declarará pura. Esa persona es pura porque todo el cuerpo se le ha puesto blanco.',
    'Pero será impura en el momento en que le aparezca una llaga ulcerosa.',
    ...
    'para que lo examine. Si la inflamación se ve más hundida que la piel y el vello se le ha puesto blanco, el sacerdote lo declarará impuro. Se trata de una enfermedad infecciosa que ha brotado en el sitio donde estaba el absceso.',
    ...
    'Si el absceso no se desarrolla ni la mancha blanca se extiende sino que ha cicatrizado, declarará puro al enfermo. Leyes sobre las quemaduras',
    '»Si alguien se quema, y sobre la quemadura le aparece una mancha blancuzca o rojiza,',
    'el sacerdote deberá examinarla. Si el vello de la mancha se le ha puesto blanco, y la mancha misma se ve más hundida que la piel, se trata de una enfermedad infecciosa que brotó en el sitio de la quemadura. El sacerdote declarará impuro al enfermo, pues se trata de una infección.',
    '»Si al examinar la quemadura encuentra el sacerdote que el vello no se ha puesto blanco ni la mancha se ve más hundida que la piel, sino que ha disminuido, entonces aislará al enfermo durante siete días.',
    ...
    'En cambio, si la mancha blancuzca no ha seguido extendiéndose sobre la piel, se trata sólo de la inflamación de la quemadura. Entonces el sacerdote lo declarará puro, ya que se trata sólo de una quemadura cicatrizada. Leyes sobre enfermedades del cuero cabelludo y de la barba',
    ...
    'Pero si al examinar la llaga tiñosa el sacerdote ve que no está más hundida que la piel ni tiene pelo negro, aislará al enfermo de tiña durante siete días.',
    ...
    'En cambio, si considera que la tiña no se ha desarrollado y nota que le ha crecido pelo negro, entonces el enfermo ha sanado. Es puro, y así deberá declararlo el sacerdote. Afecciones cutáneas benignas',
    '»Si a un hombre o a una mujer les salen manchas blancuzcas en la piel,',
    'el sacerdote deberá examinarlas. Si las manchas resultan ser blancuzcas, se trata sólo de una erupción cutánea, de modo que la persona es pura. Leyes sobre la calvicie',
    ...
    'se trata entonces de una persona infectada e impura. El sacerdote la declarará impura por esa llaga en la cabeza. Ley sobre las infecciones',
    '»La persona que contraiga una infección se vestirá de harapos y no se peinará; con el rostro semicubierto irá gritando: ¡Impuro! ¡Impuro!,',
    ...
    'y su color sea verdusco o rojizo, se trata de una infección de moho, y deberá mostrársele al sacerdote, quien examinará la mancha y aislará durante siete días el objeto infectado.',
    'Al séptimo día el sacerdote examinará la mancha. Si ésta se ha extendido en la ropa o en la urdimbre, o en la trama, o en el cuero o en cualquier artículo de piel, se trata de un moho corrosivo. Tal objeto es impuro.',
    ...
    'Ésta es la ley respecto al moho que infecta la ropa, la lana, el lino, la urdimbre, la trama o cualquier artículo de piel, para poder declararlos puros o impuros.',
  ],
  // Capítulo 14
  [
    'El Señor le dijo a Moisés:',
    '»Ésta es la ley que se aplicará para declarar pura a una persona infectada. Será presentada ante el sacerdote,',
    ...
    '»Al octavo día, el que se purifica deberá traer dos corderos sin defecto y una cordera de un año, también sin defecto; como ofrenda de cereal traerá seis kilos',
    'de flor de harina amasada con aceite, junto con un tercio de litro',
    'de aceite.',
    ...
    'A continuación, el sacerdote ofrecerá el sacrificio expiatorio, haciendo propiciación por el que se purifica de su impureza. Hecho esto, degollará la víctima del holocausto,',
    'y la ofrecerá en el altar junto con la ofrenda de cereal. Así hará propiciación por él, y lo declarará puro.',
    '»Si el que se purifica es pobre y no tiene para comprar lo requerido, tomará como sacrificio por la culpa un solo cordero, el cual será mecido para hacer propiciación por él. También llevará como ofrenda de cereal dos kilos',
    'de flor de harina amasada con aceite, y un cuarto de litro de aceite,',
    ...
    'Después degollará al cordero del sacrificio por la culpa, tomará un poco de sangre y la untará en el lóbulo de la oreja derecha, en el pulgar de la mano derecha y en el dedo gordo del pie derecho del que se purifica.',
    ...
    'uno como sacrificio expiatorio y otro como holocausto, junto con la ofrenda de cereal. Así hará el sacerdote propiciación ante el Señor en favor del que se purifica.»',
    ...
    'También mandará raspar todo el interior de la casa, y el material raspado lo arrojará fuera de la ciudad, en un lugar impuro.',
    'Después se repondrán las antiguas piedras con otras nuevas, y se resanará la casa con estuco nuevo.',
    '»Si después de haber quitado las piedras infectadas y de haber raspado y resanado la casa, vuelve a aparecer el moho y se extiende por toda ella,',
    ...
    'y deberán demolerla y arrojar, en un lugar impuro fuera de la ciudad, las piedras, el maderamen y el estuco.',
    ...
    '»Ésta es la ley respecto a cualquier tipo de infección cutánea o de tiña, o de moho, ya sea en la ropa o en una casa,',
    'o de inflamación, o erupción o mancha blancuzca',
  ...
  [
    ...
    '»Todo el que toque algún objeto que haya estado debajo del afectado por el flujo quedará impuro hasta el anochecer; el que transporte dicho objeto deberá lavarse la ropa y bañarse, y quedará impuro hasta el anochecer.',
    ...
    '»Cuando un hombre y una mujer tengan relaciones sexuales con eyaculación, ambos deberán bañarse, y quedarán impuros hasta el anochecer. Impurezas sexuales en la mujer',
  ...
  [
    ...
    'Después tomará un poco de la sangre del novillo y la rociará con su dedo al costado oriental del propiciatorio; la rociará delante del propiciatorio siete veces.',
    '»Luego degollará el macho cabrío del sacrificio expiatorio en favor del pueblo. Llevará su sangre detrás de la cortina, y hará con esa sangre lo mismo que hizo con la del novillo: la rociará sobre y delante del propiciatorio.',
    'Así hará propiciación por el santuario para purificarlo de las impurezas y transgresiones de los israelitas, cualesquiera que hayan sido sus pecados. Hará lo mismo por la Tienda de reunión, que está entre ellos en medio de sus impurezas.',
    'Nadie deberá estar en la Tienda de reunión desde el momento en que Aarón entre para hacer propiciación en el santuario hasta que salga, es decir, mientras esté haciendo propiciación por sí mismo, por su familia y por toda la asamblea de Israel.',
    '»Aarón saldrá luego para hacer propiciación por el altar que está delante del Señor. Tomará sangre del novillo y del macho cabrío, y la untará sobre cada uno de los cuernos del altar,',
    ...
    '»El novillo del sacrificio expiatorio y el macho cabrío del sacrificio expiatorio, cuya sangre se llevó para hacer propiciación por el santuario, se sacarán del campamento, y la piel, la carne y el excremento se quemarán.',
    'El que les prenda fuego deberá lavarse la ropa y bañarse. Sólo después de hacer esto podrá volver al campamento.',
    '»Éste será para ustedes un estatuto perpetuo, tanto para el nativo como para el extranjero: El día diez del mes séptimo ayunarán y no realizarán ningún tipo de trabajo.',
    ...
    '»La propiciación la realizará el sacerdote que haya sido ungido y ordenado como sucesor de su padre. Se pondrá las vestiduras sagradas de lino,',
  ...
  [
    ...
    'Y nunca más volverán a ofrecer ningún sacrificio a sus ídolos que tienen forma de machos cabríos,',
    'con los que se han prostituido. Éste es un estatuto perpetuo para ellos y para sus descendientes.',
    ...
    '»Todo nativo o extranjero que coma la carne de un animal que las fieras hayan matado o despedazado, deberá lavarse la ropa y bañarse con agua, y quedará impuro hasta el anochecer; después de eso quedará puro.',
  ...
  [
    ...
    'Observen mis estatutos y mis preceptos, pues todo el que los practique vivirá por ellos. Yo soy el Señor. Relaciones no permitidas',
  ...
  [
    ...
    'Cualquiera que lo coma sufrirá las consecuencias de su pecado por profanar lo que ha sido consagrado al Señor. Tal persona será eliminada de su pueblo. Relaciones sociales',
    ...
    '»No seas vengativo con tu prójimo, ni le guardes rencor. Ama a tu prójimo como a ti mismo.',
    'Yo soy el Señor. Otras exigencias de la santidad',
    ...
    '»Si un hombre se acuesta con una esclava prometida a otro en matrimonio, pero que aún no ha sido rescatada ni declarada libre, a los dos se les impondrá el castigo debido,',
    'pero no se les condenará a muerte porque ella aún no ha sido declarada libre.',
    ...
    '»No degraden a su hija haciendo de ella una prostituta, para que tampoco se prostituya la tierra ni se llene de perversidad. Otros deberes',
    ...
    'Al contrario, trátenlo como si fuera uno de ustedes. Ámenlo como a ustedes mismos, porque también ustedes fueron extranjeros en Egipto. Yo soy el Señor y Dios de Israel.',
    '»No cometan injusticias falseando las medidas de longitud, de peso y de capacidad.',
    'Usen balanzas, pesas y medidas',
    'justas. Yo soy el Señor su Dios, que los saqué de Egipto.',
    '»Obedezcan todos mis estatutos. Pongan por obra todos mis preceptos. Yo soy el Señor».',
  ],
  // Capítulo 20
  [
    'El Señor le ordenó a Moisés',
    'que les dijera a los israelitas: »Todo israelita o extranjero residente en Israel que entregue a uno de sus hijos para quemarlo como sacrificio a Moloc, será condenado a muerte. Los miembros de la comunidad lo matarán a pedradas.',
    ...
    '»Si alguien se acuesta con su tía, deshonra a su tío, y los dos sufrirán las consecuencias de su pecado: morirán sin tener descendencia.',
  ...
  [
    ...
    'Considéralo santo, porque él ofrece el pan de tu Dios. Santo será para ti, porque santo soy yo, el Señor, que los santifico a ustedes.',
    ...
    '»Aquel que sea elegido sumo sacerdote entre sus hermanos, y sobre cuya cabeza se haya derramado el aceite de la unción, y a quien se le haya conferido autoridad',
    'para llevar las vestiduras sacerdotales, no deberá andar despeinado ni rasgarse las vestiduras.',
  ...
  [
    'El Señor le ordenó a Moisés',
    'que les dijera a Aarón y a sus hijos: »Traten con mucho respeto las ofrendas sagradas que me consagran los israelitas, para no profanar mi santo nombre. Yo soy el Señor.»',
    'También le ordenó decirles: »Si alguno de los descendientes de Aarón está ritualmente impuro y se acerca a las ofrendas que los israelitas consagran al Señor, será eliminado de mi presencia. Yo soy el Señor.',
    '»Si un descendiente de Aarón padece de alguna enfermedad infecciosa en la piel,',
    'o de derrame seminal, deberá abstenerse de comer de las ofrendas sagradas, hasta que se purifique. Cualquiera que toque un objeto contaminado por el contacto con un cadáver, o que tenga derrame de semen, o que toque algún animal u hombre impuros, cualquiera que sea la impureza,',
    ...
    '»Si inadvertidamente alguien come de una ofrenda sagrada, deberá restituir la ofrenda al sacerdote y añadirle una quinta parte de su valor.',
    '»No deberán los sacerdotes profanar las ofrendas sagradas que los israelitas presentan al Señor,',
    'porque al permitir que las coman harán recaer sobre sí mismos un pecado que requiere un sacrificio por la culpa. Yo soy el Señor, que los santifico.» Sacrificios inaceptables',
    'El Señor le ordenó a Moisés',
    ...
    '»Si alguien, para cumplir un voto especial o como ofrenda voluntaria, le presenta al Señor ganado vacuno u ovino como sacrificio de comunión, para que el animal le sea aceptado no deberá tener ningún defecto.',
    'No deberán presentarle al Señor, como ofrenda por fuego, animales ciegos, cojos, mutilados, llagados, sarnosos ni tiñosos. No ofrecerán en el altar ningún animal así.',
    'Podrán presentar como ofrenda voluntaria una res o una oveja deforme o enana, pero tal ofrenda no será aceptada en cumplimiento de un voto.',
    ...
    'No recibirán de manos de un extranjero animales así, para ofrecerlos como alimento del Dios de ustedes. No se les aceptarán porque son deformes y tienen defectos.»',
    'El Señor le dijo a Moisés:',
  ...
  [
    'El Señor le ordenó a Moisés',
    'que les dijera a los israelitas: »Éstas son las fiestas que yo he establecido, y a las que ustedes han de convocar como fiestas solemnes en mi honor. Yo, el Señor, las establecí. Celebración del sábado',
    '»Trabajarán ustedes durante seis días, pero el séptimo día es de reposo, es un día de fiesta solemne en mi honor, en el que no harán ningún trabajo. Dondequiera que ustedes vivan, será sábado consagrado al Señor. Fiesta de la Pascua',
    '»Éstas son las fiestas que el Señor ha establecido, las fiestas solemnes en su honor que ustedes deberán convocar en las fechas señaladas para ellas:',
    ...
    'El Señor le ordenó a Moisés',
    'que les dijera a los israelitas: »Cuando ustedes hayan entrado en la tierra que les voy a dar, y sieguen la mies, deberán llevar al sacerdote una gavilla de las primeras espigas que cosechen.',
    ...
    'También presentarán cuatro kilos',
    'de harina fina mezclada con aceite, como ofrenda de cereal, ofrenda por fuego, de aroma grato al Señor, y un litro',
    'de vino como ofrenda de libación.',
    'No comerán pan, ni grano tostado o nuevo, hasta el día en que traigan esta ofrenda a su Dios. Éste será un estatuto perpetuo para todos tus descendientes, dondequiera que habiten. Fiesta de las Semanas',
    ...
    'Junto con el pan deberán presentar siete corderos de un año, sin defecto, un novillo y dos carneros. Serán, junto con sus ofrendas de cereal y sus ofrendas de libación, un holocausto al Señor, una ofrenda presentada por fuego, de aroma grato al Señor.',
    'Luego sacrificarán un macho cabrío como ofrenda por el pecado, y dos corderos de un año como sacrificio de comunión.',
    ...
    '»Cuando llegue el tiempo de la cosecha, no sieguen hasta el último rincón del campo ni recojan todas las espigas que queden de la mies. Déjenlas para los pobres y los extranjeros. Yo soy el Señor su Dios.» Fiesta de las Trompetas',
    'El Señor le ordenó a Moisés',
    ...
    'Será para ustedes un sábado de solemne reposo, y deberán observar el ayuno. Este sábado lo observarán desde la tarde del día nueve del mes hasta la tarde siguiente.» Fiesta de las Enramadas',
    'El Señor le ordenó a Moisés',
    ...
    '»Éstas son las fiestas que el Señor ha establecido, y a las que ustedes habrán de convocar como fiestas solemnes en su honor, para presentarle ofrendas por fuego, holocaustos, ofrendas de cereal, y sacrificios y ofrendas de libación, tal como está prescrito para cada día.',
    'Todas estas fiestas son adicionales a los sábados del Señor y a los tributos y ofrendas votivas o voluntarias que ustedes le presenten.',
    '»A partir del día quince del mes séptimo, luego de que hayan recogido los frutos de la tierra, celebrarán durante siete días la fiesta del Señor. El primer día y el octavo serán de descanso especial.',
    ...
    'Cada año, durante siete días, celebrarán esta fiesta en honor al Señor. La celebrarán en el mes séptimo. Éste será un estatuto perpetuo para las generaciones venideras.',
  ...
  [
    ...
    'Aarón preparará las lámparas en la Tienda de reunión, fuera de la cortina del pacto, para que ardan delante del Señor toda la noche. Éste será un estatuto perpetuo para las generaciones venideras.',
    ...
    '»Toma flor de harina y hornea doce tortas de pan. Cada torta debe pesar cuatro kilos.',
    ...
    'El pan les pertenece a Aarón y a sus hijos, quienes lo comerán en un lugar santo. Es una parte sumamente sagrada de las ofrendas que se presentan por fuego al Señor. Es un estatuto perpetuo.» Lapidación de un blasfemo',
    ...
    'Además, todo el que pronuncie el nombre del Señor al maldecir a su prójimo será condenado a muerte. Toda la asamblea lo apedreará. Sea extranjero o nativo, si pronuncia el nombre del Señor al maldecir a su prójimo, será condenado a muerte. La ley del talión',
    ...
    'Moisés les comunicó todo esto a los israelitas, y ellos sacaron al blasfemo fuera del campamento, y allí lo apedrearon. Los israelitas procedieron tal como el Señor se lo ordenó a Moisés.',
  ],
  // Capítulo 25
  [
    'En el monte Sinaí el Señor le ordenó a Moisés',
    'que les dijera a los israelitas: »Cuando ustedes hayan entrado en la tierra que les voy a dar, la tierra misma deberá observar un año de reposo',
    'en honor al Señor.',
    'Durante seis años sembrarás tus campos, podarás tus viñas y cosecharás sus productos;',
    'pero llegado el séptimo año la tierra gozará de un año de reposo en honor al Señor. No sembrarás tus campos ni podarás tus viñas; no segarás lo que haya brotado por sí mismo ni vendimiarás las uvas de tus viñas no cultivadas. La tierra gozará de un año completo de reposo.',
    ...
    'También podrán alimentarse tu ganado y los animales que haya en el país. Todo lo que la tierra produzca ese año será sólo para el consumo diario. El año del jubileo',
    ...
    'Cuando ustedes siembren durante el octavo año, todavía estarán comiendo de la cosecha anterior, y continuarán comiendo de ella hasta la cosecha del año siguiente. Leyes sobre el rescate de propiedades',
    ...
    'Pero si no consigue lo suficiente para rescatarla, la tierra quedará en posesión del comprador hasta el año del jubileo, cuando el que la vendió la recobrará, y ésta volverá a su heredad familiar.',
    ...
    'Si no rescata la casa antes de cumplirse el año, no se le devolverá en el jubileo sino que pasará a ser propiedad perpetua del comprador y de sus descendientes.',
    ...
    'Si alguno de los levitas hace valer su derecho, la casa que vendió en una de sus ciudades se le devolverá en el jubileo, porque las casas en las ciudades de los levitas son su heredad familiar entre los israelitas.',
  ...
  [
    ...
    'yo les enviaré lluvia a su tiempo, y la tierra y los árboles del campo darán sus frutos; la trilla durará hasta la vendimia, y la vendimia durará hasta la siembra. Comerán hasta saciarse y vivirán seguros en su tierra.',
    ...
    'Yo soy el Señor su Dios, que los saqué de Egipto para que dejaran de ser esclavos. Yo rompí las coyundas de su yugo y los hice caminar con la cabeza erguida. Maldiciones de la desobediencia',
    ...
    'Cuando yo destruya sus trigales, diez mujeres hornearán para ustedes pan en un solo horno. Y lo distribuirán racionado, de tal manera que comerán pero no se saciarán.',
    ...
    'Al abandonar ellos la tierra, ésta disfrutará de sus sábados mientras permanezca deshabitada. Pero tendrán que reconocer sus pecados, por cuanto rechazaron mis preceptos y aborrecieron mis estatutos.',
    ...
    'Éstos son los estatutos, preceptos y leyes que, por medio de Moisés, estableció el Señor en el monte Sinaí entre él y los israelitas.',
  ],
  // Capítulo 27
  [
    'El Señor le ordenó a Moisés',
    ...
    'se aplicará el siguiente cálculo: »Por los varones de veinte a sesenta años de edad se pagarán cincuenta monedas',
    'de plata, según la tasación oficial',
    'del santuario.',
    '»Por las mujeres se pagarán treinta monedas de plata.',
    '»Por los varones de cinco a veinte años de edad se pagarán veinte monedas, y diez monedas por las mujeres de la misma edad.',
    ...
    '»Si quien hace el voto es tan pobre que ni el precio estipulado puede pagar, se le hará comparecer ante el sacerdote, el cual fijará el valor a pagar, según los recursos de quien haga el voto.',
    '»Si lo que se presenta como ofrenda al Señor es un animal, éste quedará consagrado por haber sido ofrecido al Señor.',
    'No podrá cambiarse ni sustituirse un animal bueno por uno malo, ni un animal malo por uno bueno. Si se cambia un animal por otro, ambos quedarán consagrados.',
    '»Si lo que se presenta como ofrenda al Señor es un animal impuro, se llevará el animal ante el sacerdote,',
    'quien determinará el valor del animal. El cálculo aplicado por el sacerdote deberá aceptarse, cualquiera que éste sea.',
    ...
    '»Si alguno consagra al Señor parte del campo de su heredad familiar, su precio se determinará según la cantidad de semilla que se requiera para sembrarlo, a razón de cincuenta monedas de plata por cada doscientos veinte litros',
    'de semilla de cebada.',
    ...
    'El pastor no hará distinción entre animales buenos y malos, ni hará sustitución alguna. En caso de cambiar un animal por otro, los dos quedarán consagrados y no se les podrá rescatar.»',
    'Éstos son los mandamientos que el Señor le dio a Moisés para los israelitas, en el monte Sinaí.',
  ],
];