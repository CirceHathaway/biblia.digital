export default [
  ...
  [
    ...
    '¡Cómo quisiera que alguno de ustedes clausurara el templo, para que no encendieran en vano el fuego de mi altar! No estoy nada contento con ustedes dice el Señor Todopoderoso, y no voy a aceptar ni una sola ofrenda de sus manos.',
  ...
  [
    ...
    'Otra cosa que ustedes hacen es inundar de lágrimas el altar del Señor; lloran y se lamentan porque él ya no presta atención a sus ofrendas ni las acepta de sus manos con agrado.',
    'Y todavía preguntan por qué. Pues porque el Señor actúa como testigo entre ti y la esposa de tu juventud, a la que traicionaste aunque es tu compañera, la esposa de tu pacto.',
  ...
  [
    ...
    'Desde la época de sus antepasados se han apartado de mis preceptos y no los han guardado. Vuélvanse a mí, y yo me volveré a ustedes dice el Señor Todopoderoso. »Pero ustedes replican: ¿En qué sentido tenemos que volvernos?',
    ...
    '»Ustedes han dicho: Servir a Dios no vale la pena. ¿Qué ganamos con cumplir sus mandatos y vestirnos de luto delante del Señor Todopoderoso',
