export default [
  ...
  [
    ...
    'Salmón, padre de Roboam; Roboam, padre de Abías; Abías, padre de Asa;',
  ...
  [
    ...
    '"No den lo sagrado a los perros, no sea que se vuelvan contra ustedes y los despedacen; ni echen sus perlas a los cerdos, no sea que las pisoteen. Pidan, busquen, llamen',
  ...
  [
    ...
    'Éstos son los nombres de los doce apóstoles: primero Simón, llamado Pedro, y su hermano Andrés; Jacobo y su hermano Juan, hijos de Zebedeo;',
    ...
    'Cuando los persigan en una ciudad, huyan a otra. Les aseguro que no terminarán de recorrer las ciudades de Israel antes que venga el Hijo del hombre.',
    ...
    'Porque he venido a poner en conflicto ál hombre contra su padre, a la hija contra su madre, a la nuera contra su suegra;',
  ...
  [
    ...
    'Éste es de quien está escrito: "\'Mira, voy a enviar a mi mensajero delante de ti, el cual preparará tu camino.\'',
    ...
    'Y tú, Capernaúm, ¿acaso serás levantada hasta el cielo? No, sino que descenderás hasta el abismo. Si los milagros que se hicieron en ti se hubieran hecho en Sodoma, ésta habría permanecido hasta el día de hoy.',
  ...
  [
    ...
    'Luego llegaron los discípulos de Juan, recogieron el cuerpo y le dieron sepultura. Después fueron y avisaron a Jesús.',
  ...
  [
    ...
    'Pedro le dijo a Jesús: —Señor, ¡qué bien que estemos aquí! Si quieres, levantaré tres albergues: uno para ti, otro para Moisés y otro para Elías.',
  ...
  [
    ...
    '—¿Cuáles? —preguntó el hombre. Contestó Jesús: —\'No mates, no cometas adulterio, no robes, no des falso testimonio,',
  ...
  [
    ...
    '—Ciertamente beberán de mi copa —les dijo Jesús—, pero el sentarse a mi derecha o a mi izquierda no me corresponde concederlo. Eso ya está decidido por mi Padre.',
  ...
  [
    ...
    'Les dijo Jesús: —¿No han leído nunca en las Escrituras: "\'La piedra que desecharon los constructores ha llegado a ser piedra angular; esto lo ha hecho el Señor, y es maravilloso a nuestros ojos\'?',
  ...
  [
    ...
    'Dos mujeres estarán moliendo: una será llevada y la otra será dejado.',
  ...
  [
    ...
    '—Tú lo has dicho —respondió Jesús—. Pero yo les digo a todos: De ahora en adelante verán ustedes al Hijo del hombre sentado a la derecha del Todopoderoso, y bajando en las nubes del cielo.',
    ...
    'Luego salió a la puerta, donde otra criada lo vio y dijo a los que estaban allí: —Éste estaba con Jesús de Nazaret.',
  ...
  [
    ...
    'Luego trenzaron una corona de espinas y se la colocaron en la cabeza, y en la mano derecha le pusieron una caña. Arrodillándose delante él, se burlaban diciendo: —¡Salve, rey de los judíos!',
    ...
    'Encima de su cabeza pusieron por escrito la causa de su condena: "ÉSTE ES JES\'US, EL REY DE LOS JUDÍOS."',
    ...
    'Confía en Dios; pues que lo libre Dios ahora, si de veras lo quiere. ¿Acaso no dijo: \'Yo soy el Hijo de Dios\'?',
