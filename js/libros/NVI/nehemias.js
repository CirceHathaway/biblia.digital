// Nehemías (NVI) — generado automáticamente desde nehemias.txt
export default [
  [  // 1
    ...
    'pero si se vuelven a mí, y obedecen y ponen en práctica mis mandamientos, aunque hayan sido llevados al lugar más apartado del mundo los recogeré y los haré volver al lugar donde he decidido habitar.',
  ...
  [  // 2
    ...
    'y le respondí: ¡Qué viva Su Majestad para siempre! ¿Cómo no he de estar triste, si la ciudad donde están los sepulcros de mis padres se halla en ruinas, con sus puertas consumidas por el fuego?',
  ...
  [  // 3
    ...
    'La puerta de los Pescados la reconstruyeron los descendientes de Sená. Colocaron las vigas y pusieron la puerta en su lugar, con sus cerrojos y barras.',
    ...
    'El tramo contiguo lo reconstruyeron Melatías de Gabaón y Jadón de Meronot. A éstos se les unieron los de Gabaón y los de Mizpa, que estaban bajo el dominio del gobernador de la provincia al oeste del río Éufrates.',
    'Uziel hijo de Jaraías, que era uno de los plateros, reconstruyó el siguiente tramo de la muralla, y uno de los perfumistas, llamado Jananías, el siguiente. Entre los dos reconstruyeron la muralla de Jerusalén hasta la muralla Ancha.',
    'El siguiente tramo lo reconstruyó Refaías hijo de Jur, que era gobernador de una mitad del distrito de Jerusalén;',
    'el siguiente, Jedaías hijo de Jarumaf, cuya casa quedaba al frente, y el siguiente, Jatús hijo de Jasabnías.',
    'Malquías hijo de Jarín y Jasub hijo de Pajat Moab reconstruyeron el siguiente tramo de la muralla y la torre de los Hornos.',
    'Salún hijo de Halojés, que era gobernador de la otra mitad del distrito de Jerusalén, reconstruyó el siguiente tramo con la ayuda de sus hijas.',
    ...
    'El sector que sigue lo reconstruyeron los levitas y Rejún hijo de Baní. En el tramo siguiente Jasabías, gobernador de una mitad del distrito de Queilá, hizo las obras de reconstrucción por cuenta de su distrito,',
  ...
  [  // 4
    ...
    'Pero cuando Sambalat y Tobías, y los árabes, los amonitas y los asdodeos se enteraron de que avanzaba la reconstrucción de la muralla y de que ya estábamos cerrando las brechas, se enojaron muchísimo',
  ...
  [  // 5
    ...
    'y allí les recriminé: Hasta donde nos ha sido posible, hemos rescatado a nuestros hermanos judíos que fueron vendidos a los paganos. ¡Y ahora son ustedes quienes venden a sus hermanos, después de que nosotros los hemos rescatado! Todos se quedaron callados, pues no sabían qué responder.',
    'Yo añadí: Lo que están haciendo ustedes es incorrecto. ¿No deberían mostrar la debida reverencia a nuestro Dios y evitar así el reproche de los paganos, nuestros enemigos?',
    ...
    'Está bien respondieron ellos, haremos todo lo que nos has pedido. Se lo devolveremos todo, sin exigirles nada. Entonces llamé a los sacerdotes, y ante éstos les hice jurar que cumplirían su promesa.',
  ...
  [  // 6
    ...
    'que a la letra decía: «Corre el rumor entre la gente y Guesén lo asegura de que tú y los judíos están construyendo la muralla porque tienen planes de rebelarse. Según tal rumor, tú pretendes ser su rey,',
    ...
    'Fui entonces a la casa de Semaías, hijo de Delaías y nieto de Mehitabel, que se había encerrado en su casa. Él me dijo: «Reunámonos a puerta cerrada en la casa de Dios, en el interior del templo, porque vendrán a matarte. ¡Sí, esta noche te quitarán la vida!»',
  ...
  [  // 9
    ...
    'Luego los levitas Jesúa, Baní, Cadmiel, Sebanías, Buní, Serebías, Baní y Quenaní subieron a la plataforma y en alta voz invocaron al Señor su Dios.',
    ...
    'Les diste a conocer tu sábado santo, y por medio de tu servidor Moisés les entregaste tus mandamientos, estatutos y leyes.',
  ...
  [  // 10
    ...
    'Maazías, Bilgay y Semaías. Éstos eran los sacerdotes.',
    'Los levitas: Jesúa hijo de Azanías, Binuy, de los descendientes de Henadad, Cadmiel,',
    'y sus hermanos Sebanías, Hodías, Quelitá, Pelaías, Janán,',
    'Micaías, Rejob, Jasabías,',
    'Zacur, Serebías, Sebanías,',
    'Hodías, Baní y Beninu.',
    'Los jefes del pueblo: Parós, Pajat Moab, Elam, Zatú, Baní,',
    'Buní, Azgad, Bebay,',
    'Adonías, Bigvay, Adín,',
    'Ater, Ezequías, Azur,',
    'Hodías, Jasún, Bezay,',
    ...
    'Ahías, Janán, Anán,',
    'Maluc, Jarín y Baná.',
    'El resto del pueblo sacerdotes, levitas, porteros, cantores, servidores del templo, todos los que se habían separado de los pueblos de aquella tierra para cumplir con la ley de Dios, más sus mujeres, hijos e hijas, y todos los que tenían uso de razón',
    ...
    'Un sacerdote de la familia de Aarón acompañará a los levitas cuando éstos vayan a recolectar los diezmos. Los levitas, por su parte, depositarán el diezmo de los diezmos en la tesorería del templo de nuestro Dios.',
  ...
  [  // 11
    ...
    'Éstos son los jefes de la provincia que se establecieron en Jerusalén y en las otras poblaciones de Judá. Los israelitas, los sacerdotes, los levitas, los servidores del templo y los descendientes de los servidores de Salomón se establecieron, cada uno en su propia población y en su respectiva propiedad.',
    'Éstos fueron los judíos y benjaminitas que se establecieron en Jerusalén: De los descendientes de Judá: Ataías hijo de Uzías, hijo de Zacarías, hijo de Amarías, hijo de Sefatías, hijo de Malalel, de los descendientes de Fares;',
    ...
    'y sus hermanos Gabay y Salay. En total eran novecientos veintiocho.',
    ...
    'El jefe de los levitas que estaban en Jerusalén era Uzi hijo de Baní, hijo de Jasabías, hijo de Matanías, hijo de Micaías, uno de los descendientes de Asaf. Éstos tenían a su cargo el canto en el servicio del templo de Dios.',
    ...
    'Jesúa, Moladá, Bet Pelet,',
    'Jazar Súal, Berseba,',
    'Siclag, Mecona,',
    'Enrimón, Zora, Jarmut,',
    'Zanoa, Adulán, Laquis y Azeca, es decir, desde Berseba hasta el valle de Hinón.',
    'Los benjaminitas se establecieron en Gueba, Micmás, Aías, Betel y sus poblaciones,',
    'Anatot, Nob, Ananías,',
    'Jazor, Ramá, Guitayin,',
    'Jadid, Seboyín, Nebalat,',
  ...
  [  // 12
    ...
    'Salú, Amoc, Jilquías y Jedaías. Éstos eran los jefes de los sacerdotes y de sus parientes en los días de Jesúa.',
    'Los levitas eran Jesúa, Binuy, Cadmiel, Serebías, Judá y Matanías, quien dirigía las acciones de gracias junto con sus hermanos;',
    ...
    'Todos éstos vivieron en tiempos de Joaquim, hijo de Jesúa y nieto de Josadac, y en tiempos del gobernador Nehemías y del sacerdote y maestro Esdras.',
    ...
    'Luego hice que los jefes de Judá subieran a la muralla, y organicé dos grandes coros. Uno de ellos marchaba sobre la muralla hacia la derecha, rumbo a la puerta del Basurero,',
    'seguido de Osaías, la mitad de los jefes de Judá,',
    'Azarías, Esdras, Mesulán,',
    'Judá, Benjamín, Semaías y Jeremías.',
    'A éstos los acompañaban los siguientes sacerdotes, que llevaban trompetas: Zacarías hijo de Jonatán, hijo de Semaías, hijo de Matanías, hijo de Micaías, hijo de Zacur, hijo de Asaf,',
    'y sus parientes Semaías, Azarel, Milalay, Guilalay, May, Natanael, Judá y Jananí, que llevaban los instrumentos musicales de David, hombre de Dios. Al frente de ellos iba Esdras.',
    ...
    'El segundo coro marchaba en dirección opuesta, a lo largo de la torre de los Hornos hasta el muro Ancho. Yo iba detrás, sobre la muralla, junto con la otra mitad de la gente.',
    ...
    'y los sacerdotes Eliaquín, Maseías, Minjamín, Micaías, Elihoenay, Zacarías, Jananías,',
    'Maseías, Semaías, Eleazar, Uzi, Johanán, Malquías, Elam y Ezer. En seguida los cantores empezaron a cantar a toda voz, dirigidos por Izraías.',
    ...
    'En la época de Zorobabel y de Nehemías, todos los días los israelitas entregaban las porciones correspondientes a los cantores y a los porteros. Así mismo daban las ofrendas sagradas para los demás levitas, y los levitas a su vez les entregaban a los hijos de Aarón lo que a éstos les correspondía.',
  ],
  [  // 13
    ...
    'Para ese entonces yo no estaba en Jerusalén, porque en el año treinta y dos de Artajerjes, rey de Babilonia, había ido a ver al rey. Después de algún tiempo, con permiso del rey',
    ...
    'Durante aquellos días vi en Judá que en sábado algunos exprimían uvas y otros acarreaban, a lomo de mula, manojos de trigo, vino, uvas, higos y toda clase de cargas que llevaban a Jerusalén. Los reprendí entonces por vender sus víveres en ese día.',
    ...
    'Entonces ordené que cerraran las puertas de Jerusalén al caer la tarde, antes de que comenzara el sábado, y que no las abrieran hasta después de ese día. Así mismo, puse a algunos de mis servidores en las puertas para que no dejaran entrar ninguna carga en sábado.',
    ...
    '¿Acaso no fue ése el pecado de Salomón, rey de Israel? Entre todas las naciones no hubo un solo rey como él: Dios lo amó y lo hizo rey sobre todo Israel. Pero aun a él lo hicieron pecar las mujeres extranjeras.',
