export default [
  ...
  [
    ...
    'Su suegra le preguntó: ¿Dónde recogiste espigas hoy? ¿Dónde trabajaste? ¡Bendito sea el hombre que se fijó en ti! Entonces Rut le contó a su suegra acerca del hombre con quién había estado trabajando. Le dijo: El hombre con quien hoy trabajé se llama Booz.',
  ...
  [
    ...
    '¿Quién eres? le preguntó. Soy Rut, su sierva. Extienda sobre mí el borde de su manto, ya que usted es un pariente que me puede redimir.',
  ...
  [
    ...
    'Entonces Booz proclamó ante los ancianos y ante todo el pueblo: Hoy son ustedes testigos de que le he comprado a Noemí toda la propiedad de Elimélec, Quilión y Majlón,',
    'y de que he tomado como esposa a Rut la moabita, viuda de Majlón, a fin de preservar el nombre del difunto con su heredad, para que su nombre no desaparezca de entre su familia ni de los registros del pueblo. ¡Hoy son ustedes testigos!',
    ...
    'Jezrón, el padre de Ram; Ram, el padre de Aminadab;',
