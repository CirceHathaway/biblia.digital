export default [
  ...
  [
    ...
    '¿No se cumplieron en sus antepasados las palabras y los decretos que a mis siervos los profetas ordené comunicarles? » Entonces ellos se volvieron al Señor, y dijeron: ‘El Señor Todopoderoso nos ha tratado tal y como había resuelto hacerlo: conforme a lo que merecen nuestra conducta y nuestras acciones. »',
    ...
    'Una noche tuve una visión, en la que vi a un hombre montado en un caballo alazán. Ese hombre se detuvo entre los arrayanes que había en una hondonada. Detrás de él había jinetes en caballos alazanes, bayos y blancos.',
    ...
    'Luego el Señor me mostró cuatro herreros.',
  ...
  [
    ...
    '«Así dice el Señor Todopoderoso: »Si andas en mis caminos y me cumples como sacerdote, entonces gobernarás mi templo y te harás cargo de mis atrios. ¡Yo te concederé un lugar entre estos que están aquí!',
  ...
  [
    ...
    'Le pregunté entonces al ángel que hablaba conmigo: «¿Qué significan todo esto, mi señor?»',
    ...
    '¿Quién te crees tú, gigantesca montaña? ¡Ante Zorobabel sólo eres una llanura! Y él sacará la piedra principal entre gritos de alabanza a su belleza. »',
  ...
  [
    ...
    'Entonces el ángel me dijo: «Ésta es la maldición que caerá sobre todo el país. Según lo escrito en el rollo, alcanzará tanto al ladrón como al perjuro.',
  ...
  [
    ...
    '«Ve hoy mismo a la casa de Josías hijo de Sofonías, que es adonde han llegado de Babilonia los exiliados Jelday, Tobías y Jedaías. Recíbeles',
    ...
    'Si ustedes se esmeran en obedecer al Señor su Dios, los que están lejos vendrán para ayudar en la reconstrucción del templo del Señor. Así sabrán que el Señor Todopoderoso me ha enviado a ustedes.»'
  ],
  ...
  [
    ...
    '¿No son éstas las palabras que por medio de los antiguos profetas el Señor mismo proclamó cuando Jerusalén y las ciudades cercanas estaban habitadas y tenían paz, cuando el Néguev y las llanuras del oeste también estaban habitadas?',
    ...
    'Para no oír las instrucciones ni las palabras que por medio de los antiguos profetas el Señor Todopoderoso había enviado con su Espíritu, endurecieron su corazón como el diamante. Por lo tanto, el Señor Todopoderoso se llenó de ira.',
  ...
  [
    ...
    'Destruirá los carros de Efraín y los caballos de Jerusalén. Quebrará el arco de combate y proclamará paz a las naciones. Su dominio se extenderá de mar a mar, ¡desde el río Éufrates hasta los confines de la tierra!',
  ...
  [
    ...
    'Se enciende mi ira contra los pastores; castigaré a esos machos cabríos. Ciertamente el Señor Todopoderoso',
  ...
  [
    ...
    'y todas las demás familias y sus esposas.'
  ],
  ...
  [
    ...
    'Las dos terceras partes del país serán abatidas y perecerán; sólo una tercera parte quedará con vida afirma el Señor.',
  ...
  [
    ...
    'Será un día excepcional, que sólo el Señor conoce: no tendrá día ni noche, pues cuando llegue la noche, seguirá alumbrando la luz.',
    ...
    '»Ésta es la plaga con la que el Señor herirá a todos los pueblos que pelearon contra Jerusalén: Se les pudrirá la carne en vida, se les pudrirán los ojos en las cuencas, y se les pudrirá la lengua en la boca.',
