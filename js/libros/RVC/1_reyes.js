// Auto-generated from RVC.xml — 1 Reyes 1–22
export default [
  // Capítulo 1
  [
    ...
    'Entonces Natán habló con Betsabé, la madre de Salomón, y le dijo: «¿Ya te enteraste que Adonías, el hijo de Jaguit, se ha proclamado rey, a espaldas de nuestro señor David?',
    ...
    'Abisag se inclinó ante el rey, e hizo una reverencia. Y el rey le preguntó: «¿Te pasa algo?»',
  ...
  [
    ...
    'Salomón ocupó entonces el trono de David, su padre, y su reino se consolidó.',
  ...
  [
    ...
    'Cuando Salomón despertó de su sueño, fue a Jerusalén y se presentó delante del arca del pacto del Señor, y ofreció holocaustos y sacrificios de paz; y luego hizo un banquete para todos sus siervos.',
  ...
  // Capítulo 5
  [
    'Cuando el rey Jirán de Tiro supo que Salomón había sido consagrado como rey en lugar de su padre David, envió a sus embajadores a visitarlo, pues Jirán siempre había estimado a David.',
    ...
    'he decidido construir un templo para honrar el nombre del Señor mi Dios y para que se cumpla la promesa que el Señor le hizo a mi padre, cuando dijo: “Tu hijo, a quien yo pondré en el trono en lugar tuyo, será quien edifique el templo donde se honrará mi nombre.”',
    ...
    'Cuando Jirán oyó lo que Salomón había dicho, se llenó de alegría y dijo: «¡Bendito sea el Señor, que le dio a David un hijo tan sabio para gobernar a este gran pueblo!»',
    'Entonces le respondió a Salomón la siguiente respuesta: «He recibido tu mensaje, y en cuanto a la madera de cedro y de ciprés voy a hacer lo que me pides.',
    'Mis hombres llevarán la madera desde el Líbano hasta el mar, y allí la pondrán en balsas y te la llevarán hasta donde tú me digas; allí la desatarán para que tú la tomes. Mi pago será que me proveas de alimento para mi familia.»',
    'Fue así como Jirán proveyó a Salomón con toda la madera de cedro y de ciprés que quiso.',
    'A cambio de ella, cada año Salomón le enviaba a Jirán veinte mil coros de trigo y veinte coros de aceite puro para el sustento de su palacio.',
    'El Señor dotó a Salomón de mucha sabiduría, tal y como se lo había prometido, y los reinos de Jirán y de Salomón hicieron un pacto y hubo paz entre ellos.',
    'Después Salomón decretó leva en todo el pueblo de Israel y reunió a treinta mil hombres.',
  ...
  // Capítulo 8
  [
    'Salomón ordenó que los ancianos de Israel y todos los jefes de las tribus, más los jefes de las familias israelitas, se reunieran en Jerusalén para llevar el arca del pacto del Señor, de Sión a la ciudad de David.',
    ...
    'El rey Salomón y todos los israelitas se reunieron delante del arca y ofrecieron en sacrificio ovejas y bueyes. ¡Eran tantos los animales ofrecidos que no se podían contar!',
    ...
    'Sobre el lugar donde estaba el arca, los querubines tenían extendidas sus alas, con lo que cubrían el arca y sus travesaños.',
    'Éstos eran tan largos que sus extremos podían verse desde el lugar santo, que está frente al Lugar santísimo, aunque desde afuera no podían verse. Así se quedaron hasta el día de hoy.',
    ...
    'En el momento en que los sacerdotes salieron del santuario, la nube llenó el templo del Señor,',
    ...
    'Luego volvió el rostro hacia el pueblo de Israel, que permanecía de pie, y les dio la bendición.',
    'Y dijo: «Bendito sea el Señor, Dios de Israel, que le hizo una promesa a David, mi padre, y la ha cumplido. El Señor le dijo:',
    '“Desde el día en que saqué de Egipto a mi pueblo Israel, de ninguna de sus tribus escogí una ciudad para que se me construyera un templo donde se honrara mi nombre; pero elegí a David para que gobernara a mi pueblo Israel.”',
    'Y mi padre David se propuso de todo corazón edificar un templo donde se honrara el nombre del Señor y Dios de Israel.',
    'Pero el Señor le dijo: “Es muy bueno tu deseo sincero de construir un templo donde se honre mi nombre.',
    'Pero no serás tú quien lo construya, sino el hijo que vas a engrendrar. Será él quien edifique el templo donde se honrará mi nombre.”',
    ...
    'y allí he apartado un lugar para colocar el arca que guarda el pacto que el Señor hizo con nuestros antepasados cuando los sacó de la tierra de Egipto.»',
    ...
    'Lo que sigue, Señor y Dios de Israel, es que también cumplas la promesa que le hiciste a mi padre David, tu siervo, cuando le dijiste: “Nunca faltará delante de mí un descendiente tuyo que ocupe el trono de Israel, siempre y cuando vaya por mis sendas y me obedezca como lo has hecho tú.”',
    ...
    '¡Oye aquí las plegarias de tu pueblo Israel y de este siervo tuyo! ¡Que cuando vengan a este lugar tú, desde el cielo, donde habitas, escuches su clamor y los perdones!',
    '»Si alguno ofende a su prójimo y lo obligan a jurar ante tu altar en este templo,',
    'tú, que escuchas desde el cielo, haz justicia a tus siervos y condena al impío. Que sus malas acciones recaigan sobre él, mientras que al hombre justo lo tratas como corresponde a su justicia.',
    '»Cuando los israelitas sean derrotados por sus enemigos, por haber pecado contra ti, si se arrepienten de su pecado y reconocen la grandeza de tu nombre, y oran y claman aquí en tu templo,',
    ...
    'escúchalos desde los cielos, desde el lugar donde habitas, y trátalos según el motivo por el que te invocan, para que todos los pueblos de la tierra te conozcan y te honren, como lo hace tu pueblo Israel, y reconozcan que tú escuchas las oraciones que se hacen en este templo que construí para ti.',
    '»Si tu pueblo sale a pelear contra sus enemigos, y siguen el camino que tú les indiques, y te piden ayuda mirando hacia la ciudad que elegiste y en donde edifiqué el templo en tu honor,',
    'escucha desde el cielo su oración y súplica, y concédeles la victoria.',
    '»Si acaso pecan contra ti (pues no hay nadie que no peque), y tú te enojas y los pones en manos de sus enemigos, y éstos los llevan cautivos a países enemigos, cercanos o lejanos,',
    'si tu pueblo recapacita en el país de su cautiverio y se arrepiente y clama a ti, y confiesa haber hecho lo malo y haberte ofendido;',
    'si allá en la tierra de su cautiverio se vuelven a ti con todo su corazón y con toda su alma, y oran a ti con el rostro en dirección a la tierra que les diste a sus antepasados y a la ciudad que tú elegiste, mirando hacia el templo que edifiqué en tu honor,',
    ...
    'Señor y Dios, Tú los apartaste para que fueran tuyos; tú los elegiste de entre todos los pueblos de la tierra. Así se lo hiciste saber a Moisés, tu siervo, cuando liberaste de Egipto a nuestros antepasados.»',
    'Cuando Salomón terminó de orar y de suplicar al Señor, se levantó de delante del altar, pues había estaba arrodillado, y con los brazos extendidos al cielo',
    'se puso de pie y bendijo a todo el pueblo de Israel con estas palabras:',
    '«Bendito sea el Señor, que le ha dado paz a su pueblo Israel, conforme a su promesa, sin dejar de cumplir ninguna de las promesas que le hizo a Moisés.',
    'Que el Señor nuestro Dios esté con nosotros, como estuvo con nuestros primeros padres, y que no nos desampare ni nos abandone.',
    'Que nuestra voluntad se rinda ante él para que podamos andar por sus caminos y cumplamos sus mandamientos, estatutos y decretos, los cuales dio a nuestros primeros padres.',
    ...
    'Salomón ofreció al Señor, como sacrificios de reconciliación, veintidós mil bueyes y ciento veinte mil ovejas. Así fue como Salomón y los israelitas dedicaron el templo del Señor.',
    'Ese mismo día, Salomón consagró la parte central del atrio, frente al templo del Señor, porque allí ofreció los holocaustos, las ofrendas de cereales y la grasa de las ofrendas de reconciliación, pues en el altar de bronce que estaba delante del Señor no había espacio para los holocaustos ni para las ofrendas de cereales, ni para la grasa de los sacrificios de reconciliación.',
    'Ese día, y en presencia del Señor, Salomón y los israelitas hicieron fiesta, a la que asistió una multitud que venía desde la entrada de Jamat hasta el río de Egipto. Esa fiesta en honor al Señor se prolongó durante siete días más, y en total duró catorce días.',
    'Al octavo día, Salomón despidió al pueblo, y ellos bendijeron al rey; luego cada uno se fue a su ciudad, rebosando de gozo y alegría por todas las cosas buenas que el Señor había hecho a su siervo David y a su pueblo Israel.'
  ],
  // Capítulo 9
  [
    ...
    'Y se le responderá: “Es que abandonaron al Señor su Dios, que sacó de Egipto a sus antepasados, y ellos prefirieron adorar y servir a dioses ajenos. Por eso el Señor los ha castigado.”»',
  ...
  [
    ...
    'Cuando la reina de Sabá regresó a su país con todo su séquito, el rey Salomón le dio cuanto ella quiso y pidió, además de lo que ya le había dado.',
    ...
    'y cada año le llevaba valiosos presentes: alhajas de oro y de plata, vestiduras finas, armas, especias aromáticas, y caballos y mulos.',
  ...
  // Capítulo 11
  [
    'Pero el rey Salomón, además de amar a la hija del Faraón, se enamoró de muchas mujeres extranjeras; algunas eran de Moab, otras eran de Edom, de Sidón y de los hititas,',
    ...
    'Tuvo setecientas mujeres a las que hizo reinas, y trescientas concubinas, y todas ellas lo hicieron extraviarse.',
    ...
    'Se apartó del Señor y cometió muchas maldades porque, a diferencia de David, su padre, dejó de seguir fielmente al Señor.',
    'Hasta construyó en el monte que está frente a Jerusalén un altar a Quemos, el repugnante ídolo de Moab, y a Moloc, el ídolo repugnante de los amonitas.',
    'Esos altares los construyó para que sus mujeres pudieran quemar incienso y ofrecer sacrificios a sus dioses.',
    ...
    'Entonces el Señor le dijo a Salomón: «Como te has portado tan mal, y no has cumplido con tu pacto conmigo, ni has obedecido los estatutos que te di, voy a dividir tu reino, para entregárselo a uno de tus servidores.',
    'Pero, por amor a tu padre David, no lo haré mientras vivas. Esto lo haré cuando tu hijo llegue a ser rey.',
    ...
    'El Señor permitió que Hadad el edomita, que era hijo de reyes, se levantara en contra de Salomón.',
    'Cuando David estaba en Edom, Joab, general del ejército, llegó para enterrar a los israelitas caídos en combate, y mató a todos los hombres de Edom.',
    'Joab y todos los israelitas estuvieron seis meses en Edom, hasta que exterminaron a todos los edomitas.',
    'En aquel tiempo Hadad era un niño, pero logró huir hacia Egipto junto con algunos edomitas que servían a su padre.',
    'Salieron de Madián y llegaron a Parán, donde reunieron a más hombres; luego fueron a ver al faraón, rey de Egipto, y él les dio casa, alimentos y tierras.',
    'Hadad se ganó la buena voluntad del faraón, pues le dio por mujer a la hermana de su esposa, la reina Tapenés.',
    ...
    'Dios también permitió que Rezón hijo de Eliada se levantara contra Salomón. Rezón había huido de su amo, Hadad Ezer, que era rey de Soba.',
    'Logró reunir gente y formó una banda de bandoleros. Cuando David venció al ejército de Soba, Rezón se fue a vivir a Damasco, y allí lo coronaron rey.',
    ...
    'Otro que se rebeló contra Salomón fue Jeroboán hijo de Nabat, un efrateo de la ciudad de Seredá que estaba a su servicio. Su madre se llamaba Serúa y era viuda.',
    'La razón por la que Jeroboán se rebeló contra Salomón fue que, cuando éste estaba construyendo Milo, cerró la brecha de la Ciudad de David, su padre.',
    ...
    'Pero un día Jeroboán salió de Jerusalén y, en el camino, se encontró con el profeta Ajías de Siló, que llevaba un manto nuevo. Los dos estaban solos en el campo.',
    'Ajías tomó el manto y lo dividió en doce pedazos,',
    'y le dijo a Jeroboán: «Estos diez pedazos son para ti, porque así ha dicho el Señor, el Dios de Israel: “Voy a dividir el reino de Salomón, y a ti voy a darte diez tribus.',
    'A Salomón voy a dejarle una sola tribu, por causa de mi siervo David, su padre, y de Jerusalén, la ciudad que yo elegí de entre todas las tribus de Israel.',
    ...
    'Se lo quitaré a su hijo, y tú reinarás sobre diez tribus.',
    'Al hijo de Salomón le dejaré una tribu, para que mi siervo David tenga un descendiente en el trono de Jerusalén, la ciudad que yo escogí para poner en ella mi nombre.',
    'Yo te he elegido para que reines sobre Israel y hagas lo que te parezca bien.',
    'Si pones atención a todo lo que yo te ordene y no te desvías de mis caminos, y si haces lo recto delante de mis ojos y cumples mis estatutos y mandamientos, como lo hizo mi siervo David, yo te acompañaré siempre y estableceré tu dinastía, como lo hice con David, y te entregaré el pueblo de Israel.',
    'En cuanto a los descendientes de David, voy a hacerlos sufrir por esto, pero no será para siempre.”»',
    'Entonces Salomón procuró matar a Jeroboán, pero éste huyó a Egipto, donde Sisac era rey, y allí se quedó hasta la muerte de Salomón.',
    'Los otros hechos de Salomón, y todo lo que hizo y toda su sabiduría están escritos en el libro de los hechos de Salomón.',
    'Fueron cuarenta años los que reinó en Jerusalén y en todo el pueblo de Israel.',
    'Y cuando Salomón durmió el sueño de la muerte, como sus antepasados, fue sepultado en la ciudad de su padre David. En su lugar reinó Roboán, su hijo.'
  ],
  // Capítulo 12
  [
    ...
    '“Así ha dicho el Señor: No vayan a pelear contra sus hermanos israelitas. Regresen a sus casas, porque esto lo he provocado yo.”» Y los dos bandos hicieron caso de las palabras del Señor, y en conformidad con ellas regresaron a sus casas.',
  ...
  [
    ...
    'y también Abías entró en guerra contra Jeroboán. Todo los hechos de Abías se hallan registrados en el libro de las crónicas de los reyes de Judá.',
    ...
    'Nadab murió a manos de Basá, y éste reinó en su lugar. Para entonces, Asa llevaba tres años de reinar sobre Judá.',
    ...
    'Basá hijo de Ajías reinó sobre todo Israel en Tirsa durante veinticuatro años. Para entonces, Asa tenía tres años como rey de Judá.',
  ...
  [
    ...
    '«Yo te levanté del suelo y te puse como jefe de Israel, mi pueblo, pero tú has ido tras los malos pasos de Jeroboán; has hecho pecar a mi pueblo, y con tus pecados has provocado mi enojo.',
    'Por eso, voy a acabar con tu descendencia y con toda tu familia. Voy a acabar con tu dinastía, como acabé con la de Jeroboán hijo de Nabat.',
    ...
    'Todos los hechos de Basá, y su gran poder, se hallan registrados en el libro de las crónicas de los reyes de Israel.',
    ...
    'Cuando Asa tenía veintiséis años de reinar sobre Judá, Elá hijo de Basá comenzó a reinar sobre Israel, y reinó en Tirsa dos años.',
    'Pero Zimri, que comandaba la mitad de sus carros de combate, conspiró contra él. Un día, mientras Elá estaba en Tirsa, bebiendo hasta emborracharse en casa de su mayordomo Arsa,',
    'Zimri llegó e hirió de muerte a Elá, y comenzó a reinar en su lugar. Era el año veintisiete del reinado de Asa sobre Judá.',
    'En cuanto Zimri ocupó el trono de Israel, mandó matar a todos los descendientes de Basá, sin dejar con vida uno solo de sus parientes y amigos.',
    'Así fue como Zimri exterminó a la familia de Basá, con lo que se cumplió la palabra del Señor contra él, por medio del profeta Jehú.',
    'Ése fue el pago que recibieron por los pecados de Basá y de su hijo Elá, pues también hicieron pecar a Israel, con lo que provocaron el enojo del Señor, Dios de Israel.',
    'Todos los hechos de Elá se hallan registrados en el libro de las crónicas de los reyes de Israel.',
    'Cuando Asa llevaba veintisiete años de reinar sobre Judá, Zimri comenzó a reinar en Tirsa, pero solamente reinó siete días. Y es que cuando el pueblo, que estaba acampando a las afueras de Guibetón, ciudad de los filisteos, para atacarla,',
    'se enteró de que Zimri había conspirado contra el rey y le había dado muerte, ese mismo día proclamó rey a Omri, que era general del ejército y estaba en el campo de batalla.',
    'Entonces Omri y todo el ejército de Israel dejaron de atacar a Gibetón y fueron a sitiar a Tirsa.',
    ...
    'Todos los hechos de Zimri, y su conspiración contra el rey, se hallan registrados en el libro de las crónicas de los reyes de Israel.',
    ...
    'Los que apoyaban a Omri vencieron a los partidarios de Tibni, y Tibni murió y Omri ascendió al trono.',
    'Comenzó a reinar sobre Israel cuando el rey Asa de Judá llevaba treinta y un años de reinar sobre Judá, y reinó durante doce años, seis de los cuales reinó en Tirsa.',
    'A Semer, Omri le compró el monte de Samaria a cambio de sesenta y seis kilos de plata, y allí en ese monte edificó la ciudad de Samaria, a la que llamó así en recuerdo de Semer, el dueño de ese monte.',
    'Pero Omri hizo lo malo a los ojos del Señor. Su pecado fue peor que el de los reyes anteriores,',
    ...
    'Todos los hechos de Omri, y sus hazañas militares, se hallan registrados en el libro de las crónicas de los reyes de Israel.',
    'Y Omri fue a reunirse con sus antepasados, y fue sepultado en Samaria. En su lugar reinó su hijo Ajab.',
    'Ajab hijo de Omri comenzó a reinar sobre Israel cuando el rey Asa tenía treinta y ocho años de reinar sobre Judá.',
    'Ajab reinó veintidós años sobre Israel en Samaria, pero a los ojos del Señor sus hechos fueron peores que los de todos los que reinaron antes de él.',
    'Se le hizo fácil seguir los malos pasos de Jeroboán hijo de Nabat y tomar por esposa a Jezabel, la hija del rey Etbaal de Sidón; además, adoró y sirvió a Baal,',
    'y hasta le construyó un altar y le dedicó un templo en Samaria.',
  ...
  // Capítulo 17
  [
    'Elías, un tisbita que vivía en Galaad, fue a decirle a Ajab: «Vive el Señor, Dios de Israel, en cuya presencia estoy, que en los años que vienen no va a llover, y ni siquiera va a caer rocío, a menos que yo lo diga.»',
    'Además, la palabra del Señor vino a Elías y le dijo:',
    '«Sal de este lugar y vete al oriente; escóndete allí, cerca del arroyo de Querit, frente al río Jordán.',
    'Saciarás tu sed en el arroyo, y ya he mandado a los cuervos que te lleven de comer.»',
    'Elías fue obediente a la palabra del Señor, y se fue a vivir cerca del arroyo de Querit, frente al río Jordán.',
    'Los cuervos llegaban por la mañana y por la tarde, y le llevaban pan y carne, y él bebía agua del arroyo.',
    'Pero después de algunos días el arroyo se secó, porque no había llovido sobre la tierra.',
    ...
    'Elías abandonó ese lugar y partió a Sarepta. Cuando llegó a la entrada de la ciudad, vio a una mujer que recogía leña. Era viuda. Elías la llamó y le dijo: «Te ruego que me des a beber un vaso de agua.»',
    'Ya iba la mujer por el agua, cuando Elías la llamó y le dijo: «También te ruego que me traigas un poco de pan.»',
    'Pero ella le respondió: «Te juro por el Señor, tu Dios, que no he cocido pan. Sólo me queda un poco de harina en la tinaja, y unas gotas de aceite en una vasija. Con los leños que me viste recoger, voy a cocer el último pan para mi hijo y para mí. Después de comerlo, nos dejaremos morir.»',
    ...
    'El Señor, el Dios de Israel, me ha dicho: “No va a faltar harina en la tinaja, ni va a disminuir el aceite de la vasija, hasta el día en que el Señor haga llover sobre la tierra.”»',
    'La viuda hizo lo que Elías le dijo, y los tres comieron durante muchos días.',
    'Y tal y como el Señor se lo prometió a Elías, no faltó harina en la tinaja ni bajó de nivel el aceite en la vasija.',
    'Pero, un día, el hijo de la viuda cayó gravemente enfermo y se murió.',
    ...
    'Entonces el profeta tomó al niño y lo llevó con su madre, y le dijo: «Mira, ¡tu hijo está vivo!»',
    'Entonces la mujer le dijo: «Hoy he comprobado que tú eres un varón de Dios, y que en tus labios la palabra del Señor se hace verdad.»'
  ],
  // Capítulo 18
  [
    ...
    'Pero ordena ahora que todo el pueblo se reúna en el monte Carmelo, junto con los cuatrocientos cincuenta profetas de Baal y los cuatrocientos profetas de Asera que Jezabel alimenta.»',
    ...
    'Entonces Elías ordenó: «¡Capturen a los profetas de Baal! ¡Que no escape ninguno!» Y el pueblo los capturó, y Elías los llevó al arroyo de Cisón y allí les cortó la cabeza.',
  ...
  // Capítulo 20
  [
    'Un día el rey Ben Adad de Siria reunió a todo su ejército, y convocó a treinta y dos reyes aliados con su caballería y sus carros de combate, y se dirigió a Samaria para atacarla, y la sitió.',
    ...
    'El rey de Israel convocó entonces a todos los ancianos del país, y les dijo: «¿Se dan cuenta de que ese rey está buscando perjudicarme? Me pidió que le entregara mis tesoros de plata y de oro, y hasta mis mujeres y mis hijos, ¡y no se los negué!»',
    ...
    'y una vez más Ben Adad mandó a decirle: «¡Que los dioses me castiguen duramente, y más aún, si queda en Samaria el polvo suficiente para que mis ejércitos se lleven un puñado de sus ruinas!»',
    'Y el rey de Israel le respondió: «Díganle a su rey que una cosa es ceñirse la espada, y otra muy distinta volver victorioso del campo de batalla.»',
    ...
    'Pero un profeta fue a ver al rey Ajab de Israel, y le dijo: «Así ha dicho el Señor: “¿Ves esta gran muchedumbre? Hoy mismo voy a entregarla en tus manos, para que reconozcas que yo soy el Señor.”»',
    ...
    'Entonces Ajab pasó revista a los siervos de los jefes de las provincias, y eran doscientos treinta y dos guerreros. Luego pasó revista a todo el ejército israelita, y contó siete mil guerreros.',
    'Se pusieron en marcha al mediodía, saliendo de Samaria, mientras Ben Adad y los treinta y dos reyes que lo apoyaban seguían emborrachándose en su campamento.',
    ...
    'Los siervos de los jefes salieron de la ciudad, y tras ellos salió todo el ejército,',
    ...
    'También debes reponer el ejército que perdiste, jinete por jinete y carro por carro; entonces volveremos a luchar contra los israelitas en las llanuras, y con toda seguridad los venceremos.» Y el rey siguió el consejo.',
    'Un año después, Ben Adad pasó revista al ejército sirio y marchó hasta Afec para pelear contra Israel.',
    'También los israelitas pasaron revista, se abastecieron de víveres y marcharon al encuentro de los sirios. Acamparon frente al campamento sirio como si fueran dos pequeños rebaños de cabras; los sirios, en cambio, cubrían toda la llanura.',
    'Entonces el varón de Dios fue a ver al rey de Israel y le dijo: «Así ha dicho el Señor: “Los sirios creen que yo, el Señor, soy un Dios de los montes pero no un Dios de los valles. Pues para que todos reconozcan mi poder, voy a poner en tus manos a ese ejército tan numeroso. Así reconocerán ustedes que yo soy el Señor.”»',
    'Ambos ejércitos acamparon durante siete días en el valle, uno frente al otro, y el séptimo día comenzó la batalla. Ese mismo día, el ejército israelita mató a cien mil soldados sirios de infantería;',
    'el resto del ejército sirio huyó y se refugió en la ciudad de Afec, pero la muralla de la ciudad se les vino abajo y sepultó a veintisiete mil soldados que habían logrado escapar. También Ben Adad entró en la ciudad, y para salvarse iba escondiéndose de casa en casa.',
    ...
    'Los oficiales que fueron a ver al rey Ajab tomaron como buena señal estas palabras, y respondieron: «Tu hermano Ben Adad está vivo.» Ajab les dijo: «Quiero verlo. Vayan por él.» Ben Adad se presentó entonces ante Ajab, y éste lo invitó a subirse a su carro.',
    ...
    'En el momento en que el rey pasaba, el profeta gritó y dijo: «Este siervo de Su Majestad estaba en medio de la batalla, cuando de pronto se me acercó un soldado, y me entregó a un prisionero y me dijo: “Cuida bien a este prisionero. No lo dejes escapar. Si se escapa, tú me responderás con tu vida, o me pagarás tres mil monedas de plata.”',
    ...
    'Entonces el profeta le dijo: «Así ha dicho el Señor: “Puesto que dejaste al hombre que yo había condenado a muerte, tú morirás en su lugar, y tu pueblo morirá en lugar de su pueblo.”»',
  ...
  // Capítulo 22
  [
    'Tres años transcurrieron sin que Siria e Israel estuvieran en guerra.',
    'Pero al tercer año el rey Josafat de Judá fue a visitar al rey Ajab de Israel,',
    'y éste dijo a sus oficiales: «¿Ya no se acuerdan que Ramot de Galaad nos pertenece? Está en poder del rey de Siria, ¡y nosotros no hemos hecho nada para recuperarla!»',
    ...
    'Pero te sugiero que antes consultes que dice el Señor al respecto.»',
    ...
    'Y Ajab le respondió: «Sí, aún queda otro profeta por medio del cual podríamos consultar al Señor. Se trata de Micaías hijo de Imla, pero me cae muy mal porque nunca me da palabras de aliento, sino que siempre me desanima.» Como Josafat le recomendó que no hablara así,',
    'Ajab llamó entonces a uno de sus oficiales y le ordenó que fuera a buscar a Micaías hijo de Imla y lo llevara ante él.',
    'Mientras tanto, los dos reyes se quedaron en la plaza que está junto a la puerta de Samaria, sentados en sus tronos y ataviados con sus mantos reales. Delante de ellos, los profetas les prodigaban buenos augurios.',
    'Uno de ellos, Sedequías hijo de Quenaná, se acercó y les mostró unos cuernos de hierro que había hecho, y dijo: «Así ha dicho el Señor: “Con estos cuernos cornearás a los sirios hasta acabar con ellos.”»',
    ...
    'El mensajero que el rey mandó por Micaías, lo halló y le dijo: «Todos los profetas auguran éxito a Su Majestad. Une tu voz a la de ellos, y augúrale mucho éxito.»',
    'Pero Micaías respondió: «Juro por el Señor, que sólo diré lo que el Señor me ordene decir.»',
    'Cuando Micaías se presentó ante el rey, éste le preguntó: «Dime, Micaías; ¿debemos ir y atacar a Ramot de Galaad, o la dejaremos en paz?» Y Micaías le respondió: «Ve y atácala, que saldrás victorioso. El Señor te la va a entregar.»',
    'Pero el rey le dijo: «¿Cuántas veces tengo que decirte, en el nombre del Señor, que me digas sólo la verdad?»',
    ...
    'El rey de Israel se volvió a Josafat, y le dijo: «¿No te lo había dicho ya? Micaías nunca me anuncia nada bueno. Sólo me anuncia calamidades.»',
    'Pero Micaías replicó: «¡Ahora vas a oír la palabra del Señor! Yo vi al Señor en su trono, rodeado de todos los ejércitos del cielo.',
    ...
    'el espíritu dijo: “Voy a mezclarme entre los profetas, y los haré decir mentiras.” Entonces el Señor le dijo: “Pues ve y hazlo pronto. Indúcelos a que hagan lo que dices.”',
    ...
    'Entonces el rey de Israel dijo: «Tomen preso a Micaías, y llévenlo ante Amón, el gobernador de la ciudad, y ante Joás, mi hijo.',
    'Díganles que yo, el rey de Israel, he dicho: “Metan a la cárcel a este hombre. En vez de pan y agua, manténganlo angustiado y afligido hasta que yo regrese en paz.”»',
    ...
    'El rey de Israel y el rey de Judá salieron juntos contra Ramot de Galaad.',
    ...
    'Pero un arquero lanzó una flecha al aire, y la flecha alcanzó al rey Ajab y le penetró entre las junturas de su armadura. Al sentirse herido, el rey le ordenó al cochero darse la vuelta y sacarlo del campo de batalla, porque estaba herido.',
    'Pero la batalla arreció y el rey tuvo que quedarse en su carro y hacerle frente al ejército sirio, pero la sangre corría por el fondo del carro y al caer la tarde murió.',
    ...
    'Luego llevaron su carro al estanque de Samaria para lavarlo, y los perros lamieron la sangre del rey. (En ese mismo estanque se lavaban también las prostitutas.) Así se cumplió lo que el Señor había dicho acerca de Ajab.',
    ...
    'Y Ajab murió y fue a reunirse con sus antepasados. En su lugar reinó su hijo Ocozías.',
    'Josafat hijo de Asa comenzó a reinar sobre Judá cuando Ajab llevaba cuatro años de reinar sobre Israel.',
    'Josafat tenía treinta y cinco años cuando subió al trono, y reinó veinticinco años en Jerusalén. Su madre se llamaba Azura, y era hija de Siljí.',
    'Y Josafat siguió siempre el buen ejemplo de Asa, su padre, e hizo lo recto a los ojos del Señor. Sin embargo, no se quitaron los altares de los montes, sino que el pueblo siguió ofreciendo en ellos sacrificios y quemando incienso.',
    'Pero Josafat hizo la paz con el rey de Israel.',
    'Todos los hechos y las hazañas de Josafat, y las guerras que libró, se hallan en el libro de las crónicas de los reyes de Judá.',
    ...
    'El rey Ocozías le propuso a Josafat enviar a sus marinos con los de Josafat, pero éste no aceptó.',
    'Y murió Josafat y se reunió con sus antepasados, y lo sepultaron con ellos en la ciudad de su antepasado David. En su lugar reinó Jorán, su hijo.',
    'Ocozías hijo de Ajab comenzó a reinar sobre Israel en Samaria cuando Josafat llevaba diecisiete años de reinar en Judá.',
    'Pero Ocozías siguió el mal ejemplo de su padre, de su madre y de Jeroboán hijo de Nabat, e hizo lo malo a los ojos del Señor, haciendo pecar al pueblo de Israel.',
    'Sirvió y adoró a Baal, como antes lo había hecho su padre, y esto provocó la ira del Señor, Dios de Israel.'
  ]
];