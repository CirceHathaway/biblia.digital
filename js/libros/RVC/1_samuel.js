// Auto-generated from RVC.xml — 1 Samuel 1–31
export default [
  // Capítulo 1
  [
    'En Ramatayin de Sofín, de los montes de Efraín, vivía un varón llamado Elcana hijo de Jeroán, que era descendiente en línea directa de los efrateos Eliú, Tohu y Suf.',
    'Elcana tenía dos mujeres; una de ellas se llamaba Ana, y la otra, Peniná. Ésta tenía hijos, pero no así Ana.',
    'Todos los años Elcana salía de su ciudad para ir a Silo y adorar allí al Señor de los ejércitos. Allí oficiaban como sacerdotes Jofní y Finés, hijos de Elí.',
    ...
    'y le hizo un voto. Le dijo: «Señor de los ejércitos, si te dignas mirar la aflicción de esta sierva tuya, y te acuerdas de mí y me das un hijo varón, yo te lo dedicaré, Señor, para toda su vida. Yo te prometo que jamás la navaja rozará su cabeza.»',
    'Y mientras ella oraba largamente delante del Señor, Elí la observaba mover los labios.',
    ...
    'Por la mañana, adoraron delante del Señor y regresaron todos a su casa en Ramá. Allí, Elcana tuvo relaciones con Ana, y el Señor se acordó de lo que ella le había pedido.',
  ...
  [
    ...
    'El Señor quiebra los arcos de los poderosos, y reviste de poder a los débiles.',
    'Los que eran ricos, ahora mendigan trabajo; los que sufrían de hambre han sido saciados. Aun la estéril ha dado a luz siete hijos, y la mujer fecunda ahora desfallece.',
    ...
    'Elcana regresó a su casa en Ramá, y el niño se quedó a servir al Señor bajo la supervisión del sacerdote Elí.',
    'Los hijos de Elí eran unos malvados, y no reconocían la autoridad del Señor.',
    'Era costumbre entre los sacerdotes y el pueblo que, cuando alguien ofrecía un sacrificio, mientras se cocía la carne, el criado del sacerdote tomaba un tridente e iba',
    'al perol, la olla, el caldero o la marmita, y sacaba carne para el sacerdote. Así lo hacían con todos los israelitas que acudían a Silo.',
    ...
    'Este pecado de los jóvenes sacerdotes era muy grave, porque no mostraban ningún respeto por las ofrendas del Señor.',
    ...
    'Y el Señor bendijo a Ana con tres hijos y dos hijas. Mientras tanto, el joven Samuel crecía y seguía sirviendo al Señor.',
    'Elí ya era muy viejo, pero sabía todo lo que sus hijos hacían con el pueblo de Israel, y sabía también que ellos se acostaban con las mujeres que servían a la entrada del tabernáculo.',
    ...
    'Si el hombre peca contra el hombre, hay jueces para juzgarlo; pero si alguien peca contra el Señor, ¿quién intercederá por él?» Pero sus hijos no atendieron los consejos de su padre, porque el Señor había resuelto quitarles la vida.',
    'Mientras tanto, el joven Samuel seguía creciendo y era bien visto por Dios y por la gente.',
    ...
    'Yo escogí a tu padre de entre todas las familias de Israel, para que fuera mi sacerdote y presentara sobre mi altar las ofrendas, y quemara incienso, y llevara el efod delante de mí. Además, le di a sus descendientes todas las ofrendas de los hijos de Israel.',
    '¿Por qué han pisoteado los sacrificios y las ofrendas que pedi al pueblo ofrecerme en el tabernáculo? ¿Por qué has respetado más a tus hijos que a mí, y los has dejado engordar con las mejores ofrendas que me da mi pueblo Israel?',
    'Por todo esto, el Señor Dios de Israel te dice: Yo prometí que tu familia y los descendientes de tu padre estarían siempre a mi servicio; pero hoy te digo que esto se acabó, porque yo honro a los que me honran, y humillo a los que me desprecian.',
    'Ya está cerca el día en que tu poder y el de tus descendientes llegará a si fin; ninguno de ellos llegará a viejo.',
    ...
    'A cualquiera de tus hijos que yo no aparte de mi altar, tú lo verás para llenarte de dolor. Todos tus descendientes morirán en plena juventud.',
    'Como señal de lo que te he dicho, tus dos hijos, Jofní y Finés, morirán el mismo día.',
    'Pero levantaré un sacerdote que me sea fiel, y que haga lo que a mí me agrada. Yo haré que no le falten descendientes, y estará delante de mi ungido todos los días de su vida.',
    'El que haya sobrevivido en tu familia, irá y se arrodillará delante de él, y le rogará que le dé una moneda de plata y un bocado de pan, y que lo ocupe en algún trabajo entre los sacerdotes para tener qué comer.»'
  ],
  // Capítulo 3
  [
  ...
  [
    ...
    'Pero al niño le puso por nombre Icabod,1 pues dijo: «¡La gloria de Israel ha sido deshonrada!», porque el arca de Dios había sido capturada, y su suegro y su marido habían muerto.',
  ...
  [
    ...
    'Tomaron el arca y la metieron en el templo de su dios Dagón, y la pusieron junto a ese ídolo.',
    'Al siguiente día, cuando los habitantes de Asdod se levantaron, vieron que Dagón estaba arrodillado ante el arca del Señor, así que tomaron a Dagón y lo devolvieron a su lugar.',
    'Pero al día siguiente, Dagón estaba una vez más de rodillas ante el arca del Señor, sólo que ahora Dagón tenía cortadas la cabeza y las dos manos, y nada más le había quedado el tronco, el cual estaba colocado sobre el umbral.',
    ...
    'Entonces convocaron a los jefes de los filisteos para decirles: «Devuelvan el arca del Dios de Israel al lugar que le corresponde, para que no nos mate a todos.» Y es que toda la ciudad vivía con el temor a la muerte, pues el poder de Dios había aumentado contra ellos,',
  ...
  [
    ...
    'Ellos llamaron a los sacerdotes y adivinos, y les preguntaron: «¿Qué nos aconsejan hacer con el arca del Señor? Dígannos cómo podemos devolverla a su lugar.»',
    'Los sacerdotes dijeron: «Cuando regresen el arca del Dios de Israel a su lugar, no la envíen vacía, sino envíenla con una compensación por la culpa cometida; sólo así serán sanados, y sabrán por qué el poder de Dios se ensañó contra ustedes.»',
    'Entonces ellos preguntaron: «¿Y en qué consiste la compensación que debemos pagar?» Y ellos respondieron: «Deben entregar cinco figuras de tumores de oro, y cinco ratones de oro, conforme al número de los jefes filisteos, porque una misma plaga los afligió a ustedes y a sus jefes.',
    'Hagan las figuras de los tumores y de los ratones que destruyen la tierra, y así honrarán al Dios de Israel. Tal vez él se compadezca de ustedes, de sus dioses, y de su tierra.',
    '¿Por qué son insensibles, como el faraón y los egipcios? Ellos trataron con dureza a los israelitas, pero los dejaron ir, y ellos se fueron.',
    'Construyan ahora un carro nuevo, y elijan a dos vacas que no hayan llevado antes el yugo, y que estén criando; pónganles el yugo y únzanlas al carro, y no dejen que sus becerros las sigan.',
    ...
    'Pero fíjense qué rumbo toma el carro: si se va por el camino que lleva a Bet Semes, su tierra, eso querrá decir que fue el Señor quien nos mandó tan grandes males; pero si toma otro camino, sabremos que no fue el Señor, sino que lo que sufrimos fue un accidente.»',
    ...
    'Luego pusieron el arca del Señor sobre el carro, y a un lado la caja con los ratones de oro y las figuras de los tumores, como compensación por la culpa cometida, y la dejaron ir.',
    'Y las vacas se dirigieron a Bet Semes; iban andando y bramando, sin apartarse del camino, y los jefes de los filisteos las siguieron hasta el límite de Bet Semes.',
    'Los habitantes de Bet Semes estaban en el valle, segando el trigo, y cuando alzaron los ojos y vieron el arca, se alegraron mucho.',
    'El carro llegó al campo de Josué de Bet Semes, y se detuvo en donde había una gran piedra; entonces ellos tomaron la madera del carro y la partieron, y ofrecieron las vacas como una ofrenda al Señor.',
    'Luego los levitas bajaron el arca del Señor, y la caja que iba junto a ella, donde estaban las joyas de oro, y las pusieron sobre aquella gran piedra. Ese día los habitantes de Bet Semes ofrecieron sacrificios y ofrendas al Señor.',
    'Cuando los cinco jefes de los filisteos vieron todo esto, regresaron a Ecrón el mismo día.',
    'Las figuras de los tumores de oro que los filisteos pagaron como compensación al Señor fueron cinco: una por Asdod, una por Gaza, una por Ascalón, una por Gat, y una por Ecrón.',
    ...
    'Luego enviaron mensajeros a los habitantes de Quiriat Yearín, para que les dijeran: «Los filisteos han devuelto el arca del Señor. Vengan y llévenla con ustedes.»'
  ],
  // Capítulo 7
  [
    'Los habitantes de Quiriat Yearín fueron y se llevaron el arca del Señor, y la pusieron en casa de Abinadab, la cual estaba en una colina, y consagraron a Eleazar su hijo, como guardián del arca del Señor.',
    'Así, pasaron veinte años desde el día en que llegó el arca a Quiriat Yearín, y los israelitas gemían arrepentidos ante el Señor.',
    'Entonces Samuel habló con todos los israelitas y les dijo: «Si de todo corazón se han arrepentido delante del Señor, quiten a Astarot y a todos los dioses ajenos que todavía adoran; entréguense de corazón al Señor, y sírvanle sólo a él; entonces el Señor los librará de la ira de los filisteos.»',
    'Y los israelitas renunciaron a los baales y a Astarot, y sirvieron sólo al Señor.',
    'Entonces Samuel les dijo: «Reúnan a todos los israelitas en Mispá, y yo rogaré al Señor por ustedes.»',
    ...
    'Así fueron vencidos los filisteos, y no volvieron a entrar en el territorio de Israel porque el poder del Señor estuvo en contra de ellos mientras Samuel vivió.',
    'Los israelitas liberaron el territorio que los filisteos tenían en su poder y recuperaron las ciudades que les habían arrebatado, desde Ecrón hasta Gat. Así los israelitas y los amorreos vivieron en paz.',
    ...
    'Después regresaba a Ramá, donde vivía y donde también edificó un altar al Señor, y desde allí impartía justicia al pueblo.'
  ],
  // Capítulo 8
  [
  ...
  [
    ...
    'Este hombre tenía un hijo que se llamaba Saúl, el cual era un joven muy bien parecido. Entre todos los jóvenes israelitas no había nadie más bien parecido que él; además, era más alto que cualquiera del pueblo.',
    ...
    'Y Saúl le respondió: «Está bien, vamos; pero ¿qué podemos ofrecerle? Ya no tenemos pan en nuestras alforjas. ¿Qué podemos llevarle a ese hombre de Dios?»',
    ...
    'Ellas les respondieron: «Sí, pero más adelante. Dense prisa, porque hoy ha venido a la ciudad para acompañar al pueblo, que va a ofrecer sacrificios en el santuario que está en lo alto del cerro.',
    'En cuanto entren en la ciudad lo van a ver, pero búsquenlo antes de que suba al santuario para el banquete, pues el pueblo no comerá hasta que él llegue, ya que es él quien bendice el sacrificio; después de eso, comen los invitados. Vayan ahora mismo, y lo hallarán.»',
    'Ellos se dirigieron a la ciudad, y cuando llegaron al centro, Samuel ya venía hacia ellos y en dirección al santuario del cerro.',
    'Pero el Señor ya había hablado con Samuel un día antes de que Saúl llegara. Le había dicho:',
    '«Prepárate, porque mañana a esta misma te enviaré a un joven benjaminita. Vas a consagrarlo como rey de mi pueblo Israel, pues él lo va a salvar de los filisteos. El clamor de mi pueblo ha llegado a mis oídos, y yo he puesto en ellos mis ojos.»',
    'En cuanto Samuel vio a Saúl, el Señor le dijo: «Éste es el hombre de quien te hablé. Éste es el que va a gobernar a mi pueblo.»',
    'En cuanto Saúl vio que Samuel entraba en la ciudad, se acercó a él y le dijo: «Te ruego que me digas dónde vive el vidente.»',
    'Y Samuel le respondió: «Yo soy el vidente. Acompáñame al santuario allá arriba, y come hoy conmigo. Mañana, cuando te vayas, te diré todo lo que te está inquietando.',
    'Yo sé que hace tres días se perdieron las asnas de tu padre, pero no te preocupes, porque ya las encontraron. Ahora dime: ¿Quién merece tener lo mejor que hay en Israel? Te lo voy a decir. Lo merecen tú y la familia de tu padre.»',
    ...
    'Entonces Samuel tomó a Saúl y a su criado, y los llevó a la sala y les ofreció la cabecera de la mesa, aun cuando Samuel tenía treinta invitados más.',
    'Luego le dijo al cocinero: «Trae la porción de carne que te dije que apartaras.»',
    'El cocinero llevó la espaldilla y todo lo que iba con ella, y la puso delante de Saúl. Entonces Samuel le dijo: «Esto estaba reservado para ti. Sírvete y come, pues se reservó para tu visita que ya esperaba, aun cuando todo el pueblo también estaba invitado.» Y Saúl comió aquel día con Samuel.',
  ...
  [
    ...
    'Uno de ellos exclamó: «¡Hoy día, cualquiera es profeta!»3 Por eso es tan popular el dicho: «¿También Saúl anda entre los profetas?»',
  ...
  [
    ...
    'El efod lo llevaba Ajías hijo de Ajitob, que era hermano de Icabod hijo de Finés, el hijo de Elí, sacerdote del Señor en Silo. Nadie en el pueblo sabía que Jonatán se había ido.',
    ...
    'Entonces Jonatán le dijo a su escudero: «Ven, vamos a pasar a la guarnición de estos incircuncisos, y espero que el Señor nos ayude. Para él no es difícil vencer al enemigo con muchos hombres o con pocos.»',
    ...
    'Pero si nos dicen que vayamos a donde ellos están, vayamos; ésa será la señal de que el Señor los ha entregado en nuestras manos.»',
    'Salieron entonces de su escondite, para que los vieran los filisteos que estaban en la guarnición; y éstos, al verlos, dijeron: «Miren, ¡los hebreos ya están saliendo de las cuevas donde estaban escondidos!»',
    ...
    'Entonces el pánico se apoderó de todo el campamento, en el campo y en toda la guarnición; y cuando lo supieron los espías, también se llenaron de miedo; y el pánico aumentó porque hubo un temblor de tierra.',
    ...
    'Entonces Saúl le dijo a Ajías: «Trae el arca de Dios.» En ese entonces el arca de Dios estaba con el pueblo de Israel.',
    'Y mientras Saúl hablaba con el sacerdote, el desorden que había en el campamento de los filisteos iba en aumento. Entonces Saúl le dijo al sacerdote: «Espera, no la traigas.»',
    ...
    'Ese día los israelitas se vieron en aprietos, pues tenían mucha hambre porque Saúl había hecho jurar al pueblo que no comerían en todo el día, hasta que se hubieran vengado de sus enemigos. Cualquiera que desobedeciera quedaría bajo maldición.',
    ...
    'Pero Jonatán le respondió: «Mi padre ha causado un gran daño al pueblo. ¡Mírenme! Sólo probé un poco de miel, ¡y ya me reanimé!',
    ...
    'así que Saúl llamó a los jefes del pueblo y les preguntó: «Díganme quién ha pecado hoy, y cuál ha sido su maldad;',
    ...
    'Saúl dijo: «Ahora echen la suerte entre mi hijo Jonatán y yo.» Como la suerte cayó sobre Jonatán,',
    ...
    'Después de tomar posesión del reino de Israel, Saúl luchó contra todos los enemigos que lo rodeaban: luchó contra los moabitas, los amonitas, los edomitas, los reyes de Soba y los filisteos; y por dondequiera que iba, salía victorioso.',
    'Con el ejército que reunió, derrotó a los amalecitas y libró a Israel de quienes lo saqueaban.',
    'Saúl tuvo cinco hijos: Los varones fueron Jonatán, Isúi y Malquisúa. Las mujeres fueron Merab, la mayor, y Mical, la menor.',
    'La mujer de Saúl se llamaba Ajinoán, y era hija de Ajimaz. El general de su ejército era su primo Abner hijo de Ner.',
    'Su padre, Cis, era hermano de Ner, el padre de Abner; y los dos eran hijos de Abiel.',
  ...
  // Capítulo 16
  [
    'Un día, el Señor le dijo a Samuel: «¿Hasta cuándo vas a estar triste por causa de Saúl? ¿No recuerdas que yo lo deseché como rey de Israel? Mejor llena de aceite tu cuerno, y ve a Belén; allí, vas a visitar a Yesé, porque uno de sus hijos será el próximo rey de Israel.»',
    ...
    'Y Samuel les respondió: «Sí, vengo a ofrecer un sacrificio al Señor. Purifíquense y acompáñenme.» Y Samuel purificó también a Yesé y a sus hijos, y los invitó al sacrificio.',
    'Y cuando todos estuvieron reunidos, Samuel vio a Eliab, y pensó: «Seguramente, éste es el que Dios ha escogido.»',
    ...
    'Luego Yesé llamó a Abinadab, y lo puso enfrente de Samuel, pero éste dijo: «Tampoco éste es el elegido del Señor.»',
    'Yesé presentó también a Samá, y Samuel repitió que tampoco éste era el elegido del Señor.',
    'Yesé le presentó a siete de sus hijos, pero Samuel le dijo que el Señor no había elegido a ninguno de ellos.',
    'Y le preguntó: «¿Éstos son todos tus hijos?» Yesé respondió: «Falta uno, que es el menor, pero él anda cuidando las ovejas.» Y Samuel le dijo: «Manda a traerlo, porque sin él no podemos sentarnos a la mesa.»',
    'Yesé mandó a traerlo, y cuando éste llegó lo invitó a pasar. Era un jovencito rubio, de hermosos ojos y de agradable apariencia. Entonces el Señor le dijo a Samuel: «Éste es mi elegido. Levántate y conságralo.»',
    'Samuel tomó entonces el cuerno en donde llevaba el aceite, y lo ungió como rey en presencia de sus hermanos. Y a partir de ese día el espíritu del Señor estuvo sobre David. Después de eso, Samuel regresó a Ramá.',
    ...
    'Te sugerimos que envíes a alguno de nosotros para que busque quién sepa tañer el arpa. Así, cuando tu espíritu sea atormentado, éste tocará el arpa y la música calmará tu espíritu.»',
    'Y Saúl les respondió: «Sí, vayan y busquen alguien que toque bien el arpa, y tráiganlo acá.»',
    'Uno de sus sirvientes le dijo: «Yo conozco a uno de los hijos de Yesé, el de Belén. Toca muy bien el arpa; es un joven valiente, fuerte y aguerrido; además, es prudente cuando habla, y muy apuesto, y el Señor está con él.»',
    ...
    'Cuando David llegó, se presentó ante el rey; y en cuanto Saúl lo vio, quedó tan complacido que lo hizo su escudero.',
    ...
    'Y cuando el espíritu maligno venía de parte de Dios y atormentaba a Saúl, David tomaba el arpa y la tocaba. Con esto Saúl se calmaba y se sentía mejor, y el espíritu maligno se apartaba de Saúl.'
  ],
  // Capítulo 17
  [
    'Los filisteos volvieron a reunir sus tropas en Soco, un pueblo de Judá, y acamparon en Efesdamín, entre Soco y Azeca.',
    'También Saúl reunió a los israelitas y acamparon en el valle de Elá, y se prepararon para presentar combate.',
    'Un valle separaba a los dos ejércitos. Los filisteos estaban de un lado del monte, y los israelitas estaban del otro lado.',
    'De las filas del ejército filisteo salió un guerrero llamado Goliat, que era de Gat, el cual medía unos tres metros de altura.',
    ...
    'Con fuertes gritos, el filisteo les dijo a los soldados israelitas: «¿Para qué se forman en orden de batalla? Yo soy un guerrero filisteo, y ustedes están al servicio de Saúl. Escojan a uno de sus guerreros, para que venga y luche contra mí.',
    ...
    'Uno de esos días, Yesé le dijo a David, su hijo: «Ve al campamento y llévales a tus hermanos veinte litros de trigo tostado y estos diez panes.',
    ...
    'mientras unos a otros se decían: «¿Ya vieron a ese soldado? Siempre viene y nos desafía a pelear contra él. A quien lo venza, el rey Saúl lo colmará de riquezas y, además, le dará a su hija en matrimonio, y su familia quedará libre de pagar tributos.»',
    'Entonces David les preguntó a los que estaban allí cerca: «¿Qué recompensa se le dará a quien venza a este filisteo y libre a Israel de semejante afrenta? ¿Quién es este filisteo incircunciso, para provocar al ejército del Dios vivo?»',
    'Los del ejército le dijeron lo mismo que ya le habían dicho, en cuanto a quien venciera al filisteo.',
    'Pero cuando Eliab, su hermano mayor, lo oyó hablar con los soldados, se llenó de ira contra David y le dijo: «¿A qué has venido? ¿Con quién dejaste nuestras pocas ovejas en el desierto? Yo sé que te crees muy valiente, y también sé que por malicia has venido a ver la batalla.»',
    'David le respondió: «¿Y qué es lo que he hecho? ¡Tú sólo hablas por hablar!»',
    ...
    'Y cuando el filisteo vio a David, lo miró con desprecio, pues éste era un jovencito rubio y bien parecido.',
    ...
    'Hoy mismo el Señor te entregará en mis manos. Te voy a vencer, y te voy a cortar la cabeza, y los cadáveres de tus compatriotas se los voy a dar a las aves de rapiña y a los animales salvajes. Así en todos los pueblos se sabrá que hay Dios en Israel.',
    ...
    'Y cuando el poderoso filisteo se encaminó para encontrarse con David, éste rápidamente se colocó en línea de combate frente al filisteo,',
    'metió su mano en el morral y, sacando una piedra, la colocó en su honda y la arrojó con fuerza al filisteo. La piedra se incrustó en la frente de Goliat, y éste cayó con la cara al suelo.',
    'Así fue como David venció al filisteo: con una honda y una piedra. Lo hirió de muerte sin necesidad de usar la espada.',
    'Luego corrió y desenvainó la espada del filisteo, y se subió sobre él para rematarlo, y finalmente le cortó la cabeza. Y cuando el ejército de los filisteos vio que su gran guerrero estaba muerto, se dio a la fuga.',
    'Pero los del ejército israelita y los de Judá lanzaron fuertes alaridos y se fueron por todo el valle, en persecusión de los filisteos, y los siguieron hasta las puertas de Ecrón. Por todo el camino que va a Sagarayin, Gat y Ecrón, los filisteos quedaron tendidos y heridos de muerte.',
    'Después de perseguir a los filisteos, los israelitas volvieron y saquearon su campamento.',
    'Por su parte, David tomó la cabeza del filisteo y la llevó a Jerusalén, aunque las armas del guerrero las guardó en su tienda.',
    ...
    'Y cuando David volvía de matar al filisteo, Abner lo tomó del brazo y lo llevó ante Saúl, mientras David llevaba en su mano la cabeza del filisteo.',
    'Y Saúl le preguntó: «Dime, jovencito: ¿de quién eres hijo?» Y David respondió: «Mi padre es Yesé de Belén, siervo de Su Majestad.»'
  ],
  // Capítulo 18
  [
    ...
    'David iba a dondequiera que Saúl lo enviaba, y tanta inteligencia mostraba que Saúl lo ascendió por encima de sus jefes del ejército, y era respetado por todo el pueblo y por los siervos de Saúl.',
  ...
  [
    ...
    'Y Jonatán le dijo a su padre que David era uno de sus mejores servidores, y añadió: «No vaya Su Majestad a cometer un pecado contra su siervo David, porque él no ha hecho nada en contra de Su Majestad. Al contrario, todo lo que ha hecho es por el bien de Su Majestad.',
    'Él mismo puso en riesgo su vida cuando peleó contra el filisteo, y por medio de él salvó el Señor al pueblo de Israel. Su Majestad lo vio y se alegró con él; ¿por qué quiere Su Majestad pecar derramando la sangre inocente de David, sin ninguna razón?»',
    'Saúl aceptó lo que le dijo Jonatán, y juró por el Señor que respetaría la vida de David.',
    'Entonces Jonatán llamó a David, y le dijo lo que había hablado con el rey, y él mismo lo llevó ante Saúl, y David volvió a servirle como al principio.',
    'Tiempo después, los filisteos volvieron a pelear contra los israelitas, y David salió y peleó contra ellos, y los venció y los hizo huir.',
    ...
    'De pronto, Saúl tomó la lanza y la arrojó, con la intención de atravesar con ella a David, pero éste la esquivó y la lanza quedó clavada en la pared. Esa misma noche David escapó de morir y huyó.',
    'Saúl envió mensajeros a casa de David para que lo vigilaran y lo mataran al amanecer, pero Mical, su mujer, le advirtió: «Si no te pones a salvo esta noche, mañana serás hombre muerto.»',
    'Y así, Mical descolgó a David por una ventana para que pudiera escapar,',
    ...
    'Cuando los mensajeros de Saúl llegaron para aprehender a David, ella les dijo que estaba enfermo y en cama.',
    ...
    'Y David huyó hasta Ramá, donde vivía Samuel, y le contó cómo Saúl había intentado matarlo. Entonces los dos se fueron a vivir en Nayot.',
    'Saúl supo que David y Samuel estaban en Nayot de Ramá,',
    'y envió mensajeros para que lo llevaran a su presencia; pero al llegar, vieron a un grupo de profetas dirigidos por Samuel, que estaban profetizando. Entonces el espíritu de Dios vino sobre los mensajeros, y también ellos comenzaron a profetizar.',
    ...
    'Al llegar delante de Samuel, se quitó la ropa y, totalmente desnudo, siguió profetizando todo el día y toda la noche. Desde ese día la gente suele decir: «¿También Saúl anda entre los profetas?»'
  ],
  // Capítulo 20
  [
  ...
  [
    ...
    'David le respondió: «El rey me encomendó un asunto importante. Me recomendó: “Que nadie sepa a qué te envío, ni cuál es tu misión.” Pero voy a encontrarme en cierto lugar con los hombres a mi cargo.',
    ...
    'El sacerdote le dio entonces los panes consagrados, que ya habían sido retirados de la presencia del Señor, y cambiados por panes calientes de ese mismo día.',
    'Ese día se encontraba allí, ante el Señor, un edomita llamado Doeg, que era el jefe de los pastores de Saúl.',
    'David le preguntó a Ajimélec: «¿Tienes a la mano una espada o una lanza? No traje mi espada ni mis otras armas porque las órdenes del rey eran urgentes.»',
    'El sacerdote le respondió: «Tengo la espada del filisteo Goliat, al que tú venciste en el valle de Elá. Está aquí, detrás del efod, envuelta en un velo. Si te sirve, tómala. Es la única que tengo.» Y David le dijo: «Ninguna otra sería mejor. Dámela.»',
    'Ese día David huyó de los dominios de Saúl y llegó al pueblo de Gat, donde Aquis era rey.',
    'Los siervos de Aquis le dijeron: «¡Aquí está David, el rey de esta tierra! Éste es de quien, entre danzas y cantos, la gente decía: “Saúl mató a miles de guerreros, pero David mató a más de diez mil.”»',
    'Cuando David oyó esto, presintió que había peligro y tuvo miedo de Aquis, el rey de Gat.',
    ...
    'Al verlo, Aquis dijo a sus siervos: «¿No se dan cuenta que este hombre está loco? ¿Para qué me lo traen?',
    '¿Acaso faltan locos en mi casa, para que me traigan a éste a hacer sus locuras delante de mí? ¿Creen que voy a dejar que entre aquí?»'
  ],
  // Capítulo 22
  [
  ...
  [
    ...
    'Entonces Saúl dejó de perseguir a David, y regresó para luchar contra los filisteos. Por eso el lugar se llama Sela Hamajlecot.5',
  ...
  [
    ...
    'Por favor, no tomes en cuenta las palabras de Nabal, mi imprudente esposo. Le hace honor a su nombre,6 y siempre ha sido un imprudente. Pero cuando vinieron los jóvenes que tú enviaste, yo no los vi.',
  ...
  // Capítulo 27
  [
    'Pero David tenía un presentimiento. Y pensaba: «Un día, Saúl me va a matar. Lo que más me conviene es huir a la tierra de los filisteos. Así Saúl se olvidará de mí, y dejará de perseguirme por todo Israel, y me pondré a salvo de él.»',
    ...
    'Así fue como David y sus hombres se quedaron a vivir con Aquis, en Gat, junto con sus familias. Además, David se llevó a sus dos mujeres, es decir, a Ajinoán la jezreelita y a Abigaíl, la que había sido mujer de Nabal, el de Carmel.',
    'Y cuando Saúl supo que David se encontraba en Gat, dejó de perseguirlo.',
    'Luego, David fue a decirle a Aquis: «Si soy digno de tu bondad, permíteme vivir con mi familia en alguna de tus aldeas. No creo que esté bien que este siervo tuyo viva en la ciudad del rey.»',
    ...
    'David y sus hombres hacían incursiones en tierras de los gesuritas, gezritas y amalecitas, los cuales ocupaban esas tierras desde hacía mucho tiempo. Esas tierras se extendían hacia la región de Shur y hasta Egipto.',
  ...
  [
    ...
    'Samuel murió, y fue sepultado en Ramá, que era su ciudad. Todo el pueblo de Israel lloró su muerte. Saúl había expulsado del país a todos los encantadores y adivinos.',
    'Los filisteos se reunieron y acamparon en Sunén. También Saúl reunió a su ejército y acampó en Gilboa.',
    ...
    'Saúl se disfrazó entonces poniéndose otras ropas, y durante la noche se fue con dos de sus hombres a buscar a la mujer. Cuando la vio, le dijo: «Te ruego que me adivines el futuro, y que hagas venir a quien yo te diga.»',
    'Pero la adivina le dijo: «Tú bien sabes que Saúl ha expulsado del país a los que invocan a los espíritus y a los adivinos. ¿Por qué me tiendes esta trampa? ¿Quieres que me maten?»',
    ...
    'Saúl le preguntó: «¿Qué aspecto tienen?» Y ella le dijo: «Veo un anciano. Viene cubierto con un manto.» Al darse cuenta Saúl de que quien venía era Samuel, hizo una gran reverencia y se inclinó de cara al suelo.',
    ...
    'El Señor ha hecho contigo lo que te dijo por medio de mí. Te ha quitado el reino, y se lo ha dado a tu compañero David.',
    'Como no obedeciste a la voz del Señor, ni cumpliste su orden de acabar con Amalec, ahora el Señor te trata así.',
    'El Señor iba a entregar a Israel, lo mismo que a ti, en poder de los filisteos, y mañana tú y tus hijos estarán conmigo. El Señor hará que los filisteos venzan al ejército israelita.»',
    'Entonces Saúl se desplomó cuan largo era, lleno de temor por lo que le había dicho Samuel. Y como no había comido nada durante todo el día y toda la noche, estaba sin fuerzas.',
