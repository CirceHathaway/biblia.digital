// Auto-generated from RVC.xml — 1 Tesalonicenses 1–5
export default [
  // Capítulo 1
  [
    ...
    'pues nuestro evangelio no llegó a ustedes solamente en palabras, sino también en poder, en el Espíritu Santo y con plena convicción. Ustedes bien saben que, cuando estuvimos entre ustedes, siempre buscamos su propio bien.',
    'Ustedes recibieron la palabra con gozo del Espíritu Santo, aún en medio de muchos sufrimientos, y llegaron a ser imitadores de nosotros y del Señor,',
    'con lo que llegaron a ser un ejemplo para todos los creyentes de Macedonia y de Acaya.',
    'Con ustedes como punto de partida, la palabra del Señor ha sido divulgada, y no sólo en Macedonia y Acaya, sino también en muchos otros lugares donde se sabe de la fe que ustedes tienen en Dios. Ya no es necesario que nosotros digamos nada,',
    'porque ellos mismos hablan de lo bien que ustedes nos recibieron, y cómo se apartaron de los ídolos y se volvieron al Dios vivo y verdadero, para servirlo',
