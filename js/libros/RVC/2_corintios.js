// Auto-generated from RVC.xml — 2 Corintios 1–13
export default [
  // Capítulo 1
  [
    'Yo, Pablo, apóstol de Jesucristo por la voluntad de Dios, y el hermano Timoteo, saludamos a la iglesia de Dios que está en Corinto, con todos los santos que están en toda Acaya.',
    'Que la gracia y la paz de Dios nuestro Padre, y del Señor Jesucristo, sean con todos ustedes.',
    'Bendito sea el Dios y Padre de nuestro Señor Jesucristo, Padre de misericordias y Dios de toda consolación,',
    'quien nos consuela en todas nuestras tribulaciones, para que también nosotros podamos consolar a los que están sufriendo, por medio de la consolación con que nosotros somos consolados por Dios.',
    ...
    'Porque no les escribimos nada que no pudieran leer y entender, y espero que al final puedan comprenderlo todo,',
    'así como ya en parte han entendido que pueden estar orgullosos de nosotros, y que nosotros estaremos orgullosos de ustedes en el día del Señor Jesús.',
    ...
    'Y es Dios el que nos confirma con ustedes en Cristo, y es Dios el que nos ha ungido,',
    'y es Dios el que también nos ha marcado con su sello, y el que, como garantía, ha puesto al Espíritu en nuestros corazones.',
  ...
  [
    ...
    'Era tanto el dolor y la angustia de mi corazón que, al escribirles, lo hice con muchas lágrimas. Pero no lo hice para entristecerlos, sino para que comprendieran el gran amor que les tengo.',
  ...
  [
    ...
    'y no sólo con su llegada, sino también con el consuelo que él había recibido de parte de ustedes, pues nos habló del gran afecto que recibió por parte de ustedes, así como de su profunda tristeza y de su preocupación por mí, lo cual me hizo alegrarme aún más.',
    ...
    '¡Fíjense! Esta tristeza que provino de Dios, ¡produjo en ustedes preocupación, el deseo de disculparse, indignación, temor, vehemencia, celo, y deseos de hacer justicia! Es evidente que en este asunto ustedes no tuvieron la culpa.',
    'Y aunque yo les escribí, no lo hice por el que cometió el agravio, ni por el que lo padeció, sino para que se hiciera evidente la preocupación que tenemos por ustedes delante de Dios.',
    'Por eso el consuelo de ustedes ha sido nuestro propio consuelo. Pero más nos alegró el ver a Tito tan feliz porque su espíritu fue confortado por todos ustedes.',
    'Yo me había jactado de ustedes con él, y no he quedado mal. Y así como en todo les hemos hablado con la verdad, también resultaron ciertos los elogios que hice ante Tito acerca de ustedes.',
  ...
  [
    ...
    'Ustedes se fijan sólo en la apariencia de las cosas. Pero si alguno está convencido de que es de Cristo, piense bien en esto que le digo: que así como él es de Cristo, también nosotros somos de Cristo.',
    ...
    'Hay quienes dicen que mis cartas son duras y fuertes, pero que mi presencia física es débil y que mis palabras no valen nada.',
  ...
  [
    ...
    'y sé que ese hombre (sólo Dios sabe si esto ocurrió físicamente o no),',
    'fue arrebatado al paraíso, donde oyó palabras inefables que a ningún hombre se le permite pronunciar.',
    'De ese hombre puedo jactarme; pero de mí mismo, sólo me jactaré de mis debilidades.',
    'Sin embargo, no sería insensato de mi parte el querer jactarme, porque estaría diciendo la verdad; pero prefiero no hacerlo, para que nadie piense de mí más de lo que ve u oye de mí.',
    ...
    'Al jactarme, me he portado como un necio; pero ustedes me han obligado a hacerlo así. Aunque no soy nadie, yo debía haber sido alabado por ustedes, ya que en nada he sido menos que esos grandes apóstoles.',
    ...
    'Ya estoy dispuesto a visitarlos por tercera vez, y tampoco esta vez les seré una carga, porque no ando tras lo que es de ustedes, sino tras de ustedes mismos. No son los hijos los que deben juntar tesoros para los padres; son los padres los que deben juntar tesoros para los hijos.',
    ...
    '¿Acaso los engañé mediante alguno de los que he enviado a ustedes?',
    'Rogué a Tito que los visitara, y con él envié al hermano. ¿Acaso Tito los engañó? ¿Qué, no hemos actuado con el mismo espíritu y de la misma manera?',
    ...
    'Mucho me temo que, cuando llegue, no los encuentre como quisiera encontrarlos, y que tampoco ustedes me encuentren así. Me temo que entre ustedes hay pleitos, envidias, enojos, divisiones, calumnias, chismes, insolencias y desórdenes.',
    'También me temo que, cuando vuelva, Dios me humille ante ustedes, y que tal vez tenga que llorar por muchos de los que antes han pecado y no se han arrepentido de la inmundicia, ni de la inmoralidad sexual y el libertinaje a que se han entregado.'
  ],
  // Capítulo 13
  [
    'Ésta será la tercera vez que los visite. Todo asunto se resolverá por el testimonio de dos o tres testigos.',
    'Ya lo he dicho antes y, como si estuviera presente, vuelvo a decirlo: aunque ahora me encuentre lejos, les digo a los que antes pecaron, y a todos los demás, que en caso de volver, esta vez no seré indulgente.',
    ...
    'y si pedimos a Dios que ustedes no hagan nada malo, no es para demostrar que nosotros pasamos la prueba, sino para que ustedes hagan lo bueno, aun cuando parezca que nosotros no pasamos la prueba.',
    'Nosotros nada podemos hacer contra la verdad, sino a favor de la verdad.',
    'Por eso nos alegramos de que nosotros seamos débiles y ustedes fuertes, y hasta oramos para que ustedes sean perfectos.',
    'Por eso les escribo ahora que estoy lejos, para no ser severo cuando esté entre ustedes, ciñéndome a la autoridad que el Señor me ha dado, que es para edificar y no para destruir.',
    ...
    'Todos los santos les mandan saludos.',
