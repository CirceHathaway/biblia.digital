// Auto-generated from RVC.xml — 2 Reyes 1–25
export default [
  // Capítulo 1
  [
    'Después de la muerte de Ajab, Moab se rebeló contra Israel.',
    'Y Ocozías, que se había caído desde la ventana de una sala de su palacio de Samaria, desde su lecho de dolor mandó mensajeros para consultar a Baal Zebub, dios de Ecrón, pues quería saber si recuperaría la salud.',
    'Pero el ángel de Dios le dijo a Elías el tisbita: «Ve al encuentro de los mensajeros del rey de Samaria, y diles: “¿Ya olvidaron que Israel tiene un Dios poderoso? ¿Por qué van a consultar a Baal Zebub, dios de Ecrón?”',
    'Así ha dicho el Señor: “No te vas a levantar de tu cama, sino que definitivamente morirás.”» Elías se fue a su encuentro.',
    'Y cuando los mensajeros volvieron, el rey les preguntó: «¿Por qué regresaron?»',
    'Y ellos respondieron: «Encontramos a un profeta que nos dijo: “Regresen con el rey y díganle: Así ha dicho el Señor: ¿Acaso no hay Dios en Israel? ¿Por qué consultas a Baal Zebub, dios de Ecrón? Por eso no te vas a levantar de tu cama, sino que definitivamente morirás.”»',
    ...
    'Enseguida el rey mandó a un capitán con cincuenta soldados a buscar a Elías, que estaba sentado en la cumbre del monte. El capitán subió a verlo, y le dijo: «Varón de Dios, el rey te pide que bajes.»',
    'Pero Elías le respondió al capitán: «Si soy un varón de Dios, que caiga fuego del cielo y te consuma con tus cincuenta soldados.» Al instante cayó fuego del cielo, y consumió al capitán y a sus cincuenta soldados.',
    'Entonces el rey envió a otro capitán con otros cincuenta soldados, y éste le dijo lo mismo: «Varón de Dios, el rey te pide que bajes pronto.»',
    'Y Elías respondió: «Si soy un varón de Dios, que caiga fuego del cielo y te consuma con tus cincuenta soldados.» Y al instante cayó fuego del cielo, y consumió al capitán y a sus cincuenta soldados.',
    'Pero el rey volvió a enviar a un tercer capitán, también con cincuenta soldados, y cuando éste estuvo frente a Elías, se puso de rodillas y le dijo: «Varón de Dios, te ruego que me perdones la vida, y la de estos cincuenta siervos tuyos.',
    ...
    'Entonces el ángel de Dios le dijo a Elías: «No tengas miedo. Puedes ir con él.» Y Elías bajó del monte y fue a ver al rey.',
    'Cuando llegó ante él, le dijo: «Tú enviaste mensajeros a consultar a Baal Zebub, dios de Ecrón. ¿Acaso no hay Dios en Israel, a quien puedes consultar? Por eso, no te vas a levantar de tu cama, sino que definitivamente morirás.»',
    ...
    'Todos los hechos de Ocozías se hallan registrados en el libro de las crónicas de los reyes de Israel.'
  ],
  // Capítulo 2
  [
    ...
    '«Dios me está enviando a Betel. Tú quédate aquí.» Pero Eliseo le respondió: «Juro por el Señor y por tu vida, que no te voy a dejar.» Así que los dos se fueron a Betel.',
    'Pero en el camino se encontraron con los profetas de Betel, y éstos le preguntaron a Eliseo: «¿Ya sabes que hoy el Señor va a quitarte a tu maestro?» Eliseo les respondió: «Sí, ya lo sé, pero ustedes no digan nada.»',
    'Entonces Elías le volvió a decir: «Eliseo, quédate aquí, porque el Señor me está enviando a Jericó.» Pero Eliseo le respondió: «Juro por el Señor y por tu vida, que no te voy a dejar.» Y los dos se fueron a Jericó.',
    'En el camino se encontraron con los profetas de Jericó, y le preguntaron a Eliseo: «¿Ya sabes que hoy el Señor te va a quitar a tu maestro?» Eliseo les respondió: «Sí, ya lo sé, pero ustedes no digan nada.»',
    ...
    'En ese momento llegaron cincuenta profetas y se pararon a cierta distancia de ellos, mientras que Elías y Eliseo se quedaron junto al Jordán.',
    'Entonces Elías tomó su manto y lo dobló, y con él golpeó las aguas, y al instante éstas se abrieron, y los dos cruzaron el río en seco.',
    ...
    'Mientras ellos seguían hablando y caminando, apareció un carro envuelto en llamas, con sus caballos de fuego, y los separó. En ese momento, Elías ascendió al cielo en medio de un torbellino.',
    ...
    'Entonces tomó el manto, golpeó con él las aguas, y dijo: «¿Dónde está el Señor, el Dios de Elías?» En cuanto Eliseo golpeó las aguas, éstas se abrieron, y Eliseo cruzó el río en seco.',
    ...
    'Luego dijeron: «En Jericó tenemos cincuenta hombres aguerridos. Ellos pueden ir a buscar a tu maestro, pues tal vez el espíritu del Señor lo levantó y lo ha dejado en algún monte o en algún valle.» Eliseo les pidió que no hicieran nada,',
    ...
    'Cuando regresaron, vieron a Eliseo, que estaba en Jericó. Y éste les dijo: «¿Acaso no les pedí que no fueran a buscarlo?»',
    ...
    'Y tal como lo dijo Eliseo, ese día las aguas de Jericó quedaron sanas, hasta el día de hoy.',
    'Tiempo después, Eliseo salió de allí y se dirigió a Betel. En el camino salieron de la ciudad unos muchachos que burlones le gritaban: «¡Sube, viejo calvo, sube!»',
  ...
  [
    ...
    'Sin embargo, se entregó a los mismos pecados con que Jeroboán hijo de Nabat hizo pecar a Israel, y no se apartó de ellos.',
  ...
  [
    ...
    'Entonces ella fue a contárselo al varón de Dios, y éste dijo: «Ahora ve y vende el aceite, y págale a tu acreedor, y tú y tus hijos vivan de lo que les quede.»',
  ...
  // Capítulo 5
  [
    'Cierto general del ejército del rey de Siria, llamado Namán, era un hombre muy importante. Su señor lo tenía en alta estima porque, por medio de él, que era un guerrero muy valiente, el Señor había dado la victoria a Siria. Pero Namán era leproso.',
    ...
    'También llevó consigo cartas para el rey de Israel, las cuales decían: «Cuando estas cartas lleguen a tus manos, por ellas sabrás que yo estoy enviándote a mi siervo Namán, para que lo sanes de su lepra.»',
    'En cuanto el rey de Israel leyó las cartas, se rasgó las vestiduras y dijo: «¿Acaso soy Dios, capaz de dar la vida y de quitarla, para que éste me envíe un hombre para que lo sane de su lepra? Como pueden ver, sólo está buscando un pretexto para atacarme.»',
    'Como Eliseo, el varón de Dios, se enteró de que el rey de Israel se había rasgado las vestiduras, mandó a decirle: «¿Por qué te has rasgado las vestiduras? ¡Deja que venga a verme! ¡Así sabrá que en Israel hay profeta!»',
    'Y Namán fue a ver a Eliseo, y al llegar a la puerta de su casa se detuvo, con sus caballos y con su carro de guerra.',
    ...
    '¿Acaso los ríos Abana y Farfar, de Damasco, no son mejores que todas las aguas de Israel? ¿Y acaso no quedaré también limpio si me lavo en ellos?» Y muy enojado se fue de allí.',
    'Pero sus criados se le acercaron y le dijeron: «¡Ay, señor! Si el profeta te hubiera mandado hacer algo más impresionante, ¿acaso no lo habrías hecho? ¡Pues con más razón si te ha dicho: “Lávate, y quedarás limpio!”»',
    'Namán fue al Jordán y se zambulló siete veces, conforme a la palabra del varón de Dios, y al instante quedó limpio: Su piel se volvió tan suave como la de un niño.',
    'Entonces él y toda su compañía volvieron a donde estaba el varón de Dios, y una vez delante de él dijo: «Ahora reconozco que no hay más Dios en toda la tierra, que en Israel. Por favor, acepta algún presente de este siervo tuyo.»',
    ...
    'Entonces Namán dijo: «Entonces voy a pedirte concedas a este siervo tuyo llevarme de esta tierra la carga de un par de mulas. Porque de aquí en adelante este siervo tuyo no ofrecerá holocaustos ni sacrificios a otros dioses, sino sólo al Señor.',
    'Y anticipadamente pido al Señor perdonar a este siervo suyo si, cuando mi señor el rey entre en el templo de Rimón para adorar allí, y se apoye en mi brazo, yo también llego a inclinarme en ese templo. Si llego a hacerlo, ¡que el Señor me perdone!»',
    'Eliseo le dijo que podía irse tranquilo. Y Namán se fue. Pero apenas habría recorrido una distancia de media legua',
    'cuando Guejazí, el criado de Eliseo, varón de Dios, pensó: «¡Vaya! Mi señor no permitió que este sirio, Namán, le regalara lo que trajo. ¡Pues juro por el Señor, que ahora mismo voy a ir tras él para pedirle que me dé algo!»',
    ...
    'Guejazí dijo que sí, y añadió: «Mi señor me envía a decirte que del monte de Efraín acaban de llegar dos profetas jóvenes, y te ruega darle para ellos tres mil monedas de plata y dos vestidos nuevos.»',
    'Namán contestó: «No sólo tres mil. Te ruego que le lleves seis mil.» Y Namán insistió en que Guejazí aceptara dos bolsas, cada una con tres mil monedas de plata, y dos vestidos nuevos; luego ordenó a dos de sus criados echarse todo esto a cuestas y llevarlo delante de Guejazí.',
    ...
    'Entonces Eliseo le dijo: «¿Crees que yo no estaba allí, en espíritu, cuando aquel hombre bajó de su carro a recibirte? Pero éste no es el momento de recibir plata y vestidos, ni olivares, viñas, ovejas, bueyes, siervos y siervas.',
  ...
  [
    ...
    'Y así, se fue al Jordán con ellos, y cuando llegaron allá cortaron la madera.',
    ...
    'El varón de Dios le preguntó: «¿Y dónde cayó?» Cuando aquél le mostró el lugar, Eliseo cortó un palo y lo echó al agua, con lo que hizo que el hacha flotara;',
    'entonces le ordenó que recogiera el hacha, y aquél extendió la mano y la sacó del agua.',
    ...
    'Entonces el rey de Israel envió gente al lugar señalado por el varón de Dios, y éste una y otra vez advirtió al rey que debía tener cuidado.',
    ...
    'el rey mandó allá soldados de caballería, y carros de combate, y un gran ejército, los cuales llegaron de noche y sitiaron la ciudad.',
    ...
    'Y Eliseo le dijo: «No tengas miedo, que son más los que están con nosotros que los que están con ellos.»',
    'Acto seguido, Eliseo oró con estas palabras: «Señor, te ruego que abras los ojos de mi siervo, para que vea.» El Señor abrió los ojos del criado, y éste miró a su alrededor y vio que en torno a Eliseo el monte estaba lleno de gente de a caballo, y de carros de fuego.',
    ...
    'Luego, Eliseo les dijo: «Éste no es el camino correcto, ni esta ciudad es la que buscan. Síganme, y yo los llevaré hasta el hombre que buscan.» Y los llevó a Samaria.',
    'Y cuando llegaron allá, Eliseo dijo: «Señor, ábreles los ojos, para que puedan ver.» El Señor les abrió los ojos, y entonces vieron que se hallaban en medio de Samaria.',
    'Al verlos, el rey de Israel le preguntó a Eliseo: «¿Debo matarlos, padre mío?»',
    'Y Eliseo le dijo: «No, no los mates. ¿Acaso matarías a quienes con tu espada y con tu arco hicieras prisioneros? Más bien, dales pan y agua, y que coman y beban, y se vayan de regreso con sus amos.»',
    ...
    'Sin embargo, el rey añadió: «¿Qué te pasa?» Y ella respondió: «Esta mujer me dijo: “¡Venga acá tu hijo! ¡Vamos a comérnoslo hoy, y mañana nos comeremos el mío!”',
    'Entonces cocinamos a mi hijo, y nos lo comimos. Al día siguiente yo le dije: “¡Ahora venga acá tu hijo! ¡Vamos a comérnoslo!” ¡Pero ella lo ha escondido!»',
    'Cuando el rey oyó las palabras de aquella mujer, se rasgó las vestiduras y así pasó por la muralla; entonces el pueblo pudo ver que por dentro traía puesto un cilicio.',
    'Y el rey exclamó: «¡Que Dios me castigue, y más aun, si no le corto hoy mismo la cabeza a Eliseo hijo de Safat!»',
  ...
  [
    ...
    'La mujer se dispuso a acatar las instrucciones del varón de Dios, y junto con su familia se fue al país de los filisteos, y allá vivió siete años.',
    ...
    'Y mientras Guejazí le contaba al rey cómo Eliseo le había devuelto la vida a un muerto, la madre del hijo resucitado por Eliseo llegó a pedirle al rey la devolución de su casa y de sus tierras. Guejazí exclamó entonces: «Su Majestad, ¡ésta es la mujer, y éste es su hijo, al que Eliseo devolvió la vida!.»',
    ...
    'el rey le dijo a Jazael: «Ve a recibir al varón de Dios, y llévale un presente. Consulta por medio de él al Señor, y pregúntale si yo sanaré de esta enfermedad.»',
    ...
    'Jazael objetó: «Pero, ¿quién es tu siervo, si no un perro? ¿Cómo podría hacer algo tan formidable?» Y Eliseo respondió: «El Señor me ha revelado que tú vas a ser rey de Siria.»',
    'Cuando Jazael se fue y volvió con su amo, éste le preguntó: «¿Qué te ha dicho Eliseo?» Y Jazael respondió: «Me dijo que ciertamente sanarás.»',
    ...
    'En los días de Jorán, Edom se rebeló contra el dominio de Judá, y nombró su propio rey.',
    ...
    'Sin embargo, Edom se liberó del dominio de Judá hasta el día de hoy, y también Libna se rebeló en el mismo tiempo.',
    'Los demás hechos de Jorán, y todas sus obras, se hallan registrados en el libro de las crónicas de los reyes de Judá.',
    'Cuando Jorán se reunió con sus antepasados, fue sepultado con ellos en la ciudad de David, y en su lugar reinó Ocozías, su hijo.',
    'Jorán hijo de Ajab tenía doce años de reinar sobre Israel cuando Ocozías hijo de Jorán comenzó a reinar sobre Judá.',
    ...
    'Ocozías se unió con Jorán hijo de Ajab, y juntos marcharon a Ramot de Galaad para pelear contra el rey Jazael de Siria, pero los sirios hirieron a Jorán,',
    'por lo que el rey Jorán volvió a Jezrel para curarse las heridas que los sirios le hicieron frente a Ramot, cuando peleó contra el rey Jazael de Siria. Por eso Ocozías hijo de Jorán, rey de Judá, fue a visitar a Jorán hijo de Ajab en Jezrel, pues estaba enfermo.'
  ],
  // Capítulo 9
  [
    ...
    'Al llegar allá, irás a ver a Jehú, el hijo de Josafat y nieto de Nimsi. Cuando entres a su casa, haz que se levante de entre sus hermanos, y llévalo a otro cuarto.',
    ...
    'El joven profeta se fue entonces a Ramot de Galaad.',
    ...
    'Jehú se levantó y entró en casa; entonces el profeta derramó el aceite sobre su cabeza y le dijo: «Así ha dicho el Señor, Dios de Israel: “Yo, el Señor, te he ungido para que reines sobre Israel, mi pueblo.',
    'Vas a acabar con la dinastía de tu señor Ajab, para que yo vengue la sangre de todos mis siervos, incluidos los profetas, que Jezabel ha asesinado.',
    'Toda la dinastía de Ajab será destruida. Acabaré en Israel con todos los varones de Ajab, lo mismo esclavos que libres.',
    'Haré con la dinastía de Ajab lo mismo que hice con la dinastía de Jeroboán hijo de Nabat y con la dinastía de Basá hijo de Ajías.',
    ...
    'Y cuando Jehú salió, los oficiales de su amo le preguntaron: «¿Todo está bien? ¿Para qué vino a verte ese loco?» Y Jehú les dijo: «Ustedes ya saben cómo es esta gente, y las cosas que dicen.»',
    ...
    'Fue así como Jehú, el hijo de Josafat y nieto de Nimsi, conspiró contra Jorán, que por causa del rey Jazael de Siria estaba con todos los israelitas protegiendo la ciudad de Ramot de Galaad,',
    'aunque había regresado a Jezrel para curarse las heridas que los sirios le habían hecho en la batalla contra el rey Jazael de Siria. Jehú dijo: «Si ustedes están de acuerdo, que nadie escape de la ciudad, para que la noticia no se sepa en Jezrel.»',
    'Dicho esto, Jehú montó en su carro y se dirigió a Jezrel, donde Jorán yacía enfermo. Allí también estaba el rey Ocozías de Judá, que había ido a visitar a Jorán.',
    ...
    'Se envió entonces a otro jinete, el cual llegó hasta ellos y dijo: «El rey manda a preguntar si vienen en son de paz.» Y Jehú también le respondió: «¿De qué paz me hablas? ¡Tú pásate a mis filas!»',
    ...
    'Jorán ordenó entonces que prepararan su carro. Y cuando estuvo listo, partieron juntos el rey Jorán de Israel y el rey Ocozías de Judá, aunque cada uno en su carro, y fueron al encuentro de Jehú, al que hallaron en el campo que había pertenecido a Nabot de Jezrel.',
    'Cuando Jorán vio a Jehú, exclamó: «¿Vienes en son de paz, Jehú?» Y éste respondió: «¿Y qué paz puede haber, con tantas fornicaciones y hechicerías de tu madre Jezabel?»',
    'Entonces Jorán dio vuelta a su carro y emprendió la huida, mientras decía a Ocozías: «¡Nos han traicionado, Ocozías!»',
    ...
    'Jehú le dijo a Bidcar, su capitán: «Tómalo, y arrójalo en un extremo del campo que fue de Nabot de Jezrel. Acuérdate que cuando tú y yo íbamos juntos con la gente de Ajab, su padre, el Señor pronunció esta sentencia contra él, cuando dijo:',
    '“Yo, el Señor, vi ayer aquí la sangre de Nabot, y la sangre de sus hijos. Por eso aquí, en este campo, te daré tu merecido. Yo soy el Señor.” Así que, conforme a la palabra del Señor, tómalo y arrójalo en el que fue campo de Nabot.»',
    'Cuando el rey Ocozías de Judá vio esto, huyó por el camino de Bet Hagán, seguido de Jehú, que decía: «Hieran también a éste que va en el carro.» Y en la subida de Gur, junto a Ibleam, Ocozías fue herido. Por eso huyó a Meguido, donde murió.',
    'Sus oficiales lo llevaron a Jerusalén en un carro, y allá, en la ciudad de David, lo sepultaron en su propio sepulcro, junto a sus antepasados.',
    'Ocozías comenzó a reinar sobre Judá en el undécimo año del reinado de Jorán hijo de Ajab.',
    'Después Jehú se fue a Jezrel, y cuando Jezabel lo supo, se pintó los ojos con antimonio y se atavió la cabeza, y se asomó a la ventana.',
    'En el momento en que Jehú entró a la ciudad, ella gritó: «¿Cómo le va a Zimri, asesino de su rey?»',
    ...
    'Luego, entró y comió y bebió, y más tarde dijo: «Ahora vayan a ver a esa maldita mujer, y sepúltenla, pues es hija de un rey.»',
    'Pero cuando fueron para sepultarla, no hallaron de ella más que la calavera, los pies y las palmas de las manos.',
    'Volvieron entonces a decirle esto a Jehú, y él sentenció: «Ésta es la palabra de Dios, pronunciada por medio de su siervo, Elías el tisbita, cuando dijo: “En el campo de Jezrel los perros se comerán el cuerpo de Jezabel.',
  ...
  [
    ...
    'y en cuanto Jehú llegó a Samaria mató a todos los familiares de Ajab que habían quedado en Samaria. Los mató hasta exterminarlos, conforme a la palabra del Señor anunciada por Elías.',
  ...
  [
    ...
    'Pero Yoseba, que era hija del rey Jorán y hermana de Ocozías, se llevó a Joás hijo de Ocozías y, sin que nadie la viera, lo escondió de Atalía en una alcoba, junto con su nodriza. Así lo libró de que lo mataran junto con los otros hijos del rey.',
    'Y Ocozías estuvo escondido seis años en el templo del Señor, junto con su nodriza, mientras Atalía era la reina del país.',
    'Pero en el séptimo año Joyadá convocó a los jefes de centenas y a los capitanes, y a la gente de la guardia, y los llevó al templo del Señor, donde bajo juramento hizo alianza con ellos, después de lo cual les mostró al hijo del rey',
    ...
    'Las dos terceras partes de ustedes que están libres el día de reposo tendrán a su cargo la vigilancia del templo del Señor y del rey.',
    ...
    'Los jefes de centenas se reunieron con el sacerdote Joyadá e hicieron todo lo que el sacerdote Joyadá les ordenó; cada uno de ellos reunió a su gente, es decir, tanto a los que estaban de servicio en día de reposo como a los que estaban libres en día de reposo.',
    'El sacerdote entregó a los jefes de centenas las lanzas y los escudos que habían sido del rey David, y que estaban en el templo del Señor.',
    'Los de la guardia se formaron, desde el lado derecho hasta el lado izquierdo del templo, y junto al altar y el templo, y en derredor del rey. Cada uno tenía en sus manos sus armas.',
    ...
    'Cuando vio que el rey estaba junto a la columna, como era la costumbre, y que los príncipes y los trompeteros estaban junto al rey, y que todo el pueblo del país se regocijaba y tocaba las trompetas, se rasgó las vestiduras y a voz en cuello gritó: «¡Traición, traición!»',
    ...
    'Y toda la gente del país entró en el templo de Baal, y lo derribaron; también destruyeron del todo sus altares y sus imágenes, y delante de los altares mataron a Matán, que era sacerdote de Baal. Luego, el sacerdote apostó una guarnición en el templo del Señor.',
    'Después tomó a los jefes de centenas, a los capitanes y a la guardia, y a todo el pueblo del país, y llevaron al rey desde el templo del Señor, siguiendo el camino que va de la puerta de la guardia al palacio del rey, y el rey se sentó en el trono real.',
  ...
  [
    ...
    'Todo el tiempo que el sacerdote Joyadá dirigió a Joás, éste hizo lo recto a los ojos del Señor.',
    'Sin embargo, los altares en los montes no se quitaron, porque el pueblo aún sacrificaba y quemaba incienso allí.',
    'Un día, Joás dijo a los sacerdotes: «Todo el dinero consagrado que el pueblo suele traer al templo del Señor, y el dinero del rescate de cada persona, según está estipulado, y el dinero que cada uno trae voluntariamente al templo del Señor,',
    ...
    'Pero llegó el año veintitrés del reinado de Joás, y los sacerdotes aún no habían reparado las grietas del templo.',
    'Entonces el rey Joás llamó al sumo sacerdote Joyadá y a los sacerdotes, y les dijo: «¿Por qué no han reparado las grietas del templo? De ahora en adelante no van a recibir más dinero de sus familiares, sino que lo darán para reparar las grietas del templo.»',
    'Y los sacerdotes aceptaron no tomar más el dinero del pueblo, ni tener el cargo de reparar las grietas del templo.',
    'Entonces el sumo sacerdote Joyadá tomó un cofre, le hizo un agujero en la tapa, y lo puso junto al altar, a la derecha de la entrada al templo del Señor, y los sacerdotes que custodiaban la puerta ponían allí todo el dinero que se traía al templo.',
    ...
    'albañiles y canteros, y para comprar la madera y la piedra de cantería para reparar las grietas del templo del Señor, y para todo lo que se gastaba para reparar el templo.',
    ...
    'Lo hirieron sus oficiales Josacar hijo de Simeat y Jozabad hijo de Somer, y así murió. Lo sepultaron con sus antepasados en la ciudad de David, y en su lugar reinó su hijo Amasías.'
  ],
  // Capítulo 13
  [
    'Joás hijo de Ocozías, rey de Judá, tenía veintitrés años de reinar cuando Joacaz hijo de Jehú comenzó a reinar sobre Israel en Samaria, y reinó diecisiete años.',
    'Pero hizo lo malo a los ojos del Señor, y siguió cometiendo los mismos pecados con que Jeroboán hijo de Nabat hizo pecar a Israel, y no se apartó de ellos.',
    ...
    'En efecto, el Señor envió un salvador a Israel, que los libró del poder de los sirios; así los israelitas volvieron a habitar en sus tiendas, como antes.',
    ...
    'Joacaz no contaba ya con más de cincuenta soldados de caballería, diez carros de combate y diez mil soldados de infantería, pues el rey de Siria había desbaratado el ejército y lo había hecho morder el polvo.',
    'El resto de los hechos de Joacaz, y todas sus obras y hazañas, se halla registrado en el libro de las crónicas de los reyes de Israel.',
    'Cuando Joacaz se reunió con sus antepasados, lo sepultaron en Samaria, y en su lugar reinó su hijo Joás.',
    'Joás tenía treinta y siete años de reinar sobre Judá cuando Joás hijo de Joacaz comenzó a reinar sobre Israel, y reinó dieciséis años en Samaria.',
    'Pero hizo lo malo a los ojos del Señor. No se apartó de todos los pecados con que Jeroboán hijo de Nabat hizo pecar a Israel, sino que siguió cometiéndolos.',
    'Los demás hechos de Joás, y todas sus obras, y su denodada lucha contra el rey Amasías de Judá, se hallan registrados en el libro de las crónicas de los reyes de Israel.',
    'Cuando Joás se reunió con sus antepasados, fue sepultado en Samaria con los reyes de Israel. Jeroboán lo sucedió en el trono.',
    'Eliseo cayó enfermo, y de esa enfermedad murió. El rey Joás fue a visitarlo, y con lágrimas en los ojos dijo: «¡Padre mío, padre mío! ¡Tú has sido para Israel su caballería y sus carros de combate!»',
    'Eliseo le dijo: «Toma un arco y unas flechas.» Joás tomó el arco y las flechas,',
    'y entonces Eliseo le dijo: «Rey de Israel, sujeta el arco con tus manos.» Joás así lo hizo. Entonces Eliseo puso sus manos sobre las manos del rey,',
    ...
    'Entonces el varón de Dios se enojó con él, y le dijo: «Si hubieras golpeado el suelo cinco o seis veces, habrías derrotado a Siria hasta su último hombre. Pero ahora sólo derrotarás a Siria tres veces.»',
    'Eliseo murió, y lo sepultaron. Ese mismo año, unas bandas de bandoleros moabitas incursionaron en el país.',
    'Y sucedió que, mientras se enterraba un cadáver, de pronto apareció una banda de esos bandoleros; entonces los enterradores dejaron caer el cadáver en el sepulcro de Eliseo, y en cuanto el cadáver tocó los huesos de Eliseo, cobró vida y se puso de pie.',
    'El rey Jazael de Siria afligió a Israel durante todo el reinado de Joacaz.',
    'Pero el Señor vio esto y tuvo misericordia; se compadeció de su pueblo por causa de su pacto con Abrahán, Isaac y Jacob, y no quiso destruirlos ni arrojarlos de su presencia, hasta el día de hoy.',
    'A la muerte del rey Jazael de Siria, reinó en su lugar su hijo Ben Adad.',
    'Entonces Joás hijo de Joacaz retomó las ciudades que Jazael le había ganado en combate a Joacaz, su padre. Tres veces derrotó Joás a Ben Adad hijo de Jazael, y así recuperó las ciudades para Israel.'
  ],
  // Capítulo 14
  [
    'Joás hijo de Joacaz tenía dos años de reinar en Israel cuando Amasías hijo de Joás comenzó a reinar en Judá.',
    'Amasías tenía entonces veinticinco años, y reinó en Jerusalén veintinueve años. Su madre se llamaba Yoadán, y era de Jerusalén.',
    'Amasías hizo lo recto a los ojos del Señor, como lo había hecho Joás, su padre, aunque no como su antepasado David.',
    ...
    'Cuando Amasías se afirmó en el trono, mató a los siervos que habían dado muerte al rey, su padre,',
    'pero no mató a los hijos de éstos, con lo que cumplió lo que está escrito en el libro de la ley de Moisés, donde el Señor claramente dice: «No se matará a los padres por culpa de los hijos, ni a los hijos por culpa de los padres, sino que cada uno morirá por causa de su propio pecado.»',
    'Amasías también mató a diez mil edomitas en el Valle de la Sal, y en una batalla conquistó Sela, y la llamó Yoctel, que hasta el día de hoy es su nombre.',
    ...
    'El rey Joás de Israel respondió al rey Amasías de Judá con esta parábola: «Una vez, en las montañas del Líbano, un cardo envió a decir al cedro: “Dale tu hija a mi hijo, para que sea su mujer.” Pero pasaron las fieras del Líbano, y pisotearon el cardo.',
    'Es verdad que has derrotado a Edom, y que el corazón se te ha hinchado; por mí, puedes seguir vanagloriándote, pero dentro de tu casa. ¿Para qué meterte en problemas? ¿Quieres que tú y Judá salgan derrotados?»',
    'Amasías no se dio por aludido. Entonces el rey Joás de Israel se puso en marcha a Bet Semes, que está en Judá, y allí se vieron las caras el rey Amasías de Judá y él.',
    'Y los de Judá fueron derrotados por los de Israel, y todos salieron huyendo a su campamento.',
    'En Bet Semes, el rey Joás de Israel tomó cautivo al rey Amasías de Judá, que era hijo de Joás y nieto de Ocozías. Luego se dirigió a Jerusalén y derribó cuatrocientos codos de su muralla, desde la puerta de Efraín hasta la puerta de la esquina;',
    'se llevó todo el oro y la plata, y todos los utensilios que fueron hallados en el templo del Señor y en los tesoros del palacio real, tomó como rehenes a los hijos del rey, y después de eso volvió a Samaria.',
    'Los demás hechos de Joás, y sus hazañas, y su lucha contra el rey Amasías de Judá, se hallan registrados en el libro de las crónicas de los reyes de Israel.',
    ...
    'Después de la muerte de Joás hijo de Joacaz, rey de Israel, Amasías hijo de Joás, rey de Judá, vivió quince años.',
    'Los demás hechos de Amasías, se hallan registrados en el libro de las crónicas de los reyes de Judá.',
    'Como en Jerusalén hubo quienes conspiraron contra él, huyó a Laquis; pero fue perseguido hasta Laquis, y allá lo mataron.',
    'Luego lo trajeron en caballos, y lo sepultaron en Jerusalén, la ciudad de David, junto con sus antepasados.',
    'Entonces todo el pueblo de Judá tomó a Azarías, que tenía dieciséis años, y lo proclamaron rey en lugar de Amasías, su padre.',
    'Después de que el rey se reunió con sus antepasados, Azarías reconstruyó Elat y la restituyó a Judá.',
    'Amasías hijo de Joás tenía quince años de reinar sobre Judá cuando Jeroboán hijo de Joás comenzó a reinar sobre Israel, y reinó cuarenta y un años en Samaria.',
    ...
    'Conforme a la palabra que el Señor, Dios de Israel, pronunció por medio de su siervo Jonás hijo de Amitay, el profeta de Gat Jéfer, Jeroboán restauró los límites de Israel, desde la entrada de Jamat hasta el mar del Arabá.',
    ...
    'Además, el Señor no había determinado borrar de este mundo el nombre de Israel; por eso los salvó por medio de Jeroboán hijo de Joás.',
    'Los demás hechos de Jeroboán, y todas sus obras y hazañas, y todas las batallas que libró, y cómo restituyó Damasco y Jamat, que habían pertenecido a Judá, al dominio de Israel, todo eso se halla registrado en el libro de las crónicas de los reyes de Israel.',
    'Cuando Jeroboán se reunió con sus antepasados, los reyes de Israel, en su lugar reinó su hijo Zacarías.'
  ],
  // Capítulo 15
  [
    'Jeroboán tenía veintisiete años de reinar sobre Israel cuando Azarías hijo de Amasías comenzó a reinar sobre Judá.',
    'Azarías tenía entonces dieciséis años, y reinó cincuenta y dos años en Jerusalén. Su madre se llamaba Jecolías, y era de Jerusalén.',
    'Azarías hizo lo recto a los ojos del Señor, tal y como lo había hecho Amasías, su padre.',
    ...
    'Pero el Señor hirió al rey con lepra, y estuvo leproso hasta el día de su muerte. Vivía en una casa aparte, y su hijo Yotán estaba a cargo del palacio y de gobernar al pueblo.',
    'Los demás hechos de Azarías, y todas sus obras, se hallan registrados en el libro de las crónicas de los reyes de Judá.',
    'Cuando Azarías fue a reunirse con sus antepasados, lo sepultaron en la ciudad de David, y en su lugar reinó su hijo Yotán.',
    'Azarías tenía treinta y ocho años de reinar sobre Judá cuando Zacarías hijo de Jeroboán comenzó a reinar sobre Israel, y reinó seis meses.',
    'Pero hizo lo malo a los ojos del Señor, tal y como lo habían hecho sus antepasados, pues no se apartó de los pecados con que Jeroboán hijo de Nabat hizo pecar a Israel.',
    'Salún hijo de Jabés conspiró contra él, y en presencia de su pueblo le quitó la vida y reinó en su lugar.',
    'Los demás hechos de Zacarías se hallan registrados en el libro de las crónicas de los reyes de Israel.',
    ...
    'Uzías tenía treinta y nueve años de reinar sobre Judá cuando Salún hijo de Jabés comenzó a reinar en Samaria, pero reinó sólo un mes',
    'porque Menajén hijo de Gadi salió de Tirsa para atacar a Samaria. En el ataque, Menajén hirió de muerte a Salún, y entonces reinó en su lugar.',
    'Los demás hechos de Salún, y la conspiración que tramó, se hallan registrados en el libro de las crónicas de los reyes de Israel.',
    'Menajén saqueó la ciudad de Tifesaj, y mató a todos los que estaban allí y en los alrededores, comenzando por la ciudad de Tirsa. Como no le habían abierto las puertas, saqueó la ciudad y abrió en canal a todas las mujeres que estaban embarazadas.',
    'Azarías tenía treinta y nueve años de reinar sobre Judá cuando Menajén hijo de Gadi comenzó a reinar sobre Israel, y reinó diez años en Samaria.',
    'Pero hizo lo malo a los ojos del Señor. Durante todo su reinado no se apartó de los pecados con que Jeroboán hijo de Nabat hizo pecar a Israel.',
    ...
    'Los demás hechos de Menajén, y todas sus obras, se hallan registrados en el libro de las crónicas de los reyes de Israel.',
    'Cuando Menajén fue a reunirse con sus antepasados, en su lugar reinó su hijo Pecajías.',
    'Azarías tenía cincuenta años de reinar sobre Judá cuando Pecajías hijo de Menajén comenzó a reinar sobre Israel, y reinó dos años en Samaria.',
    'Pero hizo lo malo a los ojos del Señor, pues no se apartó de los pecados con que Jeroboán hijo de Nabat hizo pecar a Israel.',
    'Pecaj hijo de Remalías, que era uno de sus capitanes, conspiró contra él y, apoyado por Argob y Arie, más cincuenta galaaditas, le quitó la vida en el palacio real de Samaria, y reinó en su lugar.',
    'Los demás hechos de Pecajías, y todas sus obras, se hallan registrados en el libro de las crónicas de los reyes de Israel.',
    'Azarías tenía cincuenta y dos años de reinar sobre Judá cuando Pecaj hijo de Remalías comenzó a reinar sobre Israel, y reinó veinte años en Samaria.',
    'Pero hizo lo malo a los ojos del Señor, pues no se apartó de los pecados con que Jeroboán hijo de Nabat hizo pecar a Israel.',
    'En los días del rey Pecaj de Israel, el rey Tiglat Piléser de Asiria llegó y tomó las ciudades de Iyón, Abel Betmacá, Yanoja, Cedes, Jazor, Galaad, Galilea, y toda la tierra de Neftalí, y a sus habitantes los llevó cautivos a Asiria.',
    'Yotán hijo de Uzías tenía veinte años de reinar cuando Oseas hijo de Elá conspiró contra Pecaj hijo de Remalías, y le quitó la vida y reinó en su lugar.',
    'Los demás hechos de Pecaj, y todas sus obras, se hallan registrados en el libro de las crónicas de los reyes de Israel.',
    'Yotán hijo de Uzías comenzó a reinar sobre Judá cuando Pecaj hijo de Remalías tenía dos años de reinar sobre Israel,.',
    'Cuando Yotán comenzó a reinar, tenía veinticinco años, y reinó dieciséis años en Jerusalén. Su madre se llamaba Jerusa, y era hija de Sadoc.',
    'Y Yotán hizo lo recto a los ojos del Señor, pues se condujo tal y como lo había hecho Uzías, su padre,',
    'y además construyó la puerta más alta del templo del Señor. Sin embargo, no fueron quitados los altares de los montes, sino que el pueblo siguió ofreciendo sacrificios y quemando incienso en ellos.',
    'Los demás hechos de Yotán, y todas sus obras, se hallan registrados en el libro de las crónicas de los reyes de Judá.',
    'Por esos días, el Señor comenzó a enviar contra Judá al rey Resín de Siria, y a Pecaj hijo de Remalías.',
    'Y cuando Yotán fue a reunirse con sus antepasados, fue sepultado con ellos en la ciudad de su antepasado David, y en su lugar reinó su hijo Ajaz.'
  ],
  // Capítulo 16
  [
    ...
    'Cuando comenzó a reinar, Ajaz tenía veinte años, y reinó dieciséis años en Jerusalén. Pero a diferencia de su antepasado David, no hizo lo recto a los ojos del Señor su Dios,',
    ...
    'Fue entonces cuando el rey de Edom recobró Elat para Edom, y expulsó de allí a los hombres de Judá. Entonces los edomitas vinieron a Elat, y hasta el día de hoy viven allí.',
    'Ajaz envió embajadores al rey Tiglat Piléser de Asiria, con este mensaje: «Yo soy tu siervo. Soy también tu hijo. Ven a defenderme del rey de Siria y del rey de Israel, que se han levantado en armas contra mí.»',
    ...
    'Después el rey Ajaz fue a Damasco para encontrarse con el rey Tiglat Piléser de Asiria. Allí el rey Ajaz se fijó en el altar que estaba en Damasco, y le envió al sacerdote Urías el diseño y la descripción exacta de ese altar.',
    ...
    'El rey Ajaz desmontó los tableros de las bases, y les quitó las fuentes; quitó también el mar que estaba sobre los bueyes de bronce, y lo puso sobre una base de piedra.',
  ...
  [
    ...
    'Pero hizo lo malo a los ojos del Señor, aunque no como los reyes de Israel anteriores a él.',
    'El rey Salmanasar de Asiria llegó y lo atacó, y Oseas fue hecho su siervo, y se le obligó a pagar tributo.',
    'Pero Oseas envió embajadores al rey So de Egipto, y dejó de pagar tributo al rey de Asiria, como lo hacía cada año; y cuando el rey de Asiria descubrió que Oseas conspiraba contra él, mandó aprehenderlo y le mantuvo cautivo en la cárcel.',
    'Luego, el rey de Asiria invadió todo el país y durante tres años mantuvo sitiada a Samaria.',
    'A los nueve años del reinado de Oseas el rey de Asiria capturó Samaria y a los israelitas se los llevó cautivos a Asiria, y los dejó en Jalaj y en Jabor, junto al río Gozán, y en las ciudades de los medos.',
    ...
    'Rindieron culto a los ídolos, de los cuales el Señor les había advertido: «Ustedes no deben hacer tales cosas.»',
    'El Señor amonestó a Israel y a Judá por medio de todos los profetas y de todos los videntes. Les dijo: «Apártense de sus malos caminos. Obedezcan mis mandamientos y mis ordenanzas, y sigan todas las leyes que yo prescribí a sus antepasados, y que les he dado a conocer por medio de mis siervos los profetas.»',
    ...
    'Desecharon los estatutos del Señor y el pacto que había hecho con sus antepasados, así como los testimonios que él les había prescrito, y siguieron a los dioses falsos, con lo que ellos mismos perdieron valor, y siguieron a las naciones a su alrededor, a pesar de que el Señor les había mandado que no las imitaran.',
    'Abandonaron todos los mandamientos del Señor su Dios, se hicieron imágenes fundidas de dos becerros, y también imágenes de Asera, y adoraron a todo el ejército de los cielos y rindieron culto a Baal.',
    ...
    'Cuando el Señor apartó a los israelitas de la dinastía de David, ellos proclamaron como su rey a Jeroboán hijo de Nabat, y Jeroboán apartó a Israel de la obediencia al Señor y los hizo cometer grandes pecados.',
    'Los israelitas cometieron todos los pecados que cometió Jeroboán, sin apartarse de ellos,',
    'hasta que el Señor apartó de su presencia a Israel, tal y como él lo había anunciado por medio de todos los profetas, sus siervos. Fue así como Israel fue llevado cautivo a Asiria, hasta el día de hoy.',
    'Entonces el rey de Asiria trajo a las ciudades de Samaria gente de Babilonia, de Cutá, de Avá, de Jamat y de Sefarvayin, para que las habitaran en lugar de los israelitas. Y así, estos extranjeros tomaron posesión de Samaria y habitaron en sus ciudades.',
    ...
    'Y uno de los sacerdotes que había sido llevado cautivo de Samaria, vino y habitó en Betel, y les enseñó cómo debían servir al Señor.',
    ...
    'Pero esta gente también rendía culto al Señor, así que del bajo pueblo designaron sacerdotes para que ministraran en los altares de los montes, y éstos ofrecían los sacrificios de esa gente en esos santuarios.',
    'Rendían culto al Señor, pero también honraban a sus dioses, como acostumbraban hacerlo las naciones de donde habían sido tomados.',
    'Hasta el día de hoy, esta gente hace lo que siempre hizo: ni temen al Señor, ni cumplen sus estatutos ni sus ordenanzas, ni hacen lo que la ley y los mandamientos del Señor mandan hacer a los hijos de Jacob, cuyo nombre fue cambiado por el de Israel.',
    ...
    'Sólo me temerán a mí, el Señor, que con gran poder y con brazo extendido los saqué de Egipto. Sólo a mí me temerán y adorarán, y ofrecerán sacrificios.',
    ...
    'No olvidarán el pacto que yo hice con ustedes, ni temerán a dioses ajenos;',
    'me temerán a mí, el Señor su Dios, y yo los libraré del poder de todos sus enemigos.»',
    'Pero ellos no escucharon, sino que siguieron practicando sus costumbres antiguas.',
  ...
  [
    ...
    'Tenía entonces veinticinco años, y reinó veintinueve años en Jerusalén. Su madre se llamaba Abí, y era hija de Zacarías.',
    'Ezequías hizo lo recto a los ojos del Señor, como antes lo había hecho David su padre.',
    ...
    'pues siguió al Señor y no se apartó de él; al contrario, obedeció los mandamientos que el Señor le prescribió a Moisés.',
    'El Señor estaba con Ezequías. Adondequiera que él iba, tenía éxito. Se rebeló contra el rey de Asiria, y no se puso a su servicio.',
    'Además, combatió a los filisteos hasta Gaza y sus fronteras, y desde las torres de las atalayas hasta la ciudad fortificada.',
    'En el séptimo año del reinado de Oseas hijo de Elá sobre Israel, que era el cuarto año del reinado del rey Ezequías de Judá, el rey Salmanasar de Asiria atacó la ciudad de Samaria y la sitió.',
    ...
    'El rey de Asiria hizo prisioneros a los israelitas, y los llevó cautivos a Asiria. Los puso en las ciudades de Jalaj y Jabor, junto al río Gozán, y en las ciudades de los medos.',
    'Y es que los israelitas no obedecieron a la voz del Señor, su Dios, sino que faltaron a su pacto y a todo lo que había mandado Moisés, el siervo del Señor. No las obedecieron ni las pusieron por obra.',
    'En el año catorce del reinado de Ezequías, el rey Senaquerib de Asiria atacó todas las ciudades fortificadas de Judá, y las conquistó.',
    'Y el rey Ezequías de Judá envió a decirle al rey de Asiria, que estaba en Laquis: «He pecado. Aléjate de mí, y yo haré todo lo que me impongas.» El rey de Asiria impuso al rey Ezequías de Judá un tributo de nueve mil novecientos kilos de plata y novecientos noventa kilos de oro,',
    'y Ezequías entregó toda la plata que había en el templo del Señor y en los tesoros del palacio real.',
    'Además, removió el oro de las puertas y quiciales del templo del Señor, que el mismo rey Ezequías había recubierto de oro, y se lo entregó al rey de Asiria.',
    'Después el rey de Asiria envió desde Laquis un gran ejército contra el rey Ezequías. Venía comandado por el Tartán, el Rabsaris y el Rabsaces, y éstos vinieron y atacaron a Jerusalén. Cuando llegaron, acamparon junto al acueducto del estanque de arriba, en dirección al Campo del Lavador.',
    ...
    'Eliaquín hijo de Hilcías, y Sebna y Yoaj, le dijeron al Rabsaces: «Por favor, háblanos en arameo, que nosotros lo entendemos. No nos hables en la lengua de Judá, que el pueblo que está sobre la muralla te va a escuchar.»',
    ...
    'No le hagan caso.” »Así dice el rey de Asiria: “Hagan las paces conmigo, y salgan a mi encuentro. Coma cada uno de ustedes sus uvas y sus higos; beba cada uno de ustedes el agua de su pozo,',
  ...
  [
    ...
    'Luego, envió vestidos de cilicio al mayordomo Eliaquín, al escriba Sebna y a los ancianos de los sacerdotes, con el profeta Isaías hijo de Amoz,',
    'para que le dijeran: «Así ha dicho Ezequías: “Éste es un día de angustia, de reprensión y de blasfemia, pues los hijos están a punto de nacer, y la parturienta ya no tiene fuerzas.',
    'Tal vez el Señor tu Dios habrá oído todo lo que ha dicho el Rabsaces, a quien su señor, el rey de Asiria, ha enviado para blasfemar al Dios viviente y para ofenderlo con sus palabras, las cuales el Señor tu Dios habrá oído. Por lo tanto, eleva una oración por el remanente que aún queda.”»',
    'Los siervos del rey Ezequías fueron a hablar con Isaías,',
    'y éste les respondió: «Vayan y digan al rey que así ha dicho el Señor: “No tengas temor por las palabras que has oído, con las que me han blasfemado los siervos del rey de Asiria.',
    'Yo voy a poner un espíritu en él que lo hará oír rumores, y volverá a su tierra, y en su tierra haré que caiga a filo de espada.”»',
    'El Rabsaces oyó decir que el rey de Asiria se había ido de Laquis, y cuando volvió adonde éste había estado lo halló combatiendo contra Libna.',
    'Como también oyó decir que el rey Tiracá de Etiopía había salido a combatirlo, volvió y envió embajadores a que le dijeran a Ezequías:',
    '«No te dejes engañar por el Dios en quien tú confías, y que dice que Jerusalén no será entregada en manos del rey de Asiria.',
    'Tú ya debes saber lo que los reyes de Asiria han hecho con todas las naciones, y cómo las han destruido. ¿Acaso crees que tú podrás escapar?',
    '¿Acaso los dioses de las naciones que mis padres destruyeron pudieron librarlas? Me refiero a Gozán, Jarán, Resef, y a la gente de Edén que estaba en Telasar.',
    '¿Dónde están los reyes de Jamat, Arfad, y de las ciudades de Sefarvayin, Hena y Guivá?»',
    'Ezequías tomó las cartas de mano de los embajadores, y después de leerlas subió al templo del Señor y, extendiéndolas delante del Señor,',
    ...
    'Inclina, Señor, tu oído, y escucha. Abre, Señor, tus ojos, y mira. Oye las palabras de Senaquerib, que ha mandado blasfemarte a ti, el Dios viviente.',
    'Es verdad, Señor, que los reyes de Asiria han destruido naciones y países,',
    ...
    'Entonces Isaías hijo de Amoz mandó a decir a Ezequías: «Así ha dicho el Señor, Dios de Israel: “He escuchado lo que me has pedido acerca de Senaquerib, el rey de Asiria.”',
    ...
    '¿A quién has vituperado y blasfemado? ¿Contra quién has alzado la voz, y levantado en alto tus ojos? ¡Contra el Santo de Israel!',
    'Por medio de tus mensajeros has vituperado al Señor, al decir: “Con la multitud de mis carros he subido a las alturas de los montes y a lo más inaccesible del Líbano, para cortar sus altos cedros y sus mejores cipreses; me he alojado en sus lugares más remotos, en el bosque de sus más fértiles campos.',
    'He cavado pozos y bebido aguas ajenas; con las plantas de mis pies he dejado secos todos los ríos de Egipto.”',
    '¿Nunca has oído decir que, hace ya mucho tiempo, yo lo hice, y que desde tiempos pasados lo tengo planeado? Ahora lo he realizado, y tú causarás mucha desolación, y reducirás las ciudades fortificadas a montones de escombros.',
    'Sus habitantes, impotentes, se acobardaron y quedaron confundidos. ¡Parecían hierba del campo, verdes hortalizas, paja en los techos, seca antes de tiempo!',
    'Yo te conozco muy bien; sé cuándo entras y cuándo sales, y también sé cuánto ruges contra mí.',
    'Y porque me has desafiado, y porque me he enterado de tu arrogancia, voy a ponerte un gancho en la trompa y un freno en el hocico, y te haré volver por donde viniste.',
    '»A ti, Ezequías, te doy esta señal: Este año, y el siguiente, comerán ustedes lo que crezca por sí mismo, pero el tercer año podrán sembrar y segar, y plantar viñas, y comerán lo que ellas produzcan.',
    'Y los sobrevivientes de Judá volverán a echar raíces y tendrán muchos hijos.',
    'Porque en Jerusalén y en el monte de Sión quedará un remanente que se salvará. Esto lo haré yo, el Señor, por mi gran amor.',
    '»Por tanto, así dice el Señor acerca del rey de Asiria: “No entrará en esta ciudad. No lanzará ninguna flecha contra ella, ni se enfrentará a ella con escudos, ni levantará contra ella terraplenes.',
    'Por el mismo camino que vino, volverá, y no entrará en esta ciudad. —Palabra del Señor.',
    '”Por mí mismo, y por mi siervo David, yo ampararé a esta ciudad, y la salvaré.”»',
    'Y sucedió que esa misma noche el ángel del Señor salió y mató a ciento ochenta y cinco mil hombres en el campamento de los asirios. Por la mañana, cuando se levantaron, se encontraron con que por todas partes había cadáveres.',
    'Entonces el rey Senaquerib de Asiria se fue de regreso a Nínive, y nunca más volvió,',
    'pues un día, mientras él adoraba en el templo de Nisroc, su dios, sus hijos Adramelec y Sarezer lo hirieron a filo de espada, y luego huyeron al territorio de Ararat. En su lugar reinó su hijo Esarjadón.'
  ],
  // Capítulo 20
  [
    ...
    '«Señor, te ruego que hagas memoria de que en verdad me he conducido delante de ti con integridad de corazón, y que he hecho todo lo que te agrada.» Y Ezequías prorrumpió en llanto.',
    'Pero antes de que Isaías llegara a la mitad del patio, la palabra del Señor vino a Isaías, y le dijo:',
    ...
    'Voy a darte quince años más de vida, y a ti y a esta ciudad los voy a librar del poder del rey de Asiria. Por mí mismo, y por mi siervo David, voy a proteger a esta ciudad.”»',
    ...
    'Isaías le respondió: «¿Qué señal quieres recibir de que el Señor hará lo que te ha dicho? ¿Quieres que la sombra avance diez grados, o que los retroceda?»',
    'Y Ezequías dijo: «Que la sombra avance diez grados es fácil; lo difícil es que la sombra retroceda.»',
    'Entonces el profeta Isaías oró al Señor, y el Señor hizo que la sombra retrocediera los diez grados que había avanzado en el reloj de Ajaz.',
    'Por esos días Merodac Baladán hijo de Baladán, rey de Babilonia, envió cartas y presentes a Ezequías por conducto de unos mensajeros, pues se había enterado de que Ezequías había caído enfermo.',
    'Cuando Ezequías lo supo, les mostró todo su palacio y sus tesoros, con la plata y el oro, y las especias y ungüentos preciosos. También les mostró su depósito de armas y todo lo que había en sus tesoros. No hubo nada que Ezequías no les mostrara, tanto de su palacio como de todos sus dominios.',
    'Pero el profeta Isaías vino y le dijo al rey Ezequías: «¿Qué te han dicho esos hombres? ¿De dónde vienen?» Y Ezequías le respondió: «Vienen de Babilonia, un país muy lejano.»',
    'Isaías volvió a decir: «¿Y qué es lo que vieron en tu palacio?» Ezequías respondió: «Vieron todo lo que tengo allí. No quedó nada de mis tesoros que yo no les haya mostrado.»',
    'Entonces Isaías le dijo a Ezequías: «Oye ahora la palabra del Señor:',
    '“Vienen días en que todo lo que está en tu palacio, y todas las riquezas que tus antepasados acumularon hasta el día de hoy, será llevado a Babilonia, sin dejar nada.” El Señor lo ha dicho.',
    ...
    'Los demás hechos de Ezequías, y todo su poder, y sus obras en el estanque y el acueducto para llevar agua a la ciudad, se hallan registrados en el libro de las crónicas de los reyes de Judá.',
    'Y Ezequías fue a reunirse con sus padres, y en su lugar reinó su hijo Manasés.'
  ],
  // Capítulo 21
  [
    ...
    'además, reconstruyó los altares en los montes que Ezequías su padre había derribado, y erigió altares a Baal; hizo una imagen de Asera, como lo había hecho el rey Ajab de Israel, y adoró y rindió culto a todo el ejército de los cielos.',
    ...
    'Él mismo hizo una imagen de Asera, y la puso en el templo del Señor, del cual había dicho a David y a su hijo Salomón: «Yo pondré mi nombre para siempre en este templo, y en Jerusalén, ciudad que yo escogí de entre todas las tribus de Israel.',
    ...
    'Amón tenía veintidós años cuando comenzó a reinar, y reinó en Jerusalén dos años. Su madre se llamaba Mesulemet hija de Jarús, y era de Jotbá.',
  ...
  // Capítulo 22
  [
    'Josías tenía ocho años cuando comenzó a reinar, y reinó treinta y un años en Jerusalén. Su madre se llamaba Yedidá hija de Adaías, y era de Boscat.',
    'Josías hizo lo recto a los ojos del Señor y se condujo en todo como su antepasado David, sin apartarse un ápice.',
    ...
    'es decir, a los carpinteros, maestros y albañiles, y a los que compran la madera y la piedra de cantería para reparar el templo.',
    'Dile que no les pidan cuentas del dinero que se les confíe, porque ellos proceden con honradez.»',
    'El sumo sacerdote Hilcías dijo entonces al escriba Safán: «He hallado en el templo del Señor el libro de la ley.» Y no sólo le dio el libro a Safán, sino que se lo leyó.',
    ...
    'Además, el escriba Safán le informó al rey: «El sacerdote Hilcías me ha dado un libro.» Enseguida, Safán se lo leyó al rey.',
    'Y en cuanto el rey escuchó las palabras del libro de la ley, se rasgó las vestiduras',
    'y ordenó al sacerdote Hilcías, a Ajicán hijo de Safán, a Acbor hijo de Micaías, al escriba Safán y a su siervo Asaías, lo siguiente:',
    ...
    'y ella les dijo: «Así ha dicho el Señor, el Dios de Israel: “Digan al varón que los envió a consultarme,',
    'que yo, el Señor, voy a traer sobre este lugar, y sobre sus habitantes, todo el mal de que habla este libro que ha leído el rey de Judá.',
    ...
    'y tu corazón se enterneció, y te humillaste delante de mí cuando oíste mi sentencia contra este lugar y contra sus habitantes, los cuales van a ser asolados y malditos, y puesto que te rasgaste las vestiduras y lloraste en mi presencia, también yo te he prestado atención. —Palabra del Señor.',
    '”Por lo tanto, yo te reuniré con tus antepasados, y serás llevado a tu sepulcro en paz, y ya no verás todo el mal que voy a traer sobre este lugar.”» Ellos llevaron al rey la respuesta.'
  ],
  // Capítulo 23
  [
    ...
    'Hizo también que la imagen de Asera la sacaran del templo del Señor y de Jerusalén, y que la llevaran al valle del Cedrón para que allí mismo la quemaran y la redujeran a cenizas; y el polvo lo echaron sobre los sepulcros de la gente común.',
    ...
    'Los sacerdotes de los altares en los montes no podían acercarse al altar del Señor en Jerusalén, sino que comían panes sin levadura entre sus hermanos.',
    'Josías profanó también a Tofet, que está en el valle de Ben Jinón, para que ninguno ofreciera a su hijo o su hija en el fuego para rendir culto a Moloc.',
    'Quitó también los caballos que estaban a la entrada del templo del Señor, junto a la cámara del eunuco Natán Mélec, el cual tenía a su cargo los ejidos. Esos caballos habían sido dedicados al sol por los reyes de Judá, pero Josías ordenó que los quemaran.',
    'Además, el rey Josías derribó los altares que los reyes de Judá habían mandado hacer, y que estaban sobre la azotea de la sala de Ajaz, lo mismo que los altares que Manasés había mandado construir en los dos atrios del templo del Señor, y enseguida arrojó el polvo al arroyo del Cedrón.',
    'Profanó los altares de los montes delante de Jerusalén, a la derecha del monte de la destrucción, los cuales Salomón, rey de Israel, había mandado construir para Astoret y Quemos, los repugnantes ídolos de los sidonios y de los moabitas, y para Milcón, el repugnante ídolo de los amonitas.',
    'Hizo pedazos las estatuas e imágenes de Asera, y rellenó el lugar con huesos humanos.',
    'Josías destruyó también el altar que estaba en Betel, y el altar del monte que había construido Jeroboán hijo de Nabat, que hizo pecar a Israel; destruyó aquel altar y le prendió fuego hasta reducirlo a cenizas, y le prendió fuego también a la imagen de Asera.',
    'Ya volvía Josías cuando vio los sepulcros que estaban allí en el monte. Entonces mandó sacar los huesos de los sepulcros, y para profanarlo ordenó que los quemaran sobre el altar. Así se cumplió la palabra del Señor, que el varón de Dios había anunciado en su profecía.',
    'Después de eso, preguntó: «Aquí veo un monumento. ¿De quién es?» Los habitantes de la ciudad le respondieron: «Es el sepulcro del varón de Dios que vino de Judá, el cual predijo contra el altar de Betel todo lo que tú has hecho.»',
    'Entonces Josías dijo: «Que nadie lo toque ni mueva sus huesos.» Fue así como se preservaron sus huesos y los del profeta que había llegado de Samaria.',
    ...
    'Además, sobre esos altares sacrificó a todos los sacerdotes de los santuarios que había en esos montes, y quemó sobre ellos huesos humanos. Después de eso, volvió a Jerusalén.',
    'El rey dio a todo el pueblo la siguiente orden: «Celebren la pascua del Señor su Dios, tal y como está escrito en el libro de este pacto.»',
    'La pascua no se había celebrado desde los días en que los jueces gobernaban a Israel, ni tampoco en los días de los reyes de Israel y de Judá.',
    'Pero se celebró en Jerusalén en el año dieciocho del reinado de Josías, en honor del Señor.',
    'En cumplimiento de las palabras de la ley, escritas en el libro que el sacerdote Hilcías había hallado en el templo del Señor, Josías acabó también con los encantadores, adivinos y terafines, y con todas las prácticas repugnantes que solían verse en Judá y en Jerusalén.',
    ...
    'Por eso dijo: «También quitaré de mi presencia a Judá, como quité a Israel, y desecharé a Jerusalén, ciudad a la cual había escogido, y al templo del cual yo había dicho: “Allí estará mi nombre.”»',
    'Los demás hechos de Josías, y todas sus obras, se hallan registrados en el libro de las crónicas de los reyes de Judá.',
    'Por esos días, el faraón Necao, rey de Egipto, se dirigió al río Éufrates para luchar contra el rey de Asiria, y el rey Josías salió a enfrentarse con él en Meguido, pero en cuanto Necao lo vio, lo mató.',
    'Sus oficiales lo pusieron entonces en un carro, y llevaron su cadáver de Meguido a Jerusalén, para ponerlo en su sepulcro. La gente del país tomó entonces a Joacaz hijo de Josías, y lo ungieron y lo proclamaron rey en lugar de su padre.',
    'Joacaz tenía veintitrés años cuando comenzó a reinar, y reinó tres meses en Jerusalén. Su madre se llamaba Jamutal hija de Jeremías, y era de Libna.',
    'Pero Joacaz hizo lo malo a los ojos del Señor, tal y como lo habían hecho sus antepasados.',
    'Para que Joacaz no reinara en Jerusalén, el faraón Necao lo encarceló en Ribla, en la provincia de Jamat, y al país le impuso un tributo de tres mil trescientos kilos de plata y treinta y tres kilos de oro.',
    'Además, el faraón Necao puso por rey a Eliaquín hijo de Josías en lugar de su padre, y le cambió el nombre por el de Joacín; luego tomó a Joacaz y lo llevó a Egipto, donde murió.',
    'Joacín pagó al faraón el tributo de plata y oro, pero para cumplir con este tributo tuvo que imponer al pueblo un impuesto sobre el valor de la tierra que cada uno poseía, y ese dinero se lo dio al faraón Necao.',
    'Joacín tenía veinticinco años cuando comenzó a reinar, y reinó en Jerusalén once años. Su madre se llamaba Zebuda hija de Pedaías, y era de Ruma.',
    'Pero hizo lo malo a los ojos del Señor, tal y como lo habían hecho sus antepasados.'
  ],
  // Capítulo 24
  [
    'Durante el reinado de Joacín el rey Nabucodonosor de Babilonia invadió Judá, y Joacín se convirtió en su súbdito durante tres años, aunque luego decidió rebelarse contra él.',
    'Pero el Señor envió contra Joacín tropas de caldeos, sirios, moabitas y amonitas, para que destruyeran a Judá, en cumplimiento de la palabra del Señor anunciada por medio de sus siervos los profetas.',
    ...
    'Los demás hechos de Joacín, y todas sus obras, se hallan registrados en el libro de las crónicas de los reyes de Judá.',
    'Cuando Joacín fue a reunirse con sus antepasados, reinó en su lugar su hijo Joaquín.',
    ...
    'Joaquín tenía dieciocho años cuando comenzó a reinar, y reinó en Jerusalén tres meses. Su madre se llamaba Nejustá hija de Elnatán, y era de Jerusalén.',
    ...
    'Mientras sus oficiales mantenían sitiada la ciudad, llegó también Nabucodonosor mismo.',
    'Entonces el rey Joaquín de Judá se entregó al rey de Babilonia, junto con su madre, sus siervos, sus jefes y sus oficiales, y el rey de Babilonia lo capturó. Era el año octavo de su reinado.',
    ...
    'Nabucodonosor se llevó cautivos a diez mil habitantes de Jerusalén. Todos los príncipes y todos los mejores soldados, y todos los artesanos y herreros, fueron hechos cautivos. En el país sólo se quedó la gente más pobre.',
    ...
    'El rey de Babilonia también se llevó cautivos a siete mil hombres de guerra, a mil artesanos y herreros, y a todos los hombres capaces de entrar en combate.',
    'En lugar de Joaquín, el rey de Babilonia puso por rey a su tío Matanías, y le cambió el nombre por el de Sedequías.',
    'Sedequías tenía veintiún años cuando comenzó a reinar, y reinó en Jerusalén once años. Su madre se llamaba Jamutal hija de Jeremías, y era de Libna.',
  ...
  [
    ...
    'A los hijos de Sedequías los degollaron en presencia de Sedequías, y a éste le sacaron los ojos, y encadenado lo llevaron a Babilonia.',
