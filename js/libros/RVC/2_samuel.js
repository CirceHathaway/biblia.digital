// Auto-generated from RVC.xml — 2 Samuel 1–24
export default [
  // Capítulo 1
  [
    ...
    'y ordenó que lo aprendieran los descendientes de Judá. Este lamento se halla escrito en el libro de Jaser.1',
  ...
  [
    ...
    'el sexto fue Itreán, hijo de Egla, también mujer de David. Éstos fueron los hijos que le nacieron a David en Hebrón.',
    ...
    'Allí Abner le hizo a David esta promesa: «Me propongo reunir a todo el pueblo de Israel, para que hagan un pacto contigo y tú reines como lo tienes pensado.» Entonces David despidió a Abner, y éste partió en paz.',
  ...
  // Capítulo 5
  [
    'Todas las tribus de Israel se reunieron en torno a David en Hebrón, y dijeron: «Aquí nos tienes. Por nuestro cuerpo corre la misma sangre que por el tuyo.',
    'Ya de tiempo atrás, cuando Saúl aún era nuestro rey, tú salías con nuestros hombres a la guerra y regresabas victorioso. Además, el Señor te ha dicho que tú serás el pastor y príncipe de su pueblo Israel.»',
    ...
    'El rey salió acompañado de sus soldados, y fue a Jerusalén a pelear contra los jebuseos, que allí vivían. Pero ellos le dijeron a David: «Tú no entrarás aquí, pues hasta los cojos y los ciegos son capaces de echarte.» Con eso quisieron decir que David jamás entraría en su ciudad.',
    'Sin embargo, David conquistó la fortaleza de Sión, que desde entonces es conocida como «Ciudad de David».',
    'Y ese mismo día David dijo: «Quien quiera matar a los jebuseos, que entre por los canales de agua de la ciudad, y mate también a los cojos y a los ciegos, pues los odio con toda mi alma.» Desde entonces se dice: «Ni los cojos ni los ciegos pueden entrar en el templo del Señor.»',
    ...
    'Después de que David salió de Hebrón, tomó esposas y concubinas y se estableció en Jerusalén. Con ellas tuvo más hijos e hijas.',
    ...
    'Entonces David fue a Baal Perasín, y allí los venció. Por eso dijo: «El Señor se abrió paso3 entre las filas enemigas, como si fuera una corriente impetuosa», y llamó a ese lugar «Baal Perasín.»4',
  ...
  [
    ...
    'David se puso muy triste de que el Señor hubiera dado muerte a Uzá, y desde entonces aquel lugar se llama «Peres Uzá».5',
    ...
    'Y así, el arca del Señor se quedó tres meses en la casa del gatita Obed Edom, y Dios lo bendijo a éste y a toda su familia.',
  ...
  [
    ...
    'Y Natán le respondió: «Pues haz ya todo lo que te has propuesto, que el Señor está contigo.»',
    ...
    'Desde que saqué de Egipto al pueblo de Israel, y hasta la fecha, no he vivido en ninguna casa. Más bien, he estado en tiendas de campaña y en tabernáculos.',
    'En todo el tiempo en que he andado con el pueblo de Israel, hay tribus a las que les he pedido encargarse de apacentar a mi pueblo. ¿Pero acaso le he pedido a alguna de ellas que me construya un palacio de cedro?”',
    '»Dile también de mi parte: “Yo, el Señor de los ejércitos, te saqué del redil, y te quite de andar tras las ovejas, para ponerte a gobernar a mi pueblo Israel.',
    'Yo he estado contigo por dondequiera que has andado; he destruido a los enemigos que has enfrentado, y te he rodeado de gran fama; ¡te he hecho famoso entre los famosos!',
    'Además, ya he preparado para mi pueblo Israel un lugar donde se establezca, para que viva en paz y nadie lo mueva de allí, ni los malvados lo aflijan como antes lo hicieron,',
    ...
    'Será él quien me edifique un templo, y afirmaré su trono para siempre.',
    ...
    'Tus descendientes vivirán seguros, y afirmaré tu trono, el cual permanecerá para siempre.”»',
    'Y Natán le comunicó a David todas y cada una de estas palabras y de esta visión.',
    'Entonces el rey David fue y se presentó ante el Señor, y le dijo: «Señor y Dios, ¿quién soy yo, y qué es mi familia, para que me hayas encumbrado tanto?',
    ...
    'Todas estas maravillas las has realizado conforme a tu palabra, y siguiendo tu corazón, y me las has dado a conocer.',
    '¡Cuán grande eres, Señor y Dios! ¡No hay nadie como tú! Tal y como lo hemos sabido, ¡no hay más Dios que tú!',
    '¿Y qué pueblo puede compararse a Israel, nación tan singular? Tú la liberaste para hacerla tu pueblo, le diste un nombre, y en su favor hiciste grandes y terribles proezas, porque lo amas. Tú lo liberaste de Egipto, y de otros pueblos y de sus dioses.',
    'Tú hiciste de Israel tu propio pueblo; tú lo hiciste tuyo para siempre. ¡Tú, Señor, eres su Dios!',
    '»Ahora, Señor y Dios, confirma para siempre la promesa que me has hecho, a mí y a mi familia, y haz todo lo que has dicho.',
    ...
    'Tú, Señor y Dios, eres Dios, y tus promesas a este siervo tuyo son verdaderas.',
  ...
  [
    ...
    'Benaías hijo de Joyadá estaba al mando de los cretenses y peleteos; y los hijos de David eran sacerdotes.6'
  ],
  // Capítulo 9
  [
    ...
    'El rey le preguntó dónde estaba, y Sibá le respondió que estaba en Lodebar, en casa de Maquir hijo de Amiel.',
    ...
    'Tú, y tus hijos y tus sirvientes se encargarán de labrar sus tierras y de almacenar los frutos, para que no le falte comida a Mefiboset, el hijo de tu señor, aunque él tiene un lugar en mi mesa y comerá conmigo.» Sibá, que tenía quince hijos y veinte sirvientes,',
    ...
    'Mefiboset tenía un hijo pequeño que se llamaba Micaía, y toda la familia de Sibá estaba al servicio de Mefiboset.',
  ...
  [
    ...
    'Y David pensó: «Voy a tratar al hijo de Najás, con la misma buena voluntad con que su padre me trató a mí.» Envió entonces una comisión para consolar a Najás por la muerte de su padre, pero cuando los enviados de David llegaron al territorio amonita,',
    'los jefes del pueblo le dijeron a Janún: «¿De veras crees que David te envía mensajeros para consolarte y honrar a tu padre? ¡No! Ha enviado a esa gente como espías, para que inspeccionen la ciudad y luego puedan destruirla.»',
    ...
    'Los amonitas se dieron cuenta que se habían ganado la enemistad de David, así que contrataron a veinte mil soldados sirios de Bet Rejob y de Soba, mil soldados del rey de Macá y doce mil de Istob.',
    'Y cuando David lo supo, envió a Joab con sus soldados más valientes a combatirlos.',
    'Entonces los amonitas se prepararon para la batalla a las puertas de la ciudad, mientras que los sirios de Soba, de Rejob, de Istob y de Macá se alinearon en el campo.',
    ...
    'Al ejército restante lo puso en manos de su hermano Abisay, y lo alineó para encontrarse con los amonitas.',
    ...
    'Cuando Joab y sus soldados arremetieron contra los sirios, éstos salieron huyendo de Joab y del ejército israelita.',
    'Y cuando los amonitas vieron que el ejército sirio huía, también ellos huyeron de Abisay y sus hombres, y se refugiaron en la ciudad. Así terminó la batalla, y Joab regresó a Jerusalén.',
    'Pero los sirios, al verse derrotados por el ejército israelita, volvieron a reagruparse.',
    'Entonces Hadad Ezer mandó traer a los sirios que estaban al otro lado del río Éufrates, y llegaron a Jelán comandados por Sobac, general del ejército de Hadad Ezer.',
    'David supo de estos movimientos y reunió a todo el ejército de Israel, y juntos cruzaron el Jordán para llegar a Jelán. Cuando los sirios los vieron, se formaron en orden de batalla y pelearon contra David y su ejército.',
    ...
    'Y cuando los reyes que ayudaban a Hadad Ezer vieron cómo habían sido derrotados sus ejércitos, firmaron la paz con Israel y se hicieron sus súbditos, y desde entonces los sirios se abstuvieron de ayudar a los amonitas.'
  ],
  // Capítulo 11
  [
    'Al año siguiente, en el tiempo en que los reyes salen a la guerra, David envió a Joab y a sus siervos, y a todo el ejército de Israel, a combatir a los amonitas, a los que vencieron luego de ponerle sitio a la ciudad de Rabá. David se quedó en Jerusalén,',
    'y un día por la tarde, mientras se paseaba por la azotea de su palacio después de la siesta, vio desde allí a una mujer muy hermosa, que se estaba bañando.',
    'Al preguntar quién era ella, le dijeron que se llamaba Betsabé, y que era hija de Elián y esposa de Urías el hitita.',
    'Entonces David ordenó que la llevaran a su presencia, y ella se presentó ante él, y él la tomó y se acostó con ella. Después de tener relaciones, ella se purificó y regresó a su casa.',
    ...
    'y cuando Urías se presentó ante David, éste le preguntó cómo estaban Joab y los soldados, y cómo se iba desarrollando la guerra.',
    ...
    'Pero Urías no se fue a su casa, sino que pasó la noche a las puertas del palacio real, en compañía de los siervos del rey.',
    ...
    'Y Urías le respondió: «¿Podría yo entrar en mi casa, y comer y beber, y dormir con mi mujer, mientras el arca del Señor está en una tienda de campaña, y mientras mi señor Joab y los ejércitos de Israel y de Judá, y los siervos del rey, duermen en el campo? ¡Juro por la vida de Su Majestad que jamás haré algo así!»',
    'Entonces David le dijo a Urías: «Quédate todavía hoy, y mañana te enviaré de nuevo al campo de batalla.» Y Urías se quedó en Jerusalén ese día y el siguiente,',
    'y David lo invitó a comer y a beber, hasta que lo embriagó, pero más tarde Urías no regresó a su casa, sino que se fue a dormir junto con los siervos del rey.',
    ...
    '¡Recuerden cómo murió Abimelec, el hijo de Yerubaal! Murió en Tebés porque una mujer le arrojó desde la muralla un pedazo de rueda de molino. ¿Por qué se acercaron tanto a la muralla?”, tú le dirás: “También murió Urías el hitita.”»',
  ...
  [
    ...
    'pero el pobre sólo tenía una corderita que había comprado y criado, y que era como su propia hija, pues comía de su mesa, bebía de su vaso y dormía en su regazo; era como de la familia, pues había crecido con él y con sus hijos.',
    'Un día, el hombre rico recibió a un visitante y, como no quiso matar a ninguna de sus ovejas o vacas para ofrecerle de comer al visitante, fue y tomó la oveja del hombre pobre, y la preparó para su visitante.»',
    ...
    'yo te di el palacio que fue de tu señor, y puse en tus brazos sus mujeres. Además, yo te entregué las tribus de Israel y de Judá y, por si esto fuera poco, yo estaba dispuesto a darte mucho más.”',
    '¿Por qué menospreciaste la palabra del Señor, y actuaste mal delante de sus ojos? Al hitita Urías lo mataste por medio de la espada de los amonitas, para quedarte con su mujer.',
    '“Ahora, en castigo, la violencia jamás se apartará de tu propia familia, pues menospreciaste al Señor y tomaste como mujer a la esposa de Urías el hitita.”',
    'Pero así dice el Señor: “Yo haré que el mal sobrevenga sobre tu propia casa. Ante tus propios ojos entregaré tus mujeres a tu prójimo, y a pleno sol se acostará con ellas.',
    'Lo que tú hiciste en secreto, yo lo haré a plena luz del día y en presencia de todos los israelitas.”»',
    'David le respondió a Natán: «Reconozco que he pecado contra el Señor.» Y Natán le dijo: «El Señor ha perdonado tu pecado, y no vas a morir.',
    'Pero como los enemigos del Señor hablan mal de él por causa de este pecado tuyo, tu hijo recién nacido tiene que morir.»',
    'Después de esto, Natán regresó a su casa. Y el niño que la mujer de Urías le dio a David, se enfermó de gravedad porque el Señor así lo quiso.',
    'David le rogó al Señor por la salud de su hijo, y ayunaba y se pasaba la noche acostado en el suelo.',
    'Los ancianos que vivían en su palacio iban a verlo y trataban de levantarlo del suelo, pero David se negaba a levantarse, y tampoco quería comer.',
    'Siete días después, el niño murió, y sus sirvientes temían decírselo, pues decían: «Si cuando el niño vivía, el rey no quería escucharnos, con más razón se afligirá si le decimos que el niño ya murió.»',
    'Pero cuando David los vio hablar entre sí, se dio cuenta de que el niño ya había muerto, así que les preguntó: «¿Ya ha muerto el niño?» Aquellos le respondieron: «Sí, señor; ya ha muerto.»',
    'Entonces David se levantó del suelo, y se bañó y se perfumó, y se puso ropa limpia; luego fue a la casa del Señor, y lo adoró. Después regresó a su casa y pidió de comer, y comió.',
    'Los sirvientes le preguntaron: «¿Qué es lo que haces? Cuando el niño aún vivía, estuviste ayunando y orando, pero ahora que ha muerto, ¡te levantas y pides de comer!»',
    ...
    'Pero ahora que el niño ha muerto, ¿de qué me sirve ayunar? ¿Acaso podría yo devolverle la vida? Yo puedo ir a donde él está, pero él ya no volverá conmigo.»',
    ...
    'y por eso envió un mensaje al profeta Natán, para decirle que lo llamara Jedidías.7',
    'Joab se encontraba en Rabá combatiendo a los amonitas, y capturó la ciudad del rey.',
    'Entonces envió un mensaje a David para decirle: «Después de sitiar la ciudad de Rabá, he capturado también las reservas de agua.',
    ...
    'David reunió entonces al resto de su ejército, y fue y luchó contra Rabá y la capturó.',
    ...
    'A la gente que quedaba en la ciudad la puso a trabajar con sierras y trillos y hachas de hierro, y también los puso a trabajar en los hornos de ladrillos. Esto mismo lo hizo en todas la ciudades de los amonitas. Después de esto, David regresó a Jerusalén con todo su ejército.'
  ],
  // Capítulo 13
  [
    ...
    'se rasgó el vestido de colores, se echó ceniza sobre la cabeza, y con la cabeza entre sus manos se fue gritando.',
  ...
  [
    ...
    'Todas las mañanas se levantaba y se ponía a un lado del camino, junto a la puerta de la ciudad, y a quien acudía al rey para resolver un pleito o para pedir justicia, lo llamaba y le preguntaba: «¿Tú, de qué ciudad vienes?» Si el interrogado respondía: «Tu siervo es de una de las tribus de Israel»,',
    ...
    'Y si alguien se acercaba y se inclinaba ante él, Absalón le tendía los brazos y lo besaba.',
    ...
    'Y mientras Absalón presentaba sus ofrendas al Señor, mando llamar a Ajitofel, que era consejero del rey y vivía en la ciudad de Gilo. Con esto la conspiración ganó fuerza y los seguidores de Absalón aumentaron.',
    ...
    'y David ordenó a todos sus servidores: “«¡De prisa! ¡Vayámonos de aquí, o no podremos escapar de Absalón! ¡Si él llega antes, nos alcanzará y acabará con nosotros, y destruirá la ciudad a filo de espada!»',
    'Sus siervos le respondieron: «Su Majestad puede contar con estos siervos suyos. Haremos todo lo que Su Majestad decida hacer.»',
    'El rey David salió de Jerusalén, seguido de toda su familia, pero dejo a diez de sus concubinas para que cuidaran del palacio.',
    'Una vez que salió, él y todos sus seguidores se detuvieron en un lugar alejado.',
    'Todos sus hombres fieles, incluidos los cretenses y peleteos, desfilaron a su lado; la vanguardia la formaban los seiscientos geteos que habían venido caminando desde Gat.',
    'El rey David llamó a Itay el gatita, y le preguntó: «¿Y tú por qué vienes con nosotros? Regresa a Jerusalén, y quédate con el rey, pues eres extranjero y también has sido desterrado de tu país.',
    'Apenas llegaste ayer, así que no puedo pedirte que nos acompañes. Yo tengo que ir a donde pueda, pero tú, regresa, y haz que tus hermanos también regresen. Que el Señor te muestre su amor constante y su fidelidad.»',
    ...
    'Entonces David le dijo: «Adelante, pues. Ven conmigo.» Así fue como Itay el gatita, y todos sus hombres y su familia, siguieron al rey.',
    ...
    'Entre los que huían estaban el sacerdote Sadoc y los levitas que llevaban el arca del pacto de Dios. Mientras todo el pueblo salía de la ciudad, ellos descansaron el arca, y luego los siguió Sadoc.',
    ...
    'Además, el rey le dijo al sacerdote: «Tú, Sadoc, eres vidente. Así que regresa en paz a la ciudad, y llévate a tu hijo Ajimaz y a Jonatán, el hijo de Abiatar.',
    'Yo me detendré en los vados del desierto, hasta que reciba noticias de ustedes.»',
    'Entonces Sadoc y Abiatar se llevaron el arca de Dios de vuelta a la ciudad, y ellos también se quedaron allá.',
    'David, por su parte, subió por la cuesta de los olivos. Iba llorando, con los pies descalzos y la cabeza cubierta, y todos sus hombres fieles subieron con él, también llorando y con la cabeza cubierta.',
    ...
    'Así fue como Jusay, que era amigo de David, se fue a la ciudad, cuando Absalón entró en Jerusalén.'
  ],
  // Capítulo 16
  [
    'Cuando David llegó más allá de la cima del monte, Sibá, el criado de Mefiboset, salió a recibirlo con un par de asnos cargados con doscientos panes, cien racimos de pasas, cien panes de higos secos, y un cuero de vino.',
    'Y el rey le preguntó a Sibá: «¿Qué significa todo esto?» Y Sibá le respondió: «Los asnos son para que los monte la familia real, los panes y las pasas son para alimentar a los criados, y el vino es para cuando tengan sed a su paso por el desierto.»',
    ...
    'David siguió su camino, y llegó a un lugar llamado Bajurín. Allí salió a su encuentro Simey hijo de Gera, de la familia de Saúl, y al ver a David lo maldijo',
    ...
    '¡El Señor te está cobrando la sangre que derramaste de la familia de Saúl, en cuyo lugar has reinado! ¡Por eso el Señor te ha quitado el trono y se lo ha dado a tu hijo Absalón! ¡Mírate ahora! ¡Eres un asesino, y te ha alcanzado tu propia maldad!»',
    ...
    'Y a Abisay y a todos sus siervos les hizo notar: «Si mi propio hijo, a quien yo engendré, busca matarme, ¿quién puede impedirle a un benjaminita que lo haga? ¡Déjenlo que me maldiga! Seguramente el Señor le ha ordenado que lo haga.',
    'Pero tal vez el Señor vea mi aflicción, y convierta en bendición las maldiciones que hoy recibo.»',
    'Y mientras David y sus seguidores continuaban su camino, Simey iba delante del rey, por la ladera del monte, gritando y maldiciendo, y arrojando piedras y lanzando polvo al aire.',
    ...
    'Y Ajitofel le aconsejó: «Ve al palacio de tu padre y acuéstate con sus concubinas, las que se quedaron cuidando el palacio. Cuando el pueblo lo sepa, pensará que tu padre te aborrecerá, y así la gente se unirá más a ti.»',
    'Se levantó entonces en la azotea una tienda de campaña para Absalón, y éste se acostó con las concubinas de su padre a la vista de todo el pueblo.',
  ...
  [
    ...
    'También se enteró de que el ejército que regresaba entró a la ciudad en completo silencio y a escondidas, como los que avergonzados huyen de la batalla,',
    ...
    'Entre las tribus de Israel se suscitó una gran disputa, pues decían: «El rey que luchó contra nuestros enemigos, y que nos libró de los filisteos, ahora ha huido del país por miedo a Absalón.',
    ...
    'El rey David, por su parte, mandó a los sacerdotes Sadoc y Abiatar a que preguntaran a los ancianos de Judá: «Todo Israel está pidiendo que el rey David vuelva. ¿Qué esperan ustedes para hacerlo volver? ¿Por qué tienen que ser los últimos?',
    ...
    'y le dijo: «Ruego a Su Majestad no tomar en cuenta el mal proceder de este siervo suyo, ni acordarse de mi maldad cuando Su Majestad salía de Jerusalén. Por favor, ¡no me guarde rencor!',
    ...
    'Pero David dijo: «¿Qué mal les he hecho, hijos de Seruyá, para que hoy se pongan en contra mía? ¿Acaso alguien tiene qué morir hoy en Israel, y yo, que soy el rey, no lo sé?»',
    'Y a Simey Le dijo: «Te juro que no vas a morir.»',
    ...
    'Y cuando Mefiboset fue a Jerusalén para recibir al rey, éste le preguntó: «Mefiboset, ¿por qué no te fuiste conmigo?»',
    ...
    'Comprendo que, a los ojos de Su Majestad, todos los descendientes de mi padre merecían la muerte; sin embargo, tú me permitiste comer a tu mesa. ¿Con qué derecho puedo reclamarle algo a Su Majestad?»',
    ...
    'Barzilay era ya muy anciano, pues tenía ochenta años, y cuando el rey estuvo en Majanayin él le había dado provisiones, pues era muy rico.',
    ...
    'Ya tengo ochenta años de edad. ¿Crees que sabré distinguir entre lo que es agradable y lo que no lo es? ¿Crees que podré apreciar la comida o la bebida? ¿Crees que podré escuchar mejor a tus cantores y cantoras? No quiero ser una carga para mi señor, el rey.',
    'Sólo te acompañaré un poco más allá del Jordán. ¿Por qué tendrías que darme una mayor recompensa?',
    'Te ruego que me permitas regresar a mi ciudad para morir allá, junto al sepulcro de mis padres. Pero aquí está tu siervo Quimán. Permítele acompañarte, y trátalo como mejor te parezca.»',
    'El rey aceptó, y dijo: «Que venga conmigo. Lo voy a tratar como si fueras tú mismo, y haré con él todo lo que me pidas que haga.»',
    'Entonces todo el pueblo cruzó el Jordán, y en cuanto el rey lo cruzó, besó a Barzilay y lo bendijo, y éste regresó a su ciudad.',
    'El rey se dirigió a Gilgal, acompañado de Quimán y de todos los de Judá, y de la mitad del pueblo de Israel.',
    'Pero después los israelitas fueron a ver al rey, y le preguntaron: «¿Por qué permitiste que nuestros hermanos de Judá te acompañaran para cruzar el Jordán contigo, junto con tu familia y con todo tu ejército?»',
    'Y los jefes de Judá les respondieron: «Lo hicimos porque el rey también es pariente nuestro. Pero, ¿por qué se enojan? ¿Acaso piensan que lo hicimos porque el rey nos dio de comer? ¿Creen que recibimos algún regalo por acompañarlo?»',
    'Y los israelitas dijeron: «Nosotros tenemos diez veces más derecho que ustedes para que David sea nuestro rey. ¿Por qué nos han menospreciado? Recuerden que nosotros fuimos los primeros en decidir que él regresara.» Pero los argumentos de los hombres de Judá tuvieron más fuerza que los de los israelitas.'
  ],
  // Capítulo 20
  [
  ...
  [
    ...
    'y que los sepultaran en el sepulcro de Cis, el padre de Saúl. Todo fue hecho tal y como el rey lo dispuso, y después de esto Dios se compadeció del país.',
    ...
    'pero Abisay hijo de Seruyá lo vio y fue en su ayuda, e hirió de muerte al filisteo. Entonces los hombres de David le dijeron: «De ahora en adelante, no volverás a salir con nosotros a la guerra; no vaya a ser que se apague la luz que alumbra a Israel.»',
  ...
  [
    ...
    'Pero la orden del rey pudo más que Joab y que sus capitanes, así que Joab y sus capitanes salieron del palacio y se dispusieron a levantar el censo de Israel.',
    'Cruzaron el Jordán y acamparon en Aroer, al sur de la ciudad que está en el valle de Gaad, junto a Jazer.',
    'De allí fueron a Galaad y a la tierra baja de Jodsí, y luego a Dan Yaán y a los alrededores de Sidón.',
    'Luego fueron a la fortaleza de Tiro, y recorrieron todas las ciudades de los jivitas y de los cananeos, hasta llegar al Néguev de Judá, en Berseba.',
    ...
    'Al día siguiente, cuando David se levantó, la palabra del Señor vino a Gad, el vidente de David, y le dijo:',
    '«Ve y dile de mi parte a David: “Yo, el Señor, te doy a elegir una de tres cosas. Haré lo que tú elijas.”»',
    'Gad fue a ver a David y le dio el mensaje del Señor. Le dijo: «¿Quieres que haya siete años de hambre en tu tierra? ¿O prefieres huir de tus enemigos durante tres meses? ¿O prefieres que haya en tu pueblo tres días de peste? Piénsalo bien, pues debo llevar una respuesta a quien me envía.»',
    ...
    'Entonces el Señor envió la peste sobre Israel desde la mañana y hasta el día señalado, y desde Dan hasta Berseba murieron setenta mil israelitas.',
    ...
    'Y cuando David vio que el ángel destruía al pueblo, le dijo al Señor: «Yo soy quien ha pecado; yo soy quien hizo mal. ¡Pero estas ovejas no han hecho nada malo! Te ruego que nos castigues a mí y a mi familia.»',
    'Entonces Gad fue y le dijo: «Ve y edifica un altar al Señor en la era de Arauna el jebuseo.»',
    'David fue a cumplir lo que el Señor le había ordenado hacer por medio de Gad,',
    ...
    'y le preguntó: «¿A qué debe este siervo la visita de Su Majestad?» Y David le dijo: «Quiero comprar tu era, para edificar allí un altar al Señor y se detenga la mortandad entre el pueblo.»',
    ...
    'Todo lo que Su Majestad necesite, yo se lo doy.» Todavía añadió Arauna: «Que el Señor sea propicio a Su Majestad.»',
    'Pero el rey le respondió: «De ninguna manera. Yo te pagaré su precio. No voy a ofrecer al Señor mi Dios holocaustos que no me cuesten nada.» Y David le compró la era y los toros por cincuenta monedas de plata,',
    'y construyó allí un altar al Señor, en el que ofreció holocaustos y ofrendas de paz. Y el Señor escuchó las súplicas del país, y detuvo la plaga en Israel.'
  ]
];