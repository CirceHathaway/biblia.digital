// Auto-generated from RVC.xml — Amós 1–9
export default [
  // Capítulo 1
  [
  ...
  [
    ...
    'le prenderé fuego a Judá, y éste consumirá los palacios de Jerusalén.',
  ...
  // Capítulo 3
  [
    'Hijos de Israel, ésta es la palabra que el Señor ha pronunciado contra ustedes, contra toda la familia que él sacó de la tierra de Egipto. Escuchen bien:',
    ...
    '¿Cae el ave en la trampa, sin que haya cazador? ¿Salta del suelo la trampa sin que haya atrapado algo?',
    '¿Se da la alarma en la ciudad, sin que el pueblo se alborote? ¿Pasa algo malo en la ciudad, que el Señor no haya hecho?',
    'Lo cierto es que nada hace el Señor sin antes revelarlo a sus siervos los profetas.',
    ...
    'Así ha dicho el Señor: «Los hijos de Israel, que en Samaria se entronizan en el borde de una cama o en el costado de un diván, escaparán como cuando un pastor logra rescatar, de las fauces del león, sólo dos piernas de una oveja, o la punta de una oreja.',
  ...
  [
    ...
    'Y si el pariente de algún difunto quiere sacar de la casa los huesos para quemarlos, dirá a quien esté en el fondo de la casa: «¿Hay todavía alguien contigo?» Y si aquél contesta que no, éste dirá: «Calla, no vaya a suceder que mencionemos el nombre del Señor.»',
  ...
  [
    ...
    'Voy a destruir los lugares altos de Isaac, y a dejar en ruinas los santuarios de Israel. Además, voy a levantar la espada contra la casa de Jeroboán.»',
  ...
  // Capítulo 9
  [
    'El Señor estaba de pie, junto el altar. Yo lo vi, y le oí decir: «¡Derriba el capitel! ¡Que se estremezcan los umbrales! ¡Que se hagan pedazos sobre la cabeza de todos! A los que sobrevivan, los mataré a filo de espada. ¡Ninguno de ellos podrá huir ni escapar!',
    ...
    'Cuando el Señor de los ejércitos toca la tierra, ésta se derrite y todos sus habitantes lloran. Y se hincha la tierra como un río, y luego decrece como el río de Egipto.',
    ...
    '»Mis ojos están atentos y en contra de este reino pecador. ¡Voy a borrarlo de la faz de la tierra! Pero no destruiré del todo la casa de Jacob. —Palabra del Señor.',
    ...
    'para que todos aquellos sobre los que se invoca mi nombre tomen posesión del resto de Edom, y de todas las naciones. —Palabra del Señor, que así lo hará.',
    '»Vienen días en que los que aran alcanzarán a los que siegan, y los que pisan las uvas alcanzarán a los que siembran. Los montes destilarán mosto, y todas las colinas se derretirán. —Palabra del Señor.',
    ...
    'Yo los plantaré sobre su tierra, y nunca más volverán a ser arrancados de ella, pues yo se la di en posesión.» —Palabra del Señor su Dios.'
  ]
];