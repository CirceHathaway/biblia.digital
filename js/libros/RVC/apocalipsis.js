// Auto-generated from RVC.xml — Apocalipsis 1–22
export default [
  // Capítulo 1
  [
    ...
    'y éste da fe de todo lo que ha visto, y de la palabra de Dios y del testimonio de Jesucristo.',
    ...
    'y nos hizo reyes y sacerdotes para Dios, su Padre. Por eso, a él sea dada la gloria y el poder por los siglos de los siglos. Amén.',
    ...
    'Dios el Señor dice: «Yo soy el Alfa y la Omega, [el principio y el fin,]1 el que es, el que era, y el que ha de venir. Soy el Todopoderoso.»',
    ...
    'Éste es el significado de las siete estrellas que has visto en mi mano derecha, y de los siete candeleros de oro: las siete estrellas son los ángeles de las siete iglesias, y los siete candeleros que has visto, son las siete iglesias.'
  ],
  // Capítulo 2
  [
    ...
    '»Yo conozco tus obras, tu arduo trabajo y tu paciencia. Sé que no soportas a los malvados, que has puesto a prueba a los que dicen ser apóstoles y no lo son, y que has descubierto que son unos mentirosos.',
    ...
    'Pero tienes algo a tu favor: que no soportas las obras de los nicolaítas, las cuales tampoco yo soporto.',
  ...
  // Capítulo 5
  [
    'Vi entonces que el que estaba sentado en el trono tenía en la mano derecha un libro, el cual estaba escrito por dentro y por fuera. El libro estaba sellado con siete sellos.',
    'Vi también a un ángel poderoso, que a gran voz proclamaba: «¿Quién es digno de abrir el libro y de quitarle los sellos?»',
    ...
    'Y uno de los ancianos me dijo: «No llores, pues el León de la tribu de Judá, la raíz de David, ha vencido y puede abrir el libro y quitarle sus siete sellos.»',
    ...
    'El Cordero se acercó al que estaba sentado en el trono, y de su mano derecha tomó el libro.',
    ...
    'y entonaban un cántico nuevo, que decía: «Digno eres de tomar el libro y de abrir sus sellos, porque fuiste inmolado. Con tu sangre redimiste para Dios gente de toda raza, lengua, pueblo y nación,',
    ...
    'A grandes voces decían: «Digno es el Cordero inmolado de recibir el poder y las riquezas, la sabiduría y la fortaleza, la honra, la gloria y la alabanza.»',
    'Entonces oí que todo lo creado en el cielo, y en la tierra, y debajo de la tierra y en el mar, y todo lo que hay en ellos, decían: «Al que está sentado en el trono, y al Cordero, sean dadas la alabanza, la honra, la gloria y el poder, por los siglos de los siglos.»',
    'Los cuatro seres vivientes decían: «Amén.» Y los veinticuatro ancianos se inclinaron y adoraron.'
  ],
  // Capítulo 6
  [
    ...
    'Salió entonces otro caballo, éste de color rojo, y al que lo montaba se le dio una gran espada, junto con el poder de adueñarse de la paz de la tierra y de hacer que los hombres se mataran unos a otros.',
    ...
    'Yo miré, y vi aparecer un caballo descolorido, y el que lo montaba se llamaba Muerte. Tras él venía el Infierno. Recibió poder sobre la cuarta parte de la tierra, para matar con guerras, hambre y mortandad, y con las fieras de la tierra.',
    ...
    'El cielo se esfumó, como si fuera un pergamino que se enrolla, y todos los montes y las islas fueron removidas de su lugar.',
  ...
  // Capítulo 7
  [
    'Después de esto vi a cuatro ángeles que estaban de pie sobre los cuatro extremos de la tierra. Estos ángeles impedían que los cuatro vientos de la tierra soplaran sobre la tierra o sobre el mar, o sobre todo árbol.',
    'También vi que otro ángel venía por donde sale el sol. Tenía el sello del Dios vivo, y con grandes voces llamaba a los cuatro ángeles, los cuales habían recibido el poder de dañar a la tierra y al mar.',
    'Les dijo: «No dañen a la tierra, ni al mar ni a los árboles, hasta que a los siervos de nuestro Dios les hayamos puesto un sello en la frente.»',
    ...
    'doce mil de la tribu de Aser, doce mil de la tribu de Neftalí, doce mil de la tribu de Manasés,',
    ...
    'Yo le respondí: «Señor, tú lo sabes.» Entonces él me dijo: «Éstos han salido de la gran tribulación. Son los que han lavado y emblanquecido sus ropas en la sangre del Cordero.',
    'Por eso están delante del trono de Dios, y le rinden culto en su templo de día y de noche; y el que está sentado en el trono los protege con su presencia.',
  ...
  [
    ...
    'El rey que los gobierna es el ángel del abismo, cuyo nombre en hebreo es Abadón, y en griego, Apolión.2',
  ...
  [
    ...
    'Ellos tienen poder para cerrar el cielo e impedir que llueva durante los días de su profecía; tienen también poder para convertir el agua en sangre, y para azotar la tierra con toda clase de plagas, todas las veces que quieran.',
    ...
    'Decían: «Te damos gracias, Señor Dios Todopoderoso, el que eres, y el que eras, porque has tomado tu gran poder y has comenzado a reinar.',
    'Las naciones se han enfurecido, pero ha llegado tu ira, el tiempo de juzgar a los muertos y de recompensar a tus siervos los profetas, a los santos y a los que temen tu nombre, lo mismo grandes que pequeños, y de destruir a los que destruyen la tierra.»',
  ...
  [
    ...
    'También pudo verse en el cielo otra señal: Apareció un gran dragón rojo, con siete cabezas y diez cuernos, y con una diadema en cada cabeza.',
    ...
    'Entonces oí una fuerte voz en el cielo, que decía: «¡Aquí están ya la salvación y el poder y el reino de nuestro Dios, y la autoridad de su Cristo! ¡Ya ha sido expulsado el que día y noche acusaba a nuestros hermanos delante de nuestro Dios!',
    'Ellos lo vencieron por la sangre del Cordero y por la palabra que ellos proclamaron; siempre estuvieron preparados a entregar sus vidas y morir.',
    '¡Alégrense por eso, ustedes los cielos! ¡Alégrense ustedes, que los habitan! ¡Pero ay de ustedes, los que habitan la tierra y el mar! El diablo ha llegado a ustedes lleno de ira, porque sabe que le queda poco tiempo.»',
    'Cuando el dragón se dio cuenta de que había sido arrojado a la tierra, persiguió a la mujer que había dado a luz al hijo varón.',
  ...
  [
    ...
    'Cuando estaba en presencia de la primera bestia, cuya herida mortal fue sanada, ejercía toda la autoridad de ésta, y hacía que la tierra y sus habitantes la adoraran.',
    ...
    'También se le permitió infundir aliento a la imagen de la bestia, para que ésta hablara y mandara matar a todo aquel que no la adorara.',
  ...
  // Capítulo 14
  [
    'Miré, y vi que el Cordero estaba de pie sobre el monte de Sión, y que con él había ciento cuarenta y cuatro mil personas, las cuales tenían inscritos en la frente el nombre de él y el de su Padre.',
    ...
    'Éstos son los que jamás tuvieron contacto con mujeres, pues son vírgenes, y son los que siguen al Cordero por dondequiera que va. Fueron redimidos de entre toda la gente como los primeros frutos para Dios y para el Cordero.',
    'No se halló en sus labios mentira alguna, pues son irreprochables.',
    'Luego vi otro ángel, el cual volaba en medio del cielo. Tenía el evangelio eterno, para predicarlo a los habitantes de la tierra, es decir, a toda nación, raza, lengua y pueblo.',
    ...
    'A los dos ángeles los siguió un tercero, que a grandes voces decía: «El que adore a la bestia y a su imagen, y acepte llevar su marca en la frente o en la mano,',
    'también beberá del vino de la ira de Dios, que ha sido vaciado puro en la copa de su ira, y será atormentado con fuego y azufre delante de los santos ángeles y del Cordero.',
    'El humo de su tormento subirá por los siglos de los siglos, pues ni de día ni de noche tendrán reposo los que adoren a la bestia y a su imagen, ni nadie que acepte llevar la marca de su nombre.»',
    ...
    'Miré, y vi aparecer una nube blanca. Sobre esa nube estaba sentado alguien que parecía ser el Hijo del Hombre. Llevaba en la cabeza una corona de oro, y en la mano tenía una hoz afilada.',
    ...
    'El que estaba sentado sobre la nube lanzó su hoz sobre la tierra, y la cosecha de la tierra fue levantada.',
    'En ese momento, del templo que está en el cielo salió otro ángel. También llevaba una hoz afilada.',
    'Y un ángel más salió del altar, el cual tenía poder sobre el fuego. Con fuerte voz llamó al ángel que tenía la hoz afilada, y le dijo: «Usa tu afilada hoz, y vendimia los racimos de la tierra, porque sus uvas ya están maduras.»',
    'El ángel lanzó su hoz sobre la tierra y vendimió su viña, y luego echó las uvas en el gran lagar de la ira de Dios.',
    'Y se exprimieron las uvas en el lagar, fuera de la ciudad, y la sangre que salió del lagar les llegó a los caballos hasta los frenos, a una distancia de mil seiscientos estadios.'
  ],
  // Capítulo 15
  [
    ...
    'Entonaban el cántico de Moisés, el siervo de Dios, y también el cántico del Cordero. Decían: «¡Grandes y maravillosas son tus obras, Señor Dios Todopoderoso! ¡Justos y verdaderos son tus caminos, Rey de las naciones!',
    '¿Quién no te temerá, Señor? ¿Quién no glorificará tu nombre? ¡Sólo tú eres santo! Por eso todas las naciones vendrán y te adorarán, porque tus juicios se han manifestado.»',
    'Después de esto miré, y vi que en el cielo se abrió el templo donde está el tabernáculo del testimonio.',
  ...
  [
    ...
    'El tercer ángel derramó su copa sobre ríos y manantiales, y sus aguas se convirtieron en sangre.',
    ...
    'El séptimo ángel derramó su copa en el aire, y desde el trono en el templo salió una fuerte voz que decía: «Todo está hecho».',
    ...
    'La gran ciudad se partió en tres, y las ciudades de las naciones se vinieron abajo; entonces Dios se acordó de la gran Babilonia y le dio a beber de la copa que tenía el ardiente vino de su ira,',
  ...
  [
    ...
    'El ángel gritó con fuerte voz: «¡Ya ha caído! ¡Ya ha caído la gran Babilonia! Se ha convertido en refugio de demonios, en guarida de todo espíritu impuro; ¡está habitada de toda clase de aves inmundas y aborrecibles!',
    ...
    'pues son tantos sus pecados que llegan hasta el cielo, y Dios ha tomado en cuenta sus injusticias.',
    ...
    'Sentirán miedo al ver su tormento, y desde lejos dirán: «¡Ay de ti, la grande y poderosa ciudad de Babilonia! ¡Ay de ti, porque en el preciso momento llegó tu castigo!»',
    'Y los comerciantes de la tierra llorarán y harán lamentación por ella, porque ya nadie les comprará sus mercaderías',
    'ni sus cargamentos de oro, plata, piedras preciosas, perlas, telas de lino fino y seda, de color púrpura y rojo, y toda clase de madera aromática, toda clase de objetos de marfil, y maderas preciosas, cobre, hierro y mármol;',
    'canela, especias aromáticas, incienso, mirra, perfumes, vino, aceite, flor de harina, trigo, bestias, ovejas, caballos y carros, y aun esclavos, que son vidas humanas.',
    ...
    'y, al ver el humo de su incendio, exclamaron: «¿Qué otra ciudad podía compararse a esta gran ciudad?»',
    ...
    'Nunca más volverá a oírse en ti la música del arpa, de la flauta y de la trompeta; nunca más habrá en ti artífices de ningún oficio, ni volverá a oírse en ti el ruido de la piedra del molino.',
    'No volverá a alumbrar en ti ninguna lámpara, ni volverá a oírse la voz del esposo o de la esposa. Tus comerciantes eran los grandes personajes de la tierra, y con tus hechicerías engañaste a todas las naciones.',
    'Fue en ti donde se halló la sangre de los profetas y de los santos, y de todos los que han sido asesinados en la tierra.»'
  ],
  // Capítulo 19
  [
    ...
    'Yo me postré a sus pies para adorarlo, pero él me dijo: «¡No hagas eso! Yo soy consiervo tuyo, y de tus hermanos que retienen el testimonio de Jesús. Adora a Dios. Pues el testimonio de Jesús es el espíritu de la profecía.',
    ...
    'Pero la bestia fue apresada, y también el falso profeta que había hecho señales milagrosas delante de ella, con las que había engañado a los que recibieron la marca de la bestia y habían adorado su imagen. Estos dos fueron lanzados vivos a un lago de fuego que arde con azufre.',
  ...
  [
    ...
    'Ésta es la primera resurrección. Pero los otros muertos no volvieron a vivir hasta que se cumplieron los mil años.',
    'Bienaventurados y santos son los que tienen parte en la primera resurrección, pues la segunda muerte no tiene poder sobre ellos; al contrario, serán sacerdotes de Dios y de Cristo, y reinarán con él durante mil años.',
    'Al cabo de los mil años, Satanás fue puesto en libertad de su prisión,',
    ...
    'Y subieron por todo lo ancho de la tierra, y rodearon el campamento de los santos y la ciudad amada. Pero del cielo cayó fuego y los consumió.',
    ...
    'Luego la muerte y el Hades fueron lanzados al lago de fuego. Ésta es la muerte segunda.',
  ...
  [
    ...
    'La ciudad era cuadrada, pues medía lo mismo de ancho que de largo. Él midió la ciudad con la caña, y de largo y de ancho medía dos mil doscientos kilómetros.3',
    ...
    'Los cimientos de la muralla de la ciudad estaban adornados con toda clase de piedras preciosas. El primer cimiento era de jaspe; el segundo, de zafiro; el tercero, de ágata; el cuarto, de esmeralda;',
    ...
    'No vi en ella ningún templo, porque su templo son el Señor y Dios Todopoderoso, y el Cordero.',
    ...
    'Sus puertas jamás serán cerradas de día, y en ella no habrá noche.',
    'A ella serán llevadas las riquezas y la honra de las naciones,',
  ...
  [
    ...
    'Allí no volverá a haber noche; no hará falta la luz de ninguna lámpara ni la luz del sol, porque Dios el Señor los iluminará. Y reinarán por los siglos de los siglos.',
