// Auto-generated from RVC.xml — Eclesiastés 1–12
export default [
  // Capítulo 1
  [
  ...
  [
    ...
    'Y concluí que divertirse es una locura, y que los placeres no sirven de nada.',
    'En lo íntimo de mi ser me propuse agasajarme con vino, y ser lo más necio posible, sin dejar de mantenerme bajo el control de mi sabiduría. Quería ver qué de bueno sacan los mortales de sus ocupaciones de toda la vida bajo el cielo.',
    'Emprendí grandes obras, hice que me construyeran casas y que me plantaran viñas,',
    'tuve mis propios huertos y jardines, y allí planté toda clase de árboles frutales.',
    ...
    'Acumulé plata y oro, y tesoros que antes fueron de otros reyes y provincias. Tuve cantores y cantoras, y disfruté de los placeres humanos, ¡habidos y por haber!',
    ...
    'No les negué a mis ojos nada que desearan ver, ni conscientemente me aparté de placer alguno, porque en lo íntimo disfruté de todos mis afanes. ¡Ésa fue la recompensa de todos mis afanes!',
    ...
    'Entonces me dije a mí mismo: «Si lo mismo que le espera al necio, también me espera a mí, ¿qué caso tiene esforzarme por ser más sabio?» Concluí entonces que también esto es vanidad,',
    ...
    '¿Tener que dedicar sabiduría, conocimientos y rectitud, para luego dejarle el fruto de su trabajo a quien nunca se lo ganó? ¡Eso también es vanidad, y un mal muy grande!',
  ...
  [
    ...
    'También he visto que a los inicuos se les sepulta con honra, mientras que a los que frecuentaban el lugar santo se les echó al olvido en la misma ciudad donde se condujeron con rectitud. ¡Y también esto es vanidad!',
    ...
    'Por eso alabo a la alegría, pues los mortales no tenemos bajo el sol otro bien que no sea el de comer y beber y divertirnos. Sólo esto nos queda de tanto afanarnos durante la vida que Dios nos concede bajo el sol.',
    ...
    'Así pude ver todo lo que Dios ha hecho, y vi también que el hombre no alcanza a comprender todo lo que se hace bajo el sol. Por más que se esfuerce por entenderlo, no lo entenderá; y aun cuando el sabio asegure entenderlo, no por eso lo entenderá.'
  ],
  // Capítulo 9
  [
