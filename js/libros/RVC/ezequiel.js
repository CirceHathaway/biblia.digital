// Auto-generated from RVC.xml — Ezequiel 1–48
export default [
  // Capítulo 1
  [
    'El día cinco del mes cuarto del año treinta, yo, Ezequiel, me encontraba junto al río Quebar, entre los cautivos. De pronto, los cielos se abrieron y tuve visiones de parte de Dios.',
    'Habían pasado ya cinco años y cinco meses desde que el rey Joaquín había sido llevado cautivo.',
    'Yo, Ezequiel hijo de Buzi, era sacerdote, y ese día estaba en la tierra de los caldeos, junto al río Quebar, y la palabra del Señor vino a mí, y sobre mí se posó su mano.',
    'Me fijé, y vi que del norte venía un viento tempestuoso, junto con una nube impresionante envuelta en fuego y rodeada de un gran resplandor. En medio del fuego había algo semejante a bronce refulgente,',
    'y en medio de la nube se veía la figura de cuatro seres vivientes, todos ellos con apariencia humana.',
    ...
    'Tenían rostros y alas por los cuatro costados, y por debajo de sus alas tenían manos humanas.',
    ...
    'Visto de frente, su rostro era de aspecto humano, pero del lado derecho los cuatro tenían cara de león; del lado izquierdo tenían cara de toro, y por la nuca tenían cara de águila.',
    ...
    'y con la rapidez del relámpago los seres vivientes corrían de un lado a otro.',
    'Mientras observaba yo a estos seres vivientes, vi que junto a ellos, y en cada uno de los cuatro costados, había una rueda en el suelo.',
    ...
    'Sus aros eran bastante altos, y las cuatro ruedas lanzaban destellos en su derredor.',
    'Si los seres vivientes avanzaban, las ruedas avanzaban con ellos; si los seres vivientes se elevaban, también se elevaban las ruedas.',
    ...
    'Si ellos avanzaban, también ellas avanzaban; si se detenían, también ellas se detenían; si se elevaban del suelo, también ellas se elevaban, porque el espíritu de los seres vivientes estaba en ellas.',
    ...
    'Cuando caminaban, oía yo que sus alas sonaban como un conjunto de muchas aguas, como la voz del Omnipotente, como el estruendo de una muchedumbre, o como la alharaca de un ejército. Cuando se detenían, bajaban las alas,',
    'de modo que al detenerse y bajar las alas podía oírse una voz por encima de la bóveda que estaba sobre ellos.',
    ...
    'Vi también algo parecido al bronce refulgente, y en su interior y a su alrededor había algo parecido a un fuego; tanto de lo que parecían ser sus lomos para arriba, como de sus lomos para abajo, vi algo parecido al fuego, y esto estaba rodeado de un resplandor.',
    'Ese resplandor que lo rodeaba se parecía al arco iris, cuando aparece en las nubes después de un día lluvioso. Ésta fue la visión que tuve de lo que parecía ser la gloria del Señor. Al verla, me incliné sobre mi rostro, y oí la voz de alguien que hablaba.'
  ],
  // Capítulo 2
  [
  ...
  [
    ...
    'Cuando el sitio de la ciudad llegue a su fin echarás al fuego una tercera parte de ellos, a la vista de todos; otra tercera parte la desmenuzarás con espada por toda la ciudad; y la tercera parte restante la arrojarás al viento. Yo voy a perseguirlos espada en mano.',
    'Toma también unos pocos de tus cabellos, y sujétalos en el borde de tu manto,',
    'otros pocos de ellos los echarás al fuego, para que se quemen, y de allí el fuego se propagará por toda el pueblo de Israel.»',
    'Así ha dicho Dios el Señor: «¡Aquí tienen a Jerusalén! La establecí en medio de las naciones y de los países a su alrededor.',
    ...
    'Por lo tanto, así ha dicho el Señor: «Ustedes se han portado peor que las naciones a su alrededor. No han seguido mis mandamientos, ni han obedecido mis leyes. ¡Ni siquiera se han sujetado a las leyes de las naciones a su alrededor!.»',
    ...
    'Por haber profanado mi santuario con todas tus abominaciones, yo, el Señor, juro que voy a destruirte por completo y sin misericordia. ¡No te voy a perdonar! —Palabra del Señor.',
    ...
    'Así se calmará mi furor y se saciara mi enojo. Así quedaré satisfecho. Y una vez que se haya calmado mi enojo, ustedes sabrán que yo, el Señor, he hablado.',
    '»Voy a dejarte en ruinas. Serás la burla de las naciones que te rodean, y de todos los que pasen a tu lado.',
    'Cuando en mi furor e indignación te reprenda y dicte yo sentencia contra ti, serás motivo de burla y oprobio entre las naciones que te rodean. ¡Les servirás de escarmiento y de motivo de espanto. Yo, el Señor, lo he dicho.',
  ...
  [
    ...
    'Sus altares serán destruidas, y sus imágenes del sol serán hechas pedazos. Voy a hacer que sus muertos caigan delante de sus ídolos,',
    ...
    'Dondequiera que ustedes habiten, sus ciudades quedarán desiertas y los lugares altos serán destruidos; sus altares quedarán en ruinas, y sus ídolos quedarán hechos añicos; sus imágenes del sol serán destruidas, lo mismo que todo lo que han hecho.',
    'Cuando la gente caiga muerta en medio de ustedes, sabrán entonces que yo soy el Señor.',
    ...
    'Así sabrán ellos que yo soy el Señor, y que no en vano dije que les traería este mal.»',
    'Así ha dicho Dios el Señor: «Da de palmadas con tus manos, y de golpes con tus pies. Llora por todas las acciones repugnantes que ha cometido el pueblo de Israel, porque caerán a filo de espada, o por el hambre o la peste.',
    ...
    'Cuando sus cadáveres caigan ante sus ídolos, y alrededor de sus altares, y sobre toda colina elevada y en las cimas de todo monte, o bajo la fronda de los árboles y de las espesas encinas, que es donde ofrecieron incienso a todos sus ídolos, sabrán que yo soy el Señor.',
    'Yo extenderé mi mano contra ellos, y dondequiera que vivan haré que la tierra quede más árida y desolada que el desierto de Diblat. ¡Y entonces sabrán que yo soy el Señor!»'
  ],
  // Capítulo 7
  [
    'La palabra del Señor vino a mí, y me dijo:',
    ...
    'Así ha dicho Dios el Señor: «¡Fíjate bien, que viene una calamidad!',
    ...
    '»Ya viene el día, ya viene. Ya ha llegado la mañana. Ha florecido ya la vara, y ha reverdecido la soberbia.',
    ...
    'Arrojarán su plata y su oro a la calle, y no habrá quien los recoja; en el día del furor del Señor, ¡ni su plata ni su oro podrá salvarlos! No podrán saciar su apetito ni satisfacer su hambre, porque sus riquezas y su maldad los hicieron tropezar.',
    ...
    'El rey se vestirá de luto, el príncipe se cubrirá de tristeza, y al pueblo le temblarán las manos. Y es que voy a darles lo que merecen sus acciones, y a dictar sentencia contra ellos conforme a su manera de impartir justicia. Así sabrán que yo soy el Señor.»'
  ],
  // Capítulo 8
  [
    'El día cinco del mes sexto del sexto año, yo estaba sentado en mi casa, en compañía de los ancianos de Judá, cuando de pronto la mano de Dios el Señor se posó sobre mí.',
    ...
    '¡y allí estaba la gloria del Dios de Israel, tal y como la había visto en la visión del campo!',
    'Y me dijo: «Hijo de hombre, dirige ahora la mirada hacia el lado norte.» Yo dirigí la mirada hacia el norte, y allí en el norte pude ver, junto a la puerta del altar, y en la entrada misma, la imagen que despierta los celos de Dios.',
    'Entonces me dijo: «Hijo de hombre, ¡mira lo que éstos hacen! ¡Mira las grandes abominaciones que el pueblo de Israel perpetra aquí para alejarme de mi santuario! Pero sigue viendo, y verás abominaciones aún mayores.»',
    'Me llevó entonces a la entrada del atrio, y me fijé, y vi en la pared un agujero.',
    'Me dijo entonces: «Hijo de hombre, haz un hoyo en la pared.» En cuanto hice el hoyo en la pared, vi una puerta.',
    'Entonces me dijo: «Entra, y ve cuántas cosas malvadas y repugnantes hacen éstos aquí.»',
    ...
    'Delante de ellos estaban setenta ancianos del pueblo de Israel, cada uno con su incensario en su mano, y en medio de ellos estaba Jazanías hijo de Safán. Y subía una espesa nube de incienso.',
    'Me dijo entonces: «Hijo de hombre, ¡mira lo que hacen a escondidas los ancianos del pueblo de Israel! ¡Todos ellos tienen sus alcobas pintadas de imágenes! Y es que dicen: “El Señor no nos ve. El Señor ha abandonado la tierra.”»',
    'Luego me dijo: «Sigue mirando, y vas a ver cosas aún más repugnantes que éstos hacen.»',
    ...
    'Allí me dijo: «¿Lo ves, hijo de hombre? Pues sigue mirando, y verás cosas aún más repugnantes que éstas.»',
    ...
    'Entonces me dijo: «¿Lo has visto, hijo de hombre? ¿Acaso cree el pueblo de Judá que es poca cosa cometer aquí actos tan repugnantes? No sólo han llenado de maldad la tierra, sino que además quieren provocar mi enojo. ¡Hasta me hacen oler sus hediondos ramos!',
  ...
  [
    ...
    'Entonces la gloria del Dios de Israel se elevó por encima del querubín sobre el que había estado, y se detuvo en el umbral del templo; allí el Señor llamó al hombre que estaba vestido de lino y que tenía en la cintura un tintero de escribano,',
    'y le dijo: «Pasa ahora por en medio de la ciudad de Jerusalén, y pon una señal en la frente de quienes gimen y claman a causa de todas las cosas repugnantes que se cometen en ella.»',
  ...
  [
    ...
    'Y sucedió que, mientras yo profetizaba, Pelatías hijo de Benaías murió. Entonces me incliné de cara al suelo, y con gran voz clamé: «¡Ay, Señor y Dios! ¿Vas a destruir del todo al remanente de Israel?»',
  ...
  [
    ...
    'Échate al hombro el equipaje y sal con él de noche, con el rostro cubierto y sin mirar al suelo. Haz todo esto a la vista de ellos, porque yo te he puesto de ejemplo para el pueblo de Israel.»',
    'Yo hice todo lo que se ordenó hacer. A plena luz del día saqué mi equipaje, como si me estuviera yendo al cautiverio, y al caer la tarde con mis propias manos me abrí paso a través de la muralla. Salí de noche con mi equipaje al hombro, a la vista de todos ellos.',
    ...
    'Sin embargo, dejaré que unos pocos de ellos escapen de la espada, del hambre y de la peste, para que cuenten todos sus hechos repugnantes entre las naciones a las que lleguen. Así sabrán que yo soy el Señor.»',
    'La palabra del Señor vino a mí, y me dijo:',
    ...
    'Las ciudades ahora habitadas quedarán abandonadas, y el país será destruido. Así sabrán que yo soy el Señor.»',
    'La palabra del Señor vino a mí, y me dijo:',
    ...
    'Yo, el Señor, seré quien hable, y lo que yo diga se cumplirá. Ya no habrá más demoras, pueblo rebelde. Voy a hablar, y lo que yo diga se cumplirá. ¡Y ustedes vivirán para verlo!» Palabra de Dios el Señor.',
    'La palabra del Señor vino a mí, y me dijo:',
    ...
    'Así que ve y diles de mi parte: “Ya no habrá más demoras. Lo que yo diga, se cumplirá.”» Palabra de Dios el Señor.'
  ],
  // Capítulo 13
  [
    'La palabra del Señor vino a mí, y me dijo:',
  ...
  [
    ...
    'Entonces la palabra del Señor vino a mí, y me dijo:',
    '«Hijo de hombre, en lo íntimo de su corazón estos hombres adoran a los ídolos. ¡En la cara se les ve el tropiezo de su maldad! ¿Y todavía he de permitir que vengan a consultarme?',
    'Habla con ellos, pero diles de mi parte que yo, el Señor su Dios, he dicho: “A los israelitas que en lo íntimo de su corazón adoren a los ídolos y lleven marcado en el rostro el tropiezo de su maldad, y vengan a consultar al profeta, yo el Señor le responderé conforme a la multitud de sus ídolos,',
    ...
    'Porque si algún israelita, o algún extranjero que habite en Israel, viene en busca del profeta para consultarlo y preguntarle por mí, yo mismo le responderé, si es que se ha apartado de mí, y en lo íntimo de su corazón adora a los ídolos, y lleva marcado en el rostro el tropiezo de su maldad.',
    'Yo me opondré a ese hombre, y lo pondré por ejemplo y escarmiento, y lo expulsaré de mi pueblo. Así sabrán que yo soy el Señor.',
    ...
    'La palabra del Señor vino a mí, y me dijo:',
    '«Hijo de hombre, si la tierra se obstinara en pecar contra mí, yo descargaría mi mano contra ella y le cortaría el abasto de pan para que sufriera de hambre, y acabaría con hombres y animales.',
    'En caso de que allí vivieran Noé, Daniel y Job, sólo estos tres hombres se salvarían por su justicia. Palabra de Dios el Señor.',
    '»Y si yo hiciera que los animales feroces recorrieran la tierra para asolarla, y ésta quedara tan asolada que por causa de esas fieras nadie se atreviera a pasar por ella,',
    'yo, su Señor y Dios, les juro que, si estos tres hombres vivieran en la tierra, ni sus hijos ni sus hijas saldrían bien librados; sólo ellos se salvarían, y la tierra quedaría desolada.',
    ...
    'yo, su Señor y Dios, les juro que, si estos tres hombres vivieran en ella, ni sus hijos ni sus hijas saldrían bien librados; sólo ellos se salvarían.',
    '»Y si yo enviara peste sobre la tierra y descargara sobre ella mi enojo y les quitara la vida a hombres y animales,',
    'yo, su Señor y Dios, les digo que si Noé, Daniel y Job vivieran en ella, ni sus hijos ni sus hijas saldrían bien librados; sólo ellos se salvarían por su justicia.»',
    ...
    'Sin embargo, voy a dejar en ella un remanente de jóvenes y doncellas, que serán llevados a otro país. Pero ellos volverán a ustedes, y ustedes verán su conducta y sus acciones, y así se consolarán del mal que envié sobre Jerusalén y de todo lo que la hice sufrir.',
  ...
  [
    ...
    'Sólo el que peque merece la muerte. Ningún hijo pagará por el pecado de su padre, ni tampoco ningún padre pagará por el pecado de su hijo. El hombre justo será juzgado por su justicia, y el malvado será juzgado por su maldad.',
  ...
  [
    ...
    'y diles de mi parte: “Hubo un día en que yo, su Señor y Dios, escogí a Israel y levanté mi mano para hacerle un juramento a los descendientes de Jacob. Fue en Egipto donde levanté mi mano y me di a conocer a ellos. Bajo juramento les dije: ‘Yo soy el Señor su Dios.’',
    'Ese día levanté mi mano y les juré que los sacaría de Egipto y los llevaría a la tierra que les había provisto, a la tierra más hermosa de todas las tierras, ¡tierra que fluye leche y miel!',
    'Ese día les dije: ‘Cada uno de ustedes debe alejarse de sus hechos repugnantes y no contaminarse con los ídolos de Egipto. Yo soy el Señor su Dios.’',
    '”Pero ellos se rebelaron contra mí, y no quisieron obedecerme. No se alejaron de sus hechos repugnantes ni se apartaron de los ídolos de Egipto. Entonces les dije que allí, en Egipto, desahogaría mi enojo sobre ellos, para calmarme.',
    'Sin embargo, actué en su favor y los saqué de Egipto, para que ante los ojos de las naciones entre las que se encontraban, y las cuales me conocían, mi nombre no quedara en entredicho.',
    'Yo los saqué de Egipto. Yo los llevé al desierto',
    ...
    '”Pero en el desierto el pueblo de Israel se rebeló contra mí. No siguieron mis estatutos, que dan vida a todo el que los cumple, sino que desecharon mis decretos y abiertamente profanaron mis días de reposo. Por eso allí, en el desierto, les dije que descargaría sobre ellos mi ira y los exterminaría.',
    ...
    'Y esto, porque despreciaron mis decretos y no siguieron mis estatutos, y porque profanaron mis días de reposo al seguir a sus ídolos con todo el corazón.',
    ...
    'y santifiquen mis días de reposo. Hagan de ellos una señal entre nosotros, y reconozcan que yo soy el Señor su Dios.’',
    '”Pero sus hijos se rebelaron contra mí. No siguieron mis estatutos ni cumplieron con mis decretos, los cuales dan vida a todo el que los cumple. En vez de ponerlos en práctica, profanaron mis días de reposo. Por eso allí en el desierto dije que descargaría sobre ellos mi enojo, para calmarme.',
    ...
    'porque en vez de poner en práctica mis decretos rechazaron mis estatutos y profanaron mis días de reposo, y no vieron otra cosa que los ídolos de sus padres.',
    'Por eso yo también les di estatutos y decretos que no eran buenos ni podían darles vida.',
    'Cuando pasaban por el fuego a todos sus primogénitos, yo los contaminé con sus propias ofrendas. Lo hice para que se horrorizaran y reconocieran que yo soy el Señor.',
    ...
    'Porque yo los traje a la tierra que juré darles. Levanté mi mano y les hice ese juramento. Pero ellos pusieron los ojos en toda colina y en todo árbol frondoso, y allí ofrecieron sacrificios y presentaron sus irritantes ofrendas, quemaron incienso y derramaron libaciones.',
    'Yo les pregunté por qué iban a ese lugar alto. Y a partir de entonces ese lugar se conoce con el nombre de ‘Bama’.1',
    ...
    '¡Pues sí! Se han contaminado al presentar ante sus ídolos sus ofrendas y pasar a sus hijos por el fuego. ¡Y esto lo hacen hasta el día de hoy! ¿Y así espera el pueblo de Israel que yo les responda? ¡Pues yo, su Señor y Dios, les juro que no voy a responderles!',
    ...
    'Pero yo, su Señor y Dios, les juro que reinaré sobre ustedes con mano fuerte y brazo extendido, y que daré rienda suelta a mi enojo',
    ...
    '”Para que ustedes puedan hacer un pacto conmigo, los haré pasar por debajo de mi vara,',
    'para apartar de entre ustedes a los que se rebelaron contra mí. Los sacaré de la tierra a la que emigraron, aunque no podrán entrar en la tierra de Israel. Así sabrán que yo soy el Señor.',
    ...
    'Todo el pueblo, todos los que habitan en la tierra de Israel, debe adorarme en mi santo monte, en el alto monte de Israel. Allí los aceptaré. Allí demandaré sus ofrendas y sus primeros frutos, lo mismo que sus dones y todo lo que quieran consagrarme.” Palabra de Dios el Señor.',
    '»Cuando yo los haya sacado de entre los pueblos y los haya reunido de los países por donde ahora están esparcidos, los recibiré como si fueran incienso de aroma agradable, y a la vista de las naciones seré santificado en ustedes.',
    ...
    'Pueblo de Israel, cuando yo actúe en favor de ustedes, lo haré por causa de mi nombre y no por su mal proceder ni por sus acciones perversas. Así sabrán que yo soy el Señor.» Palabra de Dios el Señor.',
    'La palabra del Señor vino a mí, y me dijo:',
    ...
    'y dile: “Bosque del Néguev, oye la palabra del Señor. Así ha dicho Dios el Señor: Voy a prenderte fuego, para que ardan todos tus árboles, verdes y secos. Las llamas de ese fuego no se apagarán hasta que hayan consumido todo el bosque, desde el sur hasta el norte.',
    'No se apagará hasta que todos hayan visto que yo, el Señor, fui quien lo encendió.”»',
  ...
  [
    ...
    'Y cuando te pregunten por qué lloras, diles que es por la noticia de lo que está por suceder. Cuando se sepa la noticia, todo corazón desfallecerá y toda mano se debilitará; todo ánimo se angustiará y toda rodilla temblará. Viene como un torrente, y es inevitable.» Palabra de Dios el Señor.',
    'La palabra del Señor vino a mí, y me dijo:',
    '«Hijo de hombre, profetiza y diles que así ha dicho su Dios y Señor: »La espada está afilada y pulida.',
    ...
    '¡Grita y llora, hijo de hombre! Mi espada va a caer sobre mi pueblo y sobre todos los príncipes de Israel. ¡Todos ellos caerán bajo su filo! ¡Hiérete con ella en el muslo,',
    'que ésta es un prueba muy dura! No importa que la espada desprecie al cetro, porque la espada dejará de existir. Palabra de Dios el Señor.',
    ...
    'Por lo tanto, así ha dicho Dios el Señor: «Ustedes han hecho que se recuerde la maldad que han cometido. Sus traiciones y pecados han quedado al descubierto. Por eso, por haber traído esto a la memoria, caerán en las manos del rey.',
    '»Y a ti, profano e impío príncipe de Israel, te ha llegado el día. Tu maldad ha llegado al colmo.',
    ...
    '»Y tú, hijo de hombre, profetiza contra los amonitas y diles de mi parte acerca de sus ofensas: “Así ha dicho Dios el Señor: La espada ya está desenvainada y lista para degollar; la espada está pulida y resplandece para masacrar.',
  ...
  [
    ...
    'que desde su juventud se prostituyeron en Egipto, pues dejaron que les estrujaran y manosearan sus pechos virginales.',
    ...
    '»Aholá me fue infiel. Todavía era mi mujer cuando se enamoró de los asirios, que eran vecinos suyos, y los hizo sus amantes',
    'al ver que todos ellos eran jóvenes y atractivos, gobernadores y capitanes vestidos de púrpura, soldados de caballería.',
    ...
    'Por eso la dejé caer en manos de sus amantes los asirios, de los que ella se había enamorado.',
    ...
    'Pero Aholibá se corrompió más todavía. Cuando en las paredes vio pintadas coloridas imágenes de caldeos',
    ...
    'Fue así como los babilonios se allegaron a ella en su lecho de amores, y la contaminaron, y también ella se contaminó con ellos, hasta quedar hastiada.',
    ...
    'Y sus fornicaciones fueron en aumento, pues trajo a la memoria sus días de juventud, cuando se prostituyó en Egipto.',
    ...
    'Vendrán los babilonios, y todos los caldeos; los de Pecod, Soa y Coa, y los asirios; todos ellos jóvenes y atractivos, gobernadores y capitanes, nobles y distinguidos; todos ellos soldados de caballería.',
    'Vendrán contra ti con carros y carretas de guerra, y con grandes ejércitos; te rodearán, armados de escudos, paveses y yelmos, y yo les permitiré dictar sentencia contra ti de acuerdo con sus leyes.',
    'Descargaré mi enojo sobre ti, y con su furia te maltratarán; te quitarán la nariz y las orejas, y los que te sobrevivan caerán a filo de espada. Se llevarán por la fuerza a tus hijos y a tus hijas, y tus sobrevivientes serán consumidos por el fuego.',
    ...
    'Todo esto se hará contigo porque fuiste en pos de las naciones para prostituirte con ellas, y para contaminarte con sus ídolos.',
    'Puesto que seguiste los pasos de tu hermana, yo te haré beber del mismo cáliz.»',
    'Así ha dicho Dios el Señor: «Beberás del mismo cáliz de tu hermana, hondo y ancho y de gran capacidad. Serás la burla de las naciones, que te pondrán en ridículo.',
    ...
    'El Señor me dijo: «Hijo de hombre, ¿qué, no vas a dictar sentencia contra Aholá y Aholibá? ¿No vas a reprocharles sus hechos repugnantes?',
    'Son unas adúlteras, unas asesinas, ¡amantes de sus ídolos! A los hijos que me dieron, ¡los hicieron pasar por el fuego y los quemaron!',
    ...
    'Durante el banquete podían oírse las voces de gente que se divertía, y junto con el común de la gente vinieron los sabeos del desierto, a los que pusieron pulseras en las manos y coronaron con bellas diademas.',
    '»Al ver a estas inveteradas adúlteras, pensé: ¿Acaso éstos todavía van a tener relaciones sexuales con ellas?',
    '¡Porque han venido a verlas, como quien va en busca de rameras! ¡Así han venido con estas depravadas de Aholá y Aholibá!',
  ...
  [
    ...
    'Yo, el Señor, he hablado. No voy a cambiar de parecer ni voy a tener misericordia de ti, sino que vendré y te juzgaré de acuerdo con tus hechos y tu mal proceder.» Palabra de Dios el Señor.',
    'La palabra del Señor vino a mí, y me dijo:',
  ...
  [
    ...
    'Diles que oigan la palabra de Dios el Señor. Así dice Dios el Señor: “Cuando mi santuario era profanado y la tierra de Israel era asolada, y el pueblo de Judá era llevado en cautiverio, tú te burlaste de todo esto.',
    ...
    'Haré de Rabá un pastizal de camellos, y de Amón un redil de ovejas. Así sabrán que yo soy el Señor.”',
    '»Porque así ha dicho Dios el Señor: “Por cuanto alegre aplaudías y azotabas los pies, y burlonamente te regocijabas al ver la tierra de Israel,',
    'yo voy a extender mi mano contra ti. Voy a entregarte a las naciones, para que seas saqueada. Voy a eliminarte de entre los pueblos, y a hacerte desaparecer de entre los países. ¡Voy a exterminarte! Así sabrás que yo soy el Señor.”»',
    'Así ha dicho Dios el Señor: «Moab y Seir dijeron que el pueblo de Judá es como todos los otros pueblos.',
    'Por eso, voy a hacer una brecha en los costados de las ciudades limítrofes de Moab, en las hermosas tierras de Bet Yesimot, Baal Megón y Quiriatayin.',
    ...
    'Además, dictaré sentencia contra Moab, y así sabrán que yo soy el Señor.»',
    'Así ha dicho Dios el Señor: «Los de Edom tomaron venganza del pueblo de Judá, y no sólo se vengaron de ellos sino que cometieron muchos crímenes.»',
    'Por eso, así ha dicho Dios el Señor: «Yo también extenderé mi mano contra Edom, y los destruiré. Acabaré con su gente y sus ganados. ¡Desde Temán hasta Dedán caerán a filo de espada!',
    ...
    'Así ha dicho Dios el Señor: «La venganza de los filisteos fue artera. Por causa de antiguas enemistades destruyeron a Judá.»',
    ...
    'Grande será mi venganza contra ellos, y las reprensiones de mi ira. Cuando me vengue de ellos, sabrán que yo soy el Señor.»'
  ],
  // Capítulo 26
  [
    ...
    'Por eso yo, el Señor y Dios, estoy en contra de Tiro, y voy a lanzar contra Tiro a muchas naciones, que la azotarán como las olas del mar.',
    'Las murallas y las torres de Tiro se vendrán abajo. ¡Voy a barrerla por completo! ¡Voy a dejarla lisa como una peña!',
    ...
    'Sí, así ha dicho Dios el Señor: «Tiro, del norte voy a traer contra ti al rey Nabucodonosor de Babilonia, que es rey entre los reyes, y que cuenta con caballos y carros de guerra, y con soldados de caballería y grandes ejércitos.',
    ...
    'Se robarán tus riquezas, saquearán tus mercaderías, derribarán tus murallas, y destruirán tus bellas mansiones. ¡Hasta tus piedras, tu madera y tu polvo lo echarán a las aguas!',
    ...
    'Así ha dicho Dios el Señor a Tiro: «Cuando caigas estruendosamente, y griten tus heridos y haya en tus calles una gran matanza, ¡hasta las costas se estremecerán!',
    'Entonces todos los príncipes del mar descenderán de sus tronos, y se quitarán sus mantos; se despojarán de sus ropas bordadas y se cubrirán de espanto; sentados en el suelo, y al verte se espantarán y temblarán a cada instante.',
    ...
    'Así ha dicho Dios el Señor: «Yo te convertiré en una ciudad desierta, en una ciudad deshabitada. Haré que el mar suba hasta ti, y que sus muchas aguas te cubran.',
    'Te hundiré hasta lo más profundo de la tierra, te sepultaré con los pueblos de tiempos pasados; quedarás como los desiertos antiguos, como los que descienden al sepulcro, y nunca más volverás a ser habitada ni tendrás esplendor en la tierra de los vivientes.',
  ...
  [
    'La palabra del Señor vino a mí, y me dijo:',
    '«Tú, hijo de hombre, dedica este lamento a Tiro,',
    ...
    '»¡Ah, Tiro, que tuviste por remeros a gente de Sidón y de Arvad, y por timoneles a tus sabios!',
    'Tus barcos eran calafateados por los más hábiles obreros de Gebal; los marinos de todas las flotas del mar venían a ti para hacer negocios.',
    '»En tus ejércitos militaban soldados de Persia, Lud y Fut; de ti pendían espléndidos escudos y yelmos.',
    'Tu ejército y los mercenarios de Arvad vigilaban las murallas en tu derredor, y los gamadeos permanecían en tus torres; sus escudos pendían de tus murallas, lo cual resaltaba su belleza.',
    ...
    'Israel y Judá hacían negocios contigo, y a cambio te daban trigo de Minit y Panag, lo mismo que miel, aceite y resina.',
    'Eran tantos tus productos y tan abundante tu riqueza que Damasco hacía negocios contigo con vino de Jelbón y lana blanca.',
    'Dan y Javán venían a tus ferias, y en tu mercado ofrecían hierro forjado, mirra destilada y caña aromática.',
    'Dedán te vendía preciosos paños para que tapizaras tus carros.',
    'Arabia y todos los príncipes de Cedar hacían negocios contigo, y te pagaban con corderos, carneros y machos cabríos.',
    'También fueron tus clientes los mercaderes de Sabá y de Ragama; venían a tus ferias y te pagaban con oro y con sus mejores perfumes, y con toda clase de piedras preciosas.',
    'Contigo negociaban Harán, Cane, Edén, y los mercaderes de Sabá, Asiria y Quilmad.',
    'Estos clientes tuyos te compraban mantos de púrpura y telas bordadas, y baúles con preciosos vestidos, cordones trenzados y madera de cedro.',
    ...
    'Tus remeros te llevaron a grandes mares. Pero el viento solano te azotará en alta mar.',
    'Un día te hundirás en el fondo del mar, y contigo se hundirán tus riquezas, tus mercaderías y todo lo que vendías, junto con tus remeros y tus pilotos, tus calafateadores, tus agentes de negocios, tus guerreros y la tripulación entera.',
    'Las costas temblarán cuando escuchen los gritos angustiados de tus marineros.',
    'Los remeros abandonarán sus barcos, y junto con los pilotos se quedarán en tierra.',
    'Entonces dejarán oír su voz por ti, y gritarán amargamente; se echarán polvo sobre la cabeza y se revolcarán en ceniza.',
  ...
  [
    ...
    'A sus calles enviaré peste y sangre, y en sus calles la gente caerá a filo de espada, pues por todos lados la espada se levantará contra ella. Así sabrán que yo soy el Señor.',
    ...
    'Así ha dicho Dios el Señor: «Cuando yo reúna al pueblo de Israel de entre los pueblos por los que ahora está esparcido, me santificaré en ellos a la vista de las naciones, y ellos habitarán en la tierra que yo le di a mi siervo Jacob.',
    '»Cuando yo dicte sentencia contra todos los pueblos vecinos que los han despojado, ellos habitarán su tierra en paz, y edificarán casas, y plantarán viñas, y vivirán tranquilos. Así sabrán que yo soy el Señor su Dios.»'
  ],
  // Capítulo 29
  [
    'El día doce del mes décimo del año décimo, la palabra del Señor vino a mí, y me dijo:',
    '«Hijo de hombre, dirige ahora la mirada hacia el faraón, el rey de Egipto, y profetiza contra él y contra todos los egipcios.',
    ...
    '”Yo estoy contra ti, Egipto, y contra tus ríos. Desde Migdol hasta Sevene, y hasta los linderos con Etiopía, voy a dejarte en ruinas y en la soledad del desierto.',
    'Durante cuarenta años quedarás deshabitada, y no pondrá un pie en ti ningún caminante, y ni siquiera un animal.',
    'Entre las tierras asoladas, tú, Egipto serás la más asolada; durante cuarenta años, entre las ciudades destruidas, tus ciudades serán las más destruidas. Yo esparciré a los egipcios por todas las naciones y por todos los países.”',
    ...
    'Nunca más volverá a ser el punto de apoyo para el pueblo de Israel, sino que hará recordar a Israel su pecado de poner los ojos en ellos.” Así sabrán que yo soy Dios el Señor.»',
    'El día primero del mes primero del año veintisiete, la palabra del Señor vino a mí, y me dijo:',
    '«Hijo de hombre, el rey Nabucodonosor de Babilonia lanzó con su ejército un feroz ataque contra Tiro, al grado de que todos perdieron el cabello y quedaron con la espalda desollada. ¡Pero ni él ni su ejército ganaron nada de su ataque contra Tiro!',
    'Por eso Dios el Señor ha dicho: “Voy a dejar que Egipto caiga en manos de Nabucodonosor, el rey de Babilonia. Voy a dejar que él se apodere de sus riquezas, y que recoja sus despojos como botín de guerra. Con eso, su ejército quedará bien pagado.',
    'Al atacar a Egipto, Nabucodonosor me hizo un servicio. Por eso voy a poner a Egipto en sus manos.” Palabra de Dios el Señor.',
    '»Cuando llegue el día, haré que retoñe el poder del pueblo de Israel, y a ti, en presencia de ellos te devolveré el habla. Así sabrán que yo soy el Señor.»'
  ],
  // Capítulo 30
  [
    'La palabra del Señor vino a mí, y me dijo:',
    '«Hijo de hombre, profetiza y di que yo, Dios el Señor, he dicho: “¡Ay de aquel día! ¡Laméntenlo!”',
    'Ya se acerca el día. Sí, ya está cerca el día del Señor. Será un día nublado, un día de castigo para las naciones.',
    'La espada vendrá contra Egipto. Cuando en Egipto caigan los heridos, Etiopía temblará de miedo; y se apoderarán de sus riquezas, y sus fundamentos serán destruidos.',
    'Etiopía, Fut, Lud, toda Arabia, Libia, y sus aliados, caerán con ellos a filo de espada.»',
    ...
    '»Entre las tierras asoladas, serán los países más asolados; entre las ciudades en ruinas, serán sus ciudades las más arruinadas.',
    'Cuando yo le prenda fuego a Egipto, y todos sus aliados sean derrotados, sabrán que yo soy el Señor.',
    'Cuando llegue ese día, y ese día viene, de mi presencia saldrán mensajeros en naves para espantar a la confiada Etiopía, y se espantarán como cuando castigué a Egipto.»',
    ...
    'A Egipto le prenderé fuego, Sin experimentará un gran dolor: y Tebas será destrozada, y no tendrá fin la angustia de Menfis.',
    ...
    'Voy a dictar sentencia contra Egipto, y así sabrán que yo soy el Señor.»',
    'El día siete del mes primero del año undécimo, la palabra del Señor vino a mí, y me dijo:',
    '«Date cuenta, hijo de hombre, que al rey de Egipto le he roto su poderoso brazo, y nadie se lo ha vendado ni le ha aplicado ningún medicamento; tampoco se lo han ligado con un torniquete para darle la fuerza suficiente de sostener la espada.»',
    'Por tanto, así ha dicho Dios el Señor: «Yo estoy en contra del faraón, el rey de Egipto. Y voy a quebrarle los brazos, lo mismo el fuerte que el fracturado, para que la espada se le caiga de las manos.',
  ...
  [
    ...
    'Con su tupido ramaje yo lo embellecí; todos los árboles que estaban en Edén, en el huerto de Dios, lo envidiaban.»',
    ...
    'Así ha dicho Dios el Señor: «El día que ese cedro descendió al sepulcro, le ordené al abismo guardar luto por él; detuve sus ríos, y las muchas aguas dejaron de correr. Por él cubrí de tinieblas al Líbano, y todos los árboles del bosque se secaron.',
    'Cuando lo hice descender al sepulcro, junto con todos los que bajan al sepulcro, con el estruendo de su caída hice temblar a las naciones. En las profundidades de la tierra, todos los mejores árboles del Edén y del Líbano, todos los que beben aguas, fueron consolados.',
  ...
  [
    ...
    'Por el contrario, si tú le adviertes al impío que se aparte de su mal camino, y éste no te hace caso, morirá por causa de su pecado, pero tú habrás puesto a salvo tu vida.',
  ...
  [
    'La palabra del Señor vino a mí, y me dijo:',
    '«Hijo de hombre, profetiza contra los pastores de Israel; profetiza, y diles que yo, su Señor y Dios, he dicho: »¡Ay de ustedes, los pastores de Israel, que sólo cuidan de sí mismos! ¿Acaso no son los pastores los que deben cuidar de los rebaños?',
    'Ustedes se comen lo mejor, se visten con la lana, degüellan a las ovejas más engordadas, pero no cuidan de las ovejas.',
    'Ustedes no fortalecen a las ovejas débiles, ni curan a las enfermas, no vendan las heridas de las que se quiebran una pata, ni regresan las descarriadas al redil; tampoco van en busca de las que se pierden, sino que las manejan con dureza y violencia.',
    ...
    '«A las ovejas de mi rebaño se las roban, las hacen presa de todas las fieras del campo. Andan sin pastor, y mis pastores no las cuidan ni van en busca de ellas, sino que sólo cuidan de sí mismos. Por lo tanto yo, su Señor y Dios, juro,',
    'y ustedes, pastores, escuchen bien lo que les digo:',
    ...
    'Sí, así ha dicho Dios el Señor: «Yo mismo voy a ir en busca de mis ovejas, y yo mismo las cuidaré,',
    'tal y como las cuida el pastor cuando se halla entre sus ovejas esparcidas. Yo las rescataré de todos los lugares por los que fueron esparcidas aquel día nublado y oscuro.',
    'Las sacaré de los pueblos y países donde ahora están, y las traeré a su propia tierra; las apacentaré en los montes y en las riberas de Israel, y en todos los lugares habitados del país.',
    'Las apacentaré en los mejores pastos, y pondré su aprisco en los altos montes de Israel; allí dormirán en un buen redil, y serán apacentadas en los pastos suculentos de los montes de Israel.',
    'Yo les daré a mis ovejas buenos pastos y apriscos seguros. Palabra de Dios el Señor.',
    '»Buscaré a las ovejas perdidas, y devolveré al redil a las que perdieron el camino; les vendaré las patas a las ovejas lastimadas, y fortaleceré a las ovejas débiles. Seré justo con mis ovejas, pero eliminaré a las ovejas engordadas y rechonchas.',
    '»A ustedes, ovejas mías, yo, su Señor y Dios, les digo que yo juzgo entre una oveja y otra, y entre carneros y machos cabríos.',
    '¿Les parece poco comerse los buenos pastos, y todavía pisotear el resto de los pastos? ¿Les parece poco beber de las aguas claras, y luego enturbiar con sus patas el resto del agua?',
    '¡Y luego mis ovejas tienen que comer los pastos pisoteados, y beber el agua turbia!»',
    'Por lo tanto, su Dios y Señor les dice: «Voy a juzgar a las ovejas engordadas y a las ovejas flacas.',
    ...
    'La tierra y los árboles del campo darán su fruto, y mis ovejas vivirán seguras sobre su tierra. Cuando yo rompa las coyundas de su yugo, y las libre de las manos de sus opresores, sabrán que yo soy el Señor.',
    ...
    'Entonces mis ovejas sabrán que yo, su Señor y Dios, estoy con ellas, y que ellas son mi pueblo, el pueblo de Israel. Palabra de Dios el Señor.',
    '»Ustedes son mis ovejas. Son las ovejas de mis pastos; ustedes son hombres, y yo soy su Dios.» Palabra de Dios el Señor.'
  ],
  // Capítulo 35
  [
    'La palabra del Señor vino a mí, y me dijo:',
  ...
  [
    ...
    'Por eso, profetiza contra ellos.» Así ha dicho Dios el Señor: «Ustedes han sido asolados. Por todos lados, gente de otras naciones se los han tragado; ¡los han convertido en su propiedad!; ¡los han hecho caer en boca de habladores, para que sean la burla de todos los pueblos!',
    'Por eso, montes de Israel, escuchen la palabra de Dios el Señor.» Así ha dicho Dios el Señor a los montes y a las colinas, a los arroyos y a los valles, a las ruinas desoladas y a las ciudades desamparadas, que quedaron expuestas a la burla de las naciones vecinas, y a ser su botín de guerra.',
    'Sí, así ha dicho Dios el Señor: «En el ardor de mi enojo ciertamente he hablado en contra de las demás naciones y en contra de todo Edom, porque alegremente y con enconada vehemencia se disputaron mi tierra para quedarse con ella. Quisieron tomar prisioneros a los que fueron expulsados de allí.',
    ...
    '»Como pueden ver, yo estoy en favor de ustedes, y voy a cuidarlos, y ustedes serán cultivados y sembrados.',
    'Yo multiplicaré en ustedes a todos los habitantes de Israel, y las ciudades volverán a ser habitadas, y sus ruinas serán reconstruidas.',
    'Multiplicaré en ustedes el número de hombres y del ganado, y éstos serán multiplicados y crecerán. Haré que vuelvan a vivir como en el pasado, y los trataré mejor que antes. Así sabrán que yo soy el Señor.',
    ...
    'Pero ya no volverán a devorarse a la gente, ni a matar a tus propios hijos. Palabra de Dios el Señor.',
    '»Nunca más permitiré que oigas los insultos de las naciones, ni que vuelvas a soportar las ofensas de otros pueblos, ni que les quites la vida a tus propios hijos.» Palabra de Dios el Señor.',
    'La palabra del Señor vino a mí, y me dijo:',
    '«Hijo de hombre, mientras el pueblo de Israel habitaba en su tierra, la contaminó con sus hechos y su modo de proceder. A mis ojos, su manera de actuar fue tan repugnante como si estuvieran menstruando.',
    'Por la sangre que derramaron, descargué mi enojo sobre ellos, pues con sus ídolos contaminaron la tierra.',
    ...
    '»Por eso, dile al pueblo de Israel que yo, su Señor y Dios he dicho: “Pueblo de Israel, no lo hago por ustedes, sino por causa de mi santo nombre, el cual ustedes profanaron entre las naciones a las que fueron llevados.',
    'Pero yo santificaré la grandeza de mi nombre, el cual ustedes profanaron entre las naciones. Y cuando delante de sus ojos yo sea santificado en medio de ustedes, las naciones sabrán que yo soy el Señor. Palabra de Dios el Señor.',
    ...
    'Multiplicaré también el fruto de los árboles, y el fruto de los campos, para que nunca más vuelvan a sufrir el oprobio de pasar hambre entre las naciones.',
    ...
    'Sépanse bien, pueblo de Israel, que no lo hago por ustedes, así que deben avergonzarse y sentirse mal por las iniquidades que han cometido.”» Palabra de Dios el Señor.',
    'Así ha dicho Dios el Señor: «El día que yo los limpie de todas sus iniquidades, haré también que las ciudades vuelvan a ser habitadas, y que las ruinas sean reconstruidas.',
    'La tierra asolada volverá a ser cultivada, en vez de permanecer asolada a la vista de todos los que pasan.',
    '»Entonces se dirá: “Esta tierra, que alguna vez fue asolada, ha llegado a ser como el huerto de Edén. Estas ciudades, que habían quedado desiertas y asoladas y en ruinas, ahora están fortificadas y habitadas.”',
    'Entonces las naciones que hayan quedado a su alrededor sabrán que yo reconstruí lo que fue derribado y planté lo que estaba desolado. Yo, el Señor, lo he dicho y lo haré.»',
    'Así ha dicho Dios el Señor: «Todavía el pueblo de Israel habrá de pedirme que los multiplique, de la manera que se multiplican los rebaños.',
    'Y las ciudades ahora desiertas se llenarán de gente, como se llena Jerusalén con los rebaños de ovejas consagradas en sus fiestas solemnes. Así sabrán que yo soy el Señor.»'
  ],
  // Capítulo 37
  [
    ...
    'Luego me hizo dar de vueltas y pasar cerca de los huesos, los cuales eran muchísimos y bastante secos, y estaban a flor de tierra.',
    'Y el Señor me preguntó: «Hijo de hombre, ¿cobrarán vida estos huesos?» Yo le contesté: «Señor y Dios, tú lo sabes.»',
    'Entonces el Señor me dijo: «Profetiza sobre estos huesos, y diles: “Huesos secos, oigan la palabra del Señor.',
    'Esto es lo que Dios el Señor les dice: ‘Huesos, voy a hacer que entre en ustedes el espíritu, y ustedes volverán a vivir.’',
    'Voy a poner tendones en ustedes, y volveré a cubrirlos de carne y de piel; pondré también el espíritu en ustedes, y volverán a vivir.” Así sabrán que yo soy el Señor.»',
    'Yo profeticé, tal y como se me ordenó, y mientras yo profetizaba hubo un ruido y un temblor, y los huesos se juntaron el uno con el otro.',
    ...
    'Entonces el Señor me dijo: «Hijo de hombre, profetiza al espíritu. Háblale y dile que así ha dicho Dios el Señor: “Espíritu, ven de los cuatro vientos y sopla sobre estos huesos muertos, para que cobren vida.”»',
    ...
    'Entonces el Señor me dijo: «Hijo de hombre, todos estos huesos son el pueblo de Israel. Ellos dicen: “Nuestros huesos se han secado; ha muerto nuestra esperanza; ¡hemos sido destruidos por completo!”',
    'Por eso, profetiza y diles que yo, su Señor y Dios, he dicho: “Pueblo mío, voy a abrir los sepulcros de ustedes; voy a levantarlos de sus sepulturas para traerlos de nuevo a la tierra de Israel.',
    'Y cuando yo abra sus sepulcros y los saque de sus sepulturas, ustedes, pueblo mío, sabrán que yo soy el Señor.',
    'Entonces pondré mi espíritu en ustedes, y volverán a vivir.” Sí, yo los haré reposar en su tierra, y así sabrán que yo, el Señor, lo dije y lo cumplí.» —Palabra del Señor.',
    'La palabra del Señor vino a mí, y me dijo:',
    ...
    'Junta luego las dos ramas, de tal manera que en tu mano formen una sola rama.',
    'Y cuando los hijos de tu pueblo te pregunten: “¿No vas a decirnos qué es lo que te propones con esto?”,',
    'les dirás que yo, su Señor y Dios, he dicho: “Fíjense bien: he tomado la rama que está en la mano de Efraín, y que representa a José y a sus compañeros, las tribus de Israel, y voy a juntarla con la rama que representa a Judá, para que en mi mano formen una sola rama.”',
    ...
    'Allí, en su tierra, y en los montes de Israel, haré de ellos una nación, y tendrán un solo rey, y nunca más serán dos naciones ni volverán a dividirse en dos reinos.',
    'Tampoco volverán a contaminarse con sus ídolos, ni con sus hechos repugnantes ni con ninguna de sus rebeliones. Voy a librarlos y a limpiarlos de todas las rebeliones con las cuales pecaron, y ellos serán mi pueblo, y yo seré su Dios.”',
    ...
    'Habitarán en la tierra que le di a mi siervo Jacob, y en la cual habitaron sus padres. Allí habitarán para siempre ellos, y sus hijos y los hijos de sus hijos, y para siempre mi siervo David será su príncipe.',
    'Yo haré con ellos un pacto perpetuo de paz; haré que se establezcan y se multipliquen, y para siempre pondré mi santuario entre ellos.',
    'Allí, en medio de ellos, estará mi tabernáculo, y yo seré su Dios y ellos serán mi pueblo.',
    'Y cuando mi santuario esté para siempre en medio de ellos, las naciones sabrán que yo, el Señor, santifico a Israel.»'
  ],
  // Capítulo 38
  [
    'La palabra del Señor vino a mí, y me dijo:',
    '«Hijo de hombre, dirige ahora la mirada hacia Gog de Magog, príncipe soberano de la tierra de Mesec y Tubal, y profetiza contra él.',
    ...
    'Contigo están Persia, Cus y Fut, y todos ellos cuentan con escudos y yelmos;',
    'contigo están Gomer y todas sus tropas, y la gente de Togarmá, que habita en los confines del norte, y todas sus tropas, y muchos otros pueblos.',
    '»Prepárate y apertréchate, tú y todo el ejército que se ha reunido contigo, y manténte alerta.',
    'Dentro de algunos años vendré a visitarte para que vayas a la tierra que recogí de entre muchos pueblos. A sus habitantes los saqué de esas naciones, y los libré de la espada. Ahora habitan en los montes de Israel, que siempre estuvieron en ruinas, y todos ellos viven despreocupados.',
    ...
    'Así ha dicho Dios el Señor: «Cuando llegue el día, te vendrán a la mente ideas y pensamientos malvados,',
    ...
    'Sabá y Dedán, y los mercaderes de Tarsis y todos sus príncipes, te dirán: “¿Has venido a despojarnos de lo nuestro? ¿Has reunido a tu ejército para tomar botín y quitarnos nuestra plata y oro, y ganados y posesiones, y despojarnos de todo?”',
    ...
    'y atacarás a mi pueblo Israel y cubrirás la tierra como un nubarrón. Cuando llegue el momento, permitiré que ataques a mi tierra, para que las naciones me conozcan. Entonces, Gog, seré santificado en ti delante de sus ojos.”»',
    'Así ha dicho Dios el Señor: «¿Acaso no eres tú de quien yo hablaba en tiempos pasados por medio de mis siervos, los profetas de Israel? En aquellos tiempos ellos profetizaron que yo habría de hacer que vinieras y atacaras a mi pueblo:',
    '“Cuando llegue el día en que Gog venga y ataque a la tierra de Israel, se encenderán mi ira y mi furor.” Palabra de Dios el Señor.',
    '»Sí, lo dije en el momento en que ardían mi ira y mi furor. Y dije que ese día habría un gran temblor de tierra en Israel;',
    'que ante mí temblarían los peces del mar, las aves del cielo, las bestias salvajes y toda clase de reptiles, lo mismo que todo el género humano sobre la faz de la tierra. También dije que los montes y las colinas se desmoronarían, y que todas las murallas se vendrían abajo,',
    ...
    '»Así es, Gog: Yo te castigaré con peste y sangre. Sobre ti y sobre tus tropas, y sobre los numerosos ejércitos que están contigo, dejaré caer una lluvia impetuosa, y piedras de granizo, fuego y azufre.',
    'Así seré engrandecido, santificado y reconocido a los ojos de muchas naciones, y así sabrán que yo soy el Señor.'
  ],
  // Capítulo 39
  [
    ...
    'Y quedarás tendido en el campo, porque yo lo he dicho. Palabra de Dios el Señor.',
    '”Yo dejaré caer fuego sobre Magog y sobre los tranquilos habitantes de las costas. Así sabrán que yo soy el Señor.',
    '”Yo daré a conocer mi santo nombre en medio de mi pueblo Israel, y nunca más permitiré que mi santo nombre sea profanado. Así sabrán las naciones que yo soy el Señor, el Santo de Israel.',
    'Ya viene el día del cual he hablado. Ese día se cumplirá. Palabra de Dios el Señor.',
    '”Los habitantes de las ciudades de Israel saldrán y les prenderán fuego a las armas: escudos, paveses, arcos y flechas, lanzas y dardos de mano arderán en el fuego durante siete años.',
    ...
    '”Cuando llegue el día, abriré en Israel un sepulcro para Gog, y lo sepultaré allí, al oriente del mar, en el Valle de los Viajeros. Como esto les cerrará el paso a los que pasen por allí, lo llamarán Valle de Gamón Gog,4 porque allí enterrarán a Gog y a todo su ejército.',
    'Para limpiar la tierra, el pueblo de Israel tardará siete meses para enterrarlos.',
    'Todo el pueblo de la tierra participará en ese entierro, y ese día yo seré glorificado, y para ellos será un día memorable. Palabra de Dios el Señor.',
    ...
    'Así se limpiará la tierra, y la ciudad se llamará también Hamona.”»5',
    'Así ha dicho Dios el Señor: «Hijo de hombre, diles a las aves de toda especie, y a todas las fieras salvajes, que se junten de todas partes y vengan acá, a participar del gran sacrificio que voy a ofrecerles sobre los montes de Israel. Van a comer carne y a beber sangre.',
    ...
    'Comerán grasa hasta quedar hastiados, y beberán hasta embriagarse la sangre de las víctimas que sacrifiqué para ellos.',
    'En ese banquete que les ofreceré se saciarán de caballos y de aguerridos jinetes, y de toda clase de hombres de guerra. Palabra de Dios el Señor.',
    '»Pondré mi gloria entre las naciones, y todas las naciones me verán sentenciarlos y darles su merecido.',
    'A partir de ese día, el pueblo de Israel sabrá que yo soy el Señor su Dios.',
    'También sabrán las naciones que el pueblo de Israel fue llevado al cautiverio por causa de su pecado, pues yo les di la espalda y los entregué en manos de sus enemigos, y todos cayeron a filo de espada, porque se rebelaron contra mí.',
    'Yo les di la espalda y los traté conforme a su inmundicia y conforme a sus rebeliones.»',
    'Por lo tanto, así ha dicho Dios el Señor: «Ahora voy a cambiar la suerte de Jacob. Voy a tener misericordia de todo el pueblo de Israel, y a mostrarme celoso de mi santo nombre.',
    ...
    'No volveré a darles la espalda, porque habré derramado mi espíritu sobre el pueblo de Israel.» Palabra de Dios el Señor.'
  ],
  // Capítulo 40
  [
  ...
  [
    ...
    'El hombre permanecía junto a mí, y entonces oí que desde el templo alguien me hablaba',
    ...
    'Porque ellos contaminaron mi santo nombre con las abominaciones que cometieron, pues pusieron su umbral junto a mi umbral, y su contrafuerte junto a mi contrafuerte, con sólo una pared entre ellos y yo. Por eso en mi furor los consumí.',
    'Pero ahora arrojarán lejos de mí sus fornicaciones y los cadáveres de sus reyes, y yo habitaré en medio de ellos para siempre.',
    ...
    'Ésta es la ley del templo: La cumbre del monte, el recinto entero, y todos sus alrededores, será santísimo. Ésta es la ley del templo.»',
    'Las medidas del altar eran en codos, y el codo equivale a cincuenta centímetros. La base medía cincuenta centímetros de ancho, y el remate alrededor de su borde medía veinticinco centímetros. Éste era el zócalo del altar.',
    'Partiendo del suelo, desde la base hasta el lugar de abajo, medía un metro, y el ancho era de cincuenta centímetros; desde la cornisa menor hasta la cornisa mayor medía dos metros con cincuenta centímetros de ancho.',
    'El altar medía dos metros, y encima del altar había cuatro cuernos.',
    'Por sus cuatro costados, el altar medía seis metros de largo por seis metros de ancho, pues era cuadrado.',
    ...
    'Aquel hombre me dijo: «Hijo de hombre, así ha dicho Dios el Señor: “Para el día en que el altar sea hecho, éstas son las ordenanzas para ofrecer holocausto sobre él, y para esparcir sobre él sangre.',
    'A los sacerdotes levitas que son del linaje de Sadoc y que se acercan a mí para ministrar ante mí, les darás un becerro de la vacada para que lo ofrezcan como ofrenda de expiación. Palabra de Dios el Señor.',
    '”Luego tomarás un poco de su sangre y la pondrás en los cuatro cuernos del altar, en las cuatro esquinas del descanso, y alrededor del borde; así lo limpiarás y purificarás.',
    'Después tomarás el becerro que se ofrece por la expiación, y lo quemarás fuera del santuario, conforme a la ley del templo.',
    'Al segundo día ofrecerás un macho cabrío sin defecto, como ofrenda de expiación, y purificarán el altar como lo purificaron con el becerro.',
    'Cuando acabes de hacer la expiación, ofrecerás de la vacada un becerro sin defecto, y de la manada un carnero sin tacha.',
    'Los ofrecerás delante del Señor, y los sacerdotes les echarán sal y los ofrecerán al Señor en holocausto.',
    'Durante siete días sacrificarán cada día un macho cabrío en expiación, y sacrificarán también el becerro de la vacada y un carnero sin tacha del rebaño.',
    'Durante siete días harán expiación por el altar, y así lo limpiarán y lo consagrarán.',
    'Al cabo de estos días, es decir, del octavo día en adelante, los sacerdotes sacrificarán sobre el altar sus holocaustos y sus ofrendas de paz. Entonces me serán aceptables.”» Palabra de Dios el Señor.'
  ],
  // Capítulo 44
  [
    ...
    'Entonces el Señor me dijo: «Hijo de hombre, pon atención y abre bien los ojos; presta oído a todo lo que te digo tocante a todas las ordenanzas y leyes del templo del Señor; presta atención a todas las entradas y salidas del templo,',
    'y dile a Israel, a ese pueblo rebelde, que yo, su Señor y Dios, he dicho: “¡Basta, pueblo de Israel, de todas tus abominaciones!',
    '¡Basta de traerme extranjeros, gente incircuncisa en su corazón y en su cuerpo, para contaminar con su presencia mi santuario y mi templo! ¡Basta de ofrecer mi pan, y la grasa y la sangre, y de invalidar mi pacto con todas tus abominaciones!”',
    ...
    'Así ha dicho Dios el Señor: «No entrará en mi santuario ningún extranjero que viva entre los hijos de Israel, ni tampoco ninguno de sus hijos, ni nadie que sea incircunciso en el corazón y en su cuerpo.',
    ...
    '»Ninguno de ellos se acercará a mí para servirme como sacerdote, ni se acercará a ninguna de mis cosas santas y santísimas, sino que cargarán con su vergüenza por las abominaciones que cometieron.',
    'Yo los pondré a cargo de la custodia del templo y para todo el servicio que haya de hacerse en él.',
    '»Los que se acercarán a mí para servirme serán los sacerdotes levitas hijos de Sadoc, pues ellos respetaron el ordenamiento del santuario cuando los hijos de Israel se apartaron de mí. Ellos podrán presentarse ante mí para ofrecerme la grasa y la sangre. Palabra de Dios el Señor.',
    '»Sólo ellos podrán entrar en mi santuario y acercarse a mi mesa para servirme, pero deberán respetar mis ordenanzas.',
    ...
    'Se cubrirán la cabeza con turbantes de lino, y el cuerpo con calzoncillos de lino. No deben vestirse con nada que los haga sudar.',
    'Cuando salgan al atrio exterior para hablar con el pueblo, se quitarán las vestiduras con que hayan ministrado y las dejarán en las cámaras del santuario, y se pondrán otros vestidos para no santificar al pueblo con sus vestiduras.',
    'No se raparán la cabeza ni se dejarán crecer el cabello; sólo se lo recortarán.',
    'Y cuando algún sacerdote deba entrar en el atrio interior, ninguno de ellos deberá beber vino.',
    'Tampoco tomarán por esposa a una viuda ni a una mujer repudiada, sino que tomará por esposa a una doncella del linaje del pueblo de Israel, o a la viuda de algún sacerdote.',
    ...
    'No se acercarán a ningún cadáver, para no contaminarse. Sólo podrán contaminarse si el cadáver es el de su padre o el de su madre, o el de algún hijo suyo, o hija, o hermano, o hermana que no se haya casado nunca.',
    'Después de que haya sido purificado, se contarán siete días,',
    'y el día que entre al atrio interior para ministrar en el santuario, ofrecerá su expiación. Palabra de Dios el Señor.',
    '»Los sacerdotes no podrán tener en Israel ninguna propiedad. Su propiedad soy yo.',
    'Comerán de la ofrenda y de la expiación y del sacrificio por el pecado. Suyo será todo lo que se consagre en Israel.',
    'De los sacerdotes serán los primeros frutos de todo, y todo lo que se presente de todas las ofrendas. De igual manera, se darán a los sacerdotes las primicias de todas sus harinas. Así la bendición se posará en sus casas.',
  ...
  [
    ...
    'En ambos márgenes del río crecerá toda clase de árboles frutales, a los que nunca les faltará fruto ni sus hojas se caerán. Esos árboles madurarán a su tiempo, porque el agua que los riega sale del santuario. Sus frutos serán comestibles, y sus hojas serán medicinales.',
  ...
  [
    ...
    'Alrededor medirá dieciocho mil cañas, y a partir de ese día el nombre de la ciudad será «El Señor está allí».7'
  ]
];