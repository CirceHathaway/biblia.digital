// Auto-generated from RVC.xml — Hechos 1–28
export default [
  // Capítulo 1
  [
    'Estimado Teófilo, en mi primer tratado hablé acerca de todo lo que Jesús comenzó a hacer y a enseñar,',
    'hasta el día en que fue recibido en el cielo, después de que por medio del Espíritu Santo, les dio mandamientos a los apóstoles que había escogido.',
    ...
    'Como saben, Juan bautizó con agua, pero dentro de algunos días ustedes serán bautizados con el Espíritu Santo.»',
    ...
    'Cuando llegaron a Jerusalén, subieron al aposento alto, donde se hallaban Pedro, Jacobo, Juan, Andrés, Felipe, Tomás, Bartolomé, Mateo, Jacobo hijo de Alfeo, Simón el Zelote y Judas, el hermano de Jacobo.',
    'Todos ellos oraban y rogaban a Dios continuamente, en unión de las mujeres, de María la madre de Jesús, y de sus hermanos.',
    'Uno de esos días Pedro se puso de pie, en medio de los hermanos (que estaban reunidos y eran como ciento veinte), y dijo:',
    '«Hermanos míos, tenía que cumplirse la Escritura, donde por boca de David se dice que el Espíritu Santo habló acerca de Judas, el que guió a los que prendieron a Jesús.',
    ...
    'En el libro de los Salmos está escrito: »Que su habitación quede desierta; que nadie viva allí, y que otro tome su oficio.',
    ...
    'Entonces señalaron a José, llamado Barsabás, que tenía por sobrenombre «el Justo», y a Matías.',
    'Y en su oración dijeron: «Señor, tú conoces todos los corazones. Muéstranos a cuál de los dos has escogido,',
    ...
    'Y lo echaron a la suerte, y ésta recayó en Matías. Y a partir de entonces fue contado entre los once apóstoles.'
  ],
  // Capítulo 2
  [
  ...
  [
    ...
    'Y el hombre que había sido sanado milagrosamente tenía más de cuarenta años.',
  ...
  [
    ...
    'Esto hizo que toda la iglesia y todos los que supieron esto se llenaran de mucho miedo.',
  ...
  [
    ...
    'pero como no pudieron superar la sabiduría y el Espíritu que Dios le daba,',
    'sobornaron a otros para que dijeran que habían oído a Esteban blasfemar contra Moisés y contra Dios.',
    'De esa manera soliviantaron al pueblo, a los ancianos y a los escribas, los cuales se lanzaron contra él y, con lujo de violencia, lo llevaron ante el concilio.',
  ...
  [
    ...
    'Saulo hacía destrozos en la iglesia: entraba a las casas, y arrastraba a hombres y mujeres y los llevaba a la cárcel.',
    ...
    'Después de haber testificado y proclamado la palabra de Dios, ellos volvieron a Jerusalén, y en muchas poblaciones de los samaritanos anunciaron el evangelio.',
    ...
    '[Felipe le dijo: «Si crees de todo corazón, puedes ser bautizado.» Y el eunuco respondió: «Creo que Jesucristo es el Hijo de Dios.»]2',
  ...
  [
    ...
    'Él, temblando de temor, dijo: “Señor, ¿qué quieres que yo haga?” Y el Señor le dijo:]3 Levántate y entra en la ciudad. Allí se te dirá lo que debes hacer.»',
  ...
  [
    ...
    'A Jacobo, hermano de Juan, lo mató a filo de espada',
    'Y al ver que esto agradó a los judíos, mandó aprehender también a Pedro, en la fiesta de los panes sin levadura.',
    ...
    'La noche en que Herodes lo iba a sacar, Pedro estaba durmiendo entre dos soldados, sujeto con dos cadenas, y frente a la puerta había también guardias que vigilaban la cárcel.',
    'De pronto una luz iluminó la cárcel y apareció un ángel del Señor, el cual tocó a Pedro en el costado para despertarlo, y le dijo: «¡De prisa, levántate!» Y al instante las cadenas se le cayeron de las manos.',
    'Entonces el ángel le dijo: «Recoge tu ropa y átate las sandalias; envuélvete en tu manto y sígueme.» Y Pedro obedeció.',
    'Salieron de la celda y Pedro lo siguió, aunque creía que lo que el ángel hacía era una visión.',
    'Pasaron la primera y la segunda guardia, y al llegar a la puerta de hierro que daba a la ciudad, ¡ésta se abrió por sí misma! Una vez afuera, cruzaron una calle y luego el ángel desapareció.',
    'Entonces Pedro volvió en sí, y dijo: «Ahora me doy cuenta de que en verdad el Señor envió su ángel para librarme de Herodes y de todo lo que el pueblo judío esperaba hacer.»',
    'Mientras pensaba así, llegó a casa de María, la madre de Juan, a quien todos conocían como Marcos. Muchos hermanos se habían reunido allí para orar.',
    'Cuando Pedro llamó a la puerta del patio, una muchacha llamada Rode salió a ver quien llamaba,',
    ...
    'Pero Pedro les hizo señas con la mano para que callaran, y entonces les contó cómo el Señor lo había sacado de la cárcel. Y añadió: «Digan esto a Jacobo y a los hermanos.» Luego salió, y se fue a otro lugar.',
    'Cuando amaneció, hubo mucho alboroto entre los soldados, pues no sabían qué había pasado con Pedro.',
    'Herodes lo buscó y, como no lo halló, hizo interrogar a los guardias y luego ordenó que los mataran. Pedro, por su parte, salió de Judea y se fue a Cesarea, donde se quedó.',
    'Herodes estaba muy enojado con los habitantes de Tiro y de Sidón, pero ellos se pusieron de acuerdo y sobornaron al camarero mayor del rey, un hombre llamado Blasto, para que los llevara ante él; y es que querían llegar a un arreglo amistoso, pues sus abastos los recibían a través del territorio del rey.',
    ...
    'Cuando Bernabé y Saulo cumplieron su servicio, volvieron de Jerusalén y se llevaron con ellos a Juan, también conocido como Marcos.'
  ],
  // Capítulo 13
  [
    ...
    'Cuando el procónsul vio lo que había sucedido, quedó maravillado de la enseñanza del Señor y creyó.',
  ...
  // Capítulo 14
  [
    'Cuando llegaron a Iconio, siguiendo su costumbre entraron en la sinagoga de los judíos; y era tal la convicción con que hablaban que una gran multitud de judíos y de griegos creyó.',
    ...
    'y allí infundían ánimo a los discípulos y los alentaban a mantener la fe. Les decían: «Para entrar en el reino de Dios nos es necesario pasar por muchas tribulaciones.»',
  ...
  [
    ...
    'así que Pablo y Bernabé continuaron enseñando la palabra del Señor en Antioquía, y anunciando el evangelio a muchos más.',
  ...
  [
    ...
    'Y así las iglesias eran confirmadas en la fe, y su número aumentaba cada día.',
  ...
  [
    ...
    'Pero los judíos que no creyeron se llenaron de envidia, así que lograron reunir a una turba de vagos y maleantes, y comenzaron a alborotar la ciudad, y en su búsqueda de Pablo Y Silas irrumpieron en la casa de Jasón, pues querían expulsarlos del pueblo.',
    ...
    'Esa misma noche, los hermanos enviaron a Pablo y Silas hasta Berea. Y cuando éstos llegaron allá, entraron en la sinagoga de los judíos.',
    ...
    'Entre los que creyeron, había distinguidas mujeres griegas y un buen número de hombres.',
    'Cuando los judíos de Tesalónica supieron que también en Berea Pablo anunciaba la palabra de Dios, fueron allá para alborotar a las multitudes.',
    'Pero de inmediato los hermanos enviaron a Pablo al mar, mientras Silas y Timoteo se quedaban allí.',
    ...
    'Mientras Pablo los esperaba en Atenas, su espíritu se enardeció al ver que la ciudad estaba entregada a la idolatría.',
    'Por eso en la sinagoga discutía con los judíos y con hombres piadosos, y también con todos los que a diario acudían a la plaza.',
    'Algunos filósofos de los epicúreos y de los estoicos discutían con él. Unos preguntaban: «¿De qué habla este parlanchín?» Y otros decían: «Es alguien que habla de dioses extranjeros.» Y es que les hablaba del evangelio de Jesús, y de la resurrección.',
    ...
    'Porque esto suena extraño en nuestros oídos. Nos gustaría saber qué significa todo esto.»',
    ...
    'Porque al pasar y observar sus santuarios, hallé un altar con esta inscripción: «Al Dios no conocido». Pues al Dios que ustedes adoran sin conocerlo, es el Dios que yo les anuncio.',
    ...
    'Entonces Pablo se retiró de en medio de ellos;',
    'pero algunos le creyeron y se unieron a él. Entre ellos estaba Dionisio, que era miembro del areópago, una mujer llamada Dámaris, y otros más.'
  ],
  // Capítulo 18
  [
  ...
  [
    ...
    'Para consuelo de todos, al joven se lo llevaron vivo.',
  ...
  [
    ...
    'Allí dimos con un barco que se dirigía a Fenicia, así que nos embarcamos en él y zarpamos.',
    ...
    'luego nos abrazamos unos a otros, y subimos al barco. Ellos, por su parte, volvieron a sus casas.',
    ...
    'y que tenía cuatro hijas doncellas que profetizaban.',
    'Durante los días que allí permanecimos, un profeta llamado Agabo llegó de Judea,',
    'pues venía a vernos. Agabo tomó el cinto de Pablo, se ató con él las manos y los pies, y dijo: «El Espíritu Santo ha dicho: “Así atarán los judíos en Jerusalén al dueño de este cinto, y lo entregarán a los no judíos.”»',
    'Al oír esto, nosotros y los de Cesarea le rogamos a Pablo que no fuera a Jerusalén.',
    'Pero Pablo respondió: «¿Por qué lloran? ¡Se me parte el corazón! Por el nombre del Señor Jesús, yo estoy dispuesto no sólo a que me aten, sino a que me maten en Jerusalén.»',
    'Como no pudimos convencerlo, dejamos de insistir y le dijimos: «¡Que se haga la voluntad del Señor!»',
    'Días después hicimos los preparativos y subimos a Jerusalén.',
    ...
    'Al día siguiente entramos con Pablo en casa de Jacobo. Allí estaban reunidos todos los ancianos.',
    'Después de saludarlos, Pablo les habló de su ministerio, y con mucho detalle les contó lo que Dios había hecho entre los no judíos.',
    'Cuando ellos lo oyeron, glorificaron a Dios y le dijeron: «Hermano Pablo, ya hemos visto cuántos miles de judíos han creído, todos ellos celosos de la ley.',
    'Lo que aquí se ha sabido es que a los judíos que están entre los no judíos los enseñas a renegar de las enseñanzas de Moisés, y que les dices que no circunciden a sus hijos ni observen nuestras costumbres.',
    '¿Qué dices a esto? Seguramente ya se sabe que has venido,',
    'así que te recomendamos hacer lo siguiente: Hay entre nosotros cuatro hombres que están obligados a cumplir un voto.',
    'Ve y purifícate con ellos, y paga para que les rasuren la cabeza. Así todos comprenderán que no es cierto lo que supieron acerca de ti, y que también tú obedeces la ley.',
    'En cuanto a los creyentes no judíos, nosotros ya les hemos escrito y les recomendamos que no observen nada de esto, sino que se abstengan solamente de comer lo que se sacrifica a los ídolos, que no coman sangre ni animales ahogados, ni incurran en libertinaje sexual.»',
    ...
    'Así que había mucha inquietud en toda la ciudad; la gente se agolpó y se apoderó de Pablo, y entre todos lo sacaron del templo a rastras, y enseguida cerraron las puertas,',
    'pues querían matarlo. Pero se dio aviso al tribuno de la compañía, de que había mucho alboroto en la ciudad de Jerusalén,',
    'y éste tomó soldados y centuriones, y se fue tras ellos. Cuando la gente vio al tribuno y a los soldados, dejó de golpear a Pablo.',
    'Entonces llegó el tribuno y lo aprehendió, y ordenó que lo encadenaran; luego le preguntó quién era y qué había hecho.',
    'Entre la multitud, unos gritaban una cosa, y otros, otra; y como a causa del alboroto el tribuno no podía entender nada con claridad, mandó que lo llevaran a la fortaleza.',
    ...
    'Cuando estaban por meter a Pablo en la fortaleza, éste le dijo al tribuno: «¿Me permites decirte algo?» Y el tribuno respondió: «¿Sabes griego?',
  ...
  [
    ...
    '«Yo soy judío. Nací en Tarso de Cilicia, pero me criaron en esta ciudad, donde Gamaliel me instruyó con total apego a la ley de nuestros antepasados. El celo por Dios que ustedes sienten hoy, también lo sentí yo,',
    'pues perseguí a muerte a los de este Camino. Yo aprehendía y llevaba a las cárceles a hombres y mujeres;',
    'el sumo sacerdote y todos los ancianos me dieron cartas para apresar a los hermanos; ellos son testigos de que fui a Damasco para aprehender a los creyentes que estuvieran allí, y llevarlos a Jerusalén para castigarlos.',
    '»Pero sucedió que en el camino, ya cerca de Damasco y como a mediodía, de repente me rodeó una intensa luz del cielo,',
    'Caí al suelo, y entonces oí una voz que me decía: “Saulo, Saulo, ¿por qué me persigues?”',
    'Yo respondí: “¿Quién eres, Señor?” Y la voz me contestó: “Yo soy Jesús de Nazaret, a quien tú persigues.”',
    'Los que me acompañaban vieron la luz, y se espantaron; pero no escucharon la voz del que me hablaba.',
    ...
    '»Allí vivía Ananías, un hombre piadoso y apegado a la ley, de quien todos los judíos que allí vivían hablaban bien.',
    'Ananías vino, se me acercó y me dijo: “Hermano Saulo, ¡recibe la vista!” Y en ese mismo instante recobré la vista y pude verlo.',
    'Y él me dijo: “El Dios de nuestros padres te ha escogido para que conozcas su voluntad, y veas al Justo y escuches de sus propios labios su palabra,',
    'pues tú serás su testigo ante todo el mundo de esto que has visto y oído.',
    '¿Qué esperas, entonces? ¡Levántate y bautízate, e invoca su nombre, para que quedes limpio de tus pecados!”',
    '»Cuando volví a Jerusalén, mientras oraba yo en el templo, entré en éxtasis.',
    ...
    'Hasta aquí lo escucharon. Entonces alzaron la voz y gritaron: «¡Mátalo! ¡Bórralo de este mundo! ¡Gente así no merece vivir!»',
    'Y se rasgaban la ropa y lanzaban polvo al aire, y no dejaban de gritar.',
    ...
    'Al saber que Pablo era ciudadano romano, los que iban a interrogarlo se apartaron de él, y el tribuno hizo lo mismo, pues tuvo miedo de haber ordenado que lo interrogaran.',
    'Al día siguiente, el tribuno quiso saber por qué realmente lo acusaban los judíos, así que ordenó que le quitaran las cadenas, y también que se presentaran los principales sacerdotes y el concilio. Luego sacó a Pablo, y lo hizo comparecer ante ellos.'
  ],
  // Capítulo 23
  [
    ...
    'pero Pablo le dijo: «¡Así te golpeará Dios a ti, muro blanqueado! Tú estás sentado allí para juzgarme conforme a la ley; ¿por qué violas la ley al mandar que me golpeen?»',
    ...
    'Se levantó entonces una gritería, y los escribas que apoyaban a los fariseos se levantaron a protestar: «No vemos que este hombre haya cometido ningún crimen. ¡Puede haberle hablado un espíritu o un ángel!',
    'Y como la discusión iba en aumento, el tribuno temía que fueran a despedazar a Pablo, así que mandó que los soldados bajaran y lo quitaran de en medio, y se lo llevaran a la fortaleza.',
    ...
    'Les sugerimos a ustedes y al concilio, pedirle al tribuno la comparecencia de Pablo para mañana, porque ustedes quieren averiguar algunas cosas acerca de él. Nosotros estaremos listos para matarlo antes de que se presente.',
    'Pero el hijo de la hermana de Pablo se enteró de la emboscada, y fue a la fortaleza y entró para darle aviso a Pablo.',
    'Éste llamó entonces a uno de los centuriones, y le dijo: «Lleva a este joven ante el tribuno, porque tiene algo que informarle.»',
    'El centurión llevó al joven ante el tribuno, y a éste le dijo: «El preso Pablo me llamó y me pidió que trajera a este joven a tu presencia, porque tiene algo de qué hablarte.»',
    ...
    'El tribuno llamó a dos centuriones y les mandó que para las nueve de esa noche prepararan a doscientos soldados, setenta jinetes y doscientos lanceros, pues irían hasta Cesarea;',
    'ordenó también que prepararan cabalgaduras para Pablo, y que lo llevaran sano y salvo ante el gobernador Félix.',
    'Le escribió una carta en estos términos:',
    '«Saludos de Claudio Lisias al excelentísimo gobernador Félix.',
    ...
    'Luego me avisaron de que los judíos le habían preparado una emboscada, y por eso ahora te lo envío. Les he exigido a sus acusadores que traten en tu presencia lo que tengan en su contra.»',
    ...
    'Cuando los jinetes llegaron a Cesarea, le dieron la carta al gobernador y le presentaron a Pablo.',
  ...
  [
    ...
    'En las sinagogas, muchas veces los castigué y los forcé a blasfemar. Tan furioso estaba yo contra ellos, que los perseguí aun en las ciudades extranjeras.',
    ...
    'para que les abras los ojos y se conviertan de las tinieblas a la luz, y del poder de Satanás al poder de Dios; para que por la fe en mí, reciban el perdón de sus pecados y la herencia de los que han sido santificados.”',
  ...
  [
    ...
    'Como el puerto era incómodo para invernar, casi todos acordaron zarpar de allí. Creían poder arribar a Fenice, un puerto de Creta que mira al noroeste y al suroeste, e invernar allí.',
    ...
    'Ya satisfechos, se aligeró más la nave y se arrojó el trigo al mar.',
  ...
  [
    ...
    'Pero Pablo se sacudió la víbora y ésta cayó en el fuego, sin que Pablo sufriera ningún daño.',
    'La gente esperaba que Pablo se hinchara o cayera muerto; pero como después de mucho esperar vieron que no le pasaba nada, cambiaron de parecer y lo consideraban un dios.',
    'En aquella isla las propiedades eran de un hombre importante llamado Publio, quien nos recibió y amablemente nos hospedó durante tres días.',
    'Y resultó que el padre de Publio estaba enfermo. Tenía fiebre y disentería, y estaba en cama. Pero Pablo fue a verlo y, luego de orar por él, le impuso las manos y lo sanó.',
    'Cuando se supo lo que Pablo había hecho, otros de la isla con distintas enfermedades vinieron a él, y también fueron sanados.',
    ...
    'Llegamos a Siracusa, y allí nos quedamos tres días.',
    ...
    'Tres días después, Pablo convocó a los judíos más importantes, y cuando todos estuvieron reunidos, les dijo: «Hermanos míos, yo no he cometido ningún mal contra el pueblo ni contra las costumbres de nuestros padres; sin embargo, me aprehendieron en Jerusalén y me entregaron al poder de los romanos.',
    ...
    'Por esta razón los he llamado, pues quería verlos y hablar con ustedes. ¡Me encuentro encadenado por creer en la esperanza de Israel!',
    ...
    'Pablo les señaló un día para reunirse, y muchos acudieron al lugar donde se hospedaba, y desde la mañana hasta la tarde les habló del reino de Dios, citando tanto la ley de Moisés como a los profetas para convencerlos acerca de Jesús.',
    'Algunos concordaban con lo que Pablo decía, pero otros no creían.',
    'Y como no se pusieron de acuerdo, al retirarse Pablo les dijo: «Bien habló el Espíritu Santo a nuestros padres por medio del profeta Isaías, cuando dijo:',
    '»“Ve a este pueblo, y dile: Ustedes oirán, pero no entenderán; Verán, pero no percibirán.',
    'Porque su corazón se ha endurecido, Y sus oídos son incapaces de oír. Han cerrado sus ojos, para no ver ni oír, ni entender bien; para que no se conviertan y yo los sane.”',
    '»Por lo tanto, deben saber que a los no judíos se les envía esta salvación de Dios, y ellos sí oirán.»',
    'Al oír esto los judíos, se fueron luego de discutir largamente entre ellos.',
