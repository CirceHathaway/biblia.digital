// Auto-generated from RVC.xml — Isaías 1–66
export default [
  // Capítulo 1
  [
    ...
    'pero si no quieren y son rebeldes, serán consumidos por la espada.» Sí, la boca del Señor lo ha dicho.',
  ...
  // Capítulo 4
  [
    '»Ese día, siete mujeres se aferrarán a un solo hombre y le dirán: “Nosotras veremos qué comer y con qué vestirnos; sólo te pedimos que nos dejes llevar tu nombre. ¡Borra de nosotros esa vergüenza!”',
    ...
    'Cuando el Señor lave las impurezas de las hijas de Sión, y con el soplo abrasador de su justicia limpie la sangre que hay en medio de Jerusalén,',
    'creará una nube oscura durante el día, y un fuego flamígero y resplandeciente durante la noche, para cubrir todo lugar en el monte de Sión y donde haya reuniones. Y sobre todo esto estará la gloria del Señor.',
  ...
  [
    ...
    'Las viñas que rendían diez barriles de vino rendirán un solo barril; ¡diez sacos de semilla rendirán un solo saco de trigo!',
    ...
    '¡Ay de los que atraen la iniquidad con cuerdas de vanidad, y el pecado con correas de carreta!',
    ...
    '¡Ay de los que llaman bueno a lo malo, y malo a lo bueno! ¡Ay de los que convierten la luz en tinieblas, y las tinieblas en luz! ¡Ay de que convierten lo amargo en dulce, y lo dulce en amargo!',
    ...
    'Por eso su raíz será como la podredumbre; por eso su flor se desvanecerá como el polvo, así como la llama del fuego consume el rastrojo y la lumbre devora la paja, porque despreciaron la enseñanza del Señor de los ejércitos y desdeñaron la palabra del Santo de Israel.',
    'Por eso se encendió el furor del Señor contra su pueblo; por eso su mano se extendió contra él para herirlo; por eso se estremecieron los montes y sus cadáveres fueron arrojados a las calles. Y a pesar de todo esto, su furor no se ha calmado; su mano sigue aún extendida.',
    ...
    'Cuando llegue ese día, él bramará sobre ellos como brama el mar. Cuando mire hacia la tierra, sólo verá angustiosas tinieblas, y en sus cielos la luz será oscuridad.'
  ],
  // Capítulo 6
  [
  ...
  // Capítulo 7
  [
    'En los días en que Ajaz hijo de Yotán, hijo de Uzías, reinaba en Judá, sucedió que el rey Resín de Siria y Pecaj hijo de Remalías, que era rey de Israel, se dirigieron a Jerusalén para atacarla, pero no la pudieron tomar.',
    ...
    'y le dirás: “Ten mucho cuidado, y mucha calma. No tengas miedo ni se sobresalte tu corazón por causa de Resín y de Siria, y del hijo de Remalías.” Ellos arden de ira, pero no son más que el humo de dos tizones apagados.',
    'El sirio se ha puesto de acuerdo con Efraín y con el hijo de Remalías, para hacerte daño. Ha dicho:',
    '“Vayamos contra Judá para aterrorizarla. Nos la repartiremos, y pondremos por rey al hijo de Tabel.”',
    'Pero Dios el Señor dice así: “Eso no tendrá éxito, ni será así.”',
    'Ciertamente, la cabeza de Siria es Damasco, y la cabeza de Damasco es Resín, pero dentro de sesenta y cinco años Efraín será destruido y dejará de ser pueblo.',
    'Y la cabeza de Efraín es Samaria, y la cabeza de Samaria es el hijo de Remalías. Si ustedes no creen esto, tampoco permanecerán.»',
    ...
    'y éstas vendrán y acamparán en todos los valles desiertos, y en las grietas de las piedras, y en todos los zarzales y en todas las matas.',
    ...
    'Por temor de los espinos y cardos, nadie irá a ninguno de los montes antes cultivados con azada, porque sólo servirán como pastizales de bueyes y para que los ganados los pisoteen.»'
  ],
  // Capítulo 8
  [
    'El Señor me dijo: «Toma una tabla grande, y con un punzón escribe en ella acerca de Maher Salal Jasbaz.»3',
    'Como testigos confiables reuní conmigo al sacerdote Urías, y a Zacarías hijo de Jeberequías.',
    ...
    'y llegará hasta Judá y la inundará, y seguirá adelante y le llegará hasta la garganta; luego, oh Emanuel, extenderá sus alas y llenará la tierra en toda su extensión.',
    ...
    'Ciertamente el Señor me habló con firmeza, y me dio instrucciones de no ir por el camino de este pueblo. Me dijo así:',
    '«No llamen ustedes conspiración a todo lo que este pueblo llama conspiración. No tengan miedo, ni teman lo que ellos temen.',
    'Santifiquen al Señor de los ejércitos, y sólo a él. Que él sea para ustedes la única razón de su temor.',
    'Hagan de él su santuario. Pero para las dos casas de Israel será una piedra de tropiezo, que los hará caer; y para los habitantes de Jerusalén les será una trampa, una red.',
    'Muchos de ellos tropezarán; y caerán y serán destrozados; y se enredarán y quedarán apresados.',
    '»Ata el testimonio; ponle un sello a mi enseñanza entre mis discípulos.»',
    ...
    'Y cuando miren a la tierra, sólo verán tribulación y tinieblas, oscuridad y angustia; ¡y en las tinieblas se hundirán!'
  ],
  // Capítulo 9
  [
  ...
  [
    ...
    'El Señor de los ejércitos lo ha decidido; ¿quién podrá impedirlo? Él ha extendido su mano; ¿quién la hará retroceder?',
  ...
  [
    ...
    'Sabemos ya que Moab es soberbia; que son muy grandes su soberbia, su arrogancia y su altivez; ¡pero sus mentiras no prevalecerán!',
    'Por eso Moab aullará; todo Moab gemirá y será en gran manera abatida por causa de las tortas de uvas pasas de Quir Jaréset.',
    ...
    'Éstas son las palabras que desde hace mucho tiempo pronunció el Señor acerca de Moab,',
    'pero esto lo que el Señor ha dicho ahora: «Dentro de tres años, ni un día más ni un día menos, será destruido Moab, con toda su gloria y su riqueza, y los que sobrevivan serán pocos, pequeños y débiles.»'
  ],
  // Capítulo 17
  [
    ...
    'La fortaleza de Efraín llegó a su fin; Damasco ha dejado de ser reino. Lo que aún quede de Siria se convertirá en riqueza para los israelitas. —Palabra del Señor de los ejércitos.',
  ...
  [
    ...
    'Habrá luto y tristreza entre los pescadores, que echan su anzuelo en el río; perderán el ánimo los que tienden su red sobre las aguas;',
    ...
    'Cuando llegue ese día, habrá cinco ciudades en Egipto que hablarán la lengua de Canaán y que jurarán por el Señor de los ejércitos. Una de ellas será llamada «Ciudad de Heres».',
    'Cuando llegue ese día, habrá un altar al Señor en medio de Egipto, y un monumento en su honor junto a su frontera,',
    ...
    'Y el Señor será conocido en Egipto. Cuando llegue ese día, los egipcios conocerán al Señor, y harán sacrificios y oblaciones en su honor, y le cumplirán sus votos.',
    ...
    'Cuando llegue ese día, habrá una calzada de Egipto a Asiria, y los asirios entrarán en Egipto, y los egipcios entrarán en Asiria; y tanto los egipcios como los asirios servirán al Señor.',
  ...
  [
    ...
    'Entonces el Señor dijo: «Así como mi siervo Isaías anduvo desnudo y descalzo durante tres años, como señal y pronóstico contra Egipto y Etiopía,',
    'así también, para vergüenza de Egipto, el rey de Asiria llevará desnudos y descalzos, y con las nalgas descubiertas, a los cautivos y deportados de Egipto y Etiopía, lo mismo a jóvenes que a ancianos.',
    'Y se turbarán de haber puesto su esperanza en Etiopía, y de haber creído que Egipto era su gloria.»',
  ...
  // Capítulo 23
  [
    'Profecía acerca de Tiro, revelada desde la tierra de Quitín. ¡Aullen ustedes, naves de Tarsis, porque Tiro ha sido destruida! ¡No ha quedado una sola casa a la que se pueda entrar!',
    '¡Callen ustedes, mercaderes de Sidón, habitantes de la costa, que surcaban el mar para abastecerse!',
    ...
    '¡Vayan a Tarsis y aullen, habitantes de la costa!',
    '¿Acaso no era ésta para ustedes la ciudad alegre, la ciudad antigua que plantó sus pies en lugares lejanos?',
    '¿Quién decretó esto contra Tiro, la ciudad que repartía coronas, cuyos negociantes y mercaderes eran príncipes y nobles de la tierra?',
    ...
    'El Señor extendió su mano sobre el mar e hizo temblar los reinos, y ordenó que las fortalezas de Canaán fueran destruidas.',
    ...
    '¡Aullen, naves de Tarsis, porque su fortaleza ha sido destruida!',
    ...
    'Al cabo de los setenta años, el Señor visitará Tiro; y esta ciudad volverá a comerciar, y otra vez traficará con todos los reinos de la tierra.',
  ...
  [
    ...
    'Por eso te honra el pueblo fuerte, y te teme la ciudad de los violentos.',
    ...
    'Dios el Señor destruirá a la muerte para siempre, enjugará de todos los rostros toda lágrima, y borrará de toda la tierra la afrenta de su pueblo. El Señor lo ha dicho.',
    'En aquel día se dirá: «¡Éste es nuestro Dios! ¡Éste es el Señor, a quien hemos esperado! ¡Él nos salvará! ¡Nos regocijaremos y nos alegraremos en su salvación!»',
    ...
    'Y abatirá la fortaleza de sus altos muros; ¡la humillará y la arrojará hasta el polvo de la tierra!'
  ],
  // Capítulo 26
  [
  ...
  [
    ...
    'Cuando llegue ese día, ustedes le cantarán a la viña hermosa,',
    'a la que yo, el Señor, cuido y riego a cada momento; a la que noche y día cuido para que nadie la dañe.',
    'Ya no estoy enojado. Si me da espinos y cardos, éstos no podrán luchar contra mí, pues yo los aplastaré y los quemaré del todo.',
    '¿Quién querrá desafiar mi fuerza? ¡Que haga la paz conmigo! ¡Sí, que haga la paz conmigo!',
    'Viene el día en que Jacob echará raíces; Israel florecerá y echará renuevos, y todo el mundo se llenará con sus frutos.',
    '¿Acaso Dios ha herido a Israel como hirió a quienes lo hirieron? ¿Acaso le ha hecho sufrir la misma muerte de quienes lo mataron?',
    'Dios lo castigará en sus vástagos; lo expulsará con un viento recio, como cuando sopla el viento solano.',
    'Así será perdonada la maldad de Jacob. Con esto será removido su pecado: con desmenuzar como cal todas las piedras del altar, y con no volver a levantar los símbolos de Asera ni las imágenes del sol.',
    'Ciertamente la ciudad fortificada quedará en ruinas; la ciudad ahora habitada quedará abandonada y solitaria como un desierto; allí pastarán los becerros, allí se comerán todo el follaje.',
    'Cuando sus ramas se queden secas, las mujeres vendrán a quebrarlas y prenderles fuego. Porque éste no es un pueblo con entendimiento. Por eso no le tendrá compasión su Hacedor; ¡no le tendrá misericordia el que lo formó!',
    'Cuando llegue ese día, el Señor trillará desde el río Éufrates hasta el río Nilo, y ustedes los israelitas serán reunidos uno a uno.',
    'Cuando llegue ese día, se dará un fuerte toque de trompeta, y tanto los que fueron esparcidos en Asiria como los que fueron desterrados en Egipto vendrán a Jerusalén y adorarán al Señor en el monte santo.'
  ],
  // Capítulo 28
  [
    ...
    'Dios les había dicho: «Éste es el reposo; hagan reposar a los cansados. Éste es el descanso.» Pero ellos no quisieron oír.',
    ...
    'Por eso Dios el Señor dice así: «Miren esto: yo he puesto en Sión, por fundamento, una hermosa piedra angular, probada y de cimiento firme; quien se apoye en ella, no se tambaleará.',
  ...
  [
    ...
    'El Señor de los ejércitos te visitará con truenos y terremotos, con el estruendo de un torbellino y de una tempestad; con la llama de un fuego consumidor.',
    ...
    'Toda visión será para ustedes como las palabras de un libro sellado, que si se le diera a quien sabe leer y se le pidiera leerlo, aquél diría «No puedo leerlo, porque está sellado.»',
    'Y si se le diera el libro al que no sabe leer, y se le pidiera leerlo, aquél diría «No sé leer.»',
    'El Señor dice: «A decir verdad, este pueblo se acerca a mí con la boca, y me honra con los labios, pero su corazón está lejos de mí; el temor que de mí tiene no es más que un mandamiento humano, que le ha sido enseñado.',
    'Por eso, volveré a despertar la admiración de este pueblo con un prodigio impresionante y maravilloso. Quedará deshecha la sabiduría de sus sabios, y se desvanecerá la inteligencia de sus entendidos.»',
    ...
    'Dentro de muy poco tiempo el Líbano se convertirá en un campo fructífero, y el campo fértil será considerado bosque.',
    'Cuando llegue ese día, los sordos oirán las palabras del libro, y los ojos de los ciegos verán en medio de la más densa oscuridad.',
    'Aumentará en el Señor la alegría de los humildes, y aun la gente más pobre se alegrará por el Santo de Israel.',
    'Porque el violento será aniquilado, y el cínico será consumido; todos los que no duermen por cometer iniquidades serán eliminados;',
    ...
    'Entonces los de ánimo extraviado aprenderán a ser inteligentes, y los que hablaban mal de mí recibirán mi enseñanza.»'
  ],
  // Capítulo 30
  [
    ...
    'Profecía contra la bestia del Néguev: Por tierra de tribulación y de angustia, de donde salen la leona y el león, la víbora y la serpiente que vuela, a lomo de asno y sobre las jorobas de sus camellos llevan sus riquezas y sus tesoros a un pueblo que no les será de ningún provecho.',
    ...
    'Porque éste es un pueblo rebelde; es gente mentirosa, que no quiere obedecer las enseñanzas del Señor;',
    ...
    'Y éste se resquebrajará como una vasija de alfarero, que sin misericordia la hacen pedazos; a tal grado que, de entre los añicos, no se encuentra un solo tiesto para sacar fuego del hogar ni agua del pozo.»',
    ...
    'Ustedes, los que habitan en el monte de Sión, en Jerusalén, nunca más volverán a llorar; porque el Dios misericordioso se apiadará de ustedes, y les responderá cuando oiga la voz de su clamor.',
    ...
    'Entonces oirán ustedes decir a sus espaldas estas palabras: «Éste es el camino; vayan por él. No se desvíen a la derecha ni a la izquierda.»',
    ...
    'Cuando siembres la tierra, el Señor enviará lluvia sobre tu siembra, y del fruto de la tierra te dará abundante comida. Entonces tus ganados pastarán en terrenos espaciosos;',
    ...
    'su aliento es como un torrente que llega hasta el cuello y que todo lo inunda; va a zarandear a las naciones con una criba destructora; va a poner un freno en la quijada de los pueblos, para hacerlos errar.',
    ...
    'Desde hace mucho tiempo está ya dispuesta y preparada para el rey una pira con mucha leña. Es ancha y profunda, y sólo espera el soplo del Señor para prenderse como un río de azufre.'
  ],
  // Capítulo 31
  [
  ...
  [
    ...
    'florecerá en abundancia, y también se alegrará y cantará con júbilo, pues le serán dadas la belleza del Líbano y la hermosura del Carmelo y de Sarón. ¡Estos montes verán la gloria del Señor, ¡la hermosura de nuestro Dios!',
  ...
  [
    ...
    'Luego envió, también cubiertos de cilicio, al mayordomo Eliaquín, al escriba Sebna y a los ancianos de los sacerdotes, para que hablaran con el profeta Isaías hijo de Amoz',
    'y le dijeran de su parte: «Hoy es un día de angustia, de reprensión y de blasfemia, porque ha llegado la hora de dar a luz, y la parturienta no tiene fuerzas.',
    'Tal vez el Señor tu Dios habrá oído las palabras del primer oficial, que su señor, el rey de Asiria, envió para blasfemar contra el Dios vivo, tu Señor y Dios, y para ofenderlo con sus palabras. Eleva, pues, una oración por el remanente que todavía queda.»',
    'Los siervos de Ezequías fueron a hablar con Isaías,',
    'y éste les dijo: «Digan a su señor el rey que así ha dicho Dios nuestro Señor: “No tengas miedo por las palabras que has oído, y con las cuales los siervos del rey de Asiria han blasfemado contra mí.',
    ...
    '¿Acaso los dioses de esas naciones que destruyeron mis antepasados libraron a Gozán, Jarán, Resef y a los hijos de Edén que habitaban en Telasar?',
    '¿Dónde están ahora los reyes de Jamat y de Arfad, y el rey de las ciudades de Sefarvayin, Hena y Guivá?”»',
    'Ezequías recibió las cartas de mano de los embajadores, y las leyó; luego subió a la casa del Señor y extendió las cartas ante el Señor,',
    'y elevó esta oración al Señor:',
    '«Señor de los ejércitos, Dios de Israel, que habitas entre los querubines: sólo tú eres Dios de todos los reinos de la tierra, pues tú hiciste los cielos y la tierra.',
    'Inclina, Señor, tu oído, y oye; abre, Señor, tus ojos, y mira; oye todas las blasfemias que contra ti, el Dios viviente, ha mandado proferir Senaquerib.',
    'Ciertamente, Señor, los reyes de Asiria destruyeron todos los países y sus comarcas,',
    ...
    'Señor y Dios nuestro, líbranos ahora de caer en sus manos, para que todos los reinos de la tierra sepan que sólo tú eres el Señor.»',
    'Entonces Isaías hijo de Amoz mandó que dijeran a Ezequías: «Así dice el Señor, Dios de Israel en cuanto a tus ruegos acerca de Senaquerib, el rey de Asiria.',
    ...
    'Por medio de tus siervos me has vituperado, al decir: “Con la multitud de mis carros subiré a las alturas de los montes y a las laderas del Líbano; derribaré sus altos cedros y sus mejores cipreses; llegaré hasta sus cumbres más elevadas y sus bosques más tupidos.',
    'Yo he cavado pozos, y he bebido de sus aguas; con mis pies he pisoteado y secado todos los ríos de Egipto.”',
    '»¿No has oído hablar de lo que yo hice desde los tiempos antiguos, ni de los planes que desde los días más remotos tengo pensado realizar? Pues ahora voy a realizarlos, y tú habrás de reducir las ciudades fortificadas a montones de escombros.',
    ...
    '»Yo conozco tu condición. Sé cuándo entras y cuándo sales, y sé también de tu furor contra mí.',
    'Grande es tu furia contra mí. Estoy enterado de tu arrogancia. Por eso te pondré un gancho en la nariz, y un freno en los labios, y haré que regreses por el mismo camino por donde viniste.',
    ...
    'Los habitantes de Judá que logren escapar y queden con vida volverán a echar raíces y a ser productivos.»',
    ...
    'Por lo tanto, así dice el Señor: «El rey de Asiria no entrará en esta ciudad, ni lanzará contra ella una sola flecha; tampoco avanzará contra ella con sus escudos, ni levantará contra ella ningún baluarte.',
    'Por el mismo camino por el que vino, tendrá que volver. ¡No entrará en esta ciudad! —Palabra del Señor.',
    '»Yo ampararé a esta ciudad y la pondré a salvo. Lo haré por mí mismo y por mi siervo David.»',
    'El ángel del Señor salió entonces y mató a ciento ochenta y cinco mil hombres en el campamento de los asirios. Y al día siguiente, cuando se levantaron, todo el campamento estaba cubierto de cadáveres.',
    'Entonces Senaquerib, el rey de Asiria, se fue de allí y se quedó a vivir en Nínive.',
    'Pero sucedió que, mientras él adoraba en el templo de su dios Nisroc, sus hijos Adramelec y Sarezer lo mataron; le clavaron una espada, y luego huyeron a la tierra de Ararat. En su lugar reinó su hijo Esarjadón.'
  ],
  // Capítulo 38
  [
  ...
  [
    ...
    'Yo te he puesto como un trillo, un trillo nuevo lleno de dientes; y trillarás montes y colinas, y los molerás hasta reducirlos a tamo.',
    ...
    'En el desierto haré crecer cedros, acacias, arrayanes y olivos; en el yermo pondré juntos cipreses, pinos y bojes;',
    ...
    'Lo cierto es que ustedes no son nada, y que sus obras no tienen sustancia; ¡despreciable es quien los ha escogido!',
  ...
  [
    ...
    'Esa gente se alimenta con cenizas; su engañado corazón lo lleva a extraviarse, a no poner a salvo su vida, ni a decir: «¿Acaso no es pura mentira lo que tengo en mi mano derecha?»',
  ...
  [
    ...
    'Recuerden los primeros sucesos de antaño, porque yo soy Dios, y no hay otro. ¡Nada hay semejante a mí!',
  ...
  [
    ...
    'Los acontecimientos de antaño ya antes los había anunciado; salieron de mi boca y los di a conocer; actué al momento y los hice realidad.',
    ...
    '»Jacob, yo te he llamado; Israel, escúchame: Sólo yo soy el primero, y sólo yo soy el último.',
  ...
  [
    ...
    'Y me dijo: «Israel, tú eres mi siervo. Tú serás para mí motivo de orgullo.»',
    ...
    'Pero ahora ha hablado el Señor, el que me formó desde el vientre para que fuera yo su siervo; para que reuniera a Jacob, para que hiciera a Israel volverse a él (así yo seré muy estimado a los ojos del Señor, y mi Dios será mi fuerza),',
    'y ha dicho: «Muy poca cosa es para mí que tú seas mi siervo, y que levantes las tribus de Jacob y restaures al remanente de Israel. Te he puesto también como luz de las naciones, para que seas mi salvación hasta los confines de la tierra.»',
    ...
    'Así ha dicho el Señor: «En el momento favorable te responderé; en el día de salvación te ayudaré. Yo te protegeré, y tú representarás mi pacto con el pueblo, para que restaures la tierra y heredes las propiedades asoladas;',
    ...
    'Sión dice: «El Señor me ha abandonado. El Señor se olvidó de mí.»',
    ...
    'Y tú te pondrás a pensar: «¿Y quién me engendró estos hijos? Yo me había quedado sin hijos; estaba sola, peregrina y desterrada. ¿Quién crió a éstos? Me había quedado sola; ¿dónde estaban éstos?»',
    ...
    'Sus reyes serán tus ayos, y sus reinas tus nodrizas; ante ti se inclinarán, sin levantar la vista del suelo, y lamerán el polvo de tus pies. Sabrás entonces que yo soy el Señor, y que no quedan avergonzados los que esperan en mí.»',
    '¿Puede arrebatársele el botín al guerrero? ¿Puede rescatarse al cautivo del poder del tirano?',
    'Pues así dice el Señor: «Ciertamente el cautivo será rescatado del poder del guerrero, y el botín se le arrebatará al tirano; yo defenderé tu causa, y salvaré a tus hijos.',
  ...
  // Capítulo 50
  [
    'Así ha dicho el Señor: «¿Qué pasó con la carta de repudio, con la que repudié a la madre de ustedes? ¿Quiénes son mis acreedores, a quienes yo a ustedes los vendí? Dense cuenta de que ustedes fueron vendidos por causa de sus maldades, y de que su madre fue repudiada por sus rebeliones.',
    '¿Por qué no hallé a nadie cuando vine? ¿Por qué nadie respondió cuando llamé? ¿Acaso mi mano ha perdido su poder de redimir? ¿Acaso ya no tengo poder para librar? ¡Fíjense bien! Yo reprendo al mar, y éste se seca; convierto a los ríos en un desierto, y por la falta de agua sus peces se pudren y se mueren de sed.',
    'Cubro los cielos de oscuridad, y hago que se vistan de luto.»',
    'Dios el Señor me ha dado una lengua de sabios, para saber cómo consolar a los cansados. Todas las mañanas despierta mis oídos para que escuche como los sabios.',
    'Dios el Señor me ha abierto los oídos, y yo no he sido rebelde ni he intentado huir.',
    ...
    'Dios el Señor me ayudará, así que no me avergonzaré. Por eso endurecí mi rostro como piedra, pues bien sé que no seré avergonzado.',
    ...
    'Pero a todos ustedes, lo que encienden fuego y se rodean de teas, y andan a la luz de su fuego y de las teas que han encendido, esto es lo que recibirán de mi mano: con grandes dolores serán sepultados.'
  ],
  // Capítulo 51
  [
  ...
  // Capítulo 54
  [
    'Así ha dicho el Señor: «¡Regocíjate, mujer estéril, tú que no dabas a luz! ¡Eleva tu canto y da voces de júbilo, tú que nunca estuviste de parto! ¡Más hijos tendrá la desamparada que la casada!',
    ...
    'Tus ventanas las haré de piedras preciosas, tus puertas serán de piedra de carbunclo, y toda tu muralla será de piedras preciosas.',
    'Yo, el Señor, enseñaré a todos tus hijos, y su paz se verá multiplicada.',
    'Tu adorno será la justicia. Y no tendrás nada que temer porque la opresión se alejará de ti, y nunca más se te volverá a acercar.',
  ...
  [
    ...
    'Pero ustedes, hijos de hechicera; ustedes, descendientes de adúlteros y de rameras, ¡vengan para acá!',
    ...
    'Bajo todo árbol frondoso se encienden de lujuria, y en los valles y entre las grietas sacrifican a sus propios hijos.',
    ...
    '»¿Y de quién te asustaste? ¿Quién te hizo sentir tanto miedo, que fuiste falsa conmigo? ¡No te acordaste de mí, ni me tuviste en tus pensamientos! Hace mucho tiempo que yo he guardado silencio, pero tú nunca me has temido.',
    'Yo daré a conocer tu justicia y tus obras, y éstas de nada te servirán.',
    ...
    'Pero los impíos son como el mar en tempestad, cuyas aguas no pueden estarse quietas, y en su movimento arrojan cieno y lodo.',
    'Por eso mi Dios ha dicho: «No hay paz para los impíos».'
  ],
  // Capítulo 58
  [
    ...
    'y me preguntan: “¿Qué sentido tiene que ayunemos, si no nos haces caso? ¿Para qué afligir nuestro cuerpo, si tú no te das por enterado?” Pero resulta que cuando ayunan sólo buscan su propia satisfacción, ¡y mientras tanto oprimen a todos sus trabajadores!',
    ...
    '»Si en el día de reposo, que es mi día santo, te refrenas de hacer tu voluntad y lo llamas día santo y glorioso del Señor; y si lo honras no siguiendo tu propio camino ni buscando tu voluntad, ni hablando por hablar,',
  ...
  [
    ...
    '¡Ustedes tienen las manos manchadas de sangre! Sus dedos están llenos de iniquidad! ¡Mienten con los labios y emiten maldad con la lengua!',
    'No hay quien clame por la justicia, ni quien juzgue con la verdad; confían en lo que no es, y profieren mentiras; conciben maldades, y dan a luz iniquidad.',
    ...
    'Sus pies corren al mal y se apresuran para derramar sangre inocente; sus pensamientos son pensamientos malvados; en sus caminos sólo hay destrucción y quebrantamiento.',
    ...
    'En ninguna parte se encuentra la verdad. A quien se aparta del mal se le pone en prisión. El Señor vio esto, y le fue muy desagradable ver que ya no había derecho.',
    ...
    'Y se dispuso a vindicarlos, a retribuir con ira a sus enemigos y darles su merecido a su adversarios de las costas lejanas.',
    'Del oriente al occidente temerán el nombre del Señor y reconocerán su poder. Ciertamente el enemigo vendrá como un río caudaloso, pero el espíritu del Señor desplegará su bandera contra él.',
    'Entonces vendrá el Redentor a Sión; vendrá a todos los de Jacob que se arrepientan de su maldad. —Palabra del Señor.',
    'El Señor ha dicho: «Éste será el pacto que haré con ellos: Mi espíritu está sobre ti, y desde ahora y para siempre las palabras que puse en tu boca nunca se apartarán de tus labios, ni de los labios de tus hijos, ni de los labios de tus nietos.»'
  ],
  // Capítulo 60
  [
  ...
  [
    ...
    'El Señor ha jurado, por su mano derecha y por el poder de su brazo: «No volveré a alimentar a tus enemigos con tu trigo, ni gente extraña volverá a beber tu vino, fruto de tu trabajo.',
  ...
  [
    ...
    'Haré que de Jacob salgan descendientes, y que Judá sea el heredero de mis montes. Mis elegidos tomarán posesión de la tierra, y mis siervos la habitarán.',
    'Para el pueblo que me buscó, Sarón será el lugar donde descansarán sus ovejas, y el valle de Acor será un lugar de pastos para sus vacas.',
    ...
    'yo, el Señor, los destinaré a morir por la espada. Todos ustedes se arrodillarán para ser degollados, porque los llamé y ustedes no me respondieron; les hablé, y ustedes no me hicieron caso. Al contrario, hicieron lo malo ante mis propios ojos, y decidieron hacer lo que me disgusta.»',
    ...
    'Ustedes dejarán su nombre para que mis elegidos lo usen como maldición. Yo soy Dios, el Señor, y voy a quitarte la vida, y a mis siervos les daré otro nombre.',
    'En este país, el que quiera pronunciar una bendición, lo hará en nombre del Dios de la verdad; y el que quiera hacer un juramento, lo hará en nombre del Dios de la verdad. Ciertamente las angustias de antaño quedarán en el olvido y fuera de mi vista.',
  ...
  [
    ...
    'Yo hice todo esto con mis propias manos, y fue así como llegaron a existir. Yo pongo la mirada en los pobres y humildes de espíritu, y en los que tiemblan al escuchar mi palabra. —Palabra del Señor.',
    ...
    '¿Quién supo de algo semejante? ¿Quién vio alguna vez tal cosa? ¿Puede un país concebirse en un solo día? ¿Acaso una nación puede nacer de repente? ¡Pues Sión dio a luz sus hijos antes de tener dolores!',
    ...
    'Ciertamente, el Señor ha dicho: «¡Miren! Voy a extender sobre ella la paz y la riqueza de las naciones, como si fueran un río desbordado. Ustedes serán amamantados y llevados en brazos, y mimados en el regazo.',
    ...
    'Yo pondré una señal entre ellos, y a los que sobrevivan los enviaré a las naciones. Los mandaré a Tarsis, Fut y Lud (naciones expertas en el manejo del arco); a Tubal y Javán, y a las costas lejanas que nunca supieron de mí ni vieron mi gloria. Ellos darán a conocer mi gloria entre las naciones.',
    'Y a todos los hermanos que ustedes tienen entre las naciones los harán venir, para que se presenten ante mí como una ofrenda. Vendrán hasta mi santo monte de Jerusalén en caballos, carros, literas, mulos y camellos, y portando utensilios limpios, de la manera en que los hijos de Israel traen sus ofrendas a mi casa. Yo el Señor lo digo.',
    'Y digo también que a algunos de ellos los tomaré para que sean sacerdotes y levitas.',
