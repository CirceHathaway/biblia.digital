// Auto-generated from RVC.xml — Job 1–42
export default [
  // Capítulo 1
  [
    ...
    'Era el hombre más rico del oriente, pues tenía siete mil ovejas, tres mil camellos, quinientas yuntas de bueyes, quinientas asnas y muchísimos criados.',
    ...
    'Una vez terminados los banquetes, Job los mandaba a purificarse; se levantaba muy temprano y le ofrecía un sacrificio al Señor, de acuerdo al número de sus hijos, pues pensaba que tal vez en su interior ellos habrían ofendido al Señor. Esto lo hacía todos los días.',
    'Pero un día se presentaron ante el Señor sus servidores, y entre ellos llegó también Satanás.',
    'Cuando el Señor lo vio, le preguntó: «¿De dónde vienes?» Y Satanás le contestó: «Vengo de andar recorriendo la tierra.»',
    'Entonces el Señor le preguntó: «¿Y no has pensado en mi siervo Job? ¿Acaso has visto alguien con una conducta tan intachable como él? ¡No le hace ningún mal a nadie, y es temeroso de Dios!»',
    'Pero Satanás le respondió al Señor: «¿Y acaso Job teme a Dios sin recibir nada a cambio?',
    '¿Acaso no lo proteges, a él y a su familia, y a todo lo que tiene? Tú bendices todo lo que hace, y aumentas sus riquezas en esta tierra.',
    'Pero pon tu mano sobre todo lo que tiene, y verás cómo blasfema contra ti, y en tu propia cara.»',
    'Entonces el Señor le respondió a Satanás: «Ahí está Job. Haz lo que quieras con todas sus riquezas. Pero te prohíbo que a él le hagas daño.» Y dicho esto, Satanás salió de la presencia del Señor.',
    'Un día, mientras los hijos y las hijas de Job comían y bebían en la casa del hermano mayor,',
    'llegó un mensajero a la casa de Job y le dijo: «Estábamos arando el campo con los bueyes, y las asnas pacían cerca,',
    ...
    'Todavía estaba hablando el mensajero, cuando llegó otro y dijo: «Dios permitió que del cielo cayera un fuego destructor, que fulminó a tus ovejas y a los pastores. ¡Todo lo consumió! Sólo yo pude escapar para traerte la noticia.»',
    ...
    'cuando del desierto llegó un fuerte tornado, y azotó la casa, y ésta se derrumbó sobre tus hijos y los mató. Sólo yo pude escapar para darte la noticia.»',
    'Entonces Job se levantó y se rasgó las vestiduras, se rapó la cabeza en señal de luto, y con el rostro en tierra adoró al Señor,',
    ...
    'Y en todo esto Job no pecó ni le atribuyó al Señor ninguna mala intención.'
  ],
  // Capítulo 2
  [
  ...
  [
    ...
    '¿Por qué nos consideras unas bestias? ¿Por qué nos ves como gente despreciable?',
    ...
    'Sus tobillos quedarán atrapados en la trampa que se le tienda.',
    'Le esperan trampas ocultas en el suelo; hay trampas escondidas, esperando que pase.',
    ...
    'Arrancado de la seguridad de su casa, será arrastrado por el rey de los terrores.',
    ...
    'Será arrojado de la luz a las tinieblas, y expulsado de este mundo.',
  ...
  [
    ...
    'No hay duda de que todos ustedes lo han visto; entonces, ¿por qué dicen tantas tonterías?»',
