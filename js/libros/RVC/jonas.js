// Auto-generated from RVC.xml — Jonás 1–4
export default [
  // Capítulo 1
  [
    ...
    'Y Jonás se levantó para irse a Tarsis y huir de la presencia del Señor. Descendió a Jope, y halló una nave que partía para Tarsis. Entonces pagó su pasaje y, para alejarse de la presencia del Señor, subió a bordo, dispuesto a irse con ellos a Tarsis.',
    ...
    'Los marineros tenían mucho miedo, y cada uno de ellos clamaba a su dios. Entonces echaron al mar los enseres que había en la nave, para deshacerse de ellos. Jonás, en cambio, había bajado al interior de la nave y se había echado a dormir.',
    ...
    'Entonces ellos le dijeron: «Dinos ahora por qué nos ha sobrevenido este mal. ¿A qué te dedicas? ¿De dónde vienes? ¿Cuál es tu país? ¿De qué pueblo eres?»',
  ...
  [
    ...
    'Jonás se levantó y, conforme a la palabra del Señor, fue a Nínive. Y era Nínive una ciudad grande en extremo, de tres días de camino.',
    ...
    'Todos los habitantes de Nínive creyeron a Dios y decretaron ayuno, y desde el mayor hasta el menor se vistieron de cilicio.',
    'Cuando la noticia llegó hasta el rey de Nínive, éste se levantó de su trono, se despojó de sus vestidos, se cubrió de cilicio y se sentó sobre ceniza;',
    ...
    'Al contrario, hombres y animales por igual deberán cubrirse de cilicio y clamar a Dios con todas sus fuerzas. Apártese cada uno de su mal camino y de la violencia que hay en sus manos.',
  ...
  [
    ...
    'Entonces oró al Señor y le dijo: «Y bien, Señor, ¿no es esto lo que yo decía cuando aún estaba en mi tierra? ¡Por eso me apresuré a huir a Tarsis! ¡Ya sabía yo que tú eres un Dios clemente y piadoso, lento para la ira y grande en misericordia, y que te arrepientes del mal!',
    'Yo te ruego, Señor, que me quites la vida. ¡Prefiero la muerte a la vida!»',
    'Y el Señor le dijo: «¿Te parece bien enojarte tanto?»',
    'Entonces Jonás salió de la ciudad y acampó en la parte oriental de la ciudad; allí se hizo una enramada y se sentó bajo su sombra, esperando a ver lo que sucedería en la ciudad.',
    ...
    'Pero al día siguiente, al llegar el alba, Dios dispuso que un gusano dañara la enredadera, y ésta se marchitó.',
    'Además, Dios dispuso que al salir el sol soplara un fuerte viento solano, y el sol le dio a Jonás en la cabeza. Éste casi se desmayaba, y hasta deseaba morirse. Decía: «Mejor me sería morir que seguir viviendo.»',
