// Auto-generated from RVC.xml — Juan 1–21
export default [
  // Capítulo 1
  [
  ...
  [
    ...
    'Después de esto él, su madre, sus hermanos y sus discípulos descendieron a Cafarnaún, pero no estuvieron allí por muchos días.',
  ...
  [
    ...
    'y decían a la mujer: «Ya no creemos solamente por lo que has dicho, pues nosotros mismos hemos oído, y sabemos, que éste es verdaderamente el Salvador del mundo.»',
  ...
  [
    ...
    'porque un ángel descendía al estanque de vez en cuando, y agitaba el agua; y el primero que descendía al estanque después del movimiento del agua, quedaba sano de cualquier enfermedad que tuviera.]6',
    ...
    'Por esto los judíos con más ganas procuraban matarlo, porque no sólo quebrantaba el día de reposo sino que, además, decía que Dios mismo era su Padre, con lo cual se hacía igual a Dios.',
  ...
  [
    ...
    'Entonces ellos gustosamente lo recibieron en la barca, y ésta llegó enseguida a la tierra adonde iban.',
  ...
  [
    ...
    'Jesús se refería al Espíritu que recibirían los que creyeran en él. El Espíritu aún no había venido, porque Jesús aún no había sido glorificado.',
  ...
  [
    ...
    'Ella dijo: «Nadie, Señor.» Entonces Jesús le dijo: «Tampoco yo te condeno. Vete, y no peques más.»]7',
    ...
    'Jesús pronunció estas palabras en el lugar de las ofrendas, cuando enseñaba en el templo; y nadie lo aprehendió, porque aún no había llegado su hora.',
    ...
    'Luego de que él dijo estas cosas, muchos creyeron en él.',
  ...
  [
    ...
    'Ellos le dijeron: «¿Y dónde está él?» Él dijo: «No lo sé.»',
  ...
  [
    ...
    'Pero algunos de ellos dijeron: «Y éste, que le abrió los ojos al ciego, ¿no podría haber evitado que Lázaro muriera?',
  ...
  [
    ...
    'Si algo piden en mi nombre, yo lo haré.',
  ...
  [
    ...
    'Éste es mi mandamiento para ustedes: Que se amen unos a otros.',
  ...
  [
    ...
    'Pero les he dicho estas cosas para que, cuando llegue ese momento, se acuerden de que ya se lo había dicho. »No les dije esto al principio, porque yo estaba con ustedes.',
  ...
  [
    ...
    'Los siervos y los alguaciles, que habían encendido un fuego porque hacía frío y se calentaban, estaban de pie; y también de pie, calentándose con ellos, estaba Pedro.',
    ...
    'Pedro lo negó otra vez; y enseguida cantó el gallo.',
  ...
  [
    ...
    'Y entró otra vez en el pretorio, y le dijo a Jesús: «¿De dónde eres tú?» Pero Jesús no le respondió.',
    ...
    'A partir de entonces Pilato procuraba ponerlo en libertad; pero los judíos gritaban y decían: «Si dejas libre a éste, no eres amigo del César. Todo el que a sí mismo se hace rey, se opone al César.»',
    ...
    'y allí lo crucificaron. Con él estaban otros dos, uno a cada lado suyo, y Jesús en medio de ellos.',
    'Además, Pilato escribió también un título, que puso sobre la cruz, el cual decía: JESÚS NAZARENO, REY DE LOS JUDÍOS.',
    'Y muchos de los judíos leyeron este título, porque el lugar donde Jesús fue crucificado estaba cerca de la ciudad. Este título estaba escrito en hebreo, griego y latín.',
    'Los principales sacerdotes de los judíos le dijeron a Pilato: «No escribas “Rey de los judíos”; sino que él dijo: “Soy Rey de los judíos”.»',
    'Pero Pilato les respondió: «Lo que he escrito, escrito queda.»',
    'Cuando los soldados crucificaron a Jesús, tomaron sus vestidos y los partieron en cuatro, una parte para cada soldado. Tomaron también su túnica, la cual no tenía ninguna costura, y de arriba abajo era de un solo tejido.',
    'Y dijeron entre sí: «No la partamos. Más bien, echemos suertes, a ver quién se queda con ella.» Esto fue así para que se cumpliera la Escritura, que dice: «Repartieron entre sí mis vestidos, Y sobre mi ropa echaron suertes.» Y así lo hicieron los soldados.',
    ...
    'Y al discípulo le dijo: «Ahí tienes a tu madre.» Y a partir de ese momento el discípulo la recibió en su casa.',
    ...
    'Como era la preparación de la pascua, y a fin de que los cuerpos no se quedaran en la cruz durante el día de reposo (ya que aquel día de reposo era de gran solemnidad), los judíos le rogaron a Pilato que se les quebraran las piernas y se les quitara de allí.',
    ...
    'El que vio esto da testimonio, y su testimonio es verdadero; y él sabe que dice la verdad, para que ustedes también crean.',
    'Porque estas cosas sucedieron para que se cumpliera la Escritura: «No será quebrado ningún hueso suyo.»',
    'Además, hay también otra Escritura que dice: «Mirarán al que traspasaron.»',
    'José de Arimatea era discípulo de Jesús, aunque por miedo a los judíos lo mantenía en secreto. Después de todo esto, José le rogó a Pilato que le permitiera llevarse el cuerpo de Jesús, y Pilato se lo permitió. Entonces José fue y se llevó el cuerpo de Jesús.',
