// Auto-generated from RVC.xml — Lucas 1–24
export default [
  // Capítulo 1
  [
  ...
  [
    ...
    'y allí tuvo a su hijo primogénito; y lo envolvió en pañales, y lo acostó en un pesebre, porque no había lugar para ellos en ese albergue.',
    ...
    'En ese mismo instante Ana se presentó, y dio gracias a Dios y habló del niño a todos los que esperaban la redención de Jerusalén.',
  ...
  [
    ...
    'añadió esta otra: encerró a Juan en la cárcel.',
  ...
  [
    ...
    'Cuando el diablo agotó sus intentos de ponerlo a prueba, se apartó de él por algún tiempo.',
    ...
    'Y su fama se iba extendiendo por todos los lugares vecinos.',
    ...
    'También de muchos salían demonios, los cuales gritaban: «¡Tú eres el Hijo de Dios!» Pero Jesús los reprendía y no los dejaba hablar, porque sabían que él era el Cristo.',
  ...
  [
    ...
    'Y añadió: «El Hijo del Hombre es también Señor del día de reposo.»',
    ...
    'Los escribas y los fariseos se pusieron furiosos y comenzaron a discutir qué podrían hacer contra Jesús.',
    ...
    'Toda la gente procuraba tocarlo, porque de él salía un poder que sanaba a todos.',
  ...
  [
    ...
    'Jesús les dijo: «¿Dónde está la fe de ustedes?» Pero ellos, temorosos y asombrados, se decían unos a otros: «¿Quién es éste, que hasta a los vientos y a las aguas les da órdenes, y lo obedecen?»',
    ...
    '«Vuelve a tu casa, y cuenta allí todo lo que Dios ha hecho contigo.» Entonces el hombre se fue y contó por toda la ciudad lo que Jesús había hecho con él.',
  ...
  [
    ...
    'les dijo: «Cualquiera que reciba a un niño así en mi nombre, me recibe a mí; y cualquiera que me recibe a mí, recibe al que me envió. Porque el más insignificante entre todos ustedes, es el más grande de ustedes.»',
  ...
  [
    ...
    'Aquél respondió: «El que tuvo compasión de él.» Entonces Jesús le dijo: «Pues ve y haz tú lo mismo.»',
  ...
  [
    ...
    'Aquél responderá desde adentro y le dirá: “No me molestes. La puerta ya está cerrada, y mis niños están en la cama conmigo. No puedo levantarme para dártelos”',
    ...
    'Cuando un hombre fuerte está bien armado y protege su palacio, lo que posee no corre peligro.',
    ...
    'Y cuando llega y la encuentra barrida y adornada,',
    'va y trae otros siete espíritus peores que él, y todos entran y allí se quedan a vivir. ¡Y el estado final de aquel hombre resulta peor que el primero!»',
    ...
    'En el día del juicio, la reina del Sur se levantará con la gente de esta generación, y la condenará; porque ella vino desde los confines de la tierra para escuchar la sabiduría de Salomón, y aquí hay alguien que es más grande que Salomón.',
    ...
    'La lámpara del cuerpo es el ojo. Cuando tu ojo es bueno, también todo tu cuerpo esta lleno de luz; pero cuando tu ojo es malo, también tu cuerpo estará a oscuras.',
    'Ten cuidado, no sea que la luz que hay en ti resulte ser oscuridad.',
    'Así que, si todo tu cuerpo está lleno de luz, y no participa de la oscuridad, será todo luminoso, como cuando una lámpara te alumbra con su resplandor.»',
    ...
    'Con ello, no sólo son ustedes testigos sino cómplices de lo que hicieron sus antepasados, pues ellos los mataron y ustedes les erigen sus sepulcros.',
  ...
  [
    ...
    'Lo mismo pasa con ustedes, pues hasta los cabellos de su cabeza están todos contados. Así que no teman, pues ustedes valen más que muchos pajarillos.',
    ...
    'porque en ese mismo instante el Espíritu Santo les enseñará lo que deban decir.»',
  ...
  [
    ...
    'y así serás dichoso. Porque aunque ellos no te puedan devolver la invitación, tu recompensa la recibirás en la resurrección de los justos.»',
  ...
  [
    ...
    'Y cuando la encuentra, gozoso la pone sobre sus hombros,',
    'y al llegar a su casa reúne a sus amigos y vecinos, y les dice: “¡Alégrense conmigo, porque he encontrado la oveja que se me había perdido!”',
    ...
    'Pero voy a levantarme, e iré con mi padre, y le diré: ‘Padre, he pecado contra el cielo y contra ti,',
    ...
    'Vayan luego a buscar el becerro gordo, y mátenlo; y comamos y hagamos fiesta,',
    ...
    'El padre le dijo: “Hijo mío, tú siempre estás conmigo, y todo lo que tengo es tuyo.',
  ...
  [
    ...
    'Yo les digo que sin tardanza les hará justicia. Pero cuando venga el Hijo del Hombre, ¿hallará fe en la tierra?»',
  ...
  [
    ...
    'Entonces Jesús les dijo: «Pues yo tampoco les diré con qué autoridad hago estas cosas.»',
  ...
  [
    ...
    '«En cuanto a lo que ustedes ven, vienen días en que no quedará piedra sobre piedra. Todo será destruido.»',
  ...
  [
    ...
    'Judas aceptó y comenzó a buscar el mejor momento de entregarles a Jesús sin que el pueblo lo supiera.',
    ...
    'Ellos comenzaron a preguntarse unos a otros, quién de ellos sería capaz de hacer esto.',
    ...
    'Lleno de angustia, oraba con más intensidad. Y era su sudor como grandes gotas de sangre que caían hasta la tierra.]4',
    ...
    'Todos los días he estado con ustedes en el templo, y no me pusieron las manos encima. Pero ésta es la hora de ustedes, la hora del poder de las tinieblas.»',
    ...
    'Y lo insultaban y le decían muchas otras cosas.',
  ...
  [
    ...
    'Pero ellos seguían insistiendo: «Éste alborota al pueblo con lo que enseña por toda Judea, desde Galilea hasta este lugar.»',
    ...
    'Antes de ese día, Pilato y Herodes estaban enemistados entre sí, pero ese día se hicieron amigos.',
    ...
    'puso en libertad a quien habían pedido, que había sido encarcelado por rebelión y homicidio, y puso a Jesús a la disposición de ellos.',
    ...
    'Pero todos los conocidos de Jesús, y las mujeres que lo habían seguido desde Galilea, seguían observando a cierta distancia lo que sucedía.',
  ...
  [
    ...
    'pero Pedro se fue corriendo al sepulcro y, cuando miró hacia dentro y vio los lienzos allí dejados, volvió a su casa pasmado de lo que había sucedido.',
