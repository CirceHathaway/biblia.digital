// Auto-generated from RVC.xml — Marcos 1–16
export default [
  // Capítulo 1
  [
    ...
    'y allí fue puesto a prueba por Satanás durante cuarenta días. Estaba entre las fieras, y los ángeles lo servían.',
    ...
    'Enseguida Jesús los llamó, y ellos dejaron a su padre Zebedeo en la barca con los jornaleros, y lo siguieron.',
  ...
  [
    ...
    'Pero él les exigía con toda firmeza que no revelaran quién era él.',
    ...
    'y Judas Iscariote, que fue quien lo traicionó.',
  ...
  [
    ...
    'y aunque se quedó asombrado de la incredulidad de ellos, siguió recorriendo las aldeas de alrededor para seguir enseñando.',
    ...
    'También expulsaban muchos demonios, y ungían con aceite a muchos enfermos y los sanaban.',
    ...
    'Cuando los discípulos de Juan supieron esto, fueron a reclamar el cuerpo para darle sepultura.',
    ...
    'Más bien, su corazón estaba endurecido, y aún no habían entendido lo de los panes.',
  ...
  [
    ...
    'y enseguida entró en la barca con sus discípulos para irse a la región de Dalmanuta.',
    ...
    'Los dejó entonces, y volvió a entrar en la barca para irse a la otra orilla.',
    ...
    'Entonces les dijo: «¿Y cómo es que todavía no entienden?»',
    ...
    'Pero él les mandó que no dijeran nada a nadie acerca de él.',
  ...
  [
    ...
    'Pues yo les digo que Elías ya vino, y que hicieron con él todo lo que quisieron, tal y como está escrito acerca de él.»',
    ...
    'Ellos no entendieron lo que Jesús quiso decir con esto, pero tuvieron miedo de preguntárselo.',
    ...
    'donde los gusanos no mueren, y el fuego nunca se apaga.]5',
  ...
  [
    ...
    'Los discípulos fueron, y en la calle, junto a una puerta, encontraron el burrito atado. Lo desataron.',
    'Algunos de los que estaban allí les preguntaron: «¿Qué hacen? ¿Por qué están desatando el burrito?»',
    'Ellos les respondieron lo que Jesús les había dicho, y los dejaron desatarlo.',
    'Ellos llevaron a Jesús el burrito, sobre el que echaron sus mantos, y luego Jesús se montó sobre él.',
    ...
    'Jesús entró en Jerusalén y se dirigió al templo. Después de mirar todo a su alrededor, se fue a Betania con los doce, pues ya estaba anocheciendo.',
    ...
    'Llegaron a Jerusalén. Y al entrar Jesús en el templo comenzó a echar de allí a los que vendían y compraban en su interior. Volcó las mesas de los cambistas y las sillas de los que vendían palomas,',
    'y no permitía que nadie atravesara el templo llevando algún utensilio;',
    ...
    'Cuando los escribas y los principales sacerdotes lo oyeron, comenzaron a buscar la manera de matarlo. Y es que le tenían miedo, pues toda la gente estaba admirada de sus enseñanzas.',
    'Pero al llegar la noche, Jesús salió de la ciudad.',
    'A la mañana siguiente, cuando pasaron cerca de la higuera, vieron que ésta se había secado de raíz.',
    ...
    'Volvieron a Jerusalén. Y mientras Jesús andaba por el templo, los principales sacerdotes, los escribas y los ancianos se le acercaron',
    ...
    'Díganme: el bautismo de Juan, ¿era del cielo, o de los hombres?»',
  ...
  [
    ...
    'Al darse cuenta de que Jesús había contado esta parábola por causa de ellos, quisieron aprehenderlo; pero como temían a la multitud lo dejaron y se fueron.',
  ...
  [
    ...
    'Jesús le dijo: «¿Ves estos grandes edificios? Pues no va a quedar piedra sobre piedra. Todo será derribado.»',
  ...
  [
    ...
    'Ellas habían seguido y atendido a Jesús cuando él estaba en Galilea. Pero había también otras muchas mujeres, que habían ido con él a Jerusalén.',
  ...
  [
    ...
    'Ellos salieron entonces y predicaron por todas partes, y el Señor los ayudaba confirmando la palabra con las señales que la acompañaban. Amén.]7'
  ]
];