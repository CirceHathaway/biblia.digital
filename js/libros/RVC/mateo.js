// Auto-generated from RVC.xml — Mateo 1–28
export default [
  // Capítulo 1
  [
  ...
  [
    ...
    'Entonces el diablo lo dejó, y unos ángeles vinieron y lo servían.',
  ...
  [
    ...
    'Esto, para que se cumpliera lo dicho por el profeta Isaías: «Él mismo tomó nuestras enfermedades, y llevó nuestras dolencias.»',
  ...
  [
    ...
    'Pero los fariseos, en cuanto se fueron, conspiraron para matar a Jesús.',
    ...
    'En el juicio, la reina del Sur se levantará contra esta generación y la condenará, porque ella vino desde los confines de la tierra para escuchar la sabiduría de Salomón, y aquí hay alguien que es más grande que Salomón.',
    ...
    'Entonces va y trae otros siete espíritus peores que él, y entran y allí se quedan a vivir. ¡Y el estado final de aquel hombre resulta ser peor que el primero! Así también le pasará a esta generación malvada.»',
  ...
  [
    ...
    'Sin duda, ésta es la más pequeña de todas las semillas; pero, cuando crece, es la más grande de las plantas; se hace árbol, y hasta las aves del cielo vienen y hacen nidos en sus ramas.»',
  ...
  [
    ...
    'Entonces los que estaban en la barca se acercaron y lo adoraron, diciendo: «Verdaderamente, tú eres Hijo de Dios.»',
  ...
  [
    ...
    'Al escuchar esto, los discípulos comprendieron que les estaba hablando de Juan el Bautista.',
  ...
  [
    ...
    'y cualquiera que recibe en mi nombre a un niño como éste, me recibe a mí.',
    ...
    'Y si tu ojo te hace pecar, sácatelo y deséchalo. Es mejor que entres en la vida con un solo ojo, y no que tengas los dos ojos y seas echado en el infierno de fuego.',
  ...
  [
    ...
    'Porque hay eunucos que así nacieron del vientre de su madre, hay otros a quienes los hombres han hecho eunucos, y aún hay otros que a sí mismos se hacen eunucos por causa del reino de los cielos. El que sea capaz de comprender esto, que lo comprenda.»',
  ...
  [
    ...
    'La multitud decía: «Éste es Jesús, el profeta de Nazaret de Galilea.»',
    ...
    'Y dejándolos, se fue de la ciudad a Betania, donde pasó la noche.',
    ...
    'Porque Juan se acercó a ustedes para encaminarlos en la justicia, y no le creyeron; mientras que los cobradores de impuestos y las rameras sí le creyeron. Pero ustedes, aunque vieron esto, no se arrepintieron ni le creyeron.»',
  ...
  [
    ...
    'Muéstrenme la moneda del tributo.» Y ellos le mostraron un denario.9',
    ...
    'Al oír esto, se quedaron asombrados y se alejaron de él.',
    ...
    'Cuando la gente escuchaba esto, se admiraba de su enseñanza.',
  ...
  [
    ...
    'Pero todo esto sucede, para que se cumpla lo escrito por los profetas.» Entonces todos los discípulos lo abandonaron y huyeron.',
  ...
  [
    ...
    'y las usaron para comprar el campo del alfarero, como me ordenó el Señor.»',
  ...
  [
    ...
    'Ellos tomaron el dinero y siguieron las instrucciones recibidas. Y ésta es la versión que se ha divulgado entre los judíos hasta el día de hoy.',
