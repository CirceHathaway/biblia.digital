// Auto-generated from RVC.xml — Miqueas 1–7
export default [
  // Capítulo 1
  [
    'La palabra del Señor vino a Miqueas de Moreset durante el reinado de Yotán, Ajaz y Ezequías, reyes de Judá. Esto es lo que Miqueas vio acerca de Samaria y de Jerusalén.',
    ...
    '¡Miren al Señor! ¡Ya sale de su lugar! ¡Ya desciende para hollar las alturas de la tierra!',
    ...
    'Y todo esto sucede por causa de la rebelión de Jacob y por los pecados de la casa de Israel. ¡Y la causa de la rebelión de Jacob es Samaria! ¡Y los lugares altos de Judá están en Jerusalén!',
    ...
    'Por eso lloro y gimo. Por eso ando descalzo y semidesnudo. Mis quejas parecen aullidos de chacales, lamentos de avestruces.',
    'La llaga de Samaria es dolorosa, y se ha extendido hasta Judá. Ha llegado hasta Jerusalén, hasta la puerta de mi pueblo.',
    ...
    'Por lo tanto, ustedes pagarán tributo a Moréset Gat, y las casas de Aczib serán una trampa para los reyes de Israel.',
  ...
  [
    ...
    'Sí, se comen la carne de mi pueblo y le arrancan la piel, le rompen los huesos y los descuartizan, como cuando se echa la carne en la olla y se pone en el caldero.',
    ...
    '»Escuchen ahora esto, jefes de la casa de Jacob, y capitanes de la casa de Israel, que aborrecen la justicia y pervierten todo lo recto;',
    'que edifican a Sión con sangre, y a Jerusalén con injusticia.',
    'Sus jefes dictan sentencia a cambio del soborno; sus sacerdotes cobran por impartir sus enseñanzas, y sus profetas adivinan a cambio de dinero, y se apoyan en el Señor cuando dicen: “¿No es verdad que el Señor está entre nosotros? ¡Ningún mal nos sobrevendrá!”',
    'Por eso, por culpa de ustedes Sión será arada como un campo, Jerusalén vendrá a ser un montón de ruinas, y el monte del templo quedará hecho un matorral.»'
  ],
  // Capítulo 4
  [
    'En los últimos días el monte de la casa del Señor será confirmado como cabeza de los montes y exaltado por encima de las colinas, y a él acudirán los pueblos.',
    'Muchas naciones vendrán, y dirán: «¡Vengan, subamos al monte del Señor, a la casa del Dios de Jacob! Él nos guiará por sus caminos, y nosotros iremos por sus sendas.» Porque la enseñanza saldrá de Sión; de Jerusalén saldrá la palabra del Señor.',
    'Y el Señor juzgará entre muchos pueblos, y corregirá a naciones poderosas y lejanas; y éstas convertirán sus espadas en azadones y sus lanzas en hoces. Ninguna nación volverá a levantar la espada contra otra nación, ni se entrenarán más para hacer la guerra.',
    ...
    'con las que cojean haré un remanente, y con las descarriadas haré una nación fuerte. Y desde ahora y para siempre yo reinaré sobre ellos en el monte de Sión.» —Palabra del Señor.',
    ...
    '¡Levántate y tríllalos, hija de Sión! ¡Yo te daré cuernos de hierro y garras de bronce, para que desmenuces a muchos pueblos! Y las riquezas que les arrebates las consagrarás al Señor de toda la tierra.'
  ],
  // Capítulo 5
  [
  ...
  [
    ...
    'El mejor de ellos es peor que un espino; el más recto es más torcido que una zarza. ¡Pero ya viene el día de su castigo, el día que anunciaron sus vigilantes, y entonces se verán confundidos.',
    ...
    'Jerusalén, viene el día en que tus murallas serán reconstruidas, y en ese día se extenderán tus límites.',
    'En ese día vendrán a ti desde Asiria y las ciudades fortificadas, desde las ciudades fortificadas hasta el río, y de mar a mar, y de monte a monte.',
    'Y el país será destruido por causa de sus habitantes y por el fruto de sus obras.',
    'Señor, guía con tu cayado a tu pueblo, al rebaño de tu propiedad, que vaga solo en la montaña, y llévalo a un campo fértil. Permítele buscar pastos en Basán y en Galaad, como en los días de antaño.',
    '¡Muéstrale tus maravillas, como el día que lo sacaste de Egipto!',
    ...
    'Les cumplirás a nuestros padres Jacob y Abrahán la fidelidad y la misericordia que les prometiste desde los tiempos antiguos.'
  ]
];