// Auto-generated from RVC.xml — Oseas 1–14
export default [
  // Capítulo 1
  [
    'La palabra del Señor vino a Oseas hijo de Berí en los días de Uzías, Yotán, Ajaz y Ezequías, que fueron reyes de Judá, y también en los días de Jeroboán hijo de Joás, rey de Israel.',
    'La palabra del Señor vino a Oseas por primera vez, y le dijo: «Ve y toma por mujer a una prostituta, y ten con ella hijos de una prostituta, porque la tierra se ha prostituido. Se ha apartado del Señor.»',
    'Oseas fue y tomó por mujer a Gomer hija de Diblayin, la cual concibió y le dio a luz un hijo.',
    'Entonces el Señor le dijo: «Ponle por nombre Jezrel, porque dentro de poco tiempo voy a castigar a la casa de Jehú, por causa de los asesinatos cometidos en Jezrel. Voy a ponerle fin al reinado de la casa de Israel.',
    'Cuando llegue el día, haré pedazos el arco de Israel en el valle de Jezrel.»',
    ...
    'Después de que Gomer destetó a Lorrujama, ésta concibió y dio a luz un hijo.',
    'Entonces Dios dijo: «Ponle por nombre Loamí,2 porque ustedes no son mi pueblo, ni yo soy el Dios de ustedes.',
    'Con todo, los hijos de Israel serán tan numerosos como la arena del mar, que no es posible medirla ni contarla. Y allí donde se les dijo: “Ustedes no son mi pueblo”, se les dirá: “Ustedes son hijos del Dios de la vida”.',
    'Y se reunirán los hijos de Judá y los hijos de Israel, y nombrarán un solo jefe, y volverán a levantarse en la tierra; porque el día de Jezrel será grande.'
  ],
  // Capítulo 2
  [
    ...
    'Para siempre te tomaré por esposa, y serás mi esposa ante Dios y ante los hombres,7 con toda misericordia y compasión.',
  ...
  [
    ...
    'Todos ellos son unos adúlteros. Son como un horno encendido, cuyo fuego no hace falta avivar desde que se hace la masa y hasta que ésta fermenta.',
    ...
    'Todos ellos arden como un horno, y devoran a sus jueces; todos sus reyes fracasan, pero ninguno de ellos me pide ayuda.',
    ...
    '¡Ay de ellos, porque se apartaron de mí! ¡Les sobrevendrá la destrucción, porque se rebelaron contra mí! Yo los redimí, y ellos dijeron de mí puras mentiras.',
    ...
    'Yo los he entrenado, he fortalecido sus brazos, pero ellos sólo intrigan contra mí.',
    'Son como un arco engañoso, pues se vuelven, pero no hacía mí. Sus príncipes caen a filo de espada por la soberbia de su lengua, ¡y eso será su escarnio en la tierra de Egipto!'
  ],
  // Capítulo 8
  [
  ...
  // Capítulo 10
  [
    'Israel es una viña frondosa y muy fructífera, pero la abundancia de sus frutos fue semejante a la abundancia de sus altares. ¡Mientras más le produjo la tierra, más aumentó sus ídolos.',
    'Tiene el corazón dividido. Pero tendrá que cargar con su culpa. El Señor derribará sus altares y destruirá sus ídolos.',
    ...
    'será llevado a Asiria como un regalo para el rey Jareb. Y Efraín quedará avergonzado, e Israel se avergonzará de sus proyectos.',
    ...
    '«Tú, Israel, has pecado desde aquellos días de Gabaa, y en tu pecado has persistido. ¡Pues ahora la guerra los atrapará en Gabaa!',
    'Yo los castigaré cuando quiera castigarlos, y los pueblos se juntarán contra ellos cuando paguen por su doble crimen.',
    'Efraín es una novilla domada, a la que le gusta trillar. Pero yo pasaré sobre su lozana cerviz, y haré que Efraín lleve el yugo mientras Judá abre surco y Jacob rompe los terrones.',
    '»Siembren para ustedes la justicia, y cosecharán misericordia. Hagan para ustedes el barbecho, porque éste es el momento de buscarme. Entonces yo, el Señor, vendré y los instruiré en la justicia.»',
    ...
    'Por eso habrá alboroto en sus pueblos, y todas sus fortalezas serán destruidas, como destruyó Salmán a Bet Arbel en el día de la batalla, cuando madres e hijos fueron destrozados.',
  ...
  [
    ...
    'Mi pueblo insiste en rebelarse contra mí; me llaman el Dios Altísimo, pero ninguno de ellos me quiere enaltecer.',
    '»¿Cómo podría yo abandonarte, Efraín? ¿Podría yo entregarte, Israel? ¿Podría yo hacerte lo mismo que hice con Adma y con Zeboyin? Dentro de mí, el corazón se me estremece, toda mi compasión se inflama.',
    ...
    'Saldrán de Egipto temblorosos como aves. Saldrán de Asiria temblorosos como palomas. Yo haré que vuelvan a habitar sus casas. —Palabra del Señor.',
  ...
  [
    ...
    'Y ahora ha añadido más a su pecado, pues con su plata, y según su entender, se ha hecho imágenes fundidas de becerros, ídolos fabricados por artífices, y piden a la gente que les ofrezcan sacrificios y los besen.',
    ...
    'Yo te conocí en la aridez del desierto.',
    'Yo los cuidé, y ustedes comieron hasta saciarte, pero luego su corazón se llenó de soberbia y se olvidaron de mí.',
    ...
    '»Tú, Israel, te has corrompido, a pesar de que contabas con mi ayuda.',
    ...
    'En mi furor te di rey, y en mi ira te lo quité.',
    '»Pero no he olvidado la maldad de Efraín, ni su pecado.',
    'Es un hijo poco inteligente, que al momento de nacer no encuentra la salida. ¡Por eso le sobrevendrán dolores como de mujer parturienta!',
    '»¿Y habré entonces de librarlos del poder de la muerte? ¿Habré de ponerlos a salvo del sepulcro? ¿Y dónde están las plagas de la muerte? ¿Y dónde está la destrucción del sepulcro? Por mi parte, ¡ya no tengo compasión!»',
