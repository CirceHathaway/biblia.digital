// Auto-generated from RVC.xml — Romanos 1–16
export default [
  // Capítulo 1
  [
    ...
    'Así que, por mi parte, estoy dispuesto a anunciarles el evangelio también a ustedes, los que están en Roma.',
  ...
  [
    ...
    'Y también es padre de aquellos que, además de estar circuncidados, siguen las pisadas de la fe que tuvo nuestro padre Abrahán antes de ser circuncidado.',
  ...
  [
    ...
    'Y no sólo esto, sino que también nos regocijamos en Dios por nuestro Señor Jesucristo, por quien ahora hemos recibido la reconciliación.',
  ...
  // Capítulo 11
  [
    'Por lo tanto, pregunto: ¿Acaso Dios desechó a su pueblo? ¡De ninguna manera! Porque también yo soy israelita, descendiente de Abrahán y de la tribu de Benjamín.',
    'Dios no desechó a su pueblo, al cual conoció desde un principio. ¿No saben ustedes lo que dice la Escritura acerca de Elías, de cómo invocó a Dios contra Israel, cuando dijo:',
    ...
    'Pregunto entonces: «¿Será que los de Israel tropezaron para caer?» ¡De ninguna manera! Más bien, su transgresión redundó en la salvación de los no judíos, para que los israelitas se pongan celosos.',
    ...
    'Ahora les hablo a ustedes, a los que no son judíos. Por cuanto yo soy el apóstol de ustedes, honro mi ministerio.',
    ...
    'Si algunas de las ramas fueron cortadas, y tú, que eras un olivo silvestre, fuiste injertado en su lugar y has venido a participar de la raíz y de la rica savia del olivo,',
    ...
    'Por lo tanto, toma en cuenta la bondad y la severidad de Dios; severidad para con los que cayeron, pero bondad para contigo, si permaneces en esa bondad, pues de otra manera también tú serás cortado.',
    'Y aun ellos pueden ser injertados, si no permanecen en su incredulidad, pues Dios es poderoso para volver a injertarlos.',
    'Porque si tú, que por naturaleza eras un olivo silvestre, contra la naturaleza fuiste cortado e injertado en el buen olivo, ¡con más razón éstos, que son las ramas naturales, serán injertados en su propio olivo!',
    'Hermanos, no quiero que ignoren este misterio, para que no se vuelvan arrogantes. Parte de Israel se ha endurecido, y esto será así hasta que se haya incorporado la totalidad de los no judíos;',
    ...
    'así también éstos han sido desobedientes ahora, para que por la misericordia concedida a ustedes también ellos alcancen misericordia.',
