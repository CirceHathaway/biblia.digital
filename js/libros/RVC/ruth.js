// Auto-generated from RVC.xml — Rut 1–4
export default [
  // Capítulo 1
  [
    ...
    'Pero Noemí respondió: «Regresen a su pueblo, hijas mías. No tiene caso que vengan conmigo, pues ya no tengo más hijos que puedan ser sus maridos.',
    ...
    'Pero Rut le respondió: «¡No me pidas que te deje y me aparte de ti! A dondequiera que tú vayas, iré yo; dondequiera que tú vivas, viviré. Tu pueblo será mi pueblo, y tu Dios será mi Dios.',
    ...
    'Y así, las dos siguieron caminando juntas hasta llegar a Belén. Y en cuanto entraron a la ciudad, hubo gran agitación entre toda la gente por causa de ellas, pues decían: «¿Qué, no es ésta Noemí?»',
  ...
  [
    ...
    'Así que báñate y perfúmate, y ponte el mejor de tus vestidos, y ve a la era; pero no te presentes ante ese hombre hasta que haya acabado de comer y de beber.',
    'Y cuando se vaya a dormir, fíjate en dónde se acuesta; y ve luego y levanta el manto con que se cubre los pies. Entonces él te dirá lo que tienes que hacer.»',
    ...
    'Entonces le preguntó: «¿Quién eres?» Y ella respondió: «Soy Rut, tu sierva. Protege a esta sierva tuya bajo tu manto, porque tú eres mi pariente cercano.»',
    ...
    'Duerme aquí esta noche; y mañana, cuando sea de día, si él te rescata, está bien; que te rescate. Pero si no te quiere rescatar, yo lo haré. Pongo al Señor como testigo. Ahora descansa, y hasta mañana.»',
    ...
    'Cuando llegó con su suegra, ésta le preguntó: «¿Qué pasó, hija mía?» Y Rut le contó todo lo que había sucedido con Booz.',
    'Y añadió: «Me dio estas seis medidas de cebada y me dijo: Éstas son para que no regreses con las manos vacías.»',
  ...
  [
    ...
    'Desde hacía mucho tiempo, había una costumbre en Israel, que en una compra por rescate, una de las partes se quitaba su sandalia y se la daba al otro. Con este acto se confirmaba el trato ante todo Israel.',
    'Así que el pariente se quitó el zapato y le dijo a Booz: «Toma tú posesión de las tierras.»',
    'Entonces Booz les dijo a los ancianos y a todo el pueblo: «Ustedes son testigos de que hoy le compro a Noemí todo lo que fue de su esposo Elimelec, y de sus hijos Quelión y Majlón.',
    ...
    'El pueblo y los ancianos que estaban a la entrada de la ciudad dijeron: «Somos testigos. Que el Señor permita que la mujer que llega a tu casa sea como Raquel y Lea, las cuales levantaron como pueblo a los israelitas. Que seas tú un hombre ilustre y distinguido en Efrata y en Belén.',
    ...
    'Y las vecinas decían: «Noemí ha tenido un hijo» Y lo llamaron Obed. Éste fue el padre de Yesé, que fue padre de David.',
