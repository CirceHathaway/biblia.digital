// Auto-generated from RVC.xml — Salmos 1–150
export default [
  // Salmo 1
  [
  ...
  // Salmo 3
  [
    'Salmo de David, cuando huía de su hijo Absalón.Señor, ¡cómo han aumentado mis enemigos! Son muchos los que me atacan,',
  ...
  // Salmo 4
  [
    'Al músico principal. Sobre Neginot. Salmo de David.Dios de mi justicia, ¡responde a mi clamor! Cuando estoy angustiado, tú me infundes aliento; ¡compadécete de mí y escucha mi oración!',
  ...
  // Salmo 5
  [
    'Al músico principal; sobre Nehilot. Salmo de David.Escucha, Señor, mis palabras; toma en cuenta mis gemidos.',
  ...
  // Salmo 6
  [
    'Al músico principal. En Neginot, sobre Seminit. Salmo de David.Señor, no me reprendas en tu ira; no me castigues en tu enojo.',
  ...
  // Salmo 8
  [
    'Al músico principal. Sobre Gitit. Salmo de David.Señor y Dios nuestro, ¡cuán glorioso es tu nombre en toda la tierra! ¡Has puesto tu gloria sobre los cielos!',
  ...
  // Salmo 9
  [
    'Al músico principal. Sobre Mut Labén. Salmo de David.Señor, te alabaré de todo corazón y hablaré de todos tus portentos.',
  ...
  // Salmo 11
  [
    'Al músico principal. Salmo de David.Yo confío en el Señor; ¿Por qué, entonces, me sugieren que escape a las montañas, como un ave?',
  ...
  // Salmo 12
  [
    'Al músico principal. Sobre Seminit. Salmo de David.¡Sálvanos, Señor, pues ya no hay gente piadosa! ¡Ya no hay en este mundo gente fiel!',
  ...
  // Salmo 13
  [
    'Al músico principal. Salmo de David.¿Hasta cuándo, Señor? ¿Hasta cuándo me ocultarás tu rostro? ¿Te olvidarás de mí para siempre?',
  ...
  // Salmo 15
  [
    'Salmo de David.Señor, ¿quién puede vivir en tu templo? ¿Quién puede habitar en tu santo monte?',
  ...
  // Salmo 16
  [
    'Mictam de David.Cuídame, oh Dios, porque en ti confío.',
  ...
  // Salmo 17
  [
    'Oración de David.Señor, ¡escúchame! ¡Atiende mi clamor de justicia! ¡Presta oído a mi oración, pues no brota de labios mentirosos!',
  ...
  // Salmo 18
  [
    'Al músico principal. Salmo de David, siervo del Señor. David dedicó este cántico al Señor cuando el Señor lo libró de Saúl y de todos sus enemigos. Éstas son sus palabras:Mi Señor, mi fortaleza, ¡yo te amo!',
  ...
  // Salmo 19
  [
    'Al músico principal. Salmo de David.Los cielos proclaman la gloria de Dios; el firmamento revela la obra de sus manos.',
    'Un día se lo cuenta al otro día; una noche se lo enseña a la otra noche.',
    'Sin palabras, sin sonidos, sin que se escuche una sola voz,',
    'su mensaje recorre toda la tierra y llega al último rincón del mundo, en donde el sol pasa la noche.',
    'Y el sol, cual novio que sale del tálamo, cual si fuera un poderoso guerrero, se levanta alegre para hacer su recorrido.',
    'Sale por un extremo de los cielos, y sigue su curso hasta el otro extremo, sin que nada se esconda de su calor.',
    ...
    'El temor del Señor es bueno: permanece para siempre. Los decretos del Señor son verdaderos, y todos ellos justos.',
    'Son más deseables que el oro refinado y más dulces que la miel que destila del panal.',
    ...
    '¡No permitas que la soberbia domine a este siervo tuyo! ¡Líbrame de cometer grandes pecados, y nadie podrá entonces culparme de nada!',
    'Tú, Señor, eres mi roca y mi redentor; ¡agrádate de mis palabras y de mis pensamientos!'
  ],
  // Salmo 20
  [
    'Al músico principal. Salmo de David.Que el Señor te oiga en momentos de angustia; que te defienda el Nombre, el Dios de Jacob.',
  ...
  // Salmo 21
  [
    'Al músico principal. Salmo de David.Señor, el rey se alegra por tu poder; grande es su gozo por tu salvación.',
    'Le has concedido los deseos de su corazón; le has concedido todas sus peticiones.',
    'Lo has recibido con grandes bendiciones; lo has coronado con fina corona de oro.',
    'Te pidió muchos años de vida, y tú se los concediste.',
    'Le concediste además honra y grandeza; por eso él se gloría en tu salvación.',
    'Lo has bendecido para siempre; con tu presencia lo has llenado de alegría.',
    'El rey confía en ti, Señor; confía en tu misericordia, Dios Altísimo; ¡por eso nunca será derrocado!',
    'Su mano derribará a todos sus enemigos; su diestra destruirá a quienes lo aborrecen.',
    'Cuando tú, Señor, te manifiestes, los convertirás en un horno encendido; en tu enojo los harás pedazos, y con tu fuego acabarás con ellos.',
    'Borrarás de la tierra a sus descendientes, y ninguno de ellos quedará con vida.',
    'Ellos tramaron hacerte daño; maquinaron insidias, pero no prevalecerán.',
  ...
  // Salmo 22
  [
    'Al músico principal. Sobre Ajelet-sahar. Salmo de David.Dios mío, Dios mío, ¿por qué me has abandonado? ¿Por qué estás tan lejos, y no vienes a salvarme? ¿Por qué no atiendes mi clamor?',
  ...
  // Salmo 24
  [
    'Salmo de David.¡Del Señor son la tierra y su plenitud! ¡Del Señor es el mundo y sus habitantes!',
  ...
  // Salmo 25
  [
    'Salmo de David.A ti, Señor, elevo mi alma.',
  ...
  // Salmo 26
  [
    'Salmo de David.Señor, yo me conduzco con integridad, y en ti confío sin vacilar; ¡hazme justicia!',
  ...
  // Salmo 27
  [
    'Salmo de David.El Señor es mi luz y mi salvación; ¿a quién podría yo temer? El Señor es la fortaleza de mi vida; ¿quién podría infundirme miedo?',
  ...
  // Salmo 28
  [
    'Salmo de David.Señor, tú eres mi roca. A ti clamo. ¡No te apartes de mí! De lo contrario, seré como los que bajan al sepulcro.',
  ...
  // Salmo 29
  [
    'Salmo de David.¡Rindan al Señor, seres celestiales; rindan al Señor la gloria y el poder!',
  ...
  // Salmo 30
  [
    'Salmo cantado durante la dedicación de la casa. Salmo de David.Te alabo, Señor, porque me has salvado; porque no dejaste que mis enemigos se burlaran de mí.',
  ...
  // Salmo 31
  [
    'Al músico principal. Salmo de David.Señor, yo confío en ti; no permitas nunca que sea yo avergonzado. ¡Ponme a salvo, pues tú eres justo!',
  ...
  // Salmo 32
  [
    'Salmo de David. Masquil.Dichoso aquél cuyo pecado es perdonado, y cuya maldad queda absuelta.',
    ...
    'Por eso, todos tus fieles orarán a ti mientras puedas ser hallado. Aunque sufran una gran inundación, las aguas no los alcanzarán.',
  ...
  // Salmo 34
  [
    'Salmo de David. Cuando David fingió locura delante de Abimelec, éste lo echó de su presencia, y David se fue.Bendeciré al Señor en todo tiempo; su alabanza estará siempre en mi boca.',
  ...
  // Salmo 35
  [
    'Salmo de David.Señor, defiéndeme de mis oponentes; combate a los que me atacan.',
  ...
  // Salmo 36
  [
    'Al músico principal. Salmo de David, siervo del Señor.La maldad habla al corazón del impío; en su opinión, no hay por qué temer a Dios.',
  ...
  // Salmo 37
  [
    'Salmo de David.No te alteres por causa de los malvados, ni sientas envidia de los que practican el mal,',
  ...
  // Salmo 38
  [
    'Salmo de David, para recordar.Señor, no me reprendas en tu enojo; ¡no me castigues en tu ira!',
  ...
  // Salmo 39
  [
    'Al músico principal. A Jedutún. Salmo de David.Decidí prestar atención a mis caminos para no incurrir en pecado con mi lengua; decidí refrenar mis palabras mientras tuviera un malvado cerca de mí.',
  ...
  // Salmo 40
  [
    'Al músico principal. Salmo de David.Yo puse mi esperanza en el Señor, y él inclinó su oído y escuchó mi clamor;',
  ...
  // Salmo 41
  [
    'Al músico principal. Salmo de David.¡Dichoso aquél que piensa en los pobres! En los días malos el Señor lo ayudará.',
  ...
  // Salmo 42
  [
    'LIBRO II Al músico principal. Masquil de los hijos de Coré.Como ciervo que brama por las corrientes de agua, así mi alma clama por ti, mi Dios.',
  ...
  // Salmo 44
  [
    'Al músico principal. Masquil de los hijos de Coré.Dios nuestro, lo oímos con nuestros oídos, y nuestros padres nos lo contaron: ¡las grandes proezas que, en su favor, realizaste en los días de antaño!',
  ...
  // Salmo 45
  [
    'Al músico principal. Sobre Lirios. Masquil de los hijos de Coré. Cántico nupcial.Rebosa mi corazón con un bello poema. Esta obra mía se la dedico al rey. ¡Mi lengua es la pluma de inspirado poeta!',
  ...
  // Salmo 46
  [
    'Al músico principal. De los hijos de Coré. Cántico sobre Alamot.Dios es nuestro amparo y fortaleza, Nuestro pronto auxilio en todos los problemas.',
  ...
  // Salmo 47
  [
    'Al músico principal. Salmo de los hijos de Coré.Pueblos todos, ¡agiten las manos! ¡Aclamen a Dios con voces de júbilo!',
    ...
    'Los príncipes de los pueblos se reúnen con el pueblo del Dios de Abrahán. Sal_47:10 ¡Dios merece ser grandemente exaltado, porque de él son los poderes de la tierra!'
  ],
  // Salmo 48
  [
    'Cántico. Salmo de los hijos de Coré.¡Grande es el Señor, nuestro Dios! ¡Digno es de grandes alabanzas en su ciudad, en su santo monte!',
  ...
  // Salmo 49
  [
    'Al músico principal. Salmo de los hijos de Coré.Escuchen esto, pueblos todos; escuchen esto, habitantes del mundo entero;',
  ...
  // Salmo 50
  [
    'Salmo de Asaf.El Señor, el Dios de dioses, ha hablado; de este a oeste ha convocado a la tierra.',
  ...
  // Salmo 51
  [
    'Al músico principal. Salmo de David, cuando Natán el profeta fue a hablar con David por causa de su adulterio con Betsabé.Dios mío, por tu gran misericordia, ¡ten piedad de mí!; por tu infinita bondad, ¡borra mis rebeliones!',
  ...
  // Salmo 52
  [
    'Al músico principal. Masquil de David. De cuando Doeg el edomita fue a decirle a Saúl que David había estado en casa de Ajimélec.Y tú, fanfarrón, ¿por qué presumes de tu maldad? ¡La misericordia de Dios es constante!',
  ...
  // Salmo 53
  [
    'Al músico principal. Sobre Majalat. Masquil de David.Dentro de sí dicen los necios: «Dios no existe.» Corrompidos están. Sus hechos son repugnantes. No hay nadie que haga el bien.',
  ...
  // Salmo 54
  [
    'Al músico principal. En Neginot. Masquil de David, cuando los zifeos fueron a decir a Saúl que David estaba escondido en su tierra.Dios mío, ¡sálvame por tu nombre! ¡Defiéndeme con tu poder!',
    'Dios mío, ¡escucha mi oración! ¡Presta oído a las palabras de mi boca!',
    'Gente extraña se ha levantado contra mí; gente violenta intenta matarme. Dios mío, ¡son gente que no te toma en cuenta!',
    'Pero tú, mi Dios, eres quien me ayuda; tú, Señor, eres quien sustenta mi vida.',
    'Por tu fidelidad, ¡destrúyelos! ¡Devuélveles el mal a mis enemigos!',
  ...
  // Salmo 55
  [
    'Al músico principal. En Neginot. Masquil de David.Dios mío, ¡escucha mi oración! No te escondas; ¡atiende mi súplica!',
  ...
  // Salmo 56
  [
    'Al músico principal. Sobre «La paloma silenciosa en un paraje muy distante». Mictam de David, cuando los filisteos lo aprehendieron en Gat.Dios mío, ten misericordia de mí, porque hay gente capaz de devorarme. Todo el tiempo me oprimen y me combaten;',
  ...
  // Salmo 57
  [
    'Al músico principal; sobre No destruyas. Mictam de David, cuando huyó de delante de Saúl a la cueva.¡Ten misericordia de mí, Dios mío; ten misericordia de mí! Yo he puesto en ti mi confianza, y bajo la sombra de tus alas me refugiaré hasta que haya pasado el peligro.',
  ...
  // Salmo 58
  [
    'Al músico principal. Sobre «No destruyas». Mictam de David.Ustedes los jueces ¿en verdad hacen justicia? Ustedes, simples mortales, ¿juzgan con rectitud?',
  ...
  // Salmo 59
  [
    'Al músico principal. Sobre «No destruyas». Mictam de David, de cuando Saúl ordenó que se vigilara la casa de David para matarlo.Dios mío, ¡líbrame de mis enemigos! ¡Ponme a salvo de los que me atacan!',
  ...
  // Salmo 60
  [
    'Al músico principal. Sobre «Lirios». Testimonio. Mictam didáctico de David, de cuando estuvo en guerra contra Aram Naharayin y contra Aram de Soba, y Joab volvió y derrotó a doce mil edomitas en el valle de la Sal.Dios nuestro, tú nos has desechado; en tu enojo, nos has dejado sin defensas. ¡Vuélvete ahora a nosotros!',
  ...
  // Salmo 61
  [
    'Al músico principal. Sobre Neginot. Salmo de David.Dios mío, ¡escucha mi clamor! ¡Atiende mi oración!',
  ...
  // Salmo 62
  [
    'Al músico principal. A Jedutún. Salmo de David.Sólo en Dios halla tranquilidad mi alma; sólo de él viene mi salvación.',
  ...
  // Salmo 63
  [
    'Salmo de David, cuando estaba en el desierto de Judá.Dios mío, ¡tú eres mi Dios! Yo te buscaré de madrugada. Mi alma desfallece de sed por ti; mi ser entero te busca con ansias, en terrenos secos e inhóspitos, sin agua,',
  ...
  // Salmo 64
  [
    'Al músico principal. Salmo de David.Dios mío, ¡escucha la voz de mi queja! ¡Protege mi vida de mi temible enemigo!',
  ...
  // Salmo 65
  [
    'Al músico principal. Salmo. Cántico de David.A ti, Dios mío, debemos alabarte en Sión; a ti debemos cumplir nuestros votos,',
  ...
  // Salmo 66
  [
    'Al músico principal. Cántico. Salmo.Ustedes, habitantes de toda la tierra, ¡aclamen a Dios con alegría!',
  ...
  // Salmo 67
  [
    'Al músico principal. Sobre Neginot. Salmo. Cántico.Dios mío, ¡ten misericordia de nosotros, y bendícenos! ¡Haz resplandecer su rostro sobre nosotros!',
  ...
  // Salmo 68
  [
    'Al músico principal. Salmo de David. Cántico.¡Levántese Dios, y sean esparcidos sus enemigos! ¡Huyan de su presencia quienes lo aborrecen!',
  ...
  // Salmo 70
  [
    'Al músico principal. Salmo de David. Para conmemorar.Dios mío, ¡dígnate ayudarme! Señor, ¡ven pronto a socorrerme!',
  ...
  // Salmo 72
  [
    'Para Salomón.¡Concédele, oh Dios, al rey juzgar como tú, y concédele al hijo del rey tu justicia!',
  ...
  // Salmo 73
  [
    'LIBRO III Salmo de Asaf.¡Ah, Dios es bueno con Israel, con los limpios de corazón!',
  ...
  // Salmo 74
  [
    'Masquil de Asaf.Dios nuestro, ¿por qué nos has desechado para siempre? ¿Por qué te has enojado contra las ovejas de tu prado?',
  ...
  // Salmo 75
  [
    'Al músico principal. Sobre «No destruyas». Salmo de Asaf. Cántico.Gracias te damos, Dios mío, gracias te damos, porque tu nombre está cerca de nosotros. ¡Todos hablan de tus hechos portentosos!',
  ...
  // Salmo 76
  [
    'Al músico principal. Sobre Neginot. Salmo de Asaf. Cántico.Dios es bien conocido en Judá; grande es su nombre en Israel.',
  ...
  // Salmo 77
  [
    'Al músico principal. Sobre Jedutún. Salmo de Asaf.Con mi voz clamé a Dios, A Dios clamé, y él me escuchó.',
  ...
  // Salmo 78
  [
    'Masquil de Asaf.Pueblo mío, escucha mis enseñanzas; inclina tu oído a las palabras de mi boca.',
  ...
  // Salmo 79
  [
    'Salmo de Asaf.Dios mío, las naciones han venido a tu país, y han profanado tu santo templo. ¡Han dejado a Jerusalén en ruinas!',
  ...
  // Salmo 80
  [
    'Al músico principal. Sobre Lirios. Testimonio. Salmo de Asaf.Pastor de Israel, ¡escucha! Tú, que guías a José como a una oveja, y que estás entre los querubines, ¡manifiéstate!',
  ...
  // Salmo 81
  [
    'Al músico principal. Sobre Gitit. Salmo de Asaf.Cantemos con gozo a Dios, nuestra fortaleza; aclamemos con júbilo al Dios de Jacob.',
  ...
  // Salmo 82
  [
    'Salmo de Asaf.Dios preside la reunión de los dioses, y en medio de ellos emite su sentencia:',
  ...
  // Salmo 83
  [
    'Cántico. Salmo de Asaf.Dios mío, ¡no guardes silencio! Dios mío, ¡no te quedes callado!',
  ...
  // Salmo 84
  [
    'Al músico principal. Sobre Gitit. Salmo de los hijos de Coré.Señor de los ejércitos, ¡cuán grato es habitar en tu templo!',
  ...
  // Salmo 85
  [
    'Al músico principal. Salmo de los hijos de Coré.Señor, tú has sido propicio a tu tierra: has hecho volver a Jacob de su cautividad,',
  ...
  // Salmo 86
  [
    'Oración de David.Señor, inclina tu oído y escúchame, pues me encuentro afligido y necesitado.',
  ...
  // Salmo 88
  [
    'Cántico. Salmo de los hijos de Coré. Al músico principal. Para cantar sobre Majalat. Masquil de Hemán ezraíta.Señor, Dios de mi salvación, delante de ti clamo noche y día.',
  ...
  // Salmo 89
  [
    'Masquil de Etán ezraíta.Por siempre alabaré la misericordia del Señor; de una generación a otra, mis labios exaltarán tu fidelidad.',
  ...
  // Salmo 90
  [
    'LIBRO IV Oración de Moisés, varón de Dios.Señor, tú has sido nuestro refugio de una generación a otra generación.',
  ...
  // Salmo 92
  [
    'Salmo. Cántico para el día de reposo.¡Cuán bueno es alabarte, Señor! Bueno es, Altísimo, cantar salmos a tu nombre,',
  ...
  // Salmo 98
  [
    'Salmo.¡Cantemos al Señor un cántico nuevo por las proezas que ha realizado! ¡Con su diestra, con su santo brazo, ha alcanzado la victoria!',
  ...
  // Salmo 100
  [
    'Salmo de alabanza.¡Canten alegres al Señor, habitantes de toda la tierra!',
  ...
  // Salmo 101
  [
    'Salmo de David.Alabaré tu misericordia y tu justicia; cantaré, Señor, salmos a tu nombre.',
  ...
  // Salmo 102
  [
    'Oración de alguien que sufre y que, en su angustia, expone su queja en presencia del Señor.Señor, escucha mi oración; ¡deja que mi queja llegue a tus oídos!',
  ...
  // Salmo 103
  [
    'Salmo de David.¡Bendice, alma mía, al Señor! ¡Bendiga todo mi ser su santo nombre!',
  ...
  // Salmo 107
  [
    'LIBRO V¡Alabemos al Señor, porque él es bueno; porque su misericordia es constante!',
  ...
  // Salmo 108
  [
    'Cántico. Salmo de David.Mi corazón está dispuesto, Dios mío; quiero cantar salmos en tu honor.',
  ...
  // Salmo 109
  [
    'Al músico principal. Salmo de David.Dios de mi alabanza, ¡no te quedes callado!',
  ...
  // Salmo 110
  [
    'Salmo de David.Palabra del Señor a mi señor: «Siéntate a mi derecha, hasta que yo ponga a tus enemigos por estrado de tus pies.»',
  ...
  // Salmo 111
  [
    'Aleluya.Alabaré al Señor de todo corazón, en compañía de la comunidad de los fieles.',
  ...
  // Salmo 112
  [
    'Aleluya.Dichoso el hombre que honra al Señor y se deleita obedeciendo sus mandatos.',
  ...
  // Salmo 113
  [
    'Aleluya.Ustedes, siervos del Señor, ¡alábenlo! ¡Alaben el nombre del Señor!',
  ...
  // Salmo 119
  [
    'ÁlefDichosos los de conducta perfecta, los que siguen las enseñanzas del Señor.',
    ...
    'Quiero obedecer tus estatutos; ¡no me abandones del todo!',
    'Bet¿Cómo puede el joven limpiar su camino? ¡Obedeciendo tu palabra!',
    ...
    'Mi alegría es el cumplir tus estatutos; ¡nunca me olvido de tus palabras!',
    'GuímelConcédele a tu siervo una larga vida, y obedecer siempre tu palabra.',
    ...
    'Yo me deleito en tus testimonios, porque son mis mejores consejeros.',
    'DáletMe siento totalmente desanimado; ¡infúndeme vida, conforme a tu palabra!',
    ...
    'HeSeñor, guíame por el camino de tus estatutos, y yo los obedeceré hasta el fin.',
    ...
    'Ansío conocer tus mandamientos; ¡dame vida conforme a tu justicia!',
    'VauSeñor, ten misericordia de mí, y envíame tu salvación, como lo has prometido.',
    ...
    'Con amor levanto mis manos hacia tus mandamientos, y medito en tus estatutos.',
    'ZáyinRecuerda las promesas que me hiciste, en las cuales he puesto mi esperanza.',
    ...
    'Esto es lo que me ha tocado: poner en práctica tus mandamientos.',
    'JetSeñor, tú eres todo lo que tengo, y prometo que obedeceré tu palabra.',
    ...
    'Señor, tu misericordia llena la tierra; ¡enséñame tus decretos!',
    'TetSeñor, tú has tratado con bondad a tu siervo, de acuerdo a lo que le prometiste.',
    ...
    'Para mí, es mejor la ley que mana de tus labios que miles de monedas de oro y plata.',
    'YodTú, con tus propias manos me formaste; dame la capacidad de comprender tus mandamientos.',
    ...
    'Perfecciona mi corazón con tus estatutos, para que no tenga de que avergonzarme.',
    'CafSiento que me muero esperando tu salvación, pero sigo confiando en tu palabra.',
    ...
    'LámedSeñor, tu palabra es eterna, y permanece firme como los cielos.',
    ...
    'He visto que aun lo perfecto se acaba, pero tus mandamientos son eternos.',
    'Mem¡Cuánto amo yo tus enseñanzas! ¡Todo el día medito en ellas!',
    ...
    'NunTu palabra es una lámpara a mis pies; ¡es la luz que ilumina mi camino!',
    ...
    'De corazón me dispongo a cumplir tus estatutos siempre, hasta el fin de mis días.',
    'SámejNo soporto a la gente hipócrita, pero amo tus enseñanzas.',
    ...
    'Todo mi ser se estremece de temor; ¡tiemblo a causa de tus sentencias!',
    'AyinYo practico el derecho y la justicia; ¡no me dejes caer en poder de mis enemigos!',
    ...
    'PeTus testimonios son admirables; por eso son el tesoro de mi alma.',
    ...
    'De mis brota el llanto a mares, porque hay gente que no obedece tu ley.',
    'TsadeTú, Señor, eres justo, y tus sentencias son rectas.',
    ...
    'CofSeñor, yo te llamo con todo el corazón; ¡respóndeme, y cumpliré tus estatutos!',
    ...
    'Hace tiempo llegué a conocer tus mandatos, los cuales estableciste para la eternidad.',
    'ReshMira mi aflicción, y ven a salvarme, pues no me he olvidado de tu ley.',
    ...
    'La verdad es la esencia de tu palabra, y tus juicios son siempre justos.',
    'ShinLos poderosos me persiguen sin motivo, pero yo respeto y honro tu palabra.',
    ...
    'He cumplido tus mandamientos y tus testimonios pues tú sabes todo lo que hago.',
    'TavSeñor, ¡escucha mi clamor! ¡Dame entendimiento, conforme a tu palabra!',
  ...
  // Salmo 120
  [
    'Cántico gradual.En mi angustia, clamé al Señor, y el Señor me respondió.',
  ...
  // Salmo 121
  [
    'Cántico gradual.Elevo mis ojos a los montes; ¿de dónde vendrá mi socorro?',
  ...
  // Salmo 122
  [
    'Cántico gradual. De David.Yo me alegro con los que me dicen: «Vamos a la casa del Señor.»',
  ...
  // Salmo 123
  [
    'Cántico gradual.Hacia ti, Señor, levanto mis ojos; hacia ti, que habitas en los cielos.',
  ...
  // Salmo 124
  [
    'Cántico gradual. De David.Si el Señor no hubiera estado de nuestro lado —que lo reconozca el pueblo de Israel—,',
  ...
  // Salmo 125
  [
    'Cántico gradual.Los que confían en el Señor son semejantes al monte Sión, que jamás se mueve, que siempre está en su lugar.',
  ...
  // Salmo 126
  [
    'Cántico gradual.Cuando el Señor nos haga volver a Sión, nos parecerá estar soñando.',
  ...
  // Salmo 127
  [
    'Cántico gradual. De Salomón.Si el Señor no edifica la casa, de nada sirve que los edificadores se esfuercen. Si el Señor no protege la ciudad, de nada sirve que los guardias la vigilen.',
  ...
  // Salmo 128
  [
    'Cántico gradual.¡Dichosos todos los que honran al Señor! ¡Dichosos los que van por sus caminos!',
    ...
    'Así bendice el Señor a todo aquel que le honra.',
  ...
  // Salmo 129
  [
    'Cántico gradual.Muchas han sido mis angustias desde mi juventud... —que lo reconozca el pueblo de Israel—,',
  ...
  // Salmo 130
  [
    'Cántico gradual.A ti clamo, Señor, desde el fondo de mi angustia.',
  ...
  // Salmo 131
  [
    'Cántico gradual; de David.Señor, mi corazón no es vanidoso, ni son altaneros mis ojos; no busco realizar grandes proezas, ni hazañas que excedan a mis fuerzas.',
  ...
  // Salmo 132
  [
    'Cántico gradual.Señor, acuérdate de David y de sus muchas aflicciones;',
  ...
  // Salmo 133
  [
    'Cántico gradual. De David.¡Qué bueno es, y qué agradable, que los hermanos convivan en armonía!',
    'Es como el buen perfume que resbala por la cabeza de Aarón, y llega hasta su barba y hasta el borde de sus vestiduras.',
  ...
  // Salmo 134
  [
    'Cántico gradual.Ustedes todos, siervos del Señor, que por las noches vigilan su templo, ¡bendigan al Señor!',
    '¡Levanten las manos hacia el santuario y bendigan al Señor!',
    '¡Que te bendiga desde Sión el Señor, creador del cielo y de la tierra!'
  ],
  // Salmo 135
  [
    'Aleluya.¡Alabado sea el nombre del Señor! ¡Que lo alaben todos sus siervos,',
  ...
  // Salmo 138
  [
    'Salmo de David.Te alabaré de todo corazón, y ante todos los dioses te cantaré salmos.',
  ...
  // Salmo 139
  [
    'Al músico principal. Salmo de David.Señor, tú me has examinado y me conoces;',
  ...
  // Salmo 140
  [
    'Al músico principal. Salmo de David.Señor, líbrame de los malvados; ¡protégeme de los violentos!',
  ...
  // Salmo 141
  [
    'Salmo de David.Señor, a ti clamo; ¡ven pronto a mí! ¡Escúchame cuando te llame!',
  ...
  // Salmo 142
  [
    'Masquil de David. Oración que hizo cuando estaba en la cueva.Con mi voz clamo al Señor; con mi voz le pido su misericordia.',
  ...
  // Salmo 143
  [
    'Salmo de David.Señor, escucha mi oración atiende a mi súplica. Tú eres justo y fiel; ¡respóndeme!',
  ...
  // Salmo 144
  [
    'Salmo de David.¡Bendito seas, Señor, mi roca! Tú me entrenas para la batalla; fortaleces mis manos para el combate.',
  ...
  // Salmo 145
  [
    'Salmo de alabanza; de David.Te exaltaré, mi Dios, mi Rey; por siempre y siempre bendeciré tu nombre.',
  ...
  // Salmo 148
  [
    'Aleluya.¡Alabado sea el Señor desde los cielos! ¡Alabado sea el Señor en las alturas!',
  ...
  // Salmo 149
  [
    'Aleluya.¡Canten al Señor un cántico nuevo! ¡Alábenlo en la comunidad de los justos!',
  ...
  // Salmo 150
  [
    'Aleluya.¡Alabado sea Dios en su templo! ¡Alabado sea en la majestad del firmamento!',
    '¡Alabado sea por sus proezas! ¡Alabado sea por su imponente grandeza!',
    '¡Alabado sea el Señor al son de trompetas! ¡Alabado sea el Señor con salterio y arpa!',
    '¡Alabado sea al ritmo del pandero! ¡Alabado sea con flautas e instrumentos de cuerda!',
    '¡Alabado sea con campanillas sonoras! ¡Alabado sea con campanillas jubilosas!',
