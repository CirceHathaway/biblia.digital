// Auto-generated from RVC.xml — Sofonías 1–3
export default [
  // Capítulo 1
  [
    'Durante el reinado de Josías hijo de Amón, rey de Judá, la palabra del Señor vino a Sofonías hijo de Cusi, hijo de Gedalías, hijo de Amarías, hijo de Ezequías.',
    '«Voy a destruir por completo todo lo que hay sobre la faz de la tierra. —Palabra del Señor.',
    '»Voy a destruir a los seres humanos y a las bestias. Voy a destruir a las aves del cielo y a los peces del mar. Eliminaré a los impíos, y borraré de la faz de la tierra a la humanidad entera. —Palabra del Señor.',
    ...
    'Será un día de ira, de angustia y de estrechez; día de alboroto y destrucción, día de oscuridad y tinieblas, día nublado y sombrío,',
  ...
  [
    ...
    'En sus calles, sus magnates parecen leones rugientes; sus jueces son lobos nocturnos que no dejan un solo hueso para el día siguiente.',
    'Sus profetas son irresponsables y traicioneros; sus sacerdotes contaminan el santuario y falsean la ley.',
    'En sus calles, el Señor es justo y no hace iniquidad; por la mañana saca a luz su juicio, y nunca faltará. Pero el perverso no conoce la vergüenza.',
    ...
    '»Por lo tanto, espérenme hasta el día en que me levante para juzgarlos; porque he decidido reunir a las naciones y juntar los reinos para derramar sobre ellos todo mi enojo y el ardor de mi ira. ¡El fuego de mi celo consumirá toda la tierra!» —Palabra del Señor.',
    ...
    'De allende los ríos de Etiopía mi pueblo esparcido vendrá a adorarme y me traerá ofrendas.',
    '»Cuando llegue ese día, no tendrás que avergonzarte por ninguna de tus rebeliones contra mí, porque yo quitaré de en medio de ti a los que se alegran por tu soberbia, y nunca más volverás a envanecerte en mi santo monte.',
    'En medio de ti dejaré a un pueblo humilde y pobre, el cual confiará en mi nombre.',
    'El remanente de Israel no cometerá injusticias ni dirá mentiras, ni habrá entre ellos gente mentirosa, porque yo los cuidaré como un pastor, y ellos dormirán sin que nadie los atemorice.»',
    '¡Canta, hija de Sión! ¡Da voces de júbilo, Israel! ¡Regocíjate de todo corazón, hija de Jerusalén!',
    '¡El Señor ha apartado tus juicios, y ha expulsado a tus enemigos! ¡El Señor es el Rey de Israel, y está en medio de ti! ¡Nunca más verás el mal!',
    ...
    'Cuando llegue el momento, perseguiré a todos tus opresores; salvaré a las ovejas que cojean e iré en busca de las que perdieron el camino. Yo haré que ustedes sean motivo de alabanza, y que gocen de renombre en toda la tierra.',
    '»Cuando llegue el momento, yo mismo los haré venir. Cuando llegue el momento yo mismo los reuniré. Cuando ponga fin a su cautiverio, lo cual ustedes mismos verán, los haré gozar de renombre y haré que sean motivo de alabanza entre todos los pueblos de la tierra.» —Palabra del Señor.'
  ]
];