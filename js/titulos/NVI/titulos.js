export const titulosCapitulos = {
  "Génesis": [
    "La creación",                          // 1
    "Adán y Eva",               // 2
    "La caída del ser humano",                           // 3
    "Caín y Abel",                                   // 4
    "Descendientes de Adán",                         // 5
    "La maldad humana",     // 6
    " ",                                    // 7
    " ",                // 8
    "El pacto de Dios con Noé",              // 9
    "Las naciones de la tierra",                         // 10
    "La torre de Babel",                 // 11
    "Llamamiento de Abram",              // 12
    "Abram y Lot se separan",                     // 13
    "Abram rescata a Lot",                  // 14
    "Dios hace un pacto con Abram",                       // 15
    "Agar e Ismael",                                 // 16
    "Pacto y la circuncisión",                      // 17
    "La visita del Señor", // 18
    "Destrucción de Sodoma y Gomorra",       // 19
    "Abraham y Abimelec",                            // 20
    "Nacimiento de Isaac",     // 21
    "Dios prueba a Abraham",           // 22
    "Muerte de Sara",                    // 23
    "Isaac y Rebeca",                     // 24
    "Muerte de Abraham",               // 25
    "Isaac y Abimélec",            // 26
    " ",                    // 27
    "El sueño de Jacob en Betel",             // 28
    "Jacob llega a Padán Aram",                  // 29
    "Jacob se enriquece",          // 30
    "Jacob huye de Labán",                           // 31
    "Jacob envía mensajeros a Esaú; Jacob lucha con Dios",         // 32
    "Encuentro de Jacob con Esaú",          // 33
    "Rapto y violación de Dina",                                 // 34
    "Jacob vuelve a Betel", // 35
    "Descendientes de Esaú",                         // 36
    "Los sueños de José",                 // 37
    "Judá y Tamar",                                  // 38
    "José y la esposa de Potifar",        // 39
    "El copero y el panadero",              // 40
    "Los sueños del faraón",          // 41
    "Los hermanos de José van a Egipto",         // 42
    "Los hermanos de José vuelven a Egipto",             // 43
    "La copa de José",              // 44
    "José se da a conocer",                          // 45
    "Jacob viaja a Egipto",                      // 46
    "La administración de José",       // 47
    "Bendición de Efraín y Manasés",              // 48
    "Jacob bendice a sus hijos",              // 49
    "La promesa de José a sus hermanos;Muerte de José"                      // 50
  ],

  "Éxodo": [
    "Los egipcios oprimen a los israelitas",                  // 1
    "Nacimiento de Moisés",         // 2
    "Moisés y la zarza ardiente",             // 3
    "Señales para Moisés",          // 4
    "Primer encuentro con el faraón",       // 5
    " ",            // 6
    "La vara de Moisés; La plaga de sangre; La plaga de ranas",                    // 7
    "La plaga de mosquitos; La plaga de tábanos",                // 8
    "La plaga en el ganado; La plaga de úlceras; La plaga de granizo",              // 9
    "La plaga de langostas",                 // 10
    "La plaga contra los primogénitos",      // 11
    "La Pascua",               // 12
    "Consagración de los primogénitos israelitas",         // 13
    " ",                            // 14
    "El cántico de Moisés",              // 15
    "El maná y las codornices",                             // 16
    "El agua de la roca; Derrota de los amalecitas",             // 17
    "Jetro visita a Moisés",                       // 18
    "Los israelitas en el Sinaí",                               // 19
    "Los Diez Mandamientos",                         // 20
    "Esclavos hebreos; Injurias personales",               // 21
    "Protección de la propiedad; Responsabilidades sociales",               // 22
    "Leyes de justicia y de misericordia; Leyes sabáticas; Las tres fiestas anuales",    // 23
    "Ratificación del pacto",          // 24
    "Las ofrendas para el santuario; El arca",    // 25
    "El santuario",         // 26
    "El altar de los holocaustos",             // 27
    "Las vestiduras sacerdotales",                  // 28
    "Consagración de los sacerdotes",                       // 29
    "El altar del incienso; El aceite de la unción",     // 30
    "Bezalel y Aholiab; el sábado",                  // 31
    "El becerro de oro",                              // 32
    "Tienda de reunión; La gloria del Señor",          // 33
    "Las nuevas tablas de piedra",                 // 34
    "Normas para el sábado; Materiales para el santuario",               // 35
    "El santuario",                  // 36
    "El arca",     // 37
    "El altar de los holocaustos",       // 38
    "Las vestiduras sacerdotales; El efod; El pectoral",                         // 39
    "Se levanta el santuario; La gloria del Señor"          // 40
  ],

  "Levítico": [
    "El holocausto",                                    // 1
    "La ofrenda de cereal",                             // 2
    "El sacrificio de comunión",                               // 3
    "El sacrificio de perdón de pecados",                         // 4
    "El perdón por diversos pecados",                          // 5
    "El holocausto",         // 6
    "El sacrificio por la culpa",                      // 7
    "La ordenación de Aarón y sus hijos",             // 8
    "Los sacerdotes inician su ministerio",        // 9
    "Muerte de Nadab y Abiú",         // 10
    "Leyes sobre animales puros e impuros",                   // 11
    "Purificación después del alumbramiento",                // 12
    "Leyes sobre enfermedades cutáneas",                 // 13
    "Purificación de las enfermedades cutáneas",         // 14
    "Impurezas sexuales en el hombre",                 // 15
    "El día del Perdón",                           // 16
    "Prohibición de comer sangre",        // 17
    "Relaciones sexuales ilícitas",                     // 18
    "Llamado a la santidad",                    // 19
    "Castigos por el pecado",                      // 20
    "La santidad de los sacerdotes",                    // 21
    "Las ofrendas del Señor",                      // 22
    "Calendario de fiestas solemnes",                    // 23
    "Iluminación del santuario",     // 24
    "El año sabático; El año del jubileo",                        // 25
    "Bendiciones de la obediencia",                     // 26
    "Rescate de las ofrendas al Señor"                                // 27
  ],

  "Números": [
    "Censo de las tribus de Israel",                      // 1
    "Disposición de las tribus en el campamento",             // 2
    "La tribu de Leví; Los sacerdotes; Ministerio de los levitas",                // 3
    "Ministerio de los coatitas; Ministerio de los guersonitas; Ministerio de los meraritas",                         // 4
    "La pureza del campamento; Restitución por daños; Ley sobre los celos",            // 5
    "Los nazareos",                       // 6
    "Ofrendas para la consagración del santuario",       // 7
    "Las lámparas del candelabro",                   // 8
    "La fecha de la Pascua",                      // 9
    "La señal de las trompetas",                        // 10
    "El fuego del Señor en Taberá; Queja del pueblo en Quibrot Hatavá",                     // 11
    "Quejas de Miriam y de Aarón; Moisés intercede por Miriam",                   // 12
    "Los israelitas exploran Canaán",                     // 13
    "El pueblo se rebela",                    // 14
    "Leyes adicionales sobre las ofrendas",                      // 15
    "La rebelión de Coré, Datán y Abirán",                           // 16
    "La vara de Aarón",                              // 17
    "Deberes de sacerdotes y levitas",            // 18
    "Purificación de los impuros",                   // 19
    "El agua de la roca",                               // 20
    "Derrota de Arad",                 // 21
    "Balac manda llamar a Balán",               // 22
    "Primer mensaje de Balán",               // 23
    " ",               // 24
    "Infidelidad de Israel",                      // 25
    "Segundo censo de las tribus de Israel",                      // 26
    "Las hijas de Selofehad",                        // 27
    "Calendario litúrgico; Sacrificio diario",                          // 28
    "Fiesta de las Trompetas; El día del Perdón",                      // 29
    "Promesas de las mujeres",                               // 30
    "Guerra contra Madián",              // 31
    "Rubén y Gad se establecen en Transjordania",                      // 32
    "Ruta de Israel por el desierto",                              // 33
    "Fronteras de Canaán",                // 34
    "Ciudades levíticas",                       // 35
    "Herencia de las mujeres"            // 36
  ],

  "Deuteronomio": [
    "Moisés ordena salir de Horeb",     // 1
    "Peregrinación por el desierto",     // 2
    "Derrota de Og, rey de Basán",                        // 3
    "Exhortación a la obediencia; Prohibición de la idolatría", // 4
    "Los Diez Mandamientos",            // 5
    "El amor a Dios",                        // 6
    "Expulsión de las naciones",            // 7
    "No te olvides del Señor tu Dios",                             // 8
    "El mérito no es de Israel",          // 9
    "Las nuevas tablas de la ley",       // 10
    "Amor y obediencia al Señor",                         // 11
    "El lugar único de adoración",                   // 12
    "Advertencia contra la idolatría",          // 13
    "Alimentos puros e impuros; Los diezmos",                        // 14
    "El año del perdón de las deudas; Liberación de los esclavos",   // 15
    "Fiesta de la Pascua",                       // 16
    "Los tribunales; el rey",                      // 17
    "Ofrendas para los sacerdotes levitas; Costumbres abominables; El profeta",        // 18
    "Las ciudades de refugio",                 // 19
    "Instrucciones para la guerra",                             // 20
    "Un caso especial de homicidio; El matrimonio con prisioneras de guerra; Diversas leyes",    // 21
    " ",                   // 22
    "Exclusión de la asamblea; Otras leyes",         // 23
    " ",                  // 24
    " ",                       // 25
    "Diezmos y primicias; Exhortación a seguir los mandamientos del Señor",                 // 26
    "El altar sobre el monte Ebal; Maldiciones desde el monte Ebal",                // 27
    "Bendiciones por la obediencia; Maldiciones por la desobediencia",                      // 28
    "La renovación del pacto",                   // 29
    "Bendición a causa del arrepentimiento; Elección entre la vida y la muerte",            // 30
    "Josué, sucesor de Moisés",                   // 31
    "Cántico de Moisés",                              // 32
    "Moisés bendice a las tribus",             // 33
    "Muerte de Moisés"                                // 34
  ],

  "Josué": [
    "Comisión de Josué; preparación para cruzar",            // 1
    "Los dos espías y Rahab",                                // 2
    "Israel cruza el Jordán",                                // 3
    "Doce piedras por memorial",                             // 4
    "Circuncisión en Gilgal y Pascua; el Príncipe del ejército", // 5
    "Caída de Jericó",                                       // 6
    "Pecado de Acán y derrota en Hai",                       // 7
    "Toma de Hai y altar en Ebal; lectura de la ley",        // 8
    "Astucia de los gabaonitas",                             // 9
    "El sol se detiene; campaña del sur",                    // 10
    "Conquista del norte; sumario de victorias",             // 11
    "Relación de reyes vencidos",                            // 12
    "Tierras por repartir; herencia al otro lado del Jordán",// 13
    "Caleb recibe Hebrón",                                   // 14
    "Herencia de Judá",                                      // 15
    "Herencia de los hijos de José (Efraín)",                // 16
    "Herencia de Manasés y pedido de más tierra",            // 17
    "Restante distribución en Siló; herencia de Benjamín",   // 18
    "Herencia de Simeón, Zabulón, Isacar, Aser, Neftalí y Dan; herencia de Josué", // 19
    "Ciudades de refugio",                                   // 20
    "Ciudades levíticas",                                    // 21
    "El altar junto al Jordán y la controversia",            // 22
    "Exhortación final de Josué",                            // 23
    "Pacto renovado en Siquem; muerte de Josué y Eleazar"    // 24
  ],
