...
export const versiculosDestacados = [
  ...
  { libro: "Filipenses", capitulo: 4, versiculo: 8, texto: "Por último, hermanos, consideren bien todo lo verdadero, todo lo respetable, todo lo justo, todo lo puro, todo lo amable, todo lo digno de admiración, en fin, todo lo que sea excelente o merezca elogio." },
  { libro: "Salmos", capitulo: 139, versiculo: 14, texto: "Te alabaré; porque formidables, maravillosas son tus obras; Estoy maravillado, y mi alma lo sabe muy bien." },
  { libro: "Salmos", capitulo: 139, versiculo: 1, texto: "Oh Jehová, tú me has examinado y conocido." },
  { libro: "Salmos", capitulo: 139, versiculo: 2, texto: "Tú has conocido mi sentarme y mi levantarme; Has entendido desde lejos mis pensamientos." },
  { libro: "Salmos", capitulo: 139, versiculo: 3, texto: "Has escudriñado mi anda y mi reposo, Y todos mis caminos de son conocidos." },
  { libro: "Salmos", capitulo: 94, versiculo: 17, texto: "Si no me ayudara jehová, Pronto moraria mi alma en el silencio." },
  { libro: "Salmos", capitulo: 94, versiculo: 18, texto: "Cuando yo decía: Mi pie resbala, Tu misericordia, oh Jehová, me sustentaba." },
  { libro: "Salmos", capitulo: 94, versiculo: 22, texto: "Mas Jehová me ha sido por refugio, Y mi Dios por roca de mi confianza." },
  { libro: "Salmos", capitulo: 143, versiculo: 7, texto: "Respóndeme pronto, oh Jehová, porque desmaya mi espíritu; No escondas de mí tu rostro, No venga yo a ser semejante a los que descienden a la sepultura." },
  { libro: "Deuteronomio", capitulo: 10, versiculo: 12, texto: "Y ahora, Israel, ¿qué es lo que el Señor tu Dios pide de ti? Solamente que temas al Señor tu Dios, que vayas por todos sus caminos, y que ames y sirvas al Señor tu Dios con todo tu corazón y con toda tu alma." },
  { libro: "Eclesiastés", capitulo: 3, versiculo: 1, texto: "Todo tiene su tiempo, y todo lo que se quiere debajo del cielo tiene su hora." },
  { libro: "Romanos", capitulo: 10, versiculo: 11, texto: "Pues la Escritura dice: Todo aquel que en él creyere, no será avergonzado." },
  { libro: "Romanos", capitulo: 13, versiculo: 9, texto: "Porque: No adulterarás, no matarás, no hurtarás, no dirás falso testimonio, no codiciarás, y cualquier otro mandamiento, en esta sentencia se resume: Amarás a tu prójimo como a ti mismo." },
  { libro: "S.Mateo", capitulo: 22, versiculo: 37, texto: "Jesús le dijo: Amarás al Señor tu Dios con todo tu corazón, y con toda tu alma, y con toda tu mente." },
  { libro: "Josué", capitulo: 1, versiculo: 9, texto: "Mira que te mando que te esfuerces y seas valiente; no temas ni desmayes, porque Jehová tu Dios estará contigo en donde quiera que vayas." },
  { libro: "1 Pedro", capitulo: 4, versiculo: 16, texto: "Pero si alguno padece como cristiano, no se averguence, sino glorifique a Dios por ello." },
  { libro: "Filipenses", capitulo: 3, versiculo: 14, texto: "Prosigo a la meta, al premio del supremo llamamiento de Dios en Cristo Jesús." },
  { libro: "Filipenses", capitulo: 3, versiculo: 15, texto: "Así que, todos los que somos perfectos, esto mismo sistamos; y si otra cosa sentís, esto también os lo revelará Dios." },
  { libro: "Filipenses", capitulo: 3, versiculo: 16, texto: "Pero en aquello a que hemos llegado, sigamos una misma regla, sintamos una misma cosa." },
  { libro: "Filipenses", capitulo: 3, versiculo: 17, texto: "Hermanos, sed imitadores de mí, y mirad a los que así se conducen según el ejemplo que tenéis en nosotros." },
  { libro: "Jeremías", capitulo: 30, versiculo: 12, texto: "Porque así ha dicho Jehová: Incurable es tu quebrantamiento, y dolorosa tu llaga." },
  { libro: "Jeremías", capitulo: 30, versiculo: 17, texto: "Mas yo haré venir sanidad para ti, y sanaré tus heridas, dice Jehová; porque desechada te llamaron, diciendo: Esta es Sion, de la que nadie se acuerda." },
  { libro: "1 Tesalonicenses", capitulo: 5, versiculo: 23, texto: "Y el mismo Dios de paz os santifique por completo; y todo vuestro ser, espíritu, alma y cuerpo, sea guardado irreprensible para la venida de nuestro Señor Jesucristo." },
  { libro: "S.Lucas", capitulo: 18, versiculo: 27, texto: "El les dijo: Lo que es imposible para los hombres, es posible para Dios." },
  { libro: "S.Mateo", capitulo: 19, versiculo: 26, texto: "Y mirándolos Jesús, les dijo: Para los hombres esto es imposible; mas para Dios todo es posible." },
  { libro: "Isaias", capitulo: 40, versiculo: 10, texto: "No temas, porque yo estoy contigo; no desmayes, porque yo soy tu Dios que te esfuerzo; siempre te ayudaré, siempre te sustentaré con la diestra de mi justicia." },
  { libro: "1 Crónicas", capitulo: 16, versiculo: 25, texto: "Porque grande es Jehová, y digno de suprema alabranza, Y de ser temido sobre todos los dioses." },
];